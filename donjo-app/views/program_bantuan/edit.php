			...
			<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input name="nama" class="form-control form-control-sm nomor_sk" maxlength="100" placeholder="Nama Program"  type="text" value="<?= $data["nama"]; ?>"></input>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="ndesc">Keterangan</label>
						<div class="col-sm-8">
							<textarea id="ndesc" name="ndesc" class="form-control form-control-sm required" placeholder="Isi Keterangan" maxlength="500" rows="8"><?= $data["ndesc"]; ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select class="form-control form-control-sm required" name="asaldana" id="asaldana">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group input-group-sm date">
								...
								<input class="form-control form-control-sm pull-right" id="tgl_1" name="sdate" placeholder="Tgl. Mulai" type="text" value="<?= date("d/m/Y",strtotime($data["sdate"])); ?>">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group input-group-sm date">
								...
								<input class="form-control form-control-sm pull-right" id="tgl_2" name="edate" placeholder="Tgl. Akhir" type="text" value="<?= date("d/m/Y",strtotime($data["edate"])); ?>">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select class="form-control form-control-sm required" name="status" id="status">
