							...
							<table class="table table-bordered table-striped dataTable table-hover tabel-daftar">
								<thead class="bg-gray color-palette">
									<tr>
										...
										<?php if ($o==4): ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/3")?>">Aktif <i class='fa fa-sort-asc fa-sm'></i></a></th>
										<?php elseif ($o==3): ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/4")?>">Aktif <i class='fa fa-sort-desc fa-sm'></i></a></th>
										<?php else: ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/3")?>">Aktif <i class='fa fa-sort fa-sm'></i></a></th>
										<?php endif; ?>
										<?php if ($o==6): ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/5")?>">Dimuat Pada <i class='fa fa-sort-asc fa-sm'></i></a></th>
										<?php elseif ($o==5): ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/6")?>">Dimuat Pada <i class='fa fa-sort-desc fa-sm'></i></a></th>
										<?php else: ?>
											<th><a href="<?= site_url("{$this->controller}/index/$p/5")?>">Dimuat Pada <i class='fa fa-sort fa-sm'></i></a></th>
										<?php endif; ?>
									</tr>
								</thead>
								<tbody>
