										...
										<tr>
											...
											<td nowrap>
												...
												<?php if ($data['enabled'] == '2'): ?>
													<a href="<?= site_url($this->controller.'/lock/'.$data['id'].'/1')?>" class="btn bg-navy btn-flat btn-xs"  title="Aktifkan"><i class="fa fa-lock">&nbsp;</i></a>
												<?php elseif ($data['enabled'] == '1'): ?>
													<a href="<?= site_url($this->controller.'/lock/'.$data['id'].'/2')?>" class="btn bg-navy btn-flat btn-xs"  title="Non Aktifkan"><i class="fa fa-unlock"></i></a>
												<?php endif ?>
