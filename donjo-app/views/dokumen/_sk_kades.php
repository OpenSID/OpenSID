...
<div class="form-group">
	<label class="control-label col-sm-4" for="nama">Nomor Keputusan <?= setting('sebutan_kepala_desa') ?></label>
	<div class="col-sm-6">
		<input name="attr[no_kep_kades]" class="form-control input-sm nomor_sk" type="text" value="<?= $dokumen['attr']['no_kep_kades']?>"></input>
	</div>
</div>
<div class="form-group">
	<label class="control-label col-sm-4" for="nama">Tgl Keputusan <?= setting('sebutan_kepala_desa') ?></label>
	<div class="col-sm-6">
