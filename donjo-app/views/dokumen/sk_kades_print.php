...
<div id="body">
	...
	<table id="ttd" width="100%">
		...
		<tr>
			...
			<td colspan="2" width="25%" align="center"><span class="underline"><?php echo strtoupper($this->setting->sebutan_desa.' '.$desa['nama_desa'].', '.$desa['nama_kecamatan'].', '.tgl_indo(date("Y m d")))?></span></td>
			<td colspan="1" width="25%">&nbsp;</td>
		</tr>
		<tr>
			<td colspan="1">&nbsp;</td>
			<td colspan="2" align="center"><?php echo strtoupper($input['jabatan_ketahui'])?></td>
			<td colspan="2" align="center"><?php echo strtoupper($input['jabatan_ttd'])?></td>
			<td colspan="1">&nbsp;</td>
		</tr>
		<tr><td colspan="6">&nbsp;</td></tr>
		<tr><td colspan="6">&nbsp;</td></tr>
		...
		<tr>
			<td colspan="1">&nbsp;</td>
			<td colspan="2" align="center"><span class="underline"><?php echo strtoupper($input['pamong_ketahui'])?></span></td>
			<td colspan="2" align="center"><span class="underline"><?php echo strtoupper($input['pamong_ttd'])?></span></td>
			<td colspan="1">&nbsp;</td>
		</tr>
	</table>
</div>
