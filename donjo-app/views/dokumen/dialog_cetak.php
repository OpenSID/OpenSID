				...
				<div class="card card-outline card-danger">
					<div class="card-body">
						...
						<?php if ($kat == 3): ?>
							<div class="form-group">
								<label class="control-label">Jenis Peraturan</label>
									<select class="form-control form-control-sm select" name="jenis_peraturan" style="width: 100%;">
						...
						<div class="form-group">
							...
							<select class="form-control form-control-sm jenis_link required" name="pamong_ttd">
						...
						<div class="form-group">
							...
							<select class="form-control form-control-sm jenis_link required"  name="pamong_ketahui">
