...
<div class="form-group">
    <label class="control-label col-sm-4" for="nama">No. Diundangkan Dlm Lembaran <?= ucwords($this->setting->sebutan_desa); ?></label>
    <div class="col-sm-6">
...
<div class="form-group">
    <label class="control-label col-sm-4" for="nama">Tgl Diundangkan Dlm Lembaran <?= ucwords($this->setting->sebutan_desa); ?></label>
    <div class="col-sm-6">
        <div class="input-group input-group-sm date">
            <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
