			...
			<div class="col-sm-12">
				<div class="card-body">
					<div class="form-group">
						...
						<input  id="kategori" class="form-control form-control-sm required nomor_sk" maxlength="50" type="text" placeholder="Kategori Indikator" name="kategori" value="<?= $analisis_kategori['kategori']?>">
					</div>
				</div>
			</div>
		</div>
