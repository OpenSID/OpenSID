...
<th width="160">Aksi</th><?php }?>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div class="uibutton-group">
				<?php if($data['id_tipe']==1 OR $data['id_tipe']==2){?><a href="<?php echo site_url("analisis_indikator/parameter/$data[id]")?>" class="uibutton"><span class="fa fa-list "></span> Parameter</a><?php }?>
				<a href="<?php echo site_url("analisis_indikator/form/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="edit-edit "></span> Ubah </a>
