															...
															<tbody>
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<?php if ($analisis_master['lock']==1): ?>
																			<td nowrap>
																				<a href="<?= site_url("analisis_indikator/form_parameter/$analisis_indikator[id]/$data[id]") ?>" class="btn bg-orange btn-flat btn-xs" title="Ubah Data"  data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Data Parameter"><i class='fa fa-edit'></i></a>
																				<?php if ($analisis_master['jenis']!=1): ?>
																					<a href="#" data-href="<?= site_url("analisis_indikator/p_delete/$analisis_indikator[id]/$data[id]") ?>" class="btn bg-maroon btn-flat btn-xs"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																				<?php endif; ?>
																			</td>
																		<?php endif; ?>
