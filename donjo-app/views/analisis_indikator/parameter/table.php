...
<div id="contentpane">
 ...
 <?php if($analisis_master['lock']==1){?> <a href="<?php echo site_url("analisis_indikator/form_parameter/$analisis_indikator[id]")?>" class="uibutton tipsy south" title="Tambah Data" target="ajax-modal" rel="window" header="Form Data Jawaban"><span class="fa fa-plus-square">&nbsp;</span>Tambah Ukuran/Nilai Baru</a>
