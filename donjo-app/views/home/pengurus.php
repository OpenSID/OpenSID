    ...
    <div class="ui-layout-north panel">
        <div class="left"><h3>Pemerintah <?php echo ucwords(config_item('sebutan_desa'))?></h3>
            <div class="uibutton-group">
                <a href="<?php echo site_url('pengurus/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-square ">&nbsp;</span>Tambah Staf Pemerintah <?php echo ucwords(config_item('sebutan_desa'))?></a>
