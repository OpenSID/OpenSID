			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">
						Staf Pemerintahan <?= ucwords($this->setting->sebutan_desa)?>
					</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?= site_url('hom_sid'); ?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item"><a href="<?= site_url('pengurus')?>"</i> Daftar Staf Pemerintahan</a></li>
						<li class="breadcrumb-item active">Staf Pemerintahan <?= ucwords($this->setting->sebutan_desa)?></li>
					</ol>
				</div>
			</div>
		</div>
					...
					<div class="col-sm-12">
						<div class="card card-outline card-info">
							<div class="card-header with-border">
								<a href="<?= site_url()?>pengurus" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Staf</a>
							</div>
							<div class="card-body">
								<div class="row mb-2">
								...
								<form action="" id="main" name="main" method="POST"  class="form-horizontal">
									<div class="row mb-2">
						  			<label class="col-sm-4 col-lg-2 control-label" for="id_pend">NIK / Nama Penduduk </label>
										<div class="col-sm-7">
											<select class="form-control form-control-sm select2 text-xs" id="id_pend" name="id_pend"  onchange="formAction('main')" style="width:100%" >
				...
				<div class="col-md-3">
					<div class="card card-outline card-primary">
						<div class="card-body card-profile">
							<?php if ($pamong['foto']): ?>
								<img class="profile-user-img img-fluid rounded mx-auto d-block card-img-top" src="<?= AmbilFoto($pamong['foto'])?>" alt="Foto">
							<?php else: ?>
								<img class="profile-user-img img-fluid rounded mx-auto d-block card-img-top" src="<?= base_url()?>assets/files/user_pict/kuser.png" alt="Foto">
							<?php endif; ?>
							<br/>
						...
						<div class="card-body">
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									...
									<input name="pamong_desa" class="form-control form-control-sm pengurus-desa" type="text" placeholder="Nama" value="<?= ($individu['nama'])?>" disabled="disabled"></input>
									<input id="pamong_nama" name="pamong_nama" class="form-control form-control-sm pengurus-luar-desa <?= !empty($individu) ?: 'required'?>" type="text" placeholder="Nama" value="<?= ($pamong['pamong_nama'])?>" style="display: none;"></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_nik">Nomor Induk Kependudukan</label>
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Nomor Induk Kependudukan" value="<?=$individu['nik']?>" disabled="disabled"></input>
									<input id="pamong_nik" name="pamong_nik" class="form-control form-control-sm pengurus-luar-desa nik" type="text" maxlength="16" placeholder="Nomor Induk Kependudukan" value="<?=$pamong['pamong_nik']?>" style="display: none;"></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_niap"><?= $this->setting->sebutan_nip_desa ?></label>
								<div class="col-sm-7">
									<input id="pamong_niap" name="pamong_niap" class="form-control form-control-sm digits" type="text" maxlength="25" placeholder="<?= $this->setting->sebutan_nip_desa ?>" value="<?=$pamong['pamong_niap']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_nip">NIP</label>
								<div class="col-sm-7">
									<input id="pamong_nip" name="pamong_nip" class="form-control form-control-sm digits" type="text" maxlength="20" placeholder="NIP" value="<?=$pamong['pamong_nip']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_tempatlahir">Tempat Lahir</label>
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Tempat Lahir" value="<?= strtoupper($individu['tempatlahir'])?>" disabled="disabled"></input>
									<input name="pamong_tempatlahir" class="form-control form-control-sm pengurus-luar-desa" type="text" placeholder="Tempat Lahir" value="<?= strtoupper($pamong['pamong_tempatlahir'])?>" style="display: none;"></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_tanggallahir">Tanggal Lahir</label>
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Tanggal Lahir" value="<?= strtoupper($individu['tanggallahir'])?>" disabled="disabled"></input>
									<div class="input-group input-group-sm date pengurus-luar-desa" style="display: none;">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input class="form-control form-control-sm pull-right tgl_1" name="pamong_tanggallahir" type="text" value="<?= tgl_indo_out($pamong['pamong_tanggallahir'])?>">
									</div>
								</div>
							</div>
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Jenis Kelamin" value="<?= $individu['sex']?>" disabled="disabled"></input>
									<select class="form-control form-control-sm pengurus-luar-desa" name="pamong_sex" onchange="show_hide_hamil($(this).find(':selected').val());" style="display: none;">
							...
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Pendidikan" value="<?= $individu['pendidikan_kk']?>" disabled="disabled"></input>
									<select class="form-control form-control-sm pengurus-luar-desa" name="pamong_pendidikan" style="display: none;">
							...
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input class="form-control form-control-sm pengurus-desa" type="text" placeholder="Agama" value="<?= $individu['agama']?>" disabled="disabled"></input>
									<select class="form-control form-control-sm pengurus-luar-desa" name="pamong_agama" style="display: none;">
							...
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input name="pamong_pangkat" class="form-control form-control-sm" type="text" placeholder="Pangkat / Golongan" value="<?= $pamong['pamong_pangkat']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="pamong_nosk">Nomor SK Pengangkatan</label>
								<div class="col-sm-7">
									<input name="pamong_nosk" class="form-control form-control-sm" type="text" maxlength="30" placeholder="Nomor SK Pengangkatan" value="<?= $pamong['pamong_nosk']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control form-control-sm pull-right tgl_1" name="pamong_tglsk" type="text" value="<?= tgl_indo_out($pamong['pamong_tglsk'])?>">
									</div>
								</div>
							</div>
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input name="pamong_nohenti" class="form-control form-control-sm" type="text" placeholder="Nomor SK Pemberhentian" value="<?= $pamong['pamong_nohenti']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control form-control-sm pull-right tgl_1" name="pamong_tglhenti" type="text" value="<?= tgl_indo_out($pamong['pamong_tglhenti'])?>">
									</div>
								</div>
							</div>
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input name="pamong_masajab" class="form-control form-control-sm" type="text" placeholder="Contoh: 6 Tahun Periode Pertama (2015 s/d 2021)" value="<?= $pamong['pamong_masajab']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label" for="jabatan">Jabatan</label>
								<div class="col-sm-7">
									<input id="jabatan" name="jabatan" class="form-control form-control-sm required" type="text" placeholder="Jabatan" value="<?= $pamong['jabatan']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
							...
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<input name="bagan_tingkat" class="form-control form-control-sm number" type="text" placeholder="Angka menunjukkan tingkat di bagan organisasi. Contoh: 2" value="<?= $pamong['bagan_tingkat']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label bagan" for="jabatan">Bagan - Offset</label>
								<div class="col-sm-7">
									<input name="bagan_offset" class="form-control form-control-sm number" type="text" placeholder="Angka menunjukkan persentase geser kiri (-n) atau kanan (+n). Contoh: 75%" value="<?= $pamong['bagan_offset']?>" ></input>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-4 control-label bagan" for="jabatan">Bagan - Layout</label>
								<div class="col-sm-7">
									<select class="form-control form-control-sm" name="bagan_layout">
							...
							<div class="row mb-2">
								...
								<div class="col-sm-7">
									<div class="input-group my-colorpicker2">
										<input type="text" name="bagan_warna" class="form-control form-control-sm" placeholder="#FFFFFF" value="<?=  $pamong['bagan_warna']?>">
