<!-- Perubahan script coding untuk bisa menampilkan halaman donasi dalam bentuk tampilan bootstrap (AdminLTE)  -->
<div class="content-wrapper">
	<section class='content-header'>
		<h1>Donasi</h1>
		<ol class='breadcrumb'>
			<li><a href='<?= site_url()?>'><i class='fa fa-dashboard'></i> <?=ucwords($this->setting->sebutan_desa)?></a></li>
					...
					<div class='box-body'>
						...
						<div>
							...
							<ul>
								...
								<li>Penyiapan dan penyempurnaan panduan OpenSID</li>
								<li>Pengembangan dan perbaikan aplikasi OpenSID</li>
								<li>Mengalihkan aplikasi terkait, seperti Sistem Keuangan Desa menjadi OpenSource, untuk manfaat desa</li>
								<li>dll</li>
							</ul>
						</div>
