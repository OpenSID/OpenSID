						...
						<div class="card-header with-border">
							<div class="row">
								<div class="col-sm-12">
									...
									<a href="<?= site_url("penduduk_log/ajax_cetak/$o/cetak")?>" class="btn btn-flat bg-purple btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" title="Cetak Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Data" target="_blank"><i class="fa fa-print "></i> Cetak</a>
									<a href="<?= site_url("penduduk_log/ajax_cetak/$o/unduh")?>" class="btn btn-flat bg-navy btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data" target="_blank"><i class="fa  fa-download"></i> Unduh</a>
									<a href="<?= site_url('penduduk/clear')?>" class="btn btn-flat bg-maroon btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Penduduk</a>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="dataTables_wrapper dt-bootstrap no-footer">
										<div class="row">
											<div class="col-sm-9">
												<select class="form-control form-control-sm" name="status_dasar" onchange="formAction('mainform', '<?=site_url('penduduk_log/filter/status_dasar')?>')">
												...
												<select class="form-control form-control-sm" name="sex" onchange="formAction('mainform','<?= site_url('penduduk_log/filter/sex')?>')">
													<option value="">Jenis Kelamin</option>
													<?php foreach ($list_sex AS $data): ?>
														<option value="<?= $data['id']?>" <?php selected($sex, $data['id']); ?>><?= set_ucwords($data['nama'])?></option>
													<?php endforeach; ?>
												</select>
												<select class="form-control form-control-sm" name="agama" onchange="formAction('mainform','<?= site_url('penduduk_log/filter/agama')?>')">
													<option value="">Agama</option>
													<?php foreach ($list_agama AS $data): ?>
														<option value="<?= $data['id']?>" <?php selected($agama, $data['id']); ?>><?= set_ucwords($data['nama'])?></option>
													<?php endforeach; ?>
												</select>
												<select class="form-control form-control-sm " name="dusun" onchange="formAction('mainform','<?= site_url('penduduk_log/dusun')?>')">
												...
												<?php if ($dusun): ?>
													<select class="form-control form-control-sm" name="rw" onchange="formAction('mainform','<?= site_url('penduduk_log/rw')?>')" >
												...
												<?php endif; ?>
												<?php if ($rw): ?>
													<select class="form-control form-control-sm" name="rt" onchange="formAction('mainform','<?= site_url('penduduk_log/rt')?>')">
														...
														<tbody>
															<?php foreach ($main as $data): ?>
																<tr>
																	...
																	<td class="aksi">
																		<a href="<?= site_url("penduduk_log/edit/$p/$o/$data[id_log]")?>" class="btn bg-orange btn-flat btn-xs"  title="Ubah Log Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Log Penduduk" ><i class="fa fa-edit"></i></a>
																		<a href="#" data-href="<?= site_url("penduduk_log/kembalikan_status/$data[id_log]")?>" class="btn bg-olive btn-flat btn-xs" title="Kembalikan Status"  data-remote="false"  data-toggle="modal" data-target="#confirm-status"><i class="fa fa-undo"></i></a>
																	</td>
																	<td nowrap>
