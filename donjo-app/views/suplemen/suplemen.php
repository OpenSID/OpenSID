									...
									<?php	foreach ($suplemen as $key => $item):	?>
										<tr>
											...
											<td class="aksi">
												...
												<a href="#" data-href="<?= ($item['jml'] > 0) ? site_url("suplemen/hapus/$item[id]") : '#'; ?>" class="btn bg-maroon btn-flat btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete" <?= jecho($item['jml'], 0, 'disabled'); ?>><i class="fa fa-trash-o"></i></a>
											</td>
