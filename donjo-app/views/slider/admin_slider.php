						...
						<div class="card-body">
							<div class="row">
								<div data-toggle="buttons">
									<div class="col-sm-12">
										<div class="radio">
											<label data-toggle="tooltip" title="10 gambar utama artikel terbaru" data-placement="bottom" class="btn btn-info btn-flat btn-xs col-xs-12 col-md-4 col-lg-3 <?php if ($this->setting->sumber_gambar_slider == '1'): ?>active<?php endif ?>">
									...
									<div class="col-sm-12">
										<div class="radio">
											<label data-toggle="tooltip" title="10 gambar utama artikel terbaru yang masuk ke slider atas" data-placement="bottom" class="btn btn-info btn-flat btn-xs col-xs-12 col-md-4 col-lg-3 <?php if ($this->setting->sumber_gambar_slider == '2'): ?>active<?php endif ?>">
									...
									<div class="col-sm-12">
										<div class="radio">
											<label data-toggle="tooltip" title="Gambar dalam album galeri yang dimasukkan ke slider" data-placement="bottom" class="btn btn-info btn-flat btn-xs col-xs-12 col-md-4 col-lg-3 <?php if ($this->setting->sumber_gambar_slider == '3'): ?>active<?php endif ?>">
