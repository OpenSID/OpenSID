						...
						<div class="box-body">
							<div class="row">
								<div data-toggle="buttons">
									<div class="col-sm-12">
										<div class="radio">
											<label data-toggle="tooltip" title="<?= $this->setting->jumlah_gambar_slider ?? 10 ?> gambar utama artikel terbaru" data-placement="bottom" class="btn btn-info btn-flat btn-sm col-xs-12 col-md-4 col-lg-3 <?php if ($this->setting->sumber_gambar_slider == '1'): ?>active<?php endif ?>">
											...
											<label class="control-label row"> <?= $this->setting->jumlah_gambar_slider ?? 10 ?> gambar utama artikel terbaru</lable>
										</div>
									</div>
									<div class="col-sm-12">
										<div class="radio">
											<label data-toggle="tooltip" title="<?= $this->setting->jumlah_gambar_slider ?? 10 ?> gambar utama artikel terbaru yang masuk ke slider atas" data-placement="bottom" class="btn btn-info btn-flat btn-sm col-xs-12 col-md-4 col-lg-3 <?php if ($this->setting->sumber_gambar_slider == '2'): ?>active<?php endif ?>">
											...
											<label class="control-label row"> <?= $this->setting->jumlah_gambar_slider ?? 10 ?> gambar utama artikel terbaru yang masuk ke slider atas</lable>
										</div>
									</div>
									<div class="col-sm-12">
										<div class="radio">
