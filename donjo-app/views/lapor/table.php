	...
	<section class="content" id="maincontent">
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="box-header with-border">
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform','<?=site_url("lapor/delete_all/$p/$o")?>')" class="btn btn-social btn-flat btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
												...
												<div class="col-sm-6">
													<div class="box-tools">
														<div class="input-group input-group-sm pull-right">
															<input name="cari" id="cari" class="form-control" placeholder="cari..." type="text" value="<?=$cari?>" onkeypress="if (event.keyCode == 13) :$('#'+'mainform').attr('action','<?=site_url('lapor/search')?>');$('#'+'mainform').submit();endif;">
                                  ...
                                  <?php  endif; ?>
                                      ...
                                      <?php if ($data['enabled'] == '2'):?>
                                        <a href="<?=site_url('lapor/komentar_lock/'.$data['id'])?>" class="btn bg-purple btn-flat btn-sm"  title="Tindak-lanjuti laporan"><i class="fa fa-check"></i></a>
                                      <?php elseif ($data['enabled'] == '1'): ?>
                                        <a href="<?=site_url('lapor/komentar_unlock/'.$data['id'])?>" class="btn bg-navy btn-flat btn-sm"  title="Kembalikan ke status awal"><i class="fa fa-times"></i></a>
                                      <?php endif; ?>
                                    </td>
                                    <td nowrap><?=$data['owner']?></td>
                                    <td><?=$data['email']?></td>
                                    <td width="40%" nowrap><?=$data['komentar']?></td>
                                    <td><?=$data['aktif']?></td>
