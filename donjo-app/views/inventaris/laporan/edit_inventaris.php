                        ...
                        <form class="form-horizontal" id="form_update_gedung" name="form_update_gedung" method="post" action="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="alamat" id="alamat" ><?php echo $main->letak; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="no_bangunan" id="no_bangunan" type="text"  value="<?php echo (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" type="date" value="<?php echo $main->tanggal_dokument; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="luas_tanah" name="luas_tanah" type="number" value="<?php echo $main->luas; ?>" />
                                            <span class="input-group-addon" id="koefisien_dasar_bangunan-addon">M<sup>2</sup></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="kode_tanah" id="kode_tanah" type="text" value="<?php echo (!empty($main->kode_tanah) ? $main->kode_tanah : '-'); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="harga" name="harga" value="<?php echo $main->harga; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $("#form_update_gedung").validate({
            ...
            $.ajax({
                url: '<?php echo site_url("api_inventaris_gedung/update"); ?>' + '/' + $('#id').val(),
                method: 'post',
                dataType: 'json',
                data: formInput,
                contentType: false,
