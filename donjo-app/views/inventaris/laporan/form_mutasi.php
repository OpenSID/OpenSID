            ...
            <div class='box box-default'>
                ...
                <div class='box-body'>
                    <div class="form">
                        ...
                        <form class="form-horizontal" id="form_mutasi_gedung" name="form_mutasi_gedung" action="" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                      <select name="" id="" class="form-control" disabled>
                                          <option value="<?php echo $main->tanggal_dokument; ?>"><?php echo date('Y',strtotime($main->tanggal_dokument)); ?></option>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="pull-right" >
                                ...
                                <a href="<?php echo base_url() ?>index.php/inventaris_gedung" class="btn btn-default save"
...
$(document).ready(function(){
    ...
    $("#form_mutasi_gedung").validate({
        submitHandler: function(form) {
          var formInput = new FormData($(form));
          formInput.append('id_inventaris_gedung', $('#id_inventaris').val());
          ...
          $.ajax({
              url: '<?php echo site_url("api_inventaris_gedung/add_mutasi"); ?>',
              method: 'post',
              dataType: 'json',
              data: formInput,
              contentType: false,
