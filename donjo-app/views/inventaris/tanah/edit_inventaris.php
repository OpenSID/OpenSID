							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->kode_barang; ?>" class="form-control form-control-sm required" name="kode_barang" id="kode_barang" type="text" placeholder="Kode Barang"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input value="<?= $main->luas; ?>" class="form-control form-control-sm number required" id="luas" name="luas" type="text" placeholder="Luas Tanah"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="tahun_pengadaan" id="tahun_pengadaan" class="form-control form-control-sm required" placeholder="Tahun Pengadaan">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control form-control-sm required" name="letak" id="letak" placeholder="Letak / Alamat"><?= $main->letak; ?></textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" value="<?= $main->tanggal_sertifikat; ?>" class="form-control form-control-sm required" name="tanggal_sertifikat" id="tanggal_sertifikat" type="date" placeholder="Tanggal Sertifikat"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->no_sertifikat; ?>" class="form-control form-control-sm required" name="no_sertifikat" id="no_sertifikat" type="text" placeholder="Nomor Sertifikat"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												...
												<input value="<?= $main->harga; ?>" class="form-control form-control-sm number required" id="harga" name="harga" type="text" placeholder="Harga"/>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea rows="5" class="form-control form-control-sm required" name="keterangan" id="keterangan" placeholder="Keterangan"><?= $main->keterangan; ?></textarea>
										</div>
									</div>
								</div>
							</div>
