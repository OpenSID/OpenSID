						...
						<form class="form-horizontal" id="form_update_tanah" name="form_update_tanah" method="post" action="">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											<input type="number" value="<?= $main->luas; ?>" class="form-control" id="luas_tanah" name="luas_tanah" type="text" required/>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="<?= $main->tanggal_sertifikat; ?>" class="form-control" name="tanggal_sertifikat" id="tanggal_sertifikat" type="date" required />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label required" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
									<div class="col-sm-9">
										<input maxlength="50" value="<?= $main->no_sertifikat; ?>" class="form-control" name="nomor_sertifikat" id="nomor_sertifikat" type="text" required/>
									</div>
								</div>
								<div class="form-group">
...
$(document).ready(function()
{
	$("#form_update_tanah").validate(
	{
		submitHandler: function(form)
		{
		  ...
		  $.ajax(
		  {
			  url: '<?= site_url("api_inventaris_tanah/update"); ?>' + '/' + $('#id').val(),
			  method: 'post',
			  dataType: 'json',
			  data: formInput,
			  contentType: false,
