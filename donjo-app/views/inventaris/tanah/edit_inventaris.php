    ...
    <div class="panel-body">
        <section class="content">
            ...
            <div class='box box-default'>
                ...
                <div class='box-body'>
                    <div class="form">
                        <form class="form-horizontal" id="form_update_tanah" name="form_update_tanah" method="post" action="">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required" style="text-align:left;" for="nama_barang">Nama Barang</label>
                                    <div class="col-sm-9">
                                        <input type="hidden" id="id" name="id" value="<?php echo $main->id; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="number" value="<?php echo $main->luas; ?>" class="form-control" id="luas_tanah" name="luas_tanah" type="text" required/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="hak_tanah" id="hak_tanah" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->tanggal_sertifikat; ?>" class="form-control" name="tanggal_sertifikat" id="tanggal_sertifikat" type="date" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->no_sertifikat; ?>" class="form-control" name="nomor_sertifikat" id="nomor_sertifikat" type="text" required/>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#form_update_tanah").validate({
        submitHandler: function(form) {
          ...
          $.ajax({
              url: '<?php echo site_url("api_inventaris_tanah/update"); ?>' + '/' + $('#id').val(),
              method: 'post',
              dataType: 'json',
              data: formInput,
              contentType: false,
              ...
              success: function(){
                    ...
                    setTimeout(function(){
                        window.location.href = '<?php echo site_url("inventaris_tanah"); ?>';
                    }, 2000)
              },
              error: function(err){
