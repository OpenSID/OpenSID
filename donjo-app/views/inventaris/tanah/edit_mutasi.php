					...
					<div class="form">
						<form class="form-horizontal" id="update_mutasi_tanah" name="update_mutasi_tanah" method="post" action="">
							...
							<div class="pull-right" >
								...
								<a href="<?= base_url() ?>index.php/inventaris_tanah/mutasi" class="btn btn-default save"
...
<script>
	...
	$("#update_mutasi_tanah").validate(
	{
		submitHandler: function(form)
		{
		  ...
		  $.ajax(
		  {
			  url: '<?= site_url("api_inventaris_tanah/update_mutasi"); ?>'+'/'+ $('#id').val(),
			  method: 'post',
			  dataType: 'json',
			  data: formInput,
			  contentType: false,
			  ...
			  success: function()
			  {
					...
					setTimeout(function()
					{
						window.location.href = '<?= site_url("inventaris_tanah/mutasi"); ?>';
					}, 2000)
			  },
			  error: function(err)
			  {
