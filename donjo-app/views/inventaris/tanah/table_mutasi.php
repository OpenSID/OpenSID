														...
														<?php foreach ($main as $data): ?>
															<tr>
																...
																<td nowrap>
																	...
																	<?php endif; ?>
																	<a href="<?= base_url('inventaris_tanah/view_mutasi/'.$data->id); ?>" title="Lihat Data" class="btn bg-info btn-flat btn-sm"><i class="fa fa-eye"></i></a>
																	<a href="<?= base_url('inventaris_tanah/edit_mutasi/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-flat btn-sm"><i class="fa fa-edit"></i> </a>
