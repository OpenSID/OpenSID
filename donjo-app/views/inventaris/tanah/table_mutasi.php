							...
							<tr>
								...
								<td>
									<div class="btn-group" role="group" aria-label="...">
										<a href="<?php echo base_url('index.php/inventaris_tanah/view_mutasi/'.$data->id); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
										<a href="<?php echo base_url('index.php/inventaris_tanah/edit_mutasi/'.$data->id); ?>" title="Edit Data"  type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> </a> 
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					window.location = "../api_inventaris_tanah/delete_mutasi/" + $id;
				} else {
