						...
						<form class="form-horizontal" id="form_mutasi_tanah" name="form_mutasi_tanah" method="post" action="">
							<div class="col-md-6">
								...
								<div class="form-group harga_jual">
									...
									<div class="col-sm-9">
										<input maxlength="50"  class="form-control" name="harga_jual" id="harga_jual" type="number"/>
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="pull-right" >
								...
								<a href="<?= base_url() ?>index.php/inventaris_tanah" class="btn btn-default save"
...
$(document).ready(function()
{
	...
	$("#form_mutasi_tanah").validate(
	{
		submitHandler: function(form)
		{
		  var formInput = new FormData($(form));
		  formInput.append('id_inventaris_tanah', $('#id_inventaris').val());
		  ...
		  $.ajax(
		  {
			  url: '<?= site_url("api_inventaris_tanah/add_mutasi"); ?>',
			  method: 'post',
			  dataType: 'json',
			  data: formInput,
			  contentType: false,
