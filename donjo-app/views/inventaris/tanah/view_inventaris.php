							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input value="<?= $main->luas; ?>" class="form-control form-control-sm" id="luas_tanah" name="luas_tanah" type="text" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="hak_tanah" id="hak_tanah" class="form-control form-control-sm" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" value="<?= date('d M Y',strtotime($main->tanggal_sertifikat)); ?>" class="form-control form-control-sm" name="tanggal_sertifikat" id="tanggal_sertifikat" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label required" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->no_sertifikat; ?>" class="form-control form-control-sm" name="nomor_sertifikat" id="nomor_sertifikat" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label required" style="text-align:left;" for="penggunaan">Penggunaan </label>
										<div class="col-sm-4">
											<select name="penggunaan" id="penggunaan" class="form-control form-control-sm" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												...
												<input value="<?= $main->harga; ?>" class="form-control form-control-sm" id="harga" name="harga" type="text" disabled/>
											</div>
										</div>
									</div>
									<div class="form-group">
