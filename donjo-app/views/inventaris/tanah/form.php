...
<div class="content-wrapper">
	<section class="content-header">
		<h1><?= $label; ?> Data Inventaris Tanah</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Beranda</a></li>
			<li><a href="<?= site_url('inventaris_tanah') ?>"><i class="fa fa-dashboard"></i>Daftar Inventaris Tanah</a></li>
			<li class="active"><?= $label; ?> Data</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= site_url("api_inventaris_tanah/{$aksi}/{$main->id}"); ?>">
			<div class="row">
				<div class="col-md-3">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" value="<?= $main->tanggal_sertifikat; ?>" class="form-control input-sm" name="tanggal_sertifikat" id="tanggal_sertifikat" type="date" placeholder="Tanggal Sertifikat" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->no_sertifikat; ?>" class="form-control input-sm" name="no_sertifikat" id="no_sertifikat" type="text" placeholder="Nomor Sertifikat" />
										</div>
									</div>
									<div class="form-group">
