		...
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= $form_action?>">
          ...
          <?php	$this->load->view('inventaris/menu_kiri.php')?>
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_tanah/mutasi" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Tanah</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
