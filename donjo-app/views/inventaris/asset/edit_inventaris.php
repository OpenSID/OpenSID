                        ...
                        <form class="form-horizontal" id="form_update_asset" name="form_update_asset" method="post" action="">
                            <div class="col-md-6">
                                ...
                                <div class="form-group judul">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->judul_buku; ?>" id="judul" name="judul" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group spesifikasi">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->spesifikasi_buku; ?>" id="spesifikasi" name="spesifikasi" type="text"/>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $("#form_update_asset").validate({
        ...
        $.ajax({
            url: '<?php echo site_url("api_inventaris_asset/update"); ?>' + '/' + $('#id').val(),
            method: 'post',
            dataType: 'json',
            data: formInput,
            contentType: false,
