							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->id; ?>" class="form-control form-control-sm required" name="id" id="id" type="hidden"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="jenis_asset" id="jenis_asset" class="form-control form-control-sm required">
									...
									<div class="form-group judul">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->judul_buku; ?>" id="judul" name="judul" type="text"/>
										</div>
									</div>
									<div class="form-group spesifikasi">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->spesifikasi_buku; ?>" id="spesifikasi" name="spesifikasi" type="text"/>
										</div>
									</div>
									<div class="form-group asal_kesenian">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->asal_daerah; ?>" id="asal_kesenian" name="asal_kesenian" type="text" />
										</div>
									</div>
									<div class="form-group pencipta_kesenian">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->pencipta; ?>" id="pencipta_kesenian" name="pencipta_kesenian" type="text"/>
										</div>
									</div>
									<div class="form-group bahan_kesenian">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->bahan; ?>" id="bahan_kesenian" name="bahan_kesenian" type="text"/>
										</div>
									</div>
									<div class="form-group jenis_hewan">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->jenis_hewan; ?>" id="jenis_hewan" name="jenis_hewan" type="text"/>
										</div>
									</div>
									<div class="form-group ukuran_hewan">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control form-control-sm number" value="<?= $main->ukuran_hewan; ?>" id="ukuran_hewan" name="ukuran_hewan" type="text"/>
									...
									<div class="form-group jenis_tumbuhan">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm" value="<?= $main->jenis_tumbuhan; ?>" id="jenis_tumbuhan" name="jenis_tumbuhan" type="text"/>
										</div>
									</div>
									<div class="form-group ukuran_tumbuhan">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control form-control-sm number" value="<?= $main->ukuran_tumbuhan; ?>" id="ukuran_tumbuhan" name="ukuran_tumbuhan" type="text"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input class="form-control form-control-sm number" value="<?= $main->jumlah; ?>" id="jumlah" name="jumlah" type="text"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="asal_usul" id="asal_usul" class="form-control form-control-sm required">
