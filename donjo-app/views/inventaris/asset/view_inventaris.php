	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_asset" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Asset Lainnya</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input maxlength="50" value="<?= $main->nama_barang; ?>" class="form-control form-control-sm" name="nama_barang" id="nama_barang" type="text" disabled />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" style="text-align:left;" for="kode_barang">Kode Barang</label>
									<div class="col-sm-8">
										<input maxlength="50" value="<?= $main->kode_barang; ?>" class="form-control form-control-sm" name="kode_barang" id="kode_barang" type="text" disabled/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" style="text-align:left;" for="nomor_register">Nomor Register</label>
									<div class="col-sm-8">
										<input maxlength="50" value="<?= $main->register; ?>" class="form-control form-control-sm" name="nomor_register" id="nomor_register" type="text" disabled/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" style="text-align:left;" for="jenis_asset">Jenis Asset</label>
									<div class="col-sm-4">
										<select name="jenis_asset" id="jenis_asset" class="form-control form-control-sm" disabled>
								...
								<div class="form-group judul">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->judul_buku; ?>" id="judul" name="judul" type="text" disabled/>
									</div>
								</div>
								<div class="form-group spesifikasi">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->spesifikasi_buku; ?>" id="spesifikasi" name="spesifikasi" type="text" disabled/>
									</div>
								</div>
								<div class="form-group asal_kesenian">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->asal_daerah; ?>" id="asal_kesenian" name="asal_kesenian" type="text" disabled/>
									</div>
								</div>
								<div class="form-group pencipta_kesenian">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->pencipta; ?>" id="pencipta_kesenian" name="pencipta_kesenian" type="text" disabled/>
									</div>
								</div>
								<div class="form-group bahan_kesenian">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->bahan; ?>" id="bahan_kesenian" name="bahan_kesenian" type="text" disabled/>
									</div>
								</div>
								<div class="form-group jenis_hewan">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->jenis_hewan; ?>" id="jenis_hewan" name="jenis_hewan" type="text" disabled/>
									</div>
								</div>
								<div class="form-group ukuran_hewan">
									...
									<div class="col-sm-4">
										<div class="input-group">
											<input class="form-control form-control-sm number " value="<?= $main->ukuran_hewan; ?>" id="ukuran_hewan" name="ukuran_hewan" type="text" disabled/>
								...
								<div class="form-group jenis_tumbuhan">
									...
									<div class="col-sm-8">
										<input class="form-control form-control-sm" value="<?= $main->jenis_tumbuhan; ?>" id="jenis_tumbuhan" name="jenis_tumbuhan" type="text" disabled/>
									</div>
								</div>
								<div class="form-group ukuran_tumbuhan">
									...
									<div class="col-sm-4">
										<div class="input-group">
											<input class="form-control form-control-smn number" value="<?= $main->ukuran_tumbuhan; ?>" id="ukuran_tumbuhan" name="ukuran_tumbuhan" type="text" disabled/>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select name="tahun_pengadaan" id="tahun_pengadaan" class="form-control form-control-sm" disabled >
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select name="asal_usul" id="asal_usul" class="form-control form-control-sm" disabled>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text"  value="<?= number_format($main->harga,0,".",".");?>" class="form-control form-control-sm number" id="harga" name="harga" type="text" disabled/>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea rows="5" class="form-control form-control-sm" name="keterangan" id="keterangan" disabled><?= $main->keterangan; ?></textarea>
									</div>
								</div>
								</div>
							</div>
