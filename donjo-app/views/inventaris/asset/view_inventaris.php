                        ...
                        <form class="form-horizontal" id="form_asset" name="form_asset" method="post" action="">
                            <div class="col-md-6">
                                ...
                                <div class="form-group judul">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->judul_buku; ?>" id="judul" name="judul" type="text" disabled/>
                                    </div>
                                </div>
                                <div class="form-group spesifikasi">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->spesifikasi_buku; ?>" id="spesifikasi" name="spesifikasi" type="text" disabled/>
                                    </div>
                                </div>
                                <div class="form-group asal_kesenian">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->asal_daerah; ?>" id="asal_kesenian" name="asal_kesenian" type="text" disabled/> 
                                    </div>
                                </div>
                                <div class="form-group pencipta_kesenian">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" value="<?php echo $main->pencipta; ?>" id="pencipta_kesenian" name="pencipta_kesenian" type="text" disabled/> 
                                    </div>
                                </div>
                                <div class="form-group bahan_kesenian">
                                    ...
                                    <div class="col-sm-9">    
                                        <input class="form-control" value="<?php echo $main->bahan; ?>" id="bahan_kesenian" name="bahan_kesenian" type="text" disabled/> 
                                    </div>
                                </div>
                                <div class="form-group jenis_hewan">
                                    ...
                                    <div class="col-sm-9">    
                                        <input class="form-control" value="<?php echo $main->jenis_hewan; ?>" id="jenis_hewan" name="jenis_hewan" type="text" disabled/> 
                                    </div>
                                </div>
                                <div class="form-group ukuran_hewan">
                                    ...
                                    <div class="col-sm-4">  
                                        <div class="input-group">
                                            <input class="form-control" value="<?php echo $main->ukuran_hewan; ?>" id="ukuran_hewan" name="ukuran_hewan" type="number" disabled/>
                                ...
                                <div class="form-group jenis_tumbuhan">
                                    ...
                                    <div class="col-sm-9">    
                                        <input class="form-control" value="<?php echo $main->jenis_tumbuhan; ?>" id="jenis_tumbuhan" name="jenis_tumbuhan" type="text" disabled/> 
                                    </div>
                                </div>
                                <div class="form-group ukuran_tumbuhan">
                                    ...
                                    <div class="col-sm-4">  
                                        <div class="input-group">
                                            <input class="form-control" value="<?php echo $main->ukuran_tumbuhan; ?>" id="ukuran_tumbuhan" name="ukuran_tumbuhan" type="number" disabled/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">    
                                        <input class="form-control" value="<?php echo $main->jumlah; ?>" id="jumlah" name="jumlah" type="number" disabled /> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  value="<?php echo number_format($main->harga,0,".",".");?>" class="form-control" id="harga" name="harga" type="text" disabled/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
// });
    ...
    $(document).ready(function() {
        ...
        $("#form_asset").validate({
            ...
            $.ajax({
                url: '<?php echo site_url("api_inventaris_asset/add"); ?>',
                method: 'post',
                dataType: 'json',
                data: formInput,
                contentType: false,
                ...
                success: function(){
                        ...
                        setTimeout(function(){
                            window.location.href = '<?php echo site_url("inventaris_asset"); ?>';
                        }, 2000)
                },
                error: function(err){
