                        ...
                        <form class="form-horizontal" id="form_asset" name="form_asset" method="post" action="">
                            <div class="col-md-6">
                                ...
                                <div class="form-group spesifikasi">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="spesifikasi" name="spesifikasi" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group asal_kesenian">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="asal_kesenian" name="asal_kesenian" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group pencipta_kesenian">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="pencipta_kesenian" name="pencipta_kesenian" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group bahan_kesenian">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="bahan_kesenian" name="bahan_kesenian" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group jenis_hewan">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="jenis_hewan" name="jenis_hewan" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group ukuran_hewan">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input class="form-control" id="ukuran_hewan" name="ukuran_hewan" type="number"/>
                                ...
                                <div class="form-group jenis_tumbuhan">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="jenis_tumbuhan" name="jenis_tumbuhan" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group ukuran_tumbuhan">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input class="form-control" id="ukuran_tumbuhan" name="ukuran_tumbuhan" type="number"/>
