                        ...
                        <form class="form-horizontal" id="form_mutasi_asset" name="form_mutasi_asset" method="post" action="">    
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="hidden" name="id_asset" id="id_asset" value="<?php echo $main->id; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" type="text" disabled value="<?php echo $main->tahun_pengadaan; ?>"/>
                            ...
                            <div class="pull-right" >
                                <a href="<?php echo base_url() ?>index.php/inventaris_asset/mutasi" class="btn btn-default save"
