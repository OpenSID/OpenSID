	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_asset" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_asset/mutasi" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Asset Lainnya</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
