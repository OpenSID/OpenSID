                        ...
                        <form class="form-horizontal" id="form_kontruksi" name="form_kontruksi" method="post" action="">  
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="text" value="<?php echo ($main->kontruksi_bertingkat != 0 ? $main->kontruksi_bertingkat : '-' ); ?>" class="form-control" id="tingkat" name="tingkat" disabled />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="text" value="<?php echo ($main->luas_bangunan != 0 ? $main->luas_bangunan : '-' ); ?>" class="form-control" id="luas_bangunan" name="luas_bangunan" disabled/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->no_dokument; ?>"  class="form-control" name="no_bangunan" id="no_bangunan" type="text" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->tanggal_dokument; ?>" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" type="date" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:left;" for="tanggal_mulai">Tanggal Mulai </label>
                                    <div class="col-sm-4">
                                        <input class="form-control" value="<?php echo $main->tanggal; ?>" id="tanggal_mulai" name="tanggal_mulai" type="date" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#form_kontruksi").validate({
        ...
        $.ajax({
            url: '<?php echo site_url("api_inventaris_kontruksi/add"); ?>',
            method: 'post',
            dataType: 'json',
            data: formInput,
            contentType: false,
