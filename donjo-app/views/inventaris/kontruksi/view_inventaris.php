							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="fisik_bangunan" id="fisik_bangunan" class="form-control form-control-sm" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input type="text" value="<?= ($main->kontruksi_bertingkat != 0 ? $main->kontruksi_bertingkat : '-' ); ?>" class="form-control form-control-sm" id="tingkat" name="tingkat" disabled />
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="bahan" id="bahan" class="form-control form-control-sm" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input type="text" value="<?= ($main->luas_bangunan != 0 ? $main->luas_bangunan : '-' ); ?>" class="form-control form-control-sm" id="luas_bangunan" name="luas_bangunan" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->no_dokument; ?>"  class="form-control form-control-sm" name="no_bangunan" id="no_bangunan" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3  control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
										<div class="col-sm-4">
											<input maxlength="50" value="<?= $main->tanggal_dokument; ?>" class="form-control form-control-sm" name="tanggal_bangunan" id="tanggal_bangunan" type="date" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3  control-label" style="text-align:left;" for="tanggal_mulai">Tanggal Mulai </label>
										<div class="col-sm-4">
											<input class="form-control form-control-sm" value="<?= $main->tanggal; ?>" id="tanggal_mulai" name="tanggal_mulai" type="date" disabled/>
										</div>
									</div>
									<div class="form-group">
