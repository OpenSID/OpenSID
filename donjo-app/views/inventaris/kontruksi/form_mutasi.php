        ...
        <section class="content">
            ...
            <div class='box box-default'>
                ...
                <div class='box-body'>
                    ...
                    <form class="form-horizontal" id="form_mutasi_kontruksi" name="form_mutasi_kontruksi" action="" method="post">
                  ...
                  <div class="pull-right" >
                        ...
                        <a href="<?php echo base_url() ?>index.php/inventaris_kontruksi" class="btn btn-default save"
...
$("#form_mutasi_kontruksi").validate({
    submitHandler: function(form) {
        var formInput = new FormData($(form));
        formInput.append('id_inventaris_kontruksi', $('#id_inventaris').val());
        ...
        $.ajax({
            url: '<?php echo site_url("api_inventaris_kontruksi/add_mutasi"); ?>',
            method: 'post',
            dataType: 'json',
            data: formInput,
            contentType: false,
