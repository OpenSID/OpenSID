  ...
  <table id="inventaris" class="list border thick">
		...
		<tbody>
	    	...
	    	<tr>
				...
				<td><?php echo (!empty($data->kontruksi_bertingkat) ? $data->kontruksi_bertingkat : '-'); ?></td>
				<td><?php echo ($data->kontruksi_beton == '1' ? 'Ya': 'Tidak'); ?></td>
				<td><?php echo (!empty($data->luas_bangunan) ? $data->luas_bangunan : '-'); ?></td>
				...
				<td><?php echo (!empty($data->status_tanah) ? $data->status_tanah : '-'); ?></td>
