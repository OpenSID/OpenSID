							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input value="<?= $main->kontruksi_bertingkat; ?>" class="form-control form-control-sm number required" id="tingkat" name="tingkat" type="text"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->no_dokument; ?>"  class="form-control form-control-sm required" name="no_bangunan" id="no_bangunan" type="text"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
										<div class="col-sm-4">
											<input maxlength="50" value="<?= $main->tanggal_dokument; ?>" class="form-control form-control-sm required" name="tanggal_bangunan" id="tanggal_bangunan" type="date"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="tanggal_mulai">Tanggal Mulai </label>
										<div class="col-sm-4">
											<input class="form-control form-control-sm required" value="<?= $main->tanggal; ?>" id="tanggal_mulai" name="tanggal_mulai" type="date"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												...
												<input value="<?= $main->harga; ?>" class="form-control form-control-sm number required" id="harga" name="harga" type="text"/>
											</div>
										</div>
									</div>
									<div class="form-group">
