                        ...
                        <form class="form-horizontal" id="form_kontruksi" name="form_kontruksi" method="post" action="">  
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="tingkat" name="tingkat" type="number"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="luas_bangunan" name="luas_bangunan" type="number"/>
