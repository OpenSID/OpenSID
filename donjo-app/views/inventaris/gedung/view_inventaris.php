                        ...
                        <form class="form-horizontal" id="form_gedung" name="form_gedung" method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" value="<?php echo $main->kontruksi_bertingkat; ?>" class="form-control" id="tingkat" name="tingkat" type="number" disabled/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="kontruksi" id="kontruksi" class="form-control"disabled>
                                            <option value="<?php echo $main->kontruksi_beton; ?>"><?php echo $main->kontruksi_beton; ?></option>                                         
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="number" value="<?php echo $main->luas_bangunan; ?>" class="form-control" id="luas_bangunan" name="luas_bangunan" type="number" disabled/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="no_bangunan" id="no_bangunan" type="text" disabled value="<?php echo (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" type="text" disabled value="<?php echo date('d M Y', strtotime($main->tanggal_dokument)); ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="luas_tanah" name="luas_tanah" type="number" value="<?php echo $main->luas; ?>" disabled/>
                                            <span class="input-group-addon" id="koefisien_dasar_bangunan-addon">M<sup>2</sup></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="kode_tanah" id="kode_tanah" type="text" value="<?php echo (!empty($main->kode_tanah) ? $main->kode_tanah : '-'); ?>" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="harga" name="harga" type="text" value="<?php echo number_format($main->harga,0,".","."); ?>" disabled/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#form_gedung").validate({
        ...
        $.ajax({
            url: '<?php echo site_url("api_inventaris_gedung/add"); ?>',
            method: 'post',
            dataType: 'json',
            data: formInput,
            contentType: false,
            ...
            success: function(){
                    ...
                    setTimeout(function(){
                        window.location.href = '<?php echo site_url("inventaris_gedung"); ?>';
                    }, 2000)
            },
            error: function(err){
