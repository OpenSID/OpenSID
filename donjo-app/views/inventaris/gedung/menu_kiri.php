<div class="box box-info">
	...
	<div class="box-body no-padding">
		<ul class="nav nav-pills nav-stacked">
			<li <?php if ($tip==1): ?>class="active"<?php endif; ?>><a href="<?=site_url('inventaris_gedung')?>"><i class="fa fa-list"></i> Daftar Inventaris</a></li>
      <li <?php if ($tip==2): ?>class="active"<?php endif; ?>><a href="<?=site_url('inventaris_gedung/mutasi')?>"><i class="fa fa-share"></i> Mutasi Inventaris</a></li>
		</ul>
	</div>
</div>
<div class="box box-info">
