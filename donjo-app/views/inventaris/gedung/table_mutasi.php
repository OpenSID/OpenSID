		  ...
		  <div class="ui-layout-north panel">
				<div class="panel panel-default">
					<div class="panel-heading">
						Mutasi Inventaris Gedung dan Bangunan Desa
					</div>
					<div class="panel-body">
							...
							<tr>
								...
								<td>
									<div class="btn-group" role="group" aria-label="...">
										<a href="<?php echo base_url('index.php/inventaris_gedung/view_mutasi/'.$data->id); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
										<a href="<?php echo base_url('index.php/inventaris_gedung/edit_mutasi/'.$data->id); ?>" title="Edit Data"  type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> </a> 
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					window.location = "../api_inventaris_gedung/delete_mutasi/" + $id;
				} else {
