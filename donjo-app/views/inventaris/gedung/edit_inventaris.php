							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input type="number" value="<?= $main->kontruksi_bertingkat; ?>" class="form-control form-control-sm required" id="tingkat" name="tingkat" type="number" />
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="kontruksi" id="kontruksi" class="form-control form-control-sm required">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input value="<?= $main->luas_bangunan; ?>" class="form-control form-control-sm number required" id="luas_bangunan" name="luas_bangunan" type="text" />
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" class="form-control form-control-sm required" name="no_bangunan" id="no_bangunan" type="text"  value="<?= (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
										<div class="col-sm-4">
											<input maxlength="50" class="form-control form-control-sm required" name="tanggal_bangunan" id="tanggal_bangunan" type="date" value="<?= $main->tanggal_dokument; ?>"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control form-control-sm number required" id="luas_tanah" name="luas_tanah" type="text" value="<?= $main->luas; ?>" />
												<span class="input-group-addon input-sm" id="koefisien_dasar_bangunan-addon">M<sup>2</sup></span>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" class="form-control form-control-sm required" name="kode_tanah" id="kode_tanah" type="text" value="<?= (!empty($main->kode_tanah) ? $main->kode_tanah : '-'); ?>" />
										</div>
									</div>
									<div class="form-group">
