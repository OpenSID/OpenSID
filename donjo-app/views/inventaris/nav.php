...
<div style="padding-left:12px; color:white;" class=" nav btn-group btn-group-sm">
    ...
    <a style="color:white;" class="btn btn-primary" <?php if($this->tab_ini == 6){?>disabled<?php }?> href="<?php echo site_url('inventaris_kontruksi'); ?>">Konstruksi dalam pengerjaan</a>
