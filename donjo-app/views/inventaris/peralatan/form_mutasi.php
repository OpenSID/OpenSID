            ...
            <div class='box box-default'>
                ...
                <div class='box-body'>
                    <div class="form">
                        ...
                        <form class="form-horizontal" id="form_mutasi_peralatan" name="form_mutasi_peralatan" action="" method="post">
                          ...
                          <div class="pull-right" >
                                ...
                                <a href="<?php echo base_url() ?>index.php/inventaris_peralatan" class="btn btn-default save"
...
$(document).ready(function(){
    ...
    $("#form_mutasi_peralatan").validate({
        submitHandler: function(form) {
          var formInput = new FormData($(form));
          formInput.append('id_inventaris_peralatan', $('#id_inventaris').val());
          ...
          $.ajax({
              url: '<?php echo site_url("api_inventaris_peralatan/add_mutasi"); ?>',
              method: 'post',
              dataType: 'json',
              data: formInput,
              contentType: false,
