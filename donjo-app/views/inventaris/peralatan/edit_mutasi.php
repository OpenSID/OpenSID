            ...
            <div class='box box-default'>
                <div class='box-header with-border'>
                    <h4 class='box-title'>Edit Mutasi -
                        <small>Data Inventaris Peralatan Desa</small>
                    </h4>
                    <hr>
                </div>
                ...
                <div class='box-body'>
                    <div class="form">
                        ...
                        <form class="form-horizontal" id="update_mutasi_peralatan" name="update_mutasi_peralatan" method="post" action="">
                            ...
                            <div class="pull-right" >
                                ...
                                <a href="<?php echo base_url() ?>index.php/inventaris/mutasi" class="btn btn-default save"
...
<script>
    ...
    $("#update_mutasi_peralatan").validate({
        ...
        //   formInput.append('id', $('#id').val());
          ...
          $.ajax({
              url: '<?php echo site_url("api_inventaris_peralatan/update_mutasi"); ?>'+'/'+ $('#id').val(),
              method: 'post',
              dataType: 'json',
              data: formInput,
              contentType: false,
              ...
              success: function(){
                    ...
                    setTimeout(function(){
                        window.location.href = '<?php echo site_url("inventaris_peralatan/mutasi"); ?>';
                    }, 2000)
              },
              error: function(err){
