	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= site_url("api_inventaris_peralatan/update_mutasi/$main->id"); ?>">
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_peralatan/mutasi" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Peralatan Dan Mesin</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->register; ?>"  class="form-control form-control-sm required" name="kode_barang" id="kode_barang" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group disumbangkan">
										...
										<div class="col-sm-8">
											<input maxlength="50"  class="form-control form-control-sm" name="disumbangkan" id="disumbangkan" type="text" value="<?= $main->sumbangkan; ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="tahun" id="tahun" class="form-control form-control-sm required" disabled>
