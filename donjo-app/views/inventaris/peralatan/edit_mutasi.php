					...
					<div class="form">
						<form class="form-horizontal" id="update_mutasi_peralatan" name="update_mutasi_peralatan" method="post" action="">
							...
							<div class="pull-right" >
								...
								<a href="<?= base_url() ?>index.php/inventaris_peralatan/mutasi" class="btn btn-default save"
...
<script>
	...
	$("#update_mutasi_peralatan").validate(
	{
		submitHandler: function(form)
		{
		  ...
		  $.ajax(
		  {
			  url: '<?= site_url("api_inventaris_peralatan/update_mutasi"); ?>'+'/'+ $('#id').val(),
			  method: 'post',
			  dataType: 'json',
			  data: formInput,
			  contentType: false,
			  ...
			  success: function()
			  {
					...
					setTimeout(function()
					{
						window.location.href = '<?= site_url("inventaris_peralatan/mutasi"); ?>';
					}, 2000)
			  },
			  error: function(err)
			  {
