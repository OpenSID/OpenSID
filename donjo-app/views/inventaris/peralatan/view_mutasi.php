	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= $form_action?>">
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_peralatan/mutasi" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Mutasi Inventaris Peraltan Dan Mesin</a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= $main->register; ?>"  class="form-control form-control-sm" name="kode_barang" id="kode_barang" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" style="text-align:left;" for="mutasi" require>Jenis Mutasi </label>
										<div class="col-sm-4">
											<select name="mutasi" id="mutasi" class="form-control form-control-sm" disabled>
									...
									<div class="form-group disumbangkan">
										...
										<div class="col-sm-8">
											<input maxlength="50"  class="form-control form-control-sm" name="disumbangkan" id="disumbangkan" type="text" value="<?= $main->sumbangkan; ?>" disabled/>
										</div>
									</div>
									<div class="form-group harga_jual">
										...
										<div class="col-sm-4">
											<input maxlength="50"  class="form-control form-control-sm" name="harga_jual" id="harga_jual" type="text" value="Rp. <?= number_format( $main->harga_jual,0,".","."); ?>" disabled/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" class="form-control form-control-sm" name="tahun_mutasi" id="tahun_mutasi" value="<?= date('d M Y',strtotime($main->tahun_mutasi));;?>" disabled/>
										</div>
									</div>
									<div class="form-group">
