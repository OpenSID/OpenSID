            ...
            <div class='box box-default'>
                <div class='box-header with-border'>
                    <h4 class='box-title'>View Mutasi -
                        <small>Data _peralatan Peralatan Desa</small>
                    </h4>
                    <hr>
                </div>
                ...
                <div class='box-body'>
                    <div class="form">
                        ...
                        <form class="form-horizontal" id="form_mutasi_peralatan" name="form_mutasi_peralatan" method="post" action="">    

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required" style="text-align:left;" for="nama_barang">Nama Barang</label>
                                    <div class="col-sm-9">
                                        <input type="hidden" name="id__peralatan" id="id__peralatan" value="<?php echo $main->id; ?>">
                                ...
                                <div class="form-group disumbangkan">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50"  class="form-control" name="disumbangkan" id="disumbangkan" type="text" value="<?php echo $main->sumbangkan; ?>" disabled/>
                                    </div>
                                </div>
                                <div class="form-group harga_jual">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50"  class="form-control" name="harga_jual" id="harga_jual" type="text" value="Rp. <?php echo number_format( $main->harga_jual,0,".","."); ?>" disabled/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="tahun" id="tahun" class="form-control" disabled>
                                            <option value="<?php echo $main->tanggal_dokument; ?>"><?php echo date('d M Y', strtotime($main->tanggal_dokument)); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" class="form-control" name="tahun_mutasi" id="tahun_mutasi" value="<?php echo date('d M Y',strtotime($main->tahun_mutasi));;?>" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="pull-right" >
                                <a href="<?php echo base_url() ?>index.php/inventaris_peralatan/mutasi" class="btn btn-default save"
