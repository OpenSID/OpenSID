				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="pull-right">
              				<a class="btn btn-primary" href="<?php echo base_url('index.php/inventaris_peralatan/form'); ?>" style="color:white;">
								...
								<td>
									<div class="btn-group" role="group" aria-label="...">
										<?php if($data->status == "0"){ ?>
											<a href="<?php echo base_url('index.php/inventaris_peralatan/form_mutasi/'.$data->id); ?>" title="Mutasi Data" type="button" class="btn btn-danger btn-sm"><i class="fa fa-external-link-square"></i></a>
										<?php  }?>
										<a href="<?php echo base_url('index.php/inventaris_peralatan/view/'.$data->id); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
										<a href="<?php echo base_url('index.php/inventaris_peralatan/edit/'.$data->id); ?>" title="Edit Data"  type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> </a>
...
<script  TYPE='text/javascript'>
	...
	$("#form_cetak").click(function( event ) {
		...
		var link = '<?php echo site_url("inventaris_peralatan/cetak"); ?>'+ '/' + $('#tahun_pdf').val() + '/' + $('#penandatangan_pdf').val();
		window.open(link, '_blank');
		// alert('fell');
    });
	$("#form_download").click(function( event ) {

		var link = '<?php echo site_url("inventaris_peralatan/download"); ?>'+ '/' + $('#tahun').val() + '/' + $('#penandatangan').val();
		window.open(link, '_blank');
		// alert('fell');
    });
