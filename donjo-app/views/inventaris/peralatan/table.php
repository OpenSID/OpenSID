	...
	<section class="content" id="maincontent">
		<form id="mainformexcel" name="mainformexcel" action="" method="post" class="form-horizontal">
            ...
            <div class="card-header with-border">
							<a href="<?= site_url('inventaris_peralatan/form')?>" class="btn btn-flat btn-success btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"  title="Tambah Data Baru">
														...
														<?php foreach ($main as $data): ?>
															...
															<?php endif; ?>
																...
																<td nowrap>
																	...
																	<?php endif; ?>
																	<a href="<?= site_url('inventaris_peralatan/view/'.$data->id); ?>" title="Lihat Data" class="btn bg-info btn-flat btn-xs"><i class="fa fa-eye"></i></a>
																	<a href="<?= site_url('inventaris_peralatan/edit/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-flat btn-xs"><i class="fa fa-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_peralatan/delete/$data->id")?>" class="btn bg-maroon btn-flat btn-xs"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																</td>
