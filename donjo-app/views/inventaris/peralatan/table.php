	...
	<section class="content" id="maincontent">
		<form id="mainformexcel" name="mainformexcel"method="post" class="form-horizontal">
            ...
            <div class="box-header with-border">
							<a href="<?= site_url('inventaris_peralatan/form')?>" class="btn btn-social btn-flat btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Data Baru">
														...
														<?php foreach ($main as $data): ?>
															...
															<?php endif; ?>
																...
																<td nowrap>
																	...
																	<a href="<?= site_url('inventaris_peralatan/history?id='.$data->id); ?>" title="Lihat Jejak" class="btn bg-info btn-flat btn-sm"><i class="fa fa-history"></i></a>
