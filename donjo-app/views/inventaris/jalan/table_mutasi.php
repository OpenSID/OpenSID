														...
														<?php foreach ($main as $data): ?>
															<tr>
																...
																<td nowrap>
																	...
																	<?php endif; ?>
																	<a href="<?= site_url('inventaris_jalan/view_mutasi/'.$data->id); ?>" title="Lihat Data" class="btn bg-info btn-flat btn-xs"><i class="fa fa-eye"></i></a>
																	<a href="<?= site_url('inventaris_jalan/edit_mutasi/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-flat btn-xs"><i class="fa fa-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_jalan/delete_mutasi/$data->id")?>" class="btn bg-maroon btn-flat btn-xs"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																</td>
