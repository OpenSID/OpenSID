							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control form-control-sm" name="kontruksi" id="kontruksi" disabled><?= $main->kontruksi; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input value="<?= (!empty($main->panjang) ? $main->panjang : '0'); ?>" class="form-control form-control-sm" id="panjang" name="panjang" type="number" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
										<div class="input-group">
											<input type="number" value="<?= (!empty($main->lebar) ? $main->lebar : '0'); ?>"  class="form-control form-control-sm" id="lebar" name="lebar" type="number" disabled/>
											<span class="input-group-addon input-sm" id="koefisien_dasar_bangunan-addon">M</span>
										</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input type="number" value="<?= (!empty($main->luas) ? $main->luas : '0'); ?>"  class="form-control form-control-sm" id="luas" name="luas" type="number" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50" value="<?= (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>" class="form-control form-control-sm" name="no_bangunan" id="no_bangunan" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label " style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Kepemilikan</label>
										<div class="col-sm-8">
											<input maxlength="50" value="<?= (strtotime($main->tanggal_dokument != '0000-00-00') ? '-' : date('d M Y', strtotime($main->tanggal_dokument)) ); ?>" class="form-control form-control-sm" name="tanggal_bangunan" id="tanggal_bangunan" disabled/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input maxlength="50"value="<?= (!empty($main->kode_tanah) ? $main->kode_tanah : '-'); ?>"  class="form-control form-control-sm" name="kode_tanah" id="kode_tanah" type="text" disabled/>
										</div>
									</div>
									<div class="form-group">
