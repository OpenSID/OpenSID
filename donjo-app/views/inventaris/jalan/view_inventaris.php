                        ...
                        <form class="form-horizontal" id="form_jalan" name="form_jalan" method="post" action="">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="kontruksi" id="kontruksi" disabled><?php echo $main->kontruksi; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input value="<?php echo (!empty($main->panjang) ? $main->panjang : '0'); ?>" class="form-control" id="panjang" name="panjang" type="number" disabled/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="number" value="<?php echo (!empty($main->lebar) ? $main->lebar : '0'); ?>"  class="form-control" id="lebar" name="lebar" type="number" disabled/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" value="<?php echo (!empty($main->luas) ? $main->luas : '0'); ?>"  class="form-control" id="luas" name="luas" type="number" disabled/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>" class="form-control" name="no_bangunan" id="no_bangunan" type="text" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label " style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Kepemilikan</label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo (strtotime($main->tanggal_dokument != '0000-00-00') ? '-' : date('d M Y', strtotime($main->tanggal_dokument)) ); ?>" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50"value="<?php echo (!empty($main->kode_tanah) ? $main->kode_tanah : '-'); ?>"  class="form-control" name="kode_tanah" id="kode_tanah" type="text" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#form_jalan").validate({
        ...
        $.ajax({
            url: '<?php echo site_url("api_inventaris_jalan/add"); ?>',
            method: 'post',
            dataType: 'json',
            data: formInput,
            contentType: false,
