                        ...
                        <form class="form-horizontal" id="form_update_jalan" name="form_update_jalan" method="post" action="">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="hidden" id="id" value="<?php echo $main->id; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->kode_barang; ?>" class="form-control" name="kode_barang" id="kode_barang" type="text" required/>
                                    </div>
                                </div><!-- row -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo $main->register; ?>" class="form-control" name="nomor_register" id="nomor_register" type="text" required/>
                                    </div>
                                </div><!-- row -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="kontruksi" id="kontruksi" required><?php echo $main->kontruksi; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input value="<?php echo (!empty($main->panjang) ? $main->panjang : '0'); ?>" class="form-control" id="panjang" name="panjang" type="number"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="number" value="<?php echo (!empty($main->lebar) ? $main->lebar : '0'); ?>"  class="form-control" id="lebar" name="lebar" type="number"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" value="<?php echo (!empty($main->luas) ? $main->luas : '0'); ?>"  class="form-control" id="luas" name="luas" type="number"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input maxlength="50" value="<?php echo (!empty($main->no_dokument) ? $main->no_dokument : '-'); ?>" class="form-control" name="no_bangunan" id="no_bangunan" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label " style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Kepemilikan</label>
                                    <div class="col-sm-9">
                                        <input maxlength="50" type="date" value="<?php echo $main->tanggal_dokument;?>" class="form-control" name="tanggal_bangunan" id="tanggal_bangunan" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  value="<?php echo $main->harga; ?>" class="form-control" id="harga" name="harga" type="text" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="5" class="form-control" name="keterangan" id="keterangan" required><?php echo $main->keterangan; ?></textarea>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
     ...
     $("#form_update_jalan").validate({
            ...
            $.ajax({
                url: '<?php echo site_url("api_inventaris_jalan/update"); ?>' + '/' + $('#id').val(),
                method: 'post',
                dataType: 'json',
                data: formInput,
                contentType: false,
