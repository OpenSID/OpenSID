						...
						<form class="form-horizontal" id="form_mutasi_jalan" name="form_mutasi_jalan" action="" method="post">
						  ...
						  <div class="col-md-6">
							  <div class="form-group">
								  ...
								  <div class="col-sm-9">
										<input type="text" class="form-control" value="<?= (strtotime($main->tanggal_dokument != '0000-00-00') ? '-' : date('d M Y', strtotime($main->tanggal_dokument)) ); ?>" disabled>
								  </div>
							  </div>
							  <div class="form-group">
						  ...
						  <div class="pull-right" >
								...
								<a href="<?= base_url() ?>index.php/inventaris_jalan" class="btn btn-default save"
...
$(document).ready(function()
{
	...
	$("#form_mutasi_jalan").validate(
	{
		submitHandler: function(form)
		{
		  ...
		  $.ajax(
		  {
			  url: '<?= site_url("api_inventaris_jalan/add_mutasi"); ?>',
			  method: 'post',
			  dataType: 'json',
			  data: formInput,
			  contentType: false,
