							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
										<input maxlength="50"  class="form-control form-control-sm required" name="tahun" id="tahun" type="text" value="<?= (strtotime($main->tanggal_dokument != '0000-00-00') ? '-' : date('d M Y', strtotime($main->tanggal_dokument)) ); ?>" disabled/>
										</div>
									</div>
