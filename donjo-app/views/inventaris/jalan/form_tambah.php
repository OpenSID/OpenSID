	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_jalan" method="post" action="<?= site_url("api_inventaris_jalan/add"); ?>">
            ...
            <div class="card-header with-border">
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi Dan Jariangan</a>
						</div>
						<?php
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control form-control-sm required" name="kontruksi" id="kontruksi"></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control form-control-sm number required" id="panjang" name="panjang" type="text"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
										<div class="input-group">
											<input class="form-control form-control-sm number required" id="lebar" name="lebar" type="text"/>
											<span class="input-group-addon input-sm" id="koefisien_dasar_bangunan-addon">M</span>
										</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control form-control-sm number required" id="luas" name="luas" type="text"/>
