 ...
 * View Login tipe 1
 *
 * donjo-app/views/kehadiran/forms/login_1.php
 *
 */
...
<form id="validasi" action="<?= $form_action; ?>" method="post" class="form-login">
	...
	<div class="form-group form-login">
		<input type="password" class="form-control  required <?= jecho($cek_anjungan['keyboard'] == 1, TRUE, 'kbvnumber'); ?>" name="pin" placeholder="Masukkan" id="pin">
	</div>
