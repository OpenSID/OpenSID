...
<a href="<?=site_url("sms/anggota/$data[nama_grup]")?>" class="uibutton tipsy south"  title="Rincian Anggota"><span  class="icon-list icon-large"></span></a></div>
		  		</td>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <div class="uibutton-group">
				...
				<a href="<?=site_url("sms/group/$i/$o")?>" <? jecho($p,$i,"class='uibutton special'")?> class="uibutton"><?=$i?></a>
				<? endfor; ?>
            </div>
            <div class="uibutton-group">
			<? if($paging->next): ?>
