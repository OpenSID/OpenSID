				...
				<div class="card card-outline card-danger">
					<div class="card-body">
						<div class="form-group">
							...
							<select class="form-control form-control-sm select2 required"  id="id_pend" name="id_pend" style="width:100%;">
						...
						<div class="form-group">
							...
							<input name="no_hp" class="form-control form-control-sm required bilangan" minlength="8" maxlength="15" type="text"></input>
						</div>
					</div>
				</div>
			</div>
