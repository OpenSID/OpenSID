...
<div id="pageC">
	...
	<td class="side-menu">
		<fieldset>
			<div class="lmenu">
				<ul>
				<li class="selected"><a href="<?php echo site_url('sms/kontak')?>"><span class="fa fa-user"></span> Daftar Kontak</a></li>
				<li><a href="<?php echo site_url('sms/group')?>"><span class="fa fa-users"></span> Group Kontak</a></li>
				</ul>
			</div>
		</fieldset>
		...
		<tbody>
			...
			<tr>
				...
				<td align="center" width="5">
		  		...
		  		<td align="center">
				<div class="uibutton-group">
		    		    <a href="<?php echo site_url("sms/form_kontak/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data" target="ajax-modal" rel="window" header="Ubah Data"><span class="fa fa-edit "> Ubah</span></a>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <?php  if($paging->start_link): ?>
				<a href="<?php echo site_url("sms/kontak/$paging->start_link/$o")?>" class="uibutton"  >Awal</a>
			<?php  endif; ?>
			<?php  if($paging->prev): ?>
				<a href="<?php echo site_url("sms/kontak/$paging->prev/$o")?>" class="uibutton"  >Prev</a>
			<?php  endif; ?>
            </div>
            <div class="uibutton-group">
            ...
            <div class="uibutton-group">
			<?php  if($paging->next): ?>
				<a href="<?php echo site_url("sms/kontak/$paging->next/$o")?>" class="uibutton">Next</a>
			<?php  endif; ?>
			<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("sms/kontak/$paging->end_link/$o")?>" class="uibutton">Akhir</a>
			<?php  endif; ?>
            </div>
        </div>
    </div>
