    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('sms/form_polling/0')?>" class="uibutton tipsy south" title="Tambah Polling" target="ajax-modalx" rel="window" header="Tambah Polling"><span class="fa fa-plus">&nbsp;</span>Tambah Polling</a>
                <button type="button" title="Delete Data" onclick="deleteAllBox('mainform','<?php echo site_url('sms/delete_all_polling')?>')" class="uibutton tipsy south"><span class="fa fa-trash">&nbsp;</span>Hapus Data</button>
            </div>
        </div>
    </div>
