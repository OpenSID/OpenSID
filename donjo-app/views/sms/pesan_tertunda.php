<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="form-inline" id="mainform" name="mainform" action="" method="post">
			<div class="row">
				<div class="col-md-3">
					<a href="<?= site_url('sms/form/0/0/3')?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tulis Pesan Baru"  class="btn btn-primary btn-block margin-bottom">Tulis Pesan Baru</a>
					<div class="card card-outline card-info">
						...
						<div class="card-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								...
								<li class="active"><a href="<?= site_url('sms/pending')?>"><i class="fa fa-file-text-o"></i> Pesan Tertunda</a></li>
							</ul>
						</div>
					</div>
				</div>
															...
															<tbody>
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td><?=$data['no']?></td>
																		<td nowrap>
																			<a href="<?= site_url("sms/form/$p/$o/3/$data[ID]")?>" class="btn bg-orange btn-flat btn-xs" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Pesan" title="Ubah Pesan"><i class="fa fa-reply"></i></a>
																			<a href="#" data-href="<?= site_url("sms/delete/$p/$o/3/$data[ID]")?>" class="btn bg-maroon btn-flat btn-xs"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
                                    </td>
