	...
	<div class="box-body">
		<div class="form form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group col-sm-12">
						<textarea class="form-control input-sm <?= jecho($cek_ip, TRUE, 'kbvtext kbvopener'); ?>" name="keterangan" id="keterangan" placeholder="Ketik di sini untuk memberikan keterangan tambahan."><?= $permohonan['keterangan']?></textarea>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group col-sm-12">
						<input class="form-control input-lg bilangan_spasi required <?= jecho($cek_ip, TRUE, 'kbvnumber kbvopenernum'); ?>" type="text" name="no_hp_aktif" id="no_hp_aktif" placeholder="Ketik No. HP" maxlength="14" value="<?= $permohonan['no_hp_aktif']; ?>"/>
					</div>
				</div>
			</div>
		</div>
								...
								<div class="box-body">
									<div class="form-group">
										<label for="nama_dokumen">Nama / Jenis Dokumen</label>
											<div class="input-group col-sm-12">
												<input id="nama_dokumen" name="nama" class="form-control input-sm required <?= jecho($cek_ip, TRUE, 'kbvtext3 kbvopener3'); ?>" type="text" placeholder="Nama Dokumen" value=""/>
