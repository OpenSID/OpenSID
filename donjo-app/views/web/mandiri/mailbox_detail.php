				...
				<div class="col-md-12">
					<div class="box no-border">
						<div class="card-header">
							<a href="<?= site_url("mandiri_web/mandiri/1/3/$kat")?>" class="btn btn-flat btn-info btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"  title="Tambah Artikel">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="form-control form-control-sm"><?= $pesan['owner']?></div>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="email">NIK</label>
								<div class="col-sm-9">
									<div class="form-control form-control-sm"><?= $pesan['email']?></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="form-control form-control-sm"><?= $pesan['subjek']?></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea class="form-control form-control-sm" readonly id="pesan"><?= $pesan['komentar']?></textarea>
								</div>
							</div
						</div>
						<div class='card-footer'>
							<div class='col-xs-12'>
								<button type="submit" class='btn btn-flat btn-info btn-xs pull-right confirm'><i class='fa fa-reply'></i> Balas Pesan</button>
							</div>
						</div>
