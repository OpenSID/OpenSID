				...
				<div class="box-body">
					<form action="<?= $form_action ?>" class="form form-horizontal" id="validasi" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control input-sm required <?= jecho($cek_anjungan['keyboard'] == 1, TRUE, 'kbvtext'); ?>" id="subjek" name="subjek" value="<?php $subjek and print($subjek) ?>"></input>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="komentar">Pesan</label>
							<div class="col-sm-9">
								<textarea class="form-control input-sm required <?= jecho($cek_anjungan['keyboard'] == 1, TRUE, 'kbvtext'); ?>" name="komentar" id="komentar"></textarea>
							</div>
						</div>
					</div>
