					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input id="judul" name="judul" class="form-control input-sm required" type="text" placeholder="Judul Artikel" value="<?= $artikel['judul']?>"></input>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<div class="box box-info">
										...
										<div class="box-body no-padding">
											<div class="col-sm-12">
												<div class="form-group">
													<label class="control-label" for="tgl_post">Tanggal Kegiatan</label>
													<div class="input-group input-group-sm date">
														<div class="input-group-addon">
															<i class="fa fa-calendar"></i>
														</div>
														<input class="form-control input-sm pull-right" id="tgl_jam" name="tgl_agenda" type="text" value="<?= $artikel['tgl_agenda']?>">
													</div>
											...
											<div class="col-sm-12">
												...
												<div class="form-group">
													...
													<div class="input-group input-group-sm date">
														...
														<input class="form-control input-sm pull-right" id="tgl_jam_agenda" name="tgl_upload" type="text" value="<?= $artikel['tgl_upload']?>">
													</div>
