					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input id="judul" name="judul" class="form-control input-sm required strip_tags judul" type="text" placeholder="Judul Artikel" minlength="5" maxlength="200" value="<?= htmlspecialchars_decode($artikel['judul']) ?>"></input>
