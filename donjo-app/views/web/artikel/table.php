...
<?php
/*
	<li><a class="fa fa-plus-square " title="Ubah Data" href="<?php echo site_url("web/ajax_add_kategori")?>" target="ajax-modal" rel="window" header="Tambah Kategori Baru"> Tambah Kategori</a></li>
*/
?>
	</ul>
...
<?php if($_SESSION['grup']<4){?>
	...
	<a href="<?php echo site_url("web/headline/$cat/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Klik Untuk Jadikan Headline"><span class="<?php  if($data['headline']==1){?>fa fa-star-empty " title="Headline Saat Ini"<?php  }else{?> fa fa-star " <?php  }?>target="confirm" message="Jadikan Artikel Berikut Sebagai Headline News?" header="Headline"></span></a>
