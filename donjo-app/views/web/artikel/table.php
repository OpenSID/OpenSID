...
<button type="button" title="Hapus Artikel" onclick="deleteAllBox('mainform','<?php echo site_url("web/delete_all/$cat/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash "></span> Hapus</button>
<?php }?>
</div>
</div>
<?php if($cat < 999){?>
