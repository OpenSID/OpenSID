					...
					<div class="box box-info">
						<div class="box-header with-border">
							...
							<?php if (can('h')) : ?>
								...
								<?php if (! in_array($cat, array('0', '-1', 'statis', 'agenda', 'keuangan'))) : ?>
																	...
																	<tr>
																		...
																		<td class="aksi">
																			<?php if ($data['boleh_ubah'] && can('u')) : ?>
																				...
																				<?php else : ?>
																					<a href="<?= site_url('web/komentar_lock/' . encrypt($data['id']) . '/1') ?>" class="btn bg-info btn-flat btn-sm" title="Buka Komentar Artikel"><i class="fa fa-comment"></i></a>
																				<?php endif ?>
