		...
		<?php } else { ?>
			<div class="box box-primary box-solid">
				...
				<div class="box-body">
					...
					<form action="<?php echo site_url('mandiri_login/auth')?>" method="post">
		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				...
				<table id="mandiri" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan="3"><h4><a href="<?php echo site_url('mandiri_web/logout');?>"  class=""><button type="button" class="btn btn-danger btn-block">KELUAR</button></a></h4></td>
					</tr>
				</table>
			</div>
		</div>
