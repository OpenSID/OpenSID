        ...
        <div class="col-md-12">
            <div class="box box-info">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="text-align:left;" for="pemilik_asal">Asal Tanah Kas
                                    Desa</label>
                                <div class="col-sm-4">
                                    <select name="pemilik_asal" id="pemilik_asal" class="form-control input-sm select2 required"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input type="text" onkeyup="isi_luas()" min="0" class="form-control input-sm number required"
                                            value="<?= $main->luas ?: 0 ?>" id="luas" name="luas" <?= jecho($main->luas, true, 'disabled') ?>/>
                            ...
                            <div id="input_luas" <?= jecho($main, false, 'style="display:none"') ?>>
                                ...
                                <div class="col-sm-3" id="view_asli_milik_desa">
                                    <div class="form-group dinamic_perolehan">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <input onkeyup="dinamic_perolehan()" type="text" min="0"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group dinamic_jenis_tkd">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <input onkeyup="dinamic_jenis_tkd()" type="text" min="0"
                                                    class="form-control input-sm number required"
                ...
                <div id="form_footer" class="box-footer">
                    ...
                    <button type="button" onclick="submit_form()" class="btn btn-social btn-flat btn-info btn-sm pull-right"><i class="fa fa-check"></i> Simpan</button>
                </div>
            </div>
        </div>
    </div>
