<div class="box box-info">
	<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
	  <div class="box-header with-border">
			<a href="<?= site_url().$this->controller.'/tables/'.$kat ?>" class="btn btn-social btn-flat btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Artikel">
		...
		<div class="box-body">
			...
			<input name="kategori" type="hidden" value="<?= $dokumen['kategori'] ?: $kat_id;?>">
			<?php
				if ($kat == "keputusan" or $dokumen['kategori'] == 2)
					include ("donjo-app/views/dokumen/_sk_kades.php");
				elseif ($kat == "peraturan" or $dokumen['kategori'] == 3)
