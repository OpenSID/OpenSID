...
<div class="list-group">
  <div class="box-footer no-padding col-sm-11">
    <ul class="nav nav-stacked">
      ...
      <li class="<?php compared_return($selected_nav, 'tanah', 'active'); ?>"><a href="<?= site_url('bumindes_tanah_desa') ?>">Buku Tanah di <?= ucwords($this->setting->sebutan_desa); ?></a></li>
      ...
      <li class="<?php compared_return($selected_nav, 'lembaran', 'active'); ?>"><a href="<?= site_url('lembaran_desa/clear') ?>">Buku Lembaran <?= ucwords($this->setting->sebutan_desa); ?> dan Berita <?= ucwords($this->setting->sebutan_desa); ?></a></li>
    </ul>
  </div>
