<div class="box box-widget widget-user-2">
  <div class="box-footer no-padding">
    <ul class="nav nav-stacked">
      ...
      <li class="<?php compared_return($selected_nav, "aparat", "active"); ?>"><a href="<?= site_url('bumindes_umum/tables/aparat') ?>">Buku Aparat Pemerintah Desa</a></li>
      <li class="<?php compared_return($selected_nav, "agenda", "active"); ?>"><a href="<?= site_url('bumindes_umum/tables/agenda_masuk') ?>">Buku Agenda</a></li>
