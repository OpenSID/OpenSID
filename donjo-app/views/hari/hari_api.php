<?php 
//echo '333<pre>'.print_r($merah,1).'</pre>';
$aHari=[
	1=>'Senin', 'Selasa', 'Rabu',
	'Kamis', 'Jum\'at', 'Sabtu',
	'Minggu'
...
/*<a href="<?=site_url('keluarga/edit_nokk/1/0/37');?>" title="Ubah Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Data KK" class="btn bg-orange btn-flat btn-sm"><i class="fa fa-edit"></i></a>*/		
		echo "<td $cl> $i&nbsp;";
