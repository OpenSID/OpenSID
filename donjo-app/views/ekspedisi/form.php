			...
			<div class="col-md-12">
				<div class="card card-outline card-info">
					<div class="card-header with-border">
						<a href="<?= site_url("ekspedisi")?>" class="btn btn-flat btn-info btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"  title="Kembali Ke Buku Ekspedisi">
					...
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal nomor-urut">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="nomor_urut" name="nomor_urut" class="form-control form-control-sm number required" type="text" placeholder="Nomor Urut" readonly value="<?= $surat_keluar['nomor_urut']?>"></input>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label" for="kode_surat">Kode/Klasifikasi Surat</label>
								<div class="col-sm-8">
									<select class="form-control form-control-sm select2-tags required" id="kode_surat" disabled name="kode_surat" style="width: 100%;">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="nomor_surat" name="nomor_surat" maxlength="35" class="form-control form-control-sm required" type="text" placeholder="Nomor Surat" readonly value="<?= $surat_keluar['nomor_surat']?>"></input>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control form-control-sm pull-right required" id="tgl_2" name="tanggal_surat" type="text" readonly value="<?= tgl_indo_out($surat_keluar['tanggal_surat'])?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="tujuan" name="tujuan" class="form-control form-control-sm required" type="text" placeholder="Tujuan" readonly value="<?= $surat_keluar['tujuan']?>"></input>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label" for="disposisi_kepada">Isi Singkat/Perihal</label>
								<div class="col-sm-8">
									<textarea id="isi_singkat" name="isi_singkat" class="form-control form-control-sm required" placeholder="Isi Singkat/Perihal" readonly rows="3" style="resize:none;"><?= $surat_keluar['isi_singkat']?></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control form-control-sm pull-right tgl required" name="tanggal_pengiriman" type="text" value="<?= tgl_indo_out($surat_keluar['tanggal_pengiriman'])?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea name="keterangan" class="form-control form-control-sm" placeholder="Keterangan" rows="3" style="resize:none;"><?= $surat_keluar['keterangan']?></textarea>
								</div>
							</div>
