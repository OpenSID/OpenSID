...
<div id="contentpane">    
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<thead>
			...
			<?php  elseif($o==1): ?>
				<th align="left" width='120'><a href="<?php echo site_url("analisis_laporan_keluarga/index/$p/2")?>">Nomor KK<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
			...
			<?php  elseif($o==3): ?>
				<th align="left" width='250'><a href="<?php echo site_url("analisis_laporan_keluarga/index/$p/4")?>">Kepala Keluarga<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
			...
			<?php  elseif($o==5): ?>
				<th align="left" width='50'><a href="<?php echo site_url("analisis_laporan_keluarga/index/$p/6")?>">Nilai<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
			...
			<?php  elseif($o==5): ?>
				<th align="left" width='100'><a href="<?php echo site_url("analisis_laporan_keluarga/index/$p/6")?>">Klasifikasi<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
				<th align="left" width='100'><a href="<?php echo site_url("analisis_laporan_keluarga/index/$p/5")?>">Klasifikasi<span class="ui-icon ui-icon-triangle-2-n-s">&nbsp;</span></a></th>
			<?php  endif; ?>
...
<a href="<?php echo site_url()?>analisis_laporan_keluarga/leave" class="uibutton icon prev">Kembali</a>
        ...
        <div class="right">
            ...
            <?php  if($paging->start_link): ?>
				<a href="<?php echo site_url("analisis_laporan_keluarga/index/$paging->start_link/$o")?>" class="uibutton"  >Awal</a>
			<?php  endif; ?>
			<?php  if($paging->prev): ?>
				<a href="<?php echo site_url("analisis_laporan_keluarga/index/$paging->prev/$o")?>" class="uibutton"  >Prev</a>
			<?php  endif; ?>
            </div>
            <div class="uibutton-group">
            ...
            <div class="uibutton-group">
			<?php  if($paging->next): ?>
				<a href="<?php echo site_url("analisis_laporan_keluarga/index/$paging->next/$o")?>" class="uibutton">Next</a>
			<?php  endif; ?>
			<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("analisis_laporan_keluarga/index/$paging->end_link/$o")?>" class="uibutton">Akhir</a>
			<?php  endif; ?>
            </div>
        </div>
    </div>
