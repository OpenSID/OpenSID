				...
				<div class="col-md-8">
					<div class="box box-info">
						<div class="box-header with-border">
							...
							<?php endif; ?>
							<?php if ($lap=='15'): ?>
								<a href="<?=site_url("statistik/kategori_umur"); ?>" class="btn btn-social btn-flat bg-orange btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kategori Umur">
									<i class="fa fa-tags"></i>Kategori Umur
								</a>
							<?php endif; ?>
