    ...
    <div class="ui-layout-north panel top">
      <div class="left">
        <div class="uibutton-group">
    			...
    			<?php  if($lap=='13'){?>
    			<a href="<?php echo site_url("statistik/rentang_umur")?>" class="uibutton tipsy south" title="Rentang Umut"><span class="fa fa-sort-amount-asc"></span> Atur Rentang Umur</a><?php  }?>
        </div>
      </div>
    </div>
