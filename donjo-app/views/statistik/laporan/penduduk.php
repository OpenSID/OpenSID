...
<div id="contentpane" style="overflow:auto;">    
    ...
    <div class="ui-layout-north panel top">
        <div class="left">
			...
			<a href="<?php echo site_url("sid_laporan_penduduk/cetak/$lap")?>" class="uibutton tipsy south" title="Cetak Data" target="_blank"><span class="ui-icon ui-fa fa-print">&nbsp;</span>Cetak Data</a>
			
			<a href="<?php echo site_url("sid_laporan_penduduk/graph/$lap")?>" class="uibutton tipsy south" title="Grafik"><span class="ui-icon ui-fa fa-print">&nbsp;</span>Grafik Data</a>
			
			<a href="<?php echo site_url("sid_laporan_penduduk/pie/$lap")?>" class="uibutton tipsy south" title="Grafik"><span class="ui-icon ui-fa fa-print">&nbsp;</span>Pie Chart</a>
            </div>
        </div>
    </div>
