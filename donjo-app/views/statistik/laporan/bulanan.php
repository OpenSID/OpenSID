...
<div id="contentpane">    
    ...
    <div class="ui-layout-north panel top">
        <div class="left">
			...
			<a href="<?=site_url("laporan/cetak")?>" class="uibutton special tipsy south" title="Cetak" target="_blank"><span class="ui-icon ui-icon-print">&nbsp;</span>Cetak</a>
		<a href="<?=site_url("laporan/excel")?>" class="uibutton special tipsy south" title="Excel" target="_blank"><span class="ui-icon ui-icon-print">&nbsp;</span>Excel</a>
            </div>
        </div>
    </div>
...
table.tftable td {font-size:12px;border-width: 1px;padding: 8px;border-style: solid;border-color: #729ea5;}
	   ...
	   <table  width="100%">
				...
				<tr>						
					<td>Tahun</td>
					<td width="3%">:</td>
					<td><input name="tahun" type="text" class="inputbox required" size="5" value="<?=$tahun ?>"/></td>	
				</tr>
				 <tr>						
					<td>Bulan</td>
					<td width="3%">:</td>
