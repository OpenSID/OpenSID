...
<div id="contentpane"> 
 ...
 <div class="uibutton-group">
	...
	<a href="<?php echo site_url("laporan_rentan/excel")?>" class="uibutton special tipsy south" title="Excel" target="_blank"><span class="ui-icon ui-icon-print">&nbsp;</span>Unduh</a>
 </div>
 </div>
 </div>
