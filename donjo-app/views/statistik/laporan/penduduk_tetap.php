    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('sid_penduduk/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-user-plus"></span> Tambah Data</a>
                <button type="button" title="Delete Data" onclick="deleteAllBox('mainform','<?php echo site_url("sid_penduduk/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash"></span> Delete Data</button>
            </div>
        </div>
    </div>
