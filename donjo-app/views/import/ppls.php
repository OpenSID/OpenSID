										<div class="tab-pane <?php if($act_tab==2):?> active<?php endif?>">
											<div class="row">
												<div class="col-md-12">
													<div class="box-header with-border"><h3 class="box-title"><strong>Import Data PPLS</strong></h3>
													</div>
													<div class="box-body">
														<div class="row">
															<div class="col-sm-12">
																...
																<p>
																	<ol>
																		...
																		<li>Data yang dibutuhkan untuk Import dengan memenuhi aturan data berikut
																	...
																	<tbody>
																			...
																			<tr>
																				<td style="padding-top:20px;padding-bottom:10px;">
																					<div class="form-group">
																						<label for="file"  class="col-sm-2 control-label">Rumah Tangga .xls:</label>
																						...
																						<div class="col-sm-3 col-lg-2">
																							<button type="submit" class="btn btn-block btn-success btn-sm"><i class="fa fa-spin fa-refresh"></i> Import</button>
																						</div>
																					</div>
																				</td>
																			</tr>
																		...
																		<form action="<?=$form_action3?>" method="post" enctype="multipart/form-data" class="form-horizontal">
																			<tr>
																				<td style="padding-top:20px;padding-bottom:10px;">
																					<div class="form-group">
																						<label for="file"  class="col-sm-2 control-label">Individu .xls: </label>
																						<div class="col-sm-7 col-lg-4">
																							<div class="input-group input-group-sm">
