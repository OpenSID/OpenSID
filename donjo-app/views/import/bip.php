                ...
                <tr>
                  <td width="500" colspan="3">
                    <p font-size="14px";>
                      ...
                      <br><br>
                      UNDUH : <a class="uibutton confirm" href="<?php echo base_url()?>assets/import/format_bip_2012.xls"><span class="fa fa-download" style="color:#fff"></span> Contoh BIP 2012</a>
                      <a class="uibutton confirm" href="<?php echo base_url()?>assets/import/format_bip_2016.xls"><span class="fa fa-download" style="color:#fff"></span> Contoh BIP 2016</a>
                      <br><br>
