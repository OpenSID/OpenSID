<form id="form_penduduk" action="<?= $form_action_penduduk ?>" method="POST">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input name="nik" class="form-control form-control-sm required nik" type="text" placeholder="Nomor NIK" value="<?= $penduduk['nik']?>"></input>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm required nama" name="nama" placeholder="Nama Lengkap Tanpa Gelar" value="<?= strtoupper($penduduk['nama'])?>">
		</div>
	</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<select class="form-control form-control-sm required" name="sex" >
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm" name="tempatlahir" placeholder="Tempat Lahir" value="<?= strtoupper($penduduk['tempatlahir'])?>">
		</div>
	</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="input-group input-group-sm date">
				...
				<input class="form-control form-control-sm pull-right" id="tanggallahir" name="tanggallahir" type="text" value="<?= $penduduk['tanggallahir']?>">
			</div>
		</div>
	</div>
	...
	<div class="col-sm-12">
		<div class="form-group">
			...
			<textarea name="alamat_sekarang" class="form-control form-control-sm" rows="2"><?= strtoupper($penduduk['alamat_sekarang'])?></textarea>
		</div>
	</div>
