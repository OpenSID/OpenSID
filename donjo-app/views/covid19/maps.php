...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Lokasi Pemudik <?= $terdata['terdata_info']?></h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">Lokasi Pemudik</li>
		</ol>
	</section>
					...
					<form id="validasi1" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class='box-footer'>
							<div class='col-xs-12'>
								...
								<a href="<?= site_url('covid19')?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali"><i class="fa fa-arrow-circle-o-left"></i> Kembali</a>
