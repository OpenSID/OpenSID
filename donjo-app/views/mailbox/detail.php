	...
	<section class="content" id="maincontent">
		<form action="<?= site_url('mailbox/form') ?>" class="form-horizontal" method="post">
            ...
            <div class="card-header with-border">
							<a href="<?= site_url("mailbox/index/$kat")?>" class="btn btn-flat btn-info btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"  title="Tambah Artikel">
