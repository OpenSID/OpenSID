...
<div id="contentpane">
 ...
 <a href="<?php echo site_url("kelompok/delete_a/$kel/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash"></span> Hapus</a>

 <a href="<?php echo site_url("kelompok/form_anggota/$kel/$data[id_penduduk]")?>" class="uibutton tipsy south" title="Ubah Data" ><span class="fa fa-edit"></span> Ubah </a>
			</div>
 </td>
