		...
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="box-header with-border">
						<a href="<?= site_url("kelompok/form_anggota/$kel")?>" class="btn btn-social btn-flat bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Anggota Kelompok"><i class="fa fa-plus"></i> Tambah Anggota Kelompok</a>
							<a href="<?= site_url("kelompok/cetak_a/$kel")?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank"><i class="fa fa-print "></i> Print</a>
							<a href="<?= site_url("kelompok/excel_a/$kel")?>" class="btn btn-social btn-flat bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank"><i class="fa  fa-file-excel-o"></i> Excel</a>
														...
														<table class="table table-bordered dataTable table-hover nowrap">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><?= $data['no']?></td>
																	<td nowrap>
																		<a href="<?= site_url("kelompok/form_anggota/$kel/$data[id_penduduk]")?>" class="btn bg-orange btn-flat btn-sm"  title="Edit Anggota" ><i class="fa fa-edit"></i></a>
