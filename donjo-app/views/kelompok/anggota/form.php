		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-outline card-info">
					...
					<a href="<?= site_url("kelompok/anggota/$kelompok"); ?>" class="btn btn-flat btn-info btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-left "></i> Kembali Ke Anggota Kelompok</a>
					</div>
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data"  class="form-horizontal">
						<div class="col-md-3">
							<div class="card-body box-profile">
								<img class="profile-user-img img-fluid rounded-circle" src="<?= $pend['foto'] ? AmbilFoto($pend['foto']) : base_url() . 'assets/files/user_pict/kuser.png'; ?>" alt="Foto">
								<br/>
						...
						<div class="col-md-9">
							<div class="card-body">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control form-control-sm select2 required" <?= jecho($pend, true, 'disabled')?> id="id_penduduk" name="id_penduduk">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input  id="no_anggota" class="form-control form-control-sm number" type="text" placeholder="Nomor Anggota" name="no_anggota" value="<?=$pend['no_anggota']; ?>">
									</div>
								</div>
								<div class="form-group">
									<?php if (!empty($pend)): ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input  id="no_sk_jabatan" class="form-control form-control-sm nomor_sk" type="text" placeholder="SK Jabatan" name="no_sk_jabatan" value="<?=$pend['no_sk_jabatan']; ?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="keterangan">Keterangan</label>
									<div class="col-sm-5">
										 <textarea name="keterangan" class="form-control form-control-sm" maxlength="300" placeholder="Keterangan" rows="3"><?= $pend['keterangan']; ?></textarea>
									 </div>
								</div>
							</div>
						</div>
