        ...
        <div class="table-panel top">
            <div class="left">
                <select name="filter" onchange="formAction('mainform','<?=site_url('kelompok/filter')?>')">
					...
					<option value="<?=$data['id']?>" <?if($filter == $data['id']) :?>selected<?endif?>><?=$data['kelompok']?></option>
					<? }?>
                </select>
            </div>
            <div class="right">
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <div class="uibutton-group">
				...
				<a href="<?=site_url("kelompok/index/$i/$o")?>" <? jecho($p,$i,"class='uibutton special'")?> class="uibutton"><?=$i?></a>
				<? endfor; ?>
            </div>
            <div class="uibutton-group">
			<? if($paging->next): ?>
