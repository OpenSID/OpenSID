			...
			<fieldset>
				...
				<ul>
					...
					<li>
						...
						<span class="fa fa-gear">&nbsp;</span>Kelola Kategori Kelompok</a>
					</li>
				</ul>
			</fieldset>
		</td>
					...
					<div class="ui-layout-north panel">
						...
						<div class="left">
							<div class="uibutton-group">
								...
								<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("kelompok/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash">&nbsp;</span>Hapus Data</button>
							...
							<tbody>
								<?php foreach($main as $data): ?>
									<tr>
										...
										<td>
											<div class="uibutton-group">
												<a href="<?php echo site_url("kelompok/anggota/$data[id]")?>" class="uibutton"><span class="fa fa-list"> Rincian </span></a>
												<a href="<?php echo site_url("kelompok/form/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-edit"> Ubah </span></a>
