	...
	<div class=\"artikel\" id=\"artikel-".$single_artikel["judul"]."\">
		...
		echo "
				<div class=\"box-body\">
					...
					<table width=100%>
						<tr class=\"komentar\"><td>Nama</td><td style=\"padding-top: 5px;\"> <input type=text name=\"owner\" size=20 maxlength=30 value=\"".$_SESSION['post']['owner']."\"></td></tr>
						<tr class=\"komentar\"><td>Alamat e-mail</td><td style=\"padding-top: 5px;\"> <input type=text name=\"email\" size=20 maxlength=30 value=\"".$_SESSION['post']['email']."\"></td></tr>
						<tr class=\"komentar\"><td valign=top>Komentar</td><td style=\"padding-top: 5px;\"> <textarea name=\"komentar\" style=\"width: 300px; height: 100px;\">".$_SESSION['post']['komentar']."</textarea></td></tr>
						<tr><td>&nbsp;</td>
							<td style=\"padding-top: 10px;\">
								<img id=\"captcha\" src=\"/securimage/securimage_show.php\" alt=\"CAPTCHA Image\" style=\"height: 40px;\"/>
								<a href=\"#\" onclick=\"document.getElementById('captcha').src = '/securimage/securimage_show.php?' + Math.random(); return false\" style=\"margin-left:10px;\">[ Ganti gambar ]</a>
							</td></tr>
						...
						<tr><td>&nbsp;</td><td style=\"padding-top: 5px;\"><input type=\"submit\" value=\"Kirim\" style=\"font-size: 15px; padding: 3px 10px; \"></td></tr>
					</table>
					</form>
				</div>
			</div>
