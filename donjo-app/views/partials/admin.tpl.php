...
<li class='active'><a href="<?php echo site_url('ataswilayah/kecamatan');?>"><span>KECAMATAN</span></a></li>
<li class='active'><a href="<?php echo site_url('desa');?>"><span>DESA</span></a></li>
         ...
         <li class='active'><a href="<?php echo site_url('analisis');?>"><span>PENDIDIKAN</span></a></li>
          ...
          <li class='active'><a href="<?php echo site_url('analisis/perkawinan');?>"><span>STATUS PERKAWINAN</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisis/agama');?>"><span>AGAMA</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisis/jeniskl');?>"><span>JENIS KELAMIN</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisis/kelumur');?>"><span>KELOMPOK UMUR</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisis/golda');?>"><span>GOL DARAH</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisis/cacame');?>"><span>CACAT MENTAL</span></a></li>
          ...
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/kepemilikantanah');?>"><span>KEPEMILIKAN TANAH</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/lahan');?>"><span>KEPEMILIKAN LAHAN</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/motor');?>"><span>KEPEMILIKAN SEPEDA MOTOR</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/mobil');?>"><span>KEPEMILIKAN MOBIL</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/ternaksapi');?>"><span>KEPEMILIKAN TERNAK SAPI</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/ternakkambing');?>"><span>KEPEMILIKAN TERNAK KAMBING</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/ternakunggas');?>"><span>KEPEMILIKAN TERNAK UNGGAS</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/tanamankeras');?>"><span>KEPEMILIKAN TANAMAN KERAS</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/perhiasan');?>"><span>KEPEMILIKAN PERHIASAN</span></a></li>
          <li class='active'><a href="<?php echo site_url('analisiskeluarga/tabungan');?>"><span>KEPEMILIKAN TABUNGAN</span></a></li>
   ...
   <ul>
	...
	<ul>
		<li><a href="<?php echo site_url('user');?>"><span>PENGATURAN PENGGUNA</span></a> </li>
		<li><a href="<?php echo site_url('user/group');?>"><span>GROUP</span></a></li>
		<li><a href="<?php echo site_url('auth/create_user');?>"><span>BUAT AKUN</span></a></li>
		<li><a href="<?php echo site_url('auth/change_password');?>"><span>GANTI KATASANDI</span></a></li>
</ul></li>
         <li><a href='<?php echo site_url('content');?>'><span>ARTIKEL</span></a></li>
         <li><a href='<?php echo site_url('content/kategori');?>'><span>KATEGORI ARTIKEL</span></a></li>
         <li><a href='<?php echo site_url('content/comment');?>'><span>COMMENT</span></a></li>
         <li><a href='<?php echo site_url('siteman/admin_shoutbox');?>'><span>SHOUTBOX</span></a></li>
         <li><a href='#'><span>HALAMAN DEPAN</span></a></li>
    ...
    <ul>
         ...
         <li class='active'><a href='#'><span>GALERI VIDEO</span></a></li>
         <li class='active'><a href='#'><span>UNGGAH VIDEO BARU</span></a></li>
