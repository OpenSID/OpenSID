...
<th>Keperluan</th>
<td>
<textarea name="jeperluan" class=" required" style="resize: none; height:80px; width:300px;" size="500"></textarea>
</td>
</tr>
<tr>
<th>Keterangan</th>
...
<option value="<?=$data['pamong_nama']?>"><font style="bold"><?=$data['pamong_nama']?></font> (<?=unpenetration($data['jabatan'])?>)</option>
<?}?>
</select>
</td>
</tr>
