...
<tr><td width="40%">Nama Kepala Keluarga</td><td width="3%">:</td><td width="64%"><?=unpenetration($pribadi['kepala_kk'])?></td></tr>
<tr><td>Nomor Kartu Keluarga</td><td>:</td><td><?=$kk['no_kk']?></td></tr>
<tr><td>Alamat Keluarga</td><td>:</td><td>RT. <?=$kk['rt']?>, RW. <?=$kk['rw']?>, Dusun <?=ununderscore(unpenetration($kk['dusun']))?>, Desa <?=unpenetration($desa['nama_desa'])?>, Kec. <?=unpenetration($desa['nama_kecamatan'])?>, Kab. <?=unpenetration($desa['nama_kabupaten'])?> </td></tr>
</table>
<br/>
<table width="100%">
...
<tr><td>Pendidikan Terakhir</td><td>:</td><td><?=$pribadi['pend']?></td></tr>
