...
<tr><td>Keterangan </td><td>:</td><td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?=unpenetration(ununderscore($data['dusun']))?>, Rt. <?=$data['rt']?>, <?=unpenetration($desa['nama_desa'])?>, <?=unpenetration($desa['nama_kecamatan'])?>, <?=unpenetration($desa['nama_kabupaten'])?> akan menikah di KUA Kecamatan <?=unpenetration($desa['nama_kecamatan'])?> Kabupaten <?=unpenetration($desa['nama_kabupaten'])?>. Berhubung orang tersebut tidak mempunyai Wali Nasab, kami mohon dengan hormat Bapak Kepala KUA Kecamatan <?=unpenetration($desa['nama_kecamatan'])?> supaya berkenan menjadi Wali.</td></tr>
</table>
<table width="100%">
<tr></tr>
