...
<tr><td>Tempat Tinggal</td><td>:</td><td>RT. <?php echo $ibu['rt']; ?>, RW. <?php echo $ibu['rw']; ?>, Dusun <?php echo unpenetration(ununderscore($ibu['dusun'])); ?>, Kel. <?php echo unpenetration($desa['nama_desa']); ?>, Kec. <?php echo unpenetration($desa['nama_kecamatan']); ?>, Kab. <?php echo unpenetration($desa['nama_kabupaten']); ?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr>
...
<table width="100%">
<tr></tr>
<tr><td width="30%"></td><td width="33%"></td><td  align="center"><?=unpenetration($desa['nama_desa'])?>, <?=$tanggal_sekarang?></td></tr>
