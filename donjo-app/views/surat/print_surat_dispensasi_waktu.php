...
<tr><td>Alamat</td><td>:</td><td>RT. <?php echo $data['rt']?>, RW. <?php echo $data['rw']?>, Dusun <?php echo ununderscore($data['dusun'])?>, Kel. <?php echo $desa['nama_desa']?>, Kec. <?php echo $desa['nama_kecamatan']?>, Kab. <?php echo $desa['nama_kabupaten']?></td></tr>
</table>
