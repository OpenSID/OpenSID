...
<tr><td class="indentasi" colspan="3">Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?=unpenetration(ununderscore($data['dusun']))?>, Rt. <?=$data['rt']?>, <?=unpenetration($desa['nama_desa'])?>, <?=unpenetration($desa['nama_kecamatan'])?>, <?=unpenetration($desa['nama_kabupaten'])?> tercatat dalam
No. KK: <?=$data['no_kk']?> dengan NIK: <?=$data['nik']?>.</td></tr>
<tr><td class="indentasi" colspan="3">Orang tersebut telah datang kepada kami untuk melapor dan mengaku telah kehilangan <?=$input['barang']?>. </td></tr>
<tr><td>Rincian </td><td>:</td><td> <?=$input['rincian']?>. </td></tr>
...
<tr></tr>
<tr></tr>
<tr><td  align="center">( <?=$data['nama']?> )<td></td><td align="center">( <?=unpenetration($pamong['pamong_nama'])?> )</td></tr>
</table>  </div></div>
<div id="aside">
</div>
</div>
