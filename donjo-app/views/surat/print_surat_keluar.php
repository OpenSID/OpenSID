...
Kabupaten <?php echo $desa['nama_kabupaten']?>, Provinsi <?php echo $desa['nama_propinsi']?> menerangkan bahwa:  </td></tr>
</table>
<table width="100%">
...
<tr><td>Alamat</td><td>:</td><td>RT. <?php echo $data['rt']?>, RW. <?php echo $data['rw']?>, Dusun <?php echo ununderscore($data['dusun'])?>, Desa <?php echo $desa['nama_desa']?>, Kec. <?php echo $desa['nama_kecamatan']?>, Kab. <?php echo $desa['nama_kabupaten']?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr></tr>
...
<tr></tr>
<tr></tr>
<tr><td><?php echo $pamong['pamong_nama']?> <td></td><td><?php echo $pamong['jabatan']?></td></tr>
</table>  </div></div>
<div id="aside">
</div>
</div>
