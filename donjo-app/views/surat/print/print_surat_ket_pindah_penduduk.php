...
<table width="100%">
<align="center"><u><h4 class="kop">SURAT KETERANGAN PINDAH PENDUDUK</h4></u>
<tr><th align="center"><?< class="kop">Nomor : 471.2/<?php echo $input['nomor']?>/PEM/<?php echo date("Y")?></th></tr>
<tr>
<div class="clear"></div>
</table>
<table width="100%">

<td class="indentasi">Yang bertanda tangan dibawah ini <?php echo unpenetration($pamong['jabatan'])?> <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan bahwa :  </td></tr>
</table><div id="isi3">
<table width="100%">
...
<tr><td><b>Alamat yang dituju</td><td>:</td><td><?php echo $input['alamat_tujuan']?> RT. <?php echo $input['rt_tujuan']?> RW. <?php echo $input['rw_tujuan']?> Dusun <?php echo $input['dusun_tujuan']?> Desa <?php echo unpenetration($input['kelurahan_tujuan'])?> Kecamatan <?php echo unpenetration($input['kecamatan_tujuan'])?> Kabupaten <?php echo unpenetration($input['kabupaten_tujuan'])?></td></tr>
...
<table width="100%">
<td class="indentasi">Surat keterangan ini diterbitkan sebagai <b><?php echo $input['keterangan']?>.</td>
<tr></tr>
<tr></tr>
</table>
<table width="100%">
...
<tr></tr>
<tr></tr>
<tr><td></td><td width="60%"></td><td align="center"><?php echo unpenetration($desa['nama_desa'])?>, <?php echo $tanggal_sekarang?></td></tr>
<tr><td></td><td width="60%"></td><td align="center"><?php echo unpenetration($input['jabatan'])?> <?php echo unpenetration($desa['nama_desa'])?></td></tr>
</table></div>
<table width="100%">
<tr></tr>
<tr></tr>
...
<tr></tr>
<tr></tr>
<tr><td></td><td width="45%"></td><td align="center"><u><b> <?php echo unpenetration($input['pamong'])?> </u></td></tr>
