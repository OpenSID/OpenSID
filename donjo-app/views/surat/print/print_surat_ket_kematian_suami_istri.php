...
<table width="100%">
<div align="center"><u><h4 class="kop">SURAT KETERANGAN KEMATIAN SUAMI/ISTRI (N-6)</h4></u></div>
...
<tr><td>Pekerjaan</td><td>:</td><td><?php echo $input['pekerjaan']; ?></td></tr>
				...
				<table width="55%">
<tr></tr><tr><td>telah meninggal dunia pada hari/ tanggal</td><td> :</td><td><?php echo tgl_indo(tgl_indo_in($input['tgl_meninggal'])); ?></td></tr>
...
<table width="100%">
<tr></tr>
<td>adalah === <?php echo unpenetration($input['status'])?>=== orang yang telah meninggal tersebut di atas.</td>
<tr>
</table>
<table width="100%">
