...
<table width="100%">
<div align="center"><u><h4 class="kop">SURAT KETERANGAN WALI</h4></u>
...
<td class="indentasi">Yang bertanda tangan dibawah ini <?php echo $input['jabatan']?> <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan dengan sebenarnya bahwa mempelai perempuan :  </td></tr>
</table><div id="isi3">
<table width="100%">
...
<tr></tr>
<tr></tr>
<tr><td>Yang berhak menjadi wali adalah </td><td>:
<tr><td>Nama </td><td>: </td><td><b> <?php echo $input['nama_wali']?></td></tr>
...
<table width="100%">
<tr></tr><tr></tr>
<tr><td class="indentasi">Demikian Surat Keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya.<td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
