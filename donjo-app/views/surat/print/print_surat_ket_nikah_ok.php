...
<table width="100%">
<div align="center"><u><h4 class="kop">SURAT KETERANGAN NIKAH</h4></u></div>
...
<table width="100%">
<tr></tr>
				<tr><td colspan="3"><b>DATA SUAMI  </td></tr>
<tr><td width="23%">Nama</td><td width="3%">:</td><td width="64%"><b><?php echo unpenetration($pribadi['nama']); ?></td></tr>
<tr><td width="23%">NIK</td><td width="3%">:</td><td width="64%"><?php echo $pribadi['nik']; ?></td></tr>
...
<tr><td width="23%">Alamat</td><td width="3%">:</td><td width="64%"> <?php echo $pribadi['alamat']?> RT. <?php echo $pribadi['rt']?> RW. <?php echo $pribadi['rw']?> Dusun <?php echo unpenetration(ununderscore($pribadi['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
				...
				<tr></tr>
				<tr><td colspan="3"><b>DATA ISTRI  </td></tr>
<tr><td width="23%">Nama</td><td width="3%">:</td><td width="64%"><b><?php echo unpenetration($input['nama_pasangan']); ?></td></tr>
<tr><td width="23%">NIK</td><td width="3%">:</td><td width="64%"><?php echo $input['nik_pasangan']; ?></td></tr>
...
<table width="100%">
<tr></tr>
<td class="indentasi">Memang benar telah menikah secara Syariat Agama Islam Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> pada Tahun <?php echo $input['tahun_menikah']; ?>, yang dilakukan oleh Pemuka Agama/ Penghulu Desa <?php echo unpenetration($desa['nama_desa'])?>.</td></tr>
<tr></tr>
<table width="100%">
<tr></tr>
...
<tr></tr>
<tr>
					<td class="indentasi">Demikianlah surat keterangan ini dibuat dengan sebenarnya untuk dapat digunakan sebagaimana mestinya.</td>
				</tr>
<tr></tr>
<tr></tr>
<tr></tr>
