...
<div id="isi2">
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><b><?php echo unpenetration($ayah['nama']); ?></td></tr>
...
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><b><?php echo unpenetration($ibu['nama']); ?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td> <?php echo $ibu['alamat']?> RT. <?php echo $ibu['rt']?> RW. <?php echo $ibu['rw']?> Dusun <?php echo unpenetration(ununderscore($ibu['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr>
...
<tr></tr>
<tr><td align="center">
<tr><td align="center"><b><?php echo unpenetration($ayah['nama']);?><td></td><td align="center"><b><?php echo unpenetration($ibu['nama']);?></td></tr>
</td></tr>
</table>  </div></div>
<div id="aside">
</div>
