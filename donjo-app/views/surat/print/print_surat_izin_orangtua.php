...
<div align="center"><u><h4 class="kop">SURAT KETERANGAN IZIN ORANG TUA</h4></u></div>
...
<div id="isi2">
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?php echo unpenetration($ayah['nama']); ?></td></tr>
<tr><td>Tempat dan tanggal lahir</td><td>:</td><td><?php echo $ayah['tempatlahir']; ?>, <?php echo tgl_indo(($ayah['tanggallahir'])); ?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td>RT. <?php echo $ibu['rt']; ?>, RW. <?php echo $ibu['rw']; ?>, Dusun <?php echo unpenetration(ununderscore($ibu['dusun'])); ?>, Kel. <?php echo unpenetration($desa['nama_desa']); ?>, Kec. <?php echo unpenetration($desa['nama_kecamatan']); ?>, <?php echo ucwords(config_item('sebutan_kabupaten_singkat'))?> <?php echo unpenetration($desa['nama_kabupaten']); ?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td>RT. <?php echo $pribadi['rt']; ?>, RW. <?php echo $pribadi['rw']; ?>, Dusun <?php echo unpenetration(ununderscore($pribadi['dusun'])); ?>, Kel. <?php echo unpenetration($desa['nama_desa']); ?>, Kec. <?php echo unpenetration($desa['nama_kecamatan']); ?>, <?php echo ucwords(config_item('sebutan_kabupaten_singkat'))?> <?php echo unpenetration($desa['nama_kabupaten']); ?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr>
...
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?php echo unpenetration($input['nama_pasangan']); ?></td></tr>
...
<tr></tr>
<tr></tr>
<tr><td align="center">( <?php echo unpenetration($ayah['nama_ayah']);?> )<td></td><td align="center">( <?php echo unpenetration($ibu['nama_ibu']);?> )</td></tr>
</table>  </div></div>
<div id="aside">
</div>
</div>
