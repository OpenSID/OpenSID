...
<div align="center"><u><h4 class="kop">SURAT KUASA PERMOHONAN KARTU KELUARGA BARU</h4></u></div>
<table width="100%">
<table width="100%">
...
<tr><td>Tempat dan Tanggal Lahir<td>:</td><td><?php echo ($input['tempatlahir_2'])?> </td></tr>
...
<tr><td class="indentasi">Saya PIHAK PERTAMA menyatakan dengan sebenarnya bahwa saya memberikan kuasa sepenuhnya Kepada PIHAK KEDUA untuk membuatkan Kartu Keluarga saya sesuai dengan data terlampir.  </td></tr>
<table width="100%">
