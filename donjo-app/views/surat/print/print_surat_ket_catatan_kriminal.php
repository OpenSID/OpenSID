...
<table width="100%">
<div align="center"><u><h4 class="kop">PENGANTAR SURAT KETERANGAN CATATAN KEPOLISIAN</h4></u></div>
...
<tr><td>Pendidikan</td><td>:</td><td><?php echo $data['pendidikan']?></td>
...
<table width="100%">
<td class="indentasi">Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di <?php echo unpenetration(ununderscore($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?>, <?php echo unpenetration($desa['nama_kecamatan'])?> <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam
No. KK : <?php echo $data['no_kk']?> dengan NIK : <?php echo $data['nik']?> Kepala Keluarga : <?php echo unpenetration($data['kepala_kk'])?> menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik </td></tr>
</table>
<table width="100%">
<td class="indentasi">Surat Pengantar ini dibuat Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk <b><?php echo $input['keperluan']?>.</td></tr>
</table>
<table width="100%">
...
<table width="100%">
<tr><td></td><td width="55%"></td><td  align="center"><b><u><?php echo unpenetration($input['pamong'])?></td></tr>
