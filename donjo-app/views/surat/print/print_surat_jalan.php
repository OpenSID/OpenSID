...
<table width="100%">
<div align="center"><u><h4 class="kop">SURAT KETERANGAN BEPERGIAN/ JALAN</h4></u></div>
<div align="center"><h4 class="kop3">Nomor : 471.2/<?php echo $input['nomor']?>/PEM/<?php echo date("Y")?></h4></div>
<tr>
<div class="clear"></div>
</table>
<table width="100%">
<tr><td class="indentasi">Yang bertanda tangan dibawah ini <?php echo $input['jabatan']?> <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan dengan sebenarnya bahwa :  </td></tr>
</table><div id="isi3">
<table width="100%">
...
<tr><td>Alamat Tujuan</td><td>:</td><td><?php echo $input['alamattujuan']?></td></tr>

</table>
<table width="100%">
<tr></tr>
<tr></tr>
<tr><td class="indentasi">Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di <?php echo unpenetration(ununderscore($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam No. KK : <?php echo $data['no_kk']?> dengan NIK : <?php echo $data['nik']?> Kepala Keluarga : <?php echo unpenetration($data['kepala_kk'])?>.
</td></tr>
<table width="100%">
<tr></tr>
<tr><td class="indentasi">Surat Keterangan ini dibuat untuk Keperluan : <u><b><?php echo $input['keperluan']?>
<tr></tr>
<table width="100%">
<tr></tr>
