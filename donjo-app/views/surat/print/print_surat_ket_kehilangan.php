...
<table width="100%">
<div align="center"><u><h4 class="kop">SURAT PENGANTAR LAPORAN KEHILANGAN</h4></u></div>
<div align="center"><h4 class="kop3">Nomor : 337/<?php echo $input['nomor']?>/TRANTIB/<?php echo date("Y")?></h4></div>
</table>
<div class="clear"></div>
...
<table width="100%">
<tr><td class="indentasi" colspan="3">Orang tersebut adalah benar-benar warga kami yang bertempat tinggal di <?php echo unpenetration(ununderscore($data['alamat']))?> RT. <?php echo $data['rt']?> RT. <?php echo $data['rw']?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam No. KK : <?php echo $data['no_kk']?> dengan NIK : <?php echo $data['nik']?>.</td></tr>

</table>
<table width="100%">
<tr><td class="indentasi" colspan="3">Orang tersebut telah datang kepada kami untuk melapor dan mengaku telah kehilangan berupa <?php echo $input['barang']?> dengan rincian sebagai berikut : 
<tr><td>Warna/ Merek</td><td>:</td><td><?php echo $input['rincian']?></td></tr>
<tr><td>Tempat Kejadian</td><td>:</td><td><?php echo $input['tempat']?></td></tr>
<tr><td>Hari/ Tanggal Kejadian</td><td>:</td><td><?php echo $input['hari']?></td></tr>
<tr><td>Waktu Kejadian</td><td>:</td><td><?php echo $input['waktu']?></td></tr>
