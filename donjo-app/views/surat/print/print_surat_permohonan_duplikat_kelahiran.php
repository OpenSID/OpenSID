...
<div align="center"> Nomor : 471.2/<?php echo $input['nomor']?>/PEM/<?php echo date("Y")?>
</table>
<div class="clear"></div>
...
<table width="100%">
	...
	<tr><td >Alamat</td><td >:</td><td > <?php echo unpenetration($data['alamat'])?> RT. <?php echo unpenetration($data['rt'])?> RW. <?php echo unpenetration($data['rw'])?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
	<tr><td ><b>Telah lahir pada</td><td >: </td><td >
	<tr><td >Hari, Tanggal, Pukul</td><td >:</td><td ><?php echo $input['hari_bayi']?>, Jam <?php echo $input['jam_bayi']?> WITA</td></tr>
...
<tr></tr>
<tr></tr>
<tr><td><b>Dengan Orang Tua</td><td >: </td><td >
<tr></tr>
	<tr><td >Nama Ibu</td><td >:</td><td ><b><?php echo unpenetration($ibu['nama'])?></td></tr>
	...
	<tr><td >Alamat</td><td >:</td><td > <?php echo unpenetration($ibu['alamat'])?> RT. <?php echo unpenetration($ibu['rt'])?> RW. <?php echo unpenetration($ibu['rw'])?> Dusun <?php echo unpenetration(ununderscore($ibu['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
	<tr><td >Nama Ayah</td><td >:</td><td ><b><?php echo unpenetration($ayah['nama'])?></td></tr>
	...
	<tr><td >Alamat</td><td >:</td><td > <?php echo unpenetration($ayah['alamat'])?> RT. <?php echo unpenetration($ayah['rt'])?> RW. <?php echo unpenetration($ayah['rw'])?> Dusun <?php echo unpenetration(ununderscore($ayah['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
</table>
<div id="isi2">
<table width="100%">
<tr>Surat Keterangan ini dibuat berdasarkan keterangan pelapor :</td><td >
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><b><?php echo unpenetration($input['nama_pelapor'])?></td></tr>
...
<table width="100%">
<tr></tr>
<td class="indentasi">Demikian surat keterangan ini dibuat dengan sebenarnya, atas perhatian dan terkabulnya diucapkan terima kasih. </td>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
