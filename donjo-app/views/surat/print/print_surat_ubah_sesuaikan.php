...
<div align="center"><u><h4 class="kop"><?php echo $input['nama_surat']?></h4></u></div>
...
<tr><td>
<table width="100%">
<tr><td width="18%">Nama Lengkap</td><td width="2%">:</td><td width="64%"><?php echo unpenetration($data['nama'])?></td></tr>
<tr><td width="18%">Nomor KTP</td><td width="2%">:</td><td width="64%"><?php echo $data['nik']?></td></tr>
...
<tr></tr>
<tr></tr>
<tr></tr><tr><td class="indentasi"> <?php echo $input['keterangan']?></td></tr>
