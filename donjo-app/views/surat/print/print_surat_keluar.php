...
<div align="center"><h4><u>NO: <?php echo $input['nomor']?></u></h4></div>
<tr>

<td>Yang bertanda tangan dibawah ini <?php echo $pamong['jabatan']?> <?php echo $desa['nama_desa']?>, Kecamatan <?php echo $desa['nama_kecamatan']?>,
<?php echo ucwords(config_item('sebutan_kabupaten'))?> <?php echo $desa['nama_kabupaten']?>, Provinsi <?php echo $desa['nama_propinsi']?> menerangkan bahwa:  </td></tr>
</table>
<table width="100%">
...
<tr><td>Tempat/Tgl. Lahir (Umur)</td><td>:</td><td><?php echo $data['tanggallahir']?> / <?php echo $data['tanggallahir']?> (<?php echo $data['umur']?> Tahun)</td></tr>
...
<tr><td>Alamat</td><td>:</td><td>RT. <?php echo $data['rt']?>, RW. <?php echo $data['rw']?>, Dusun <?php echo ununderscore($data['dusun'])?>, <?php echo ucwords(config_item('sebutan_desa'))?> <?php echo $desa['nama_desa']?>, Kec. <?php echo $desa['nama_kecamatan']?>, <?php echo ucwords(config_item('sebutan_kabupaten_singkat'))?> <?php echo $desa['nama_kabupaten']?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr></tr>
<tr>
<td>Orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo ununderscore($data['dusun'])?>, Rt. <?php echo $data['rt']?>, <?php echo $desa['nama_desa']?>, <?php echo $desa['nama_kecamatan']?>, <?php echo $desa['nama_kabupaten']?> tercatat dalam
