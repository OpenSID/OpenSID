...
<div align="center"><u><h4 class="kop">SURAT KETERANGAN KURANG MAMPU</h4></u></div>
...
No. KK: <?php echo $data['no_kk']?> dengan NIK: <?php echo $data['nik']?>, kepala keluarga : <?php echo unpenetration($data['kepala_kk'])?> yang perekonomiannya kurang mampu.</td></tr>
