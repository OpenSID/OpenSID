...
<table width="100%">
<tr></tr><tr></tr>
<td class="indentasi">Yang namanya tersebut di atas memang benar warga kami dan telah menikah di Kantor Urusan Agama (KUA) Kecamatan <?php echo $input['kecamatan_kua']?> pada tanggal <?php echo tgl_indo(tgl_indo_in($input['tgl_nikah']))?> dengan seseorang yang bernama <?php echo unpenetration($input['nama_pasangan'])?>. Berdasarkan data di atas mohon untuk dibuatkan Duplikat Surat Nikah orang tersebut di atas. </td></tr>
</table>
<table width="100%">
<tr></tr>
<td  class="indentasi">Demikian surat permohonan duplikat surat nikah ini dibuat dengan sebenarnya, untuk dipergunakan sebagaimana mestinya.</td><tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
