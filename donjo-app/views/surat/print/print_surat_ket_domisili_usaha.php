...
<div align="center"><u><h4 class="kop">SURAT KETERANGAN TEMPAT BERDOMISILI USAHA</h4></u></div>
...
<tr><td class="indentasi" colspan="3">Bahwa yang tersebut namanya diatas, memang benar penduduk kami yang memiliki usaha <?php echo $input['usaha']?>, berlokasi di Dusun <?php echo unpenetration($data['dusun'])?>, <?php echo ucwords(config_item('sebutan_desa'))?> <?php echo unpenetration($desa['nama_desa'])?>, Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?>, <?php echo ucwords(config_item('sebutan_kabupaten'))?> <?php echo unpenetration($desa['nama_kabupaten'])?>.</td></tr>
