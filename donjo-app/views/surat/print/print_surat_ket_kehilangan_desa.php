...
<table width="100%">
<tr><td class="indentasi" colspan="3">Bahwa yang namanya tersebut diatas menurut laporan dari Kepala Dusun dan sepengetahuan Kami memang benar telah kehilangan berupa <?php echo $input['barang']?> </td></tr>
