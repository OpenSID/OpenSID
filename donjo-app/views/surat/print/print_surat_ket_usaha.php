...
<table width="100%">
<tr><td class="indentasi">Orang tersebut adalah benar-benar warga kami yang bertempat tinggal di <?php echo unpenetration(ununderscore($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam
No. KK : <?php echo $data['no_kk']?> dengan NIK : <?php echo $data['nik']?> Kepala Keluarga : <?php echo unpenetration($data['kepala_kk'])?> yang memiliki usaha  <b><?php echo $input['usaha']?> mulai dari tahun  <?php echo $input['mulai_usaha']?>  sampai dengan sekarang.</td></tr>

</table>
<table width="100%">
<tr><td class="indentasi"> Surat Keterangan ini dibuat untuk keperluan : <b><?php echo $input['keterangan']?></td></tr>
</table>
<table width="100%">
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<td class="indentasi">Demikian surat keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya. </td>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
...
<tr></tr>
<tr></tr>
<tr><td width="20%" align="center"><b><?php echo unpenetration($data['nama'])?> </td><td width="40%"></td><td align="center"><b><u> <?php echo unpenetration($input['pamong'])?> </td></tr>   
