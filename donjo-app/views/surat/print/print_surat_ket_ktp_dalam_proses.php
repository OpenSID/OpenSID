...
<tr><td class="indentasi">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di <?php echo unpenetration(ununderscore($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> <?php echo unpenetration($desa['nama_kecamatan'])?> <?php echo unpenetration($desa['nama_kabupaten'])?> yang saat ini Kartu Tanda Penduduk  sedang dalam proses.</td></tr>
</table>
</table>
<table width="100%"> 
