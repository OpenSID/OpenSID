...
<img src="<?php echo base_url()?>assets/files/logo/<?php echo $desa['logo']?>" alt="" width="100" height="80" class="logo">
<div class="header">
...
<div align="center"><h4 class="kop-nomor">Nomor : <?php echo $input['nomor']?></h4></div>
<table width="100%">
