...
<table width="100%">
<div align="center"><u><h4  class="kop">SURAT KETERANGAN PENGANTAR</h4></u></div>
<div align="center"><h4  class="kop">Nomor : 471.2/<?php echo $input['nomor']?>/PEM/<?php echo date("Y")?></h4></div>
</table>
<table width="100%">
</table>
<table width="100%">
...
<table width="100%">
<td class="indentasi"> Surat Pengantar ini dibuat untuk keperluan : <b><?php echo $input['keperluan']?></td></tr>
<tr></tr>
</table>
<table width="100%">
<tr></tr>
