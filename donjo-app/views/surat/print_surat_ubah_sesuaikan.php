...
<div align="center"><u><h4 class="kop"><?=$input['nama_surat']?></h4></u></div>
...
<tr><td>
<table width="100%">
<tr><td width="18%">Nama Lengkap</td><td width="2%">:</td><td width="64%"><?=unpenetration($data['nama'])?></td></tr>
<tr><td width="18%">Nomor KTP</td><td width="2%">:</td><td width="64%"><?=$data['nik']?></td></tr>
<tr><td>Tempat Tgl. Lahir </td><td>:</td><td><?=($data['tempatlahir'])?>, <?=tgl_indo($data['tanggallahir'])?></td></tr>
...
<tr></tr>
<tr></tr>
<tr></tr><tr><td class="indentasi"> <?=$input['keterangan']?></td></tr>
