...
<td class="indentasi">Yang bertanda tangan dibawah ini <?=$pamong['jabatan']?> <?=$desa['nama_desa']?>, Kecamatan <?=$desa['nama_kecamatan']?>,
...
<tr><td>Tempat dan Tgl. Lahir (Umur)</td><td>:</td><td><?=$data['tanggallahir']?> <?=$data['tanggallahir']?> (<?=$data['umur']?> Tahun)</td></tr>
...
<tr></tr>
<tr>
<td>Orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?=$data['dusun']?>, Rt. <?=$data['rt']?>, <?=$desa['nama_desa']?>, <?=$desa['nama_kecamatan']?>, <?=$desa['nama_kabupaten']?> tercatat dalam
