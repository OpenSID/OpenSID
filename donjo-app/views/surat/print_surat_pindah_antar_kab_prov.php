...
Kabupaten <?=unpenetration($desa['nama_kabupaten'])?>, Provinsi <?=unpenetration($desa['nama_propinsi'])?> menerangkan Permohonan Pindah Penduduk WNI dengan data sebagai berikut :  </td></tr>
</table>
...
<tr><td >Nomor Kartu Keluarga</td><td>:</td><td><?=$data['no_kk']?> </td></tr>
<tr><td >Nama Kepala Keluarga</td><td>:</td><td ><?=unpenetration($data['kepala_kk'])?></td></tr>
<tr><td>Alamat Sekarang</td><td>:</td><td>RT. <?=$data['rt']?>, RW. <?=$data['rw']?>, Dusun <?=unpenetration(ununderscore($data['dusun']))?>, Desa <?=unpenetration($desa['nama_desa'])?>, Kec. <?=unpenetration($desa['nama_kecamatan'])?>, Kab. <?=unpenetration($desa['nama_kabupaten'])?></td></tr>
<tr><td>Alamat Tujuan Pindah</td><td>:</td><td><?=$input['alamat_tujuan']?></td></tr>
<tr><td>Jumlah Keluarga yang Pindah</td><td>:</td><td><?=$input['jumlah']?> orang</td></tr>
<table width="100%">
...
<tr></tr>
<tr></tr>
<tr><td width="10%"></td><td width="43%"></td><td  align="center"><?=unpenetration($desa['nama_desa'])?>, <?=$tanggal_sekarang?></td></tr>
<tr><td width="10%"></td><td width="43%"></td><td align="center"><?=unpenetration($input['jabatan'])?> <?=unpenetration($desa['nama_desa'])?></td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
