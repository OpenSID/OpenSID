	...
	<td style="background:#fff;"> 
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Formulir Layanan : Surat KK emem</h3>
				...
				<div id="form-melengkapi-data-permohonan">
					...
					<table class="form">
						...
						<tr>
							<th>Berlaku</th>
							<td><input name="berlaku_dari" type="text" class="inputbox datepicker" size="20"/> sampai <input name="berlaku_sampai" type="text" class="inputbox datepicker" size="20"/></td>
						</tr>
						<tr>
