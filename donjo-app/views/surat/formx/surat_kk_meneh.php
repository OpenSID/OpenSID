	...
	<td style="background:#fff;"> 
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Formulir Layanan : Surat KK Meneh</h3>
					...
					<table class="form">
						...
						if($individu){ 
							...
							<tr>
								...
								<td>
									<button class='uibutton special' class='showData'>Tampilkan</button>
									<button class='uibutton' class='hideData'>Sembunyikan</button>
								</td>
							</tr>
