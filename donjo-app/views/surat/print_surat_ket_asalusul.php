...
<tr><td>Warganegara</td><td>:</td><td><?=$data['warganegara']?></td></tr>
<tr><td>Agama</td><td>:</td><td><?=$data['agama']?></td></tr>
<tr><td>Pekerjaan</td><td>:</td><td><?=$data['pekerjaan']?></td></tr>
<tr><td>Tempat Tinggal</td><td>:</td><td>RT. <?=$data['rt']?>, RW. <?=$data['rw']?>, Dusun <?=unpenetration(ununderscore($data['dusun']))?>, Kel. <?=unpenetration($desa['nama_desa'])?>, Kec. <?=unpenetration($desa['nama_kecamatan'])?>, Kab. <?=unpenetration($desa['nama_kabupaten'])?></td></tr>
</table>
<table width="100%">
<tr></tr>
...
<? if($ayah){?>
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?=unpenetration($ayah['nama'])?></td></tr>
...
<? } else {?>
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?=unpenetration($input['nama_ayah'])?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td><? echo $input['alamat_ayah']; ?></td></tr>
</table>
<? }?>
<table width="100%">
<tr></tr>
...
<? if($ibu){?>
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?=unpenetration($ibu['nama'])?></td></tr>
...
<? } else {?>
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?=unpenetration($input['nama_ibu'])?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td><? echo $input['alamat_ibu']; ?></td></tr>
</table>
<? }?>
<table width="100%">
<tr></tr>
