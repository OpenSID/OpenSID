...
<?php }?>
<tr>
	<th>Permohonan KTP  (Diisi gengan Tanda Silang Pada kotak)</th>
	<td><input name="baru" type="text" class="inputbox" size="1"/> a. Baru <input name="perpanjang" type="text" class="inputbox" size="1"/> b. Perpanjang <input name="penggantian" type="text" class="inputbox" size="1"/> b. Penggantian</td>
	</tr>
<tr>
