	...
	<td style="background:#fff;"> 
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Formulir Layanan : Surat Keterangan Belum Menikah</h3>
					...
					<table class="form">
						...
						if($individu){ 
							...
							<tr>
								...
								<td>
									<button class='uibutton special' id='showData'>Tampilkan</button>
									<button class='uibutton' id='hideData'>Sembunyikan</button>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<a header="Dokumen" target="ajax-modal" rel="dokumen" href="<?php echo site_url("penduduk/dokumen_list/$individu[id]")?>" </td>
							</tr>
						<?php 
						}
						?>
						...
						<tr>
							<th>Keperluan</th>
							<td>
								<textarea name="keperluan" class="" style="resize:none;height:30px;width:600px;" size="800"></textarea>
							</td>
						</tr>
						<tr>
						<tr>
							<th>Status</th>
							<td ><input name="status" type="text" class="inputbox " size="12"/></td>
							</td>
						</tr>
						<tr>
