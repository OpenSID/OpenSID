	...
	<td style="background:#fff;"> 
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Formulir Layanan : Surat Keterangan Miskin</h3>
				<form action="" id="main" name="main" method="POST" class="formular">
				<div id="form-cari-pemohon">
					<table class="form">
						<tr>
							<td width="200">NIK / Nama Orang Tua</td>
							<td>
					...
					<table class="form">
						...
						<tr>
							<th>Sekolah/Universitas</th>
								<td ><input name="sekolah" type="text" class="inputbox " size="50"/></td>
							</td>
						</tr>
						<tr>
							<th>Jurusan/Fakultas/Prodi</th>
								<td ><input name="jurusan" type="text" class="inputbox " size="50"/></td>
							</td>
						</tr>
						<tr>
							<th>Kelas/Semester</th>
								<td ><input name="kelas" type="text" class="inputbox " size="20"/></td>
							</td>
						</tr>						
						<tr>
