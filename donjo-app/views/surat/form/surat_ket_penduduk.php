...
<?php foreach($pamong AS $data){?>
	<option value="<?php echo $data['pamong_nama']?>" <?php if($data['pamong_ttd']==1) echo "selected"?>><font style="bold"><?php echo $data['pamong_nama']?></font> (<?php echo unpenetration($data['jabatan'])?>)</option>
<?php }?>
</select>
</td>
</tr>
