...
<h3>Surat Pengantar Permohonan Kartu Keluarga Baru</h3>
</div>
...
<?php }?>		
			<tr>
				<tr>
				<th>TELEPON KANTOR DESA</th>
				<td>
					<input name="telepon" type="text" class="inputbox required" size="40"/>
				</td>
			    </tr>	
	        <tr>
	        <th>10. Jumlah Anggota Keluarga</th>
				<td>
