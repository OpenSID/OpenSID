...
<div id="pageC">
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Formulir Layanan : Surat Pengantar Akta Kematian</h3>
				...
				<div id="form-melengkapi-data-permohonan">
					...
					<table class="form">
						...
						<tr>
							<th>Nomor Surat</th>
							<td><input name="nomor" type="text" class="inputbox required" size="20"/>
							</td></tr>
						<tr>
							<th>Nama Almahum</th>
							<td><input name="nama_mati" type="text" class="inputbox required" size="50"/></td>
						</tr>
						<tr>
							<th>NIK Almarhum</th>
							<td><input name="nik_mati" type="text" class="inputbox required" size="20"/></td>
						</tr>
						<tr>
