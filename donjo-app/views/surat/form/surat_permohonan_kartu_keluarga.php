	...
	<td style="background:#fff;">
		<div id="contentpane">
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
				<h3>Surat Permohonan Kartu Keluarga Baru</h3>
				...
				<div class="ui-layout-south panel bottom">
					...
					<div class="right">
						<div class="uibutton-group">
							...
							<?php if (SuratCetak($url)) { ?><button type="button" onclick="$('#'+'validasi').attr('action','<?php echo $form_action?>');$('#'+'validasi').submit();" class="uibutton special"><span class="fa fa-print" style="color:#fff">&nbsp;</span>Cetak</button><?php } ?>
