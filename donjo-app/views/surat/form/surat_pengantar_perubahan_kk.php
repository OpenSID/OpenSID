...
<h3>Surat Pengantar Perubahan Kartu Keluarga</h3>
</div>
...
<?php }?>
			...
			<tr>
				...
				<td>
					<input name="alasan" type="text" class="inputbox required" size="5"/>
				1. Karena Penambahan Anggota Keluarga (Kelahiran, Kedatangan) 2. Karena Pengurangan Anggota Keluarga (Kematian, Kepindahan) 3. Lainnya	
			<tr>
				<th>Jumlah Anggota Keluarga</th>
				<td>
					<input name="jml_keluarga" type="text" class="inputbox required" size="40"/>
				</td>
			</tr>
			<tr>
