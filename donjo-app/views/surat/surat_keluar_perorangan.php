								...
								<tbody>
									<form id="main" name="main" action="" method="post">
              						...
              						<div class="col-sm-6 col-lg-6">
              							<select class="form-control required input-sm select2-nik-ajax" id="nik" name="nik" data-selected="<?= $individu['id']?>" data-url="<?= site_url('surat/list_penduduk_ajax')?>" onchange="formAction('main')">
															<?php if ($individu): ?>
