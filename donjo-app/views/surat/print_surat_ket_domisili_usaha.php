...
<tr><td class="indentasi" colspan="3">Bahwa yang tersebut namanya diatas, memang benar penduduk kami yang memiliki usaha <?=$input['usaha']?>, berlokasi di Dusun <?=unpenetration($data['dusun'])?>, Desa <?=unpenetration($desa['nama_desa'])?>, Kecamatan <?=unpenetration($desa['nama_kecamatan'])?>, Kabupaten <?=unpenetration($desa['nama_kabupaten'])?>.</td></tr> 
