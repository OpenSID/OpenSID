	...
	<form id="validasi" action="<?=$form_action?>" method="POST" enctype="multipart/form-data">
		<div class="box-body">
			<div class="form-group">
				...
				<input name="nama" class="form-control strip_tags required" type="text" placeholder="Nama Produk" minlength="3" maxlength="100" value="<?= htmlentities($produk->nama) ?>" />
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input id="harga" name="harga" onkeyup="cek_nominal();" class="form-control number required" type="number" placeholder="Harga Produk" style="text-align:right;" min="100" max="2000000000" step="100" value="<?= $produk->harga ?>" />
						</div>
					</div>
				</div>
				<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-sm-6" id="tampil-persen" <?php if ($produk->tipe_potongan == 2) echo 'style="display:none;"' ?>>
					<div class="form-group">
						<div class="input-group">
							<input type="number" class="form-control number required" <?= $produk->tipe_potongan == 1 || $produk->tipe_potongan == null ? '' : 'disabled' ?> id="persen" name="persen" onkeyup="cek_persen();" placeholder="Potongan Persen (%)" style="text-align:right;" min="0" max="100" step="1" value="<?= $produk->potongan ?? 0 ?>" />
							<span class="input-group-addon">%</span>
						</div>
					</div>
				</div>
				<div class="col-sm-6" id="tampil-nominal" <?php if ($produk->tipe_potongan == 1 || $produk->tipe_potongan == null) echo 'style="display:none;"' ?>>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon ">Rp.</span>
							<input type="number" class="form-control number required" <?= $produk->tipe_potongan == 2 ? '' : 'disabled' ?> id="nominal" name="nominal" onkeyup="cek_nominal();" placeholder="Potongan Nominal (Rp.)" style="text-align:right;" min="0" max="99999999999" step="10" value="<?= $produk->potongan ?? 0 ?>" />
						</div>
					</div>
				</div>
			</div>
