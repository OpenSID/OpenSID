...
<button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('plan/area/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"title="Cari Data"><span class="fa fa-search">&nbsp;</span>Cari</button>
</div>
</div>
<table class="list">
<thead>
...
<th width="50">Aksi</th>
 ...
 <?php  if($o==2): ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/1")?>">Kategori <span class="fa fa-sort-asc fa-sm">
<?php  elseif($o==1): ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/2")?>">Kategori <span class="fa fa-sort-desc fa-sm">
<?php  else: ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/1")?>">Kategori <span class="fa fa-sort fa-sm">
<?php  endif; ?>&nbsp;</span></a></th>

<?php  if($o==4): ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/3")?>">Aktif <span class="fa fa-sort-asc fa-sm">
<?php  elseif($o==3): ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/4")?>">Aktif <span class="fa fa-sort-desc fa-sm">
<?php  else: ?>
<th align="left"><a href="<?php echo site_url("area/index/$p/3")?>">Aktif <span class="fa fa-sort fa-sm">
<?php  endif; ?>&nbsp;</span></a></th>
<th>Kategori</th>
<th>Jenis</th>
<th></th>
...
<td>
<a href="<?php echo site_url("area/form/$p/$o/$data[id]")?>" class="ui-icons fa fa-edit tipsy south" title="Edit Data"></a><a href="<?php echo site_url("area/delete/$p/$o/$data[id]")?>" class="ui-icons fa fa-trash tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php /*if($data['enabled'] == '2'):?><a href="<?php echo site_url('plan/area/area_lock/'.$data['id'])?>" class="ui-icons fa fa-lock tipsy south" title="Enable area"></a><?php elseif($data['enabled'] == '1'): ?><a href="<?php echo site_url('plan/area/area_unlock/'.$data['id'])?>" class="ui-icons fa fa-unlock tipsy south" title="Disable area"></a>*/?><a href="<?php echo site_url("area/ajax_area_maps/$p/$o/$data[id]")?>" target="ajax-modalz" rel="window" header="area <?php echo $data['nama']?>" class="ui-icons fa fa-map tipsy south" title="area <?php echo $data['nama']?>"></a>
...
<div class="uibutton-group">
<?php  if($paging->next): ?>
<a href="<?php echo site_url("area/index/$paging->next/$o")?>" class="uibutton">Next <span class="fa fa-step-forward"></span></a>
<?php  endif; ?>
<?php  if($paging->end_link): ?>
<a href="<?php echo site_url("area/index/$paging->end_link/$o")?>" class="uibutton">Akhir <span class="fa fa-fast-forward"></span></a>
<?php  endif; ?>
</div>
</div>
</div>
