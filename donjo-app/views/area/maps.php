...
<script>
  ...
  window.onload = function()
  {
    ...
    layerCustom = tampilkan_layer_area_garis_lokasi(peta_area, '<?=addslashes(json_encode($all_area))?>', '<?=addslashes(json_encode($all_garis))?>', '<?=addslashes(json_encode($all_lokasi))?>', '<?= base_url().LOKASI_SIMBOL_LOKASI?>');
