...
<div id="contentpane"> 
 ...
 <a href="<?php echo site_url("analisis_statistik_jawaban/form_parameter/$analisis_statistik_jawaban[id]/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data" target="ajax-modal" rel="window" header="Form Data Parameter"><span class="fa fa-edit "></span> Ubah</a>
 <a href="<?php echo site_url("analisis_statistik_jawaban/delete_parameter/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash "></span></a>
			</div>
 </td>
		 <?php }?>
