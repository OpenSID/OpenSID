...
<td>
<a href="<?php echo site_url("point/form/$p/$o/$data[id]")?>" class="ui-icons icon-edit tipsy south" title="Edit Data"></a><a href="<?php echo site_url("point/delete/$p/$o/$data[id]")?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php if($data['enabled'] == '2'):?><a href="<?php echo site_url('point/point_lock/'.$data['id'])?>" class="ui-icons icon-lock tipsy south" title="Enable point"></a><?php elseif($data['enabled'] == '1'): ?><a href="<?php echo site_url('point/point_unlock/'.$data['id'])?>" class="ui-icons icon-unlock tipsy south" title="Disable point"></a><a href="<?php echo site_url("point/sub_point/$data[id]")?>" class="ui-icons icon-document-table tipsy south" title="Rincian Sub point"></a><a href="<?php echo site_url("point/ajax_add_sub_point/$data[id]")?>" target="ajax-modal" rel="window" header="Tambah Sub point <?php echo $data['nama']?>" class="ui-icons icon-plus tipsy south" title="Tambah Sub point"></a>
<?php endif?>
</td>
