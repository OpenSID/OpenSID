...
<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("menu/delete_all/$tip/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash "></span> Hapus Data</button>
</div>
</div>
</div>
      ...
      <tr>
        ...
        <td>
          <div class="uibutton-group">
            ...
            <?php endif; ?>
            <a href="<?php echo site_url("menu/sub_menu/$tip/$data[id]")?>" class="uibutton tipsy south" title="Rincian Sub Menu"><span class="fa fa-list"></span> Detail</a>
            ...
            <?php if($data['enabled'] == '2'):?>
              <a href="<?php echo site_url("menu/menu_lock/$tip/".$data['id'])?>"  title="Aktivasi menu"><span class="icon-lock "></span></a><?php elseif($data['enabled'] == '1'): ?><a href="<?php echo site_url("menu/menu_unlock/$tip/".$data['id'])?>" class="uibutton tipsy south"  title="Non-aktifkan menu"><span class="fa fa-unlock "></span></a>
