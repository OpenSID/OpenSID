        ...
        <td>
          <div class="uibutton-group">
            ...
            <?php if($data['enabled'] == '2'):?>
              ...
              <a href="<?php echo site_url("menu/ajax_add_sub_menu/$tip/$data[id]")?>" class="uibutton tipsy south" target="ajax-modalx" rel="window" header="Tambah Sub Menu <?php echo $data['nama']?>" class="uibutton tipsy south" title="Tambah Sub Menu"><span class="fa fa-plus-square "></span></a>
            <?php endif?>
              </div>
        </td>
