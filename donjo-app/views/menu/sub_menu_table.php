																	...
																	<tr>
																		...
																		<td nowrap>
																		  <?php if ($_SESSION['grup']==1): ?>
																				<a href="<?= site_url("menu/urut/$tip/$data[id]/1/$menu")?>" class="btn bg-olive btn-flat btn-sm"  title="Pindah Posis Ke Bawah"><i class="fa fa-arrow-down"></i></a>
																				<a href="<?= site_url("menu/urut/$tip/$data[id]/2/$menu")?>" class="btn bg-olive btn-flat btn-sm"  title="Pindah Posis Ke Atas"><i class="fa fa-arrow-up"></i></a>
                                      <?php endif; ?>
