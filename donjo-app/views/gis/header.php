...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/css/noJS.css" /></noscript>
		...
		<script type="text/javascript" src="<?php echo base_url()?>assets/js/validasi.js"></script><script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?v=4&key=<?php echo $this->config->item('sid')['googlekey']?>"></script>
<!---->
<!--[if lte IE 6]>
<style type="text/css">
