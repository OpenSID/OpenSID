...
<?php  if($_SESSION['grup']==1 OR $_SESSION['grup']==2){?>
	...
	<li><a href="<?php echo site_url()?>sid_core"><i class="fa fa-group "></i>Penduduk</a></li>
...
<?php  if($_SESSION['grup']==1 OR $_SESSION['grup']==2){?>
	<?php  if($_SESSION['grup']==1){?>
		...
		<li><a href="<?php echo site_url()?>database"><i class="fa fa-hdd "></i>Database</a></li>
	<?php  }?>
	<li><a href="<?php echo site_url()?>sms"><i class="fa fa-envelope-alt "></i>SMS</a></li>
	<li><a href="<?php echo site_url()?>web"><i class="fa fa-cloud "></i>Admin Web</a></li>
<?php  }?>
<li><a href="<?php echo site_url()?>siteman"><i class="fa fa-off "></i>Log Out</a></li>
</ul>
