								...
								<div class="leaflet-control-layers-group" id="leaflet-control-layers-group-2">
									...
									<div class="leaflet-control-layers-separator"></div>
										<div class="form-group">
											...
											<select class="form-control form-control-sm " name="filter" onchange="formAction('mainform_map','<?= site_url('gis/filter')?>')">
										...
										<div class="form-group">
											...
											<select class="form-control form-control-sm " name="sex" onchange="formAction('mainform_map','<?= site_url('gis/sex')?>')">
										...
										<label><?=ucwords($this->setting->sebutan_dusun)?></label>
											<select class="form-control form-control-sm " name="dusun" onchange="formAction('mainform_map','<?= site_url('gis/dusun')?>')">
										...
										<?php if ($dusun): ?>
											<div class="form-group">
												<label>RW</label>
												<select class="form-control form-control-sm " name="rw" onchange="formAction('mainform_map','<?= site_url('gis/rw')?>')">
											...
											<?php if ($rw): ?>
												<div class="form-group">
													<label>RT</label>
													<select class="form-control form-control-sm " name="rt" onchange="formAction('mainform_map','<?= site_url('gis/rt')?>')">
										...
										<div class="form-group">
											<a href="<?=site_url("gis/ajax_adv_search")?>" class="btn btn-block btn-social bg-olive btn-xs" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Pencarian Spesifik" title="Pencarian Spesifik">
												<i class="fa fa-search"></i> Pencarian Spesifik
											</a>
											<a href="<?=site_url("gis/clear")?>" class="btn btn-block btn-social bg-orange btn-xs">
