...
<button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('gis/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="ui-icon ui-fa fa-search">&nbsp;</span>Search</button>
<button href="<?php echo site_url("gis/ajax_adv_search")?>"  target="ajax-modalx" rel="window" header="Pencarian Spesifik"  class="uibutton tipsy south"  title="Pencarian Spesifik"><span class="ui-icon ui-fa fa-search">&nbsp;</span>Pencarian Spesifik</button>

<a href="<?php echo site_url("gis/clear")?>"  class="uibutton tipsy south"  title="Clear Pencarian" style=""><span class="ui-icon ui-fa fa-search">&nbsp;</span>Clear</a>
		</form>
	</div>
</div>
<div id="map"></div>
