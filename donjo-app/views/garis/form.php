            ...
            <div class="box-header with-border">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input name="nama" class="form-control input-sm required" type="text" value="<?=$garis['nama']?>"></input>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<p class="help-block small text-red">Kosongi jika tidak ingin mengubah foto.</p>
								</div>
							</div>
							<div class="form-group">
