...
<a href="<?php  echo site_url("garis/ajax_add_sub_garis/$garis")?>" target="ajax-modal" rel="window" header="Tambah Sub garis" class="uibutton tipsy south" title="Tambah Sub garis"><span class="fa fa-plus-square">&nbsp;</span>Tambah garis Baru</a>
<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php  echo site_url("garis/delete_all/")?>')" class="uibutton tipsy south"><span class="fa fa-trash">&nbsp;</span>Hapus Data</button>
</div>
</div>
</div>
...
<td>
	<div class="uibutton-group">
		<a href="<?php  echo site_url("garis/ajax_add_sub_garis/$garis/$data[id]")?>" class="uibutton tipsy south" target="ajax-modal" rel="window" header="Edit garis" title="Ubah Data"><span class="fa fa-edit"></span></a>
		<a href="<?php  echo site_url("garis/delete_sub_garis/$garis/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash"></a>
