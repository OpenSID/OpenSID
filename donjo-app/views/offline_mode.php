...
<body>
	...
	<div align="center">
		<?php if ($main['logo']): ?>
			<img class="profile-user-img img-fluid rounded-circle" src="<?=gambar_desa($main['logo'])?>" alt="Logo">
		<?php else: ?>
			<img class="profile-user-img img-fluid rounded-circle" src="<?= base_url()?>assets/files/logo/home.png" alt="Logo">
		<?php endif ?>
		<p>
