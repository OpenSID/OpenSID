	...
	<div id="content" class="container_12 clearfix">
		<div id="content-main" class="grid_7">
			...
			<table width="100%" style="border: solid 0px black; text-align: center;">
				<tr>
					<td align="center"><img src="<?php echo site_url(); ?>desa/logo/logo_clean.png" alt="<?php echo $desa['nama_desa']?>"  class="logo_mandiri">
				</tr>
				<tr>
					</td>
					<td>
						<h3>BIODATA PENDUDUK WARGA NEGARA INDONESIA</h3>
						<h5><?php echo ucwords($this->setting->sebutan_kabupaten_singkat)?> <?php echo $desa['desa']['nama_kabupaten']?>, <?php echo ucwords($this->setting->sebutan_kecamatan_singkat)?> <?php echo $desa['desa']['nama_kecamatan']?>, <?php echo ucwords($this->setting->sebutan_desa)?> <?php echo $desa['desa']['nama_desa']?></h5>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<td align="center" scope="col" width="50%"><?php echo ucwords($this->setting->sebutan_desa)?> <?php echo $desa['desa']['nama_desa']?>, <?php echo tgl_indo(date("Y m d"))?></td>
			  </tr>
			  <tr>
				<td align="center">&nbsp;</td>
				<td align="center">&nbsp;</td>
				<td align="center">Kepala <?php echo ucwords($this->setting->sebutan_desa)?> <?php echo $desa['desa']['nama_desa']?></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td align="center">( <?php echo strtoupper($penduduk['nama'])?> )</td>
				<td align="center">&nbsp;</td>
				<td align="center"><b>( <?php echo $desa['desa']['nama_kepala_desa']?> )</b></td>
			  </tr>
			</table>
