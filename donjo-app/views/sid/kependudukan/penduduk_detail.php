			...
			<div class="row">
				<div class="col-md-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h4 class="box-title"><strong><?= 'Biodata Penduduk ( ' . $penduduk['nik'] . ' | ' . $penduduk['nama'] . ' )'; ?></strong></h4>
						</div>
						<div class="box-header with-border">
						...
						<div class="box-body">
								...
								<table class="table table-bordered table-striped table-hover tabel-rincian">
									<tbody>
										...
										<tr>
											...
											<td width="1%">:</td><td>
												<span class="<?= ($penduduk['status_dasar_id'] != 1) ? 'label label-danger' : 'label label-success'?>"><strong><?= strtoupper($penduduk['status_dasar']); ?></strong></span></td>
										</tr>
										<tr>
											<td>NIK</td>
											<td>:</td>
							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover">
									<tbody>
										<tr>
											<th class="subtitle_head"><strong>DATA PROGRAM BANTUAN</strong></th>
										</tr>
										<tr>
											<td>
												<table class="table table-bordered table-striped table-hover tabel-rincian">
													...
													<tbody>
														<?php foreach ($program['programkerja'] as $key => $item): ?>
															<tr>
																...
																<td width="15%"><?= fTampilTgl($item["sdate"], $item["edate"]); ?></td>
																<td width="20%"><a href="<?= site_url("program_bantuan/data_peserta/$item[peserta_id]"); ?>"><?= $item["nama"]; ?></a></td>
																<td class="text-justify"><?= $item["ndesc"];?></td>
															</tr>
														<?php endforeach; ?>
													</tbody>
												</table>
										...
										<tr>
											<th class="subtitle_head"><strong>DATA DOKUMEN / KELENGKAPAN PENDUDUK</strong></th>
										</tr>
										<tr>
											<td>
												<table class="table table-bordered table-striped table-hover tabel-rincian">
													...
													<tbody>
														<?php foreach ($list_dokumen as $key => $data): ?>
															<tr>
																<td class="padat"><?= ($key + 1); ?></td>
																<td><?= $data['nama']?></td>
																<td><a href="<?= base_url() . LOKASI_DOKUMEN . '' . urlencode($data['satuan']); ?>" target="_blank" ><?= $data['satuan']; ?></a></td>
