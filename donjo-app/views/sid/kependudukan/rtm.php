            ...
            <div class="ui-layout-north panel">
              ...
              <div class="left">
                <div class="uibutton-group">
                  ...
                  <?php /*<a href="<?php echo site_url('rtm/form_kk')?>" target="ajax-modalx" rel="window" header="Tambah Data Per Keluarga" class="uibutton tipsy south" title="Tambah Data Berbasis Keluarga" ><span class="fa fa-plus-square ">&nbsp;</span>Tambah Data By Keluarga</a>*/?>
              ...
              <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
                ...
                <table class="list">
                  ...
                  <?php  foreach($main as $data): ?>
                      ...
                      <td width="5">
                        <div class="uibutton-group">
                    			<a href="<?php echo site_url("rtm/anggota/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Rincian Anggota rtm"><span class="fa fa-list "> Rincian </span></a>
                    			<a href="<?php echo site_url("rtm/ajax_add_anggota/$p/$o/$data[id]")?>" target="ajax-modalx" rel="window" header="Tambah Anggota rtm" class="uibutton tipsy south" title="Tambah Anggota rtm"><span  class="fa fa-plus-square  "></span></a>
                          <?php  if($grup==1){?>
