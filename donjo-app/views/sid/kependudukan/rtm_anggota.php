...
<div class="content-header">
    ...
    <h3>Daftar Anggota Rumah Tangga : <?php echo $kepala_kk['nama']?> - <?php echo $kepala_kk['no_kk']?></h3>
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url("rtm/ajax_add_anggota/$p/$o/$kk")?>" class="uibutton tipsy south" title="Tambah Data"  header="Tambah Anggota rtm" target="ajax-modalx" rel="window"><span class="fa fa-user-plus"></span> Tambah Anggota</a>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
          <td align="center" width="2"><?php echo $data['no']?></td>
			...
			<td>
				<div class="uibutton-group">
				<a href="<?php echo site_url("rtm/delete_anggota/$p/$o/$kk/$data[id]")?>" class="uibutton tipsy south" title="Hapus dari Ruta" target="confirm" message="Apakah Anda Yakin?" header="Hapus"><span class="fa fa-minus-square"></span> Hapus</a>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            <a href="<?php echo site_url("rtm/kartu_rtm/$p/$o/$kk")?>" class="uibutton confirm icon next"><span class="fa fa-address-card"></span>Kartu RTM</a>
        </div>
    </div>
</div>
</td></tr></table>
