...
<div class="row">
	<div class="col-sm-12">
		<div class="form-group subtitle_head">
			<label class="text-right"><strong>DATA DASAR</strong></label>
		</div>
	</div>
	<div class="col-sm-4">
							...
							<td width="25">
								<select name="ktp_el" class="form-control input-sm">
									...
									<?php foreach ($ktp_el as $id => $nama): ?>
										<option value="<?= $id?>" <?= selected(strtolower($penduduk['ktp_el']), $nama); ?>><?= strtoupper($nama)?></option>
									<?php endforeach;?>
								</select>
							</td>
							<td width="25">
								<select name="status_rekam" class="form-control input-sm">
									...
									<?php foreach ($status_rekam as $id => $nama): ?>
										<option value="<?= $id?>" <?= selected(strtolower($penduduk['status_rekam']), $nama); ?>><?= strtoupper($nama)?></option>
									<?php endforeach;?>
								</select>
							</td>
							<td width="25">
...
<div class="col-sm-12">
	<div class="form-group subtitle_head">
		<label class="text-right"><strong>DATA PERNIKAHAN</strong></label>
	</div>
</div>
<div class="col-sm-4">
	<div class="form-group">
