			...
			<div class="row text-sm">
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="nik"  name="nik" class="form-control form-control-sm required nik" type="text" placeholder="Nomor NIK" value="<?= $penduduk['nik']?>"></input>
				...
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="nama" name="nama" class="form-control form-control-sm required nama" maxlength="100" type="text" placeholder="Nama Lengkap" value="<?= strtoupper($penduduk['nama'])?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class='form-group'>
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<tr>
										...
										<td width='25%'>
										  <input name="tag_id_card" class="form-control form-control-sm digits" type="text" minlength="10" maxlength="15" placeholder="Tag Id Card" value="<?= $penduduk['tag_id_card']?>"></input>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="no_kk_sebelumnya" name="no_kk_sebelumnya" class="form-control form-control-sm nik" maxlength="30" type="text" placeholder="No KK Sebelumnya" value="<?= strtoupper($penduduk['no_kk_sebelumnya'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm <?= ( ! $id_kk) ?: 'required'; ?>" name="kk_level">
				...
				<div class='col-sm-5'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm required" name="status" <?php ($penduduk['no_kk']) and print('disabled') ?>>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="akta_lahir" name="akta_lahir" class="form-control form-control-sm nomor_sk" type="text" maxlength="40" placeholder="Nomor Akta Kelahiran" value="<?= $penduduk['akta_lahir']?>"></input>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						<label for="tempatlahir">Tempat Lahir</label>
						<input id="tempatlahir" name="tempatlahir" class="form-control form-control-sm" maxlength="100" type="text" placeholder="Tempat Lahir" value="<?= strtoupper($penduduk['tempatlahir'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm pull-right" id="tgl_1" name="tanggallahir" type="text" value="<?= $penduduk['tanggallahir']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm pull-right" id="jammenit_1" name="waktu_lahir" type="text" value="<?= $penduduk['waktu_lahir']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-4'>
					...
					<div class='row'>
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<select class="form-control form-control-sm" name="jenis_kelahiran">
						...
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="kelahiran_anak_ke" name="kelahiran_anak_ke" class="form-control form-control-sm number" maxlength="2" type="text" placeholder="Anak Ke" value="<?= strtoupper($penduduk['kelahiran_anak_ke'])?>"></input>
							</div>
						</div>
						<div class='col-sm-4'>
							<div class='form-group'>
					...
					<div class='row'>
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="berat_lahir" name="berat_lahir" class="form-control form-control-sm number" maxlength="6" type="text" placeholder="Berat Lahir" value="<?= strtoupper($penduduk['berat_lahir'])?>"></input>
							</div>
						</div>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="panjang_lahir">Panjang Lahir <code>( cm )</code></label>
								<input id="panjang_lahir" name="panjang_lahir" class="form-control form-control-sm number" maxlength="3" type="text" placeholder="Panjang Lahir" value="<?= strtoupper($penduduk['panjang_lahir'])?>"></input>
							</div>
						</div>
					</div>
				</div>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm" name="pendidikan_kk_id">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm" name="pekerjaan_id">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm" name="warganegara_id">
				...
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="dokumen_pasport"  name="dokumen_pasport" class="form-control form-control-sm nomor_sk" maxlength="45" type="text" placeholder="Nomor Paspor" value="<?= strtoupper($penduduk['dokumen_pasport'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm pull-right" id="tgl_2" name="tanggal_akhir_paspor" type="text" value="<?= $penduduk['tanggal_akhir_paspor']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="dokumen_kitas"  name="dokumen_kitas" class="form-control form-control-sm number" maxlength="10" type="text" placeholder="Nomor KITAS/KITAP" value="<?= strtoupper($penduduk['dokumen_kitas'])?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class="form-group subtitle_head">
					...
					<div class="row">
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="ayah_nik"  name="ayah_nik"  class="form-control form-control-sm nik" type="text" placeholder="Nomor NIK Ayah"  value="<?= $penduduk['ayah_nik']?>"></input>
							</div>
						</div>
						<div class='col-sm-8'>
							<div class='form-group'>
								<label for="nama_ayah">Nama Ayah </label>
								<input id="nama_ayah" name="nama_ayah" class="form-control form-control-sm nama" maxlength="100" type="text" placeholder="Nama Ayah" value="<?= strtoupper($penduduk['nama_ayah'])?>"></input>
							</div>
						</div>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="ibu_nik"  name="ibu_nik"  class="form-control form-control-sm nik" type="text" placeholder="Nomor NIK Ibu" value="<?= $penduduk['ibu_nik']?>"></input>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						<label for="nama_ibu">Nama Ibu </label>
						<input id="nama_ibu" name="nama_ibu" class="form-control form-control-sm nama" maxlength="100" type="text" placeholder="Nama Ibu"  value="<?= strtoupper($penduduk['nama_ibu'])?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class="form-group subtitle_head">
				...
				<?php if (!empty($penduduk['no_kk']) or $kk_baru) : ?>
					<div class='col-sm-12'>
						<div class='form-group'>
							...
							<input id="alamat"  name="alamat"  class="form-control form-control-sm" maxlength="200" ype="text" placeholder="Alamat di Kartu Keluarga" size="20" value="<?= $penduduk['alamat']?>"></input>
						</div>
					</div>
				<?php endif; ?>
				<?php if (empty($id_kk)): ?>
					<div class="container-fluid">
						<div class="row">
								<div class='form-group col-sm-3'>
									...
									<select name="dusun" class="form-control form-control-sm required" onchange="ubah_dusun($(this).val())">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class='row'>
							<div class='col-sm-12'>
								<a href="<?=site_url("penduduk/ajax_penduduk_maps/$p/$o/$penduduk[id]/1")?>" title="Lokasi <?= $penduduk['nama']?>" class="btn btn-flat bg-navy btn-xs"><i class='fa fa-map-marker'></i> Cari Lokasi Tempat Tinggal</a>
							</div>
						</div>
					</div>
				</div>
				<div class='col-sm-12'>
					...
					<div class='form-group'>
						...
						<input id="email"  name="email"  class="form-control form-control-sm email" maxlength="50" placeholder="Alamat Email" size="20" value="<?= $penduduk['email']?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class='form-group'>
						<label for="alamat_sebelumnya">Alamat Sebelumnya </label>
						<input id="alamat_sebelumnya" name="alamat_sebelumnya" class="form-control form-control-sm" maxlength="200" type="text" placeholder="Alamat Sebelumnya" value="<?= strtoupper($penduduk['alamat_sebelumnya'])?>"></input>
					</div>
				</div>
				<?php if (!$penduduk['no_kk'] and !$kk_baru): ?>
					<div class='col-sm-12'>
						<div class='form-group'>
							...
							<input id="alamat_sekarang" name="alamat_sekarang" class="form-control form-control-sm" maxlength="200" type="text" placeholder="Alamat Sekarang" value="<?= strtoupper($penduduk['alamat_sekarang'])?>"></input>
						</div>
					</div>
				<?php endif; ?>
				<div class='col-sm-12'>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm" name="status_kawin" onchange="disable_kawin_cerai($(this).find(':selected').val())">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<?php endif; ?>
							<input id="akta_perkawinan" name="akta_perkawinan" class="form-control form-control-sm nomor_sk" type="text" maxlength="40" placeholder="Nomor Akta Perkawinan" value="<?= $penduduk['akta_perkawinan']?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm pull-right" id="tgl_3" name="tanggalperkawinan" type="text" value="<?= $penduduk['tanggalperkawinan']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="akta_perceraian" name="akta_perceraian" class="form-control form-control-sm nomor_sk" maxlength="40" type="text" placeholder="Akta Perceraian" value="<?= strtoupper($penduduk['akta_perceraian'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm pull-right" id="tgl_4" name="tanggalperceraian" type="text" value="<?= $penduduk['tanggalperceraian']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-12'>
				...
				<div id='asuransi_pilihan' class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="no_asuransi" name="no_asuransi" class="form-control form-control-sm" type="text" maxlength="50" placeholder="Nomor Asuransi" value="<?= $penduduk['no_asuransi']?>"></input>
					</div>
				</div>
			</div>
