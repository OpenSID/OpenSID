...
<a href="<?php echo site_url("penduduk/ajax_penduduk_pindah/$data[id]")?>" class="uibutton tipsy south" title="Pindah Penduduk dalam Desa" target="ajax-modal" rel="window" header="Pindah Penduduk Lepas" modalWidth="auto" modalHeight="auto"><span class="icon-share icon-large"></span></a>
