						...
						<div class="table-responsive">
							...
							<table class="table table-bordered dataTable table-striped table-hover tabel-daftar">
								...
								<tr>
									...
									<th>Tag ID Card</th>
									<?php if ($o==4): ?>
										<th><a href="<?= site_url("penduduk/index/$p/3"); ?>">Nama <i class='fa fa-sort-asc fa-sm'></i></a></th>
									<?php elseif ($o==3): ?>
										<th><a href="<?= site_url("penduduk/index/$p/4"); ?>">Nama <i class='fa fa-sort-desc fa-sm'></i></a></th>
									<?php else: ?>
										<th><a href="<?= site_url("penduduk/index/$p/3"); ?>">Nama <i class='fa fa-sort fa-sm'></i></a></th>
									<?php endif; ?>
									<?php if ($o==6): ?>
										<th><a href="<?= site_url("penduduk/index/$p/5"); ?>">No. KK <i class='fa fa-sort-asc fa-sm'></i></a></th>
									<?php elseif ($o==5): ?>
										<th><a href="<?= site_url("penduduk/index/$p/6"); ?>">No. KK <i class='fa fa-sort-desc fa-sm'></i></a></th>
									<?php else: ?>
										<th><a href="<?= site_url("penduduk/index/$p/5"); ?>">No. KK <i class='fa fa-sort fa-sm'></i></a></th>
									<?php endif; ?>
									...
									<?php if ($o==8): ?>
										<th><a href="<?= site_url("penduduk/index/$p/7"); ?>">Umur <i class='fa fa-sort-asc fa-sm'></i></a></th>
									<?php elseif ($o==7): ?>
										<th><a href="<?= site_url("penduduk/index/$p/8"); ?>">Umur <i class='fa fa-sort-desc fa-sm'></i></a></th>
									<?php else: ?>
										<th><a href="<?= site_url("penduduk/index/$p/7"); ?>">Umur <i class='fa fa-sort fa-sm'></i></a></th>
									<?php endif; ?>
									<th>Pekerjaan</th>
									<th>Kawin</th>
									<?php if ($o==10): ?>
										<th><a href="<?= site_url("penduduk/index/$p/9"); ?>">Tgl Terdaftar <i class='fa fa-sort-asc fa-sm'></i></a></th>
									<?php elseif ($o==9): ?>
										<th><a href="<?= site_url("penduduk/index/$p/10"); ?>">Tgl Terdaftar <i class='fa fa-sort-desc fa-sm'></i></a></th>
									<?php else: ?>
										<th><a href="<?= site_url("penduduk/index/$p/10"); ?>">Tgl Terdaftar <i class='fa fa-sort fa-sm'></i></a></th>
									<?php endif; ?>
								</tr>
								</thead>
								<tbody>
