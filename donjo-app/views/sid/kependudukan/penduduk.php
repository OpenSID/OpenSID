																	...
																	<div class="btn-group">
																		...
																		<ul class="dropdown-menu" role="menu">
																			...
																			<?php if ($data['status_dasar']==1): ?>
																				...
																				<li>
																					<a href="<?= site_url("penduduk/ajax_penduduk_maps/$p/$o/$data[id]/0")?>" data-remote="false" data-toggle="modal" data-target="#modalBox" title="Lokasi <?= $data['nama']?>" data-title="Lokasi <?= $data['nama']?>" class="btn btn-social btn-flat btn-block btn-sm"><i class='fa fa-map-marker'></i> Cari Lokasi Tempat Tinggal</a>
																				</li>
																				<li>
