    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('penduduk/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-user-plus">&nbsp;</span>Penduduk Pendatang</a>
        ...
        <div class="right">
            ...
            <div class="right">
                ...
                <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('penduduk/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="icon-search ">&nbsp;</span> Cari </button>
            </div>
    </div>
...
<td> <div class="uibutton-group">
	<a href="<?php echo site_url("penduduk/detail/$p/$o/$data[id]")?>"  class="uibutton tipsy south"  title="Rincian Data Penduduk"> <span class="fa fa-address-book"></span> Detail</a>
	...
	<a href="<?php echo site_url("penduduk/ajax_penduduk_pindah/$data[id]")?>" class="uibutton tipsy south" title="Ubah Alamat/Pindah Penduduk dalam Desa" target="ajax-modal" rel="window" header="Ubah/Pindah Alamat Penduduk Lepas" modalWidth="auto" modalHeight="auto"><span class="fa fa-share-square"></span></a>
...
<a href="<?php echo site_url("penduduk/index/$paging->start_link/$o")?>" class="uibutton"><span class="fa fa-arrow-left"></span>&nbsp;AWAL</a>
<?php  endif; ?>
<?php  if($paging->prev): ?>
<a href="<?php echo site_url("penduduk/index/$paging->prev/$o")?>" class="uibutton"><span class="fa fa-backward"></span>&nbsp;PREV</a>
<?php  endif; ?>
            </div>
            <div class="uibutton-group">
...
<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("penduduk/index/$paging->end_link/$o")?>" class="uibutton">AKHIR&nbsp;<span class="fa fa-arrow-right"></span></a>
<?php  endif; ?>
            </div>
        </div>
    </div>
