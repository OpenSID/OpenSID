    ...
    <form id="validasi" action="<?= $form_action?>" method="POST">
        <div class="modal-body">
            <div class="form-group">
                <p style="margin-bottom: 30px">Pecah semua anggota keluarga dan masukkan ke keluarga baru. Misalnya, pada kasus kepala keluarga meninggal, di mana perlu dibuat kartu keluarga baru untuk anggota keluarga yang ditinggal.</p>
            </div>
            <div class="form-group">
