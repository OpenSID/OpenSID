                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="cetak_privasi_nik"><?= $deskripsi_cetak ?></label>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal-footer">
    ...
    <a href="#" class="btn btn-social btn-flat btn-info btn-sm" title="Simpan" target="_blank" onclick="cetak()" id="cetak_data" ><i class="fa fa-check"></i> Simpan</a>
</div>