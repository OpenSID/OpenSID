				...
				<div class="card card-outline card-danger">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input id="umur_max" class="form-control form-control-sm bilangan" maxlength="3" type="text" placeholder="Sampai" name="umur_max" value="<?= $umur_max?>"></input>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="pekerjaan">Pekerjaan</label>
									<select class="form-control form-control-sm" id="pekerjaan_id" name="pekerjaan_id">
										<option value=""> -- </option>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control form-control-sm" id="pendidikan_sedang_id"  name="pendidikan_sedang_id">
										<option value=""> -- </option>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control form-control-sm" id="pendidikan_kk_id" name="pendidikan_kk_id">
										<option value=""> -- </option>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select class="form-control form-control-sm" id="status_penduduk" name="status_penduduk">
										<option value=""> -- </option>
