						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-hover">
								<tbody>
									...
									<tr>
										<td nowrap style="padding-top : 10px;padding-bottom : 10px;" >Alamat</td><td nowrap > : <?= $penduduk->alamat_sekarang ?? $penduduk->alamat ?> RT/RW :  <?= $penduduk->wilayah->rt?>/<?= $penduduk->wilayah->rw?> <?= strtoupper(setting('sebutan_dusun'))?> :  <?= $penduduk->wilayah->dusun?> </td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							<form id="mainform" name="mainform" method="post">
								<div class="table-responsive">
									<table class="table table-bordered dataTable table-striped table-hover tabel-daftar">
										...
										<tbody>
											<?php foreach ($penduduk->dokumen as $key => $data): ?>
												<tr>
