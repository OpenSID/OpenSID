<div id="pageC">
	<div id="contentpane">
			...
			<div class="ui-layout-north panel">
				...
				<div class="left">
					<div class="uibutton-group">
						<a header="Form Dokumen" target="ajax-modal" rel="dokumen" href="<?php echo site_url("penduduk/dokumen_form/$penduduk[id]")?>" class="uibutton tipsy south"><span class="fa fa-plus-square "></span> Tambah Dokumen</a>
						<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("penduduk/delete_all_dokumen/$penduduk[id]")?>')" class="uibutton tipsy south"><span class="fa fa-trash"></span> Hapus</button>
					</div>
				</div>
			</div>
      ...
      <div class="ui-layout-south panel bottom">
				<div class="left">
					<div class="uibutton-group">
						<a href="<?php echo site_url("penduduk/detail/1/0/$penduduk[id]")?>" class="uibutton icon prev">Kembali</a>
					</div>
				</div>
			</div>
		</form>
