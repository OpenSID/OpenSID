					...
					<div class="box-header with-border">
						...
						<div class="btn-group btn-group-vertical">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<?php if ($grup==1):?>
									<li>
										<a href="#confirm-delete" class="btn btn-social btn-flat btn-block btn-sm" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("keluarga/delete_all/$p/$o")?>')"><i class="fa fa-search"></i> Hapus Data Terpilih</a>
									</li>
								<?php endif;?>
							</ul>
						</div>
