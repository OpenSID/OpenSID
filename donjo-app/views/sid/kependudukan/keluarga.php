    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
      <table class="list">
          ...
          <tr>
			...
			<?php  if($o==2): ?>
			<a href="<?php echo site_url("keluarga/index/$p/1")?>">Nomor KK<span class="ui-icon ui-fa fa-triangle-1-n">
			<?php  elseif($o==1): ?>
			<a href="<?php echo site_url("keluarga/index/$p/2")?>">Nomor KK<span class="ui-icon ui-fa fa-triangle-1-s">
			<?php  else: ?>
			<a href="<?php echo site_url("keluarga/index/$p/1")?>">Nomor KK<span class="ui-icon ui-fa fa-triangle-2-n-s">
			<?php  endif; ?>
			&nbsp;</span></a></th>

			<th align="center">
			<?php  if($o==4): ?>
			<a href="<?php echo site_url("keluarga/index/$p/3")?>">Kepala Keluarga<span class="ui-icon ui-fa fa-triangle-1-n">
			<?php  elseif($o==3): ?>
			<a href="<?php echo site_url("keluarga/index/$p/4")?>">Kepala Keluarga<span class="ui-icon ui-fa fa-triangle-1-s">
			<?php  else: ?>
			<a href="<?php echo site_url("keluarga/index/$p/3")?>">Kepala Keluarga<span class="ui-icon ui-fa fa-triangle-2-n-s">
			<?php  endif; ?>
			&nbsp;</span></a></th>
          ...
          <?php  foreach($main as $data): ?>
            ...
            <td width="5"><div class="uibutton-group">
          		<a href="<?php echo site_url("keluarga/anggota/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Rincian Anggota Keluarga"><span class="fa fa-address-book"></span> Detail</a>
				...
				<a href="<?php echo site_url("keluarga/form_a/$p/$o/$data[id]")?>" header="Tambah Anggota Keluarga" class="uibutton tipsy south" title="Tambah Anggota Keluarga"><span  class="fa fa-user-plus"></span></a>
        		<a href="<?php echo site_url("keluarga/ajax_penduduk_pindah/$data[id]")?>"  class="uibutton tipsy south" title="Ubah Alamat/Pindah Keluarga dalam Desa" target="ajax-modal" rel="window" header="Ubah/Pindah Alamat Keluarga" modalWidth="auto" modalHeight="auto"><span class="fa fa-share-square"></span></a>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <?php  if($paging->start_link): ?>
				<a href="<?php echo site_url("keluarga/index/$paging->start_link/$o")?>" class="uibutton"  ><span class="fa fa-arrow-left"></span>&nbsp;AWAL</a>
			<?php  endif; ?>
			<?php  if($paging->prev): ?>
				<a href="<?php echo site_url("keluarga/index/$paging->prev/$o")?>" class="uibutton"  ><span class="fa fa-backward"></span>&nbsp;PREV</a>
			<?php  endif; ?>
            </div>
            <div class="uibutton-group">
			...
			<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("keluarga/index/$paging->end_link/$o")?>" class="uibutton">AKHIR&nbsp;<span class="fa fa-arrow-right"></span></a>
			<?php  endif; ?>
            </div>
        </div>
    </div>
