			...
			<div class="box-header with-border">
				...
				<div class="btn-group-vertical">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li>
							<a href="<?= site_url("keluarga/pencarian_spesifik")?>" class="btn btn-social btn-flat btn-block btn-sm" title="Pencarian Spesifik" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Pencarian Spesifik"><i class="fa fa-search"></i> Pencarian Spesifik</a>
						</li>
					</ul>
				</div>
