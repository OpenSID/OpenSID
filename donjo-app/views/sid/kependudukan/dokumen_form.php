				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-group">
							...
							<input id="nama" name="nama" class="form-control input-sm nomor_surat_keputusan required" type="text" placeholder="Nama Dokumen" value="<?= $dokumen['nama']?>"></input>	<input type="hidden" name="id_pend" value="<?= $penduduk['id']?>"/>
						</div>
						<div class="form-group">
