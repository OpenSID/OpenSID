    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
              <button type="button" title="Delete Data" onclick="deleteAllBox('mainform','<?php echo site_url("penduduk_log/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash"></span> Delete Data</button>
            </div>
        </div>
<div class="right">
...
<a href="<?php echo site_url("penduduk_log/index/$paging->start_link/$o")?>" class="uibutton"><span class="fa fa-arrow-left"></span>&nbsp;AWAL</a>
<?php  endif; ?>
<?php  if($paging->prev): ?>
<a href="<?php echo site_url("penduduk_log/index/$paging->prev/$o")?>" class="uibutton"><span class="fa fa-backward"></span>&nbsp;PREV</a>
<?php  endif; ?>
            </div>
            <div class="uibutton-group">
...
<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("penduduk_log/index/$paging->end_link/$o")?>" class="uibutton">AKHIR&nbsp;<span class="fa fa-arrow-right"></span></a>
<?php  endif; ?>
            </div>
        </div>
    </div>
