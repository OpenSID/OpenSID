    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                ...
                <a href="<?php echo site_url('keluarga/form_old')?>" target="ajax-modal" rel="window" header="Tambah Data Keluarga" class="uibutton tipsy south" title="Tambah Data dari penduduk yang sudah ter-input" ><span class="fa fa-user-plus"></span> Tambah Data</a>
...
<!--				<a href="<?php //=site_url("keluarga/sosial/")?>" class="uibutton confirm" title="Grafik Kelas Sosial" ><span class="icon-bar-chart ">&nbsp;</span>Grafik Kelas Sosial</a>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
        <div class="table-panel top">
            ...
            <div class="right">
                ...
                <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('keluarga/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="icon-search ">&nbsp;</span>Cari</button>
            </div>
...
<a href="<?php echo site_url("keluarga/anggota/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Rincian Anggota Keluarga"><span class="fa fa-address-book"></span>Detail </a>
			...
			<a href="<?php echo site_url("keluarga/ajax_penduduk_pindah/$data[id]")?>"  class="uibutton tipsy south" title="Pindah Keluarga dalam Desa" target="ajax-modal" rel="window" header="Pindah Keluarga"><span class="fa fa-share-square"></span></a>
