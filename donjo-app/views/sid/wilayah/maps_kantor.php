		...
		<div class="container-fluid">
			<div class="row mb-2">
				...
				<div class="col-sm-6">
			      ...
			      <?php endforeach; ?>
						<li class="breadcrumb-item active">Lokasi Kantor <?= $wilayah ?></li>
					</ol>
				</div>
			</div>
		</div>
					...
					<form id="validasi1" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class='card-footer'>
							<div class="row mb-2">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control form-control-sm number" name="lat" id="lat" value="<?= $wil_ini['lat']?>"/>
								</div>
							</div>
							<div class="row mb-2">
								<label class="col-sm-3 control-label" for="lat">Longitude</label>
								<div class="col-sm-9">
									<input type="text" class="form-control form-control-sm number" name="lng" id="lng" value="<?= $wil_ini['lng']?>" />
								</div>
							</div>
								<a href="<?= $tautan['link'] ?>" class="btn btn-flat bg-purple btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" title="Kembali"><i class="fa fa-arrow-circle-o-left"></i> Kembali</a>
