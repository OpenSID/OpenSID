		...
		<div class="container-fluid">
			<div class="row mb-2">
				...
				<div class="col-sm-6">
			      ...
			      <?php endforeach; ?>
						<li class="breadcrumb-item active">Peta Wilayah <?= $wilayah ?></li>
					</ol>
				</div>
			</div>
		</div>
							...
							<div class="row mb-2">
								...
								<div class="col-sm-2">
									<div class="input-group my-colorpicker2">
										<input type="text" id="warna" name="warna" class="form-control form-control-sm required" placeholder="#FFFFFF" value="<?= $wil_ini['warna']?>">
