							...
							<table class="table table-bordered dataTable table-striped table-hover tabel-daftar">
								...
								<tbody>
									...
									<tr>
										...
										<td width="25%"><?= strtoupper($data['dusun'])?></td>
								...
								<tfoot class="bg-gray disabled color-palette">
									<tr>
										...
										<th class="padat"><?= $total['total_rw']?></th>
										<th class="padat"><?= $total['total_rt']?></th>
										<th class="padat"><?= $total['total_kk']?></th>
										<th class="padat"><?= $total['total_warga']?></th>
										<th class="padat"><?= $total['total_warga_l']?></th>
										<th class="padat"><?= $total['total_warga_p']?></th>
									</tr>
								</tfoot>
							</table>
						</div>
