...
<a href="<?php echo site_url("sid_core/sub_rw/$data[id]")?>" class="uibutton tipsy south" title="Rincian Sub Wilayah"><span class="fa fa-list" aria-hidden="true"> Rincian</span></a>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <?php  if($paging->start_link): ?>
				<a href="<?php echo site_url("sid_core/index/$paging->start_link/$o")?>" class="uibutton"  ><span class="fa fa-arrow-left"></span>&nbsp;AWAL</a>
			<?php  endif; ?>
			<?php  if($paging->prev): ?>
				<a href="<?php echo site_url("sid_core/index/$paging->prev/$o")?>" class="uibutton"  ><span class="fa fa-backward"></span>&nbsp;PREV</a>
			<?php  endif; ?>
            </div>
            <div class="uibutton-group">
			...
			<?php  if($paging->end_link): ?>
                <a href="<?php echo site_url("sid_core/index/$paging->end_link/$o")?>" class="uibutton">AKHIR&nbsp;<span class="fa fa-arrow-right"></span></a>
			<?php  endif; ?>
            </div>
        </div>
    </div>
