    ...
    <h3>Wilayah Administratif <?php echo ucwords(config_item('sebutan_dusun'))?></h3>
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('sid_core/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-square ">&nbsp;</span>Tambah <?php echo ucwords(config_item('sebutan_dusun'))?></a>
...
<a href="<?php echo site_url("sid_core/sub_rw/$data[id]")?>" class="uibutton tipsy south" title="Rincian Sub Wilayah"><span class="fa fa-list "> Rincian</span></a>
...
<?php  if($grup==1){?>
        ...
        endforeach; ?>
            ...
            <tr style="background-color:rgba(134,174,204,1);font-weight:bold;">
