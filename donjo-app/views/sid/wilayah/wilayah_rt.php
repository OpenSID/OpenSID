    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
			...
			<td width="5"><div class="uibutton-group">
				<?php if($data['rt']!="-"){?><a href="<?php echo site_url("sid_core/form_rt/$id_dusun/$rw/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-edit "> Ubah </span></a>
