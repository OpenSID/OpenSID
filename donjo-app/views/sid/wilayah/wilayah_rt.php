            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <?php if (can('u')): ?>
                            <a href="<?= site_url("wilayah/form_rt/{$id_dusun}/{$id_rw}")?>" class="btn btn-social btn-flat btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data"><i class="fa fa-plus"></i> Tambah RT</a>
                        <?php endif; ?>
                        <a href="<?= site_url("wilayah/cetak_rt/{$id_dusun}/{$id_rw}")?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Cetak Data" target="_blank"><i class="fa fa-print "></i> Cetak</a>
                        <a href="<?= site_url("wilayah/excel_rt/{$id_dusun}/{$id_rw}")?>" class="btn btn-social btn-flat bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Data" target="_blank"><i class="fa fa-download"></i> Unduh</a>
                                                                        ...
                                                                        <?php if ($data['rt'] != '-'): ?>
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu" role="menu">
                                                                                    <li>
                                                                                        <a href="<?= site_url("wilayah/ajax_kantor_rt_maps/{$id_dusun}/{$id_rw}/{$data['id']}")?>" class="btn btn-social btn-flat btn-block btn-sm"><i class='fa fa-map-marker'></i> Lokasi Kantor RT</a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a href="<?= site_url("wilayah/ajax_wilayah_rt_maps/{$id_dusun}/{$id_rw}/{$data['id']}")?>" class="btn btn-social btn-flat btn-block btn-sm"><i class='fa fa-map'></i> Peta Wilayah RT</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        <?php endif; ?>
