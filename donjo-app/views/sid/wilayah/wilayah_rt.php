    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
			...
			<td width="5"><div class="uibutton-group">
				<?if($data['rt']!="-"){?><a href="<?=site_url("sid_core/form_rt/$id_dusun/$rw/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="icon-edit icon-large"> Ubah </span></a>
				<a href="<?=site_url("sid_core/delete_rt/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="icon-trash icon-large"></span></a><?}?>
			</div></td>
			<td><?=$data['rt']?></td>
