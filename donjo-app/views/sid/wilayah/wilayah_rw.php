	...
	<section class="content" id="maincontent">
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<a href="<?= site_url("sid_core"); ?>" class="btn btn-social btn-flat btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar RW"><i class="fa fa-arrow-circle-left"></i>Kembali ke Daftar <?= ucwords($this->setting->sebutan_dusun)?>
				</a>
			</div>
			<div class="box-header with-border">
							...
							<tbody>
								<?php foreach ($main as $key => $data): ?>
									<tr>
										...
										<td class="padat"><?= $data['jumlah_kk'] ?: '0'; ?></td>
										<td class="padat"><?= $data['jumlah_warga'] ?: '0'; ?></td>
										<td class="padat"><?= $data['jumlah_warga_l'] ?: '0'; ?></td>
										<td class="padat"><?= $data['jumlah_warga_p'] ?: '0'; ?></td>
									</tr>
								<?php endforeach; ?>
							</tbody>
