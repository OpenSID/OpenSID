...
window.onload = function()
{
	...
	var defaultLayer = L.tileLayer.provider('OpenStreetMap.Mapnik').addTo(peta_dusun);
	...
	L.control.layers(baseLayers, null, {position: 'topleft', collapsed: true}).addTo(peta_dusun);
