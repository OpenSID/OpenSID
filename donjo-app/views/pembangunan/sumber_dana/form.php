<div class="content-wrapper">
    <section class="content-header">
        <h1>Isi Data Sumber Dana Pembangunan</h1>
        <ol class="breadcrumb">
            <li><a href="<?= site_url('hom_sid') ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= site_url('pembangunan_sumber_dana') ?>"><i class="fa fa-dashboard"></i>Daftar Jenis</a></li>
            <li class="active">Isi Data</li>
        </ol>
    </section>
    <section class="content" id="maincontent">
        <form class="form-horizontal" id="validasi" method="post" action="<?= site_url('pembangunan_sumber_dana/create') ?>">
            <div class="row">
                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input maxlength="50" class="form-control input-sm required" name="sumber_dana" id="sumber_dana" type="text" placeholder="Sumber Dana" />
                                        </div>
                                    </div>
                                    <div class="form-group">
