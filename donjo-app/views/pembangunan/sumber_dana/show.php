                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input maxlength="50" class="form-control input-sm required" name="sumber_dana" id="sumber_dana" type="text" placeholder="Jenis Pembangunan" value="<?= $main->sumber_dana ?>" disabled/>
                                        </div>
                                    </div>
                                    <div class="form-group">
