...
<div class="ui-layout-north panel">
	...
	<div class="left">
		<div class="uibutton-group">
			...
			<a href="<?php echo site_url('analisis_master/import_analisis')?>" class="uibutton special tipsy south" title="Import" target="ajax-modal" rel="window" header="Import XLS Analisis"><span class="fa fa-plus-square ">&nbsp;</span>Import Analisis</a>
		</div>
	</div>
</div>
