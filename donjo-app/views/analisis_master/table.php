...
<div id="contentpane">    
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<thead>
			...
			<?php  if($o==2): ?>
				<th align="left" width='20'><a href="<?php echo site_url("analisis_master/index/$p/1")?>">Status Analisis<span class="ui-icon ui-icon-triangle-1-n">&nbsp;</span></a></th>
			<?php  elseif($o==1): ?>
				<th align="left" width='20'><a href="<?php echo site_url("analisis_master/index/$p/2")?>">Status Analisis<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
				<th align="left" width='20'><a href="<?php echo site_url("analisis_master/index/$p/1")?>">Status Analisis<span class="ui-icon ui-icon-triangle-2-n-s">&nbsp;</span></a></th>
			<?php  endif; ?>
			</tr>
		</thead>
		<tbody>
