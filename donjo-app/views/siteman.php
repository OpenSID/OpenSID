						...
						<div class="col-sm-6 col-sm-offset-3 form-box">
							<div class="form-top">
								...
								<div class="login-footer-top"><h1><?=ucwords($this->setting->sebutan_desa)?> <?=unpenetration($desa['nama_desa'])?></h1>
									<h3><br /><?=$desa['alamat_kantor']?><br />Kodepos <?=$desa['kode_pos']?>
									<br /><?=ucwords($this->setting->sebutan_kecamatan)?> <?=unpenetration($desa['nama_kecamatan'])?><br /><?=ucwords($this->setting->sebutan_kabupaten)?> <?=unpenetration($desa['nama_kabupaten'])?></h3>
								</div>
							<hr />
							</div>
