<div class="content-wrapper">
	<section class="content-header">
		<h1>Setting Aplikasi Halaman Web</h1>
		<ol class="breadcrumb">
			<li><a href="<?=site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">Setting Aplikasi Halaman Web</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<div class="row">
			<form id="validasi" action="<?=site_url('setting/update_konfigurasi')?>" method="POST" class="form-horizontal">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-body">
							<?php foreach ($this->list_setting_web as $setting): ?>
