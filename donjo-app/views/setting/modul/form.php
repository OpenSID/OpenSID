				...
				<div class="col-md-12">
					<div class="card card-outline card-primary">
						<div class="card-header with-border">
							...
							<?php if ($modul['parent']!='0'): ?>
								<a href="<?= site_url()?>modul/sub_modul/<?=($modul['parent'])?>" class="btn btn-flat btn-primary btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Sub Modul</a>
							<?php endif ?>
						</div>
						<div class="card-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input id="modul" name="modul" class="form-control form-control-sm required" type="text" placeholder="Nama Modul/Sub Modul" value="<?=($modul['modul'])?>" maxlength="30"></input>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="btn-group col-xs-12 col-sm-7" data-toggle="buttons">
									<label id="sx3" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php ($modul['aktif'] =='1' OR $modul['aktif'] == NULL) and print('active'); ?>">
									...
									<label id="sx4" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php ($modul['aktif'] == '2' ) and print('active'); ?>">
