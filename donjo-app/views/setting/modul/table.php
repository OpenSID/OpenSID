		 ...
		 <div class="ui-layout-center" id="maincontent">
			 <div class="table-panel top">
				 ...
				 <div class="right">
					 ...
					 <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('modul/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south" title="Cari Data"><span class="icon-search ">&nbsp;</span>Cari</button>
				 </div>
			</div>
					...
					<tr>
						...
						<td width="5">
							<div class="uibutton-group">
								<a href="<?php echo site_url("modul/form/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="icon-edit ">Ubah </span></a>
							</div>
						</td>
