          ...
          <?php if ($data_lengkap): ?>
            <div class="box box-info">
              <div class="box-header with-border">
                ...
                <a href="<?= site_url("{$this->controller}/perbaiki/log_keluarga")?>" title="Perbaiki Log Keluarga" class="btn btn-social btn-flat bg-orange btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Perbaiki Log Keluarga" data-remote="false" data-toggle="modal" ><i class="fa fa-gear"></i> Perbaiki Log Keluarga</a>
              </div>
              <div class="box-body">
                <div class="row">
                  <div class="col-sm-12">
