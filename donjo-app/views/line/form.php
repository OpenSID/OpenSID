...
<th>Tipe line</th>
	<td>
		<input class="inputbox" type="file" name="simbol" value="<?=$line['simbol']?>" size="20"/>
		<div class="uiradio">
			<input type="radio" id="sx1" name="tipe" value="1"/<?if($line['tipe'] == '1' OR $line['tipe'] == ''){echo 'checked';}?>>
			<label for="sx1">line Atas</label>
			<input type="radio" id="sx2" name="tipe" value="2"/<?if($line['tipe'] == '2'){echo 'checked';}?>>
