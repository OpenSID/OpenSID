...
<td>
<a href="<?=site_url("line/ajax_add_sub_line/$line/$data[id]")?>" class="ui-icons icon-edit tipsy south" target="ajax-modal" rel="window" header="Edit line" title="Edit Data"></a><a href="<?=site_url("line/delete_sub_line/$line/$data[id]")?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?if($data['enabled'] == '2'):?><a href="<?=site_url("line/line_lock_sub_line/$line/$data[id]")?>" class="ui-icons icon-lock tipsy south" title="Enable line"></a><?elseif($data['enabled'] == '1'): ?><a href="<?=site_url("line/line_unlock_sub_line/$line/$data[id]")?>" class="ui-icons icon-unlock tipsy south" title="Disable line"></a><?endif;?>
</td>
