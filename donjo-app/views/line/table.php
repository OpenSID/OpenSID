												...
												<div class="col-sm-6">
													<div class="box-tools">
														<div class="input-group input-group-sm pull-right">
															<input name="cari" id="cari" class="form-control" placeholder="Cari..." type="text" value="<?=$cari?>" onkeypress="if (event.keyCode == 13):$('#'+'mainform').attr('action', '<?=site_url("line/search")?>');$('#'+'mainform').submit();endif">
																...
																<?php foreach ($main as $data):?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="<?= site_url("line/ajax_add_sub_line/$data[id]")?>" class="btn bg-olive btn-flat btn-sm"  title="Tambah Sub Line <?= $data['nama']?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Sub Line"><i class="fa fa-plus"></i></a>
