											...
											<table class="table table-bordered table-striped dataTable table-hover tabel-daftar">
												<thead class="bg-gray disabled color-palette">
													<tr>
														...
														<?php endif; ?>
														<?php if ($o == 2) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/1") ?>">Username <i class='fa fa-sort-asc fa-sm'></i></a></th>
														<?php elseif ($o == 1) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/2") ?>">Username <i class='fa fa-sort-desc fa-sm'></i></a></th>
														<?php else : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/1") ?>">Username <i class='fa fa-sort fa-sm'></i></a></th>
														<?php endif; ?>

														<?php if ($o == 4) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/3") ?>">Nama <i class='fa fa-sort-asc fa-sm'></i></a></th>
														<?php elseif ($o == 3) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/4") ?>">Nama <i class='fa fa-sort-desc fa-sm'></i></a></th>
														<?php else : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/3") ?>">Nama <i class='fa fa-sort fa-sm'></i></a></th>
														<?php endif; ?>

														<th>Staf</th>

														<?php if ($o == 6) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/5") ?>">Group <i class='fa fa-sort-asc fa-sm'></i></a></th>
														<?php elseif ($o == 5) : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/6") ?>">Group <i class='fa fa-sort-desc fa-sm'></i></a></th>
														<?php else : ?>
															<th><a href="<?= site_url("man_user/index/{$p}/5") ?>">Group <i class='fa fa-sort fa-sm'></i></a></th>
														<?php endif; ?>
