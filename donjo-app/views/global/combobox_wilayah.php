...
<?php if ($dusun): ?>
	<select class="form-control input-sm" name="rw" onchange="formAction('mainform','<?= site_url("{$this->controller}/filter/rw"); ?>')" >
...
<?php endif; ?>
<?php if ($rw): ?>
	<select class="form-control input-sm" name="rt" onchange="formAction('mainform','<?= site_url("{$this->controller}/filter/rt"); ?>')">
