    ...
    <h3>Modul kelompok</h3>
        <div class="left">
            <div class="uibutton-group">
                ...
                <a href="<?=site_url('kelompok_master/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="icon-plus-sign icon-large">&nbsp;</span>Tambah Master Kelompok Baru</a>
    ...
    <div class="ui-layout-south panel bottom">
        ...
        <div class="right">
            ...
            <div class="uibutton-group">
				...
				<a href="<?=site_url("kelompok_master/index/$i/$o")?>" <? jecho($p,$i,"class='uibutton special'")?> class="uibutton"><?=$i?></a>
				<? endfor; ?>
            </div>
            <div class="uibutton-group">
			<? if($paging->next): ?>
