    ...
    <h3>Modul kelompok</h3>
        <div class="left">
            <div class="uibutton-group">
                ...
                <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("kelompok_master/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash ">&nbsp;</span>Hapus Data</button>
            </div>
        </div>
            <div class="right">
