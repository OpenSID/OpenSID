						...
						<?php foreach($main as $data): ?>
							<tr>
								...
								<td> <div class="uibutton-group">
									<a href="<?php echo site_url("mandiri/delete/$p/$o/$data[nik]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash "></span> Hapus</span></a>
									</div>
								</td>
