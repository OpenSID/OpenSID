																...
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="<?=site_url('mandiri/cetak/'.$data[id_pend])?>" data-remote="false" data-toggle="modal" target="_blank" data-placement="bottom" title="Cetak PIN Warga" class="btn btn-flat btn-danger btn-sm"><i class="fa fa-print"></i></a>
