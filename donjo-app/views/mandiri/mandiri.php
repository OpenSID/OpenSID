		...
		<form class="form-inline" id="mainform" name="mainform" action="" method="post">
			<div class="card card-outline card-info">
				<div class="card-header with-border">
					<a href="<?= site_url('mandiri/ajax_pin'); ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Buat PIN Warga" class="btn btn-flat btn-success btn-xs"><i class="fa fa-plus"></i> Tambah Pengguna</a>
				</div>
				<div class="card-body">
					<form class="form-inline" id="mainform" name="mainform" action="" method="post">
						<div class="row">
										...
										<?php if($main): ?>
											<?php foreach ($main as $key => $data): ?>
												<tr <?= jecho($data['telepon'], FALSE, 'class="select-row"'); ?>>
													...
													<td class="aksi">
														<a href="<?= site_url("mandiri/ajax_pin/$data[id_pend]"); ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ganti PIN Warga" title="Ganti PIN Warga" class="btn btn-flat btn-primary btn-xs"><i class="fa fa-key"></i></a>
														<a href="<?= site_url("mandiri/ajax_hp/$data[id_pend]"); ?>" data-remote="false"  data-toggle="modal" data-target="#modalBox"  data-title="<?= $data['telepon'] ? 'Ubah' : 'Tambah' ?> Telepon Warga" title="<?= $data['telepon'] ? 'Ubah' : 'Tambah' ?> Telepon" class="btn <?= $data['telepon'] ? 'bg-teal' : 'bg-green' ?> btn-flat btn-xs" ><i class="fa fa-phone"></i></a>
														<a href="#" data-href="<?= site_url("mandiri/delete/$data[id_pend]"); ?>" class="btn bg-maroon btn-flat btn-xs" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
													</td>
													<td><?= $data['nik']; ?></td>
													<td><?= $data['nama']; ?></td>
								...
								<form action="<?= site_url("mandiri/kirim/$info[id_pend]"); ?>" method="post" id="validasi" target="_blank">
									...
									<div class="modal-footer">
										...
										<?php if (cek_koneksi_internet() && $info['pin'] && $info['telepon']): ?>
											<button type="submit" class="btn btn-flat btn-success btn-xs"><i class="fa fa-whatsapp"></i> Kirim</button>
										<?php endif; ?>
									</div>
								</form>
							</div>
