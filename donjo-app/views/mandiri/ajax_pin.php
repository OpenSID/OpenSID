	...
	<div class="modal-body">
		<?php if ( ! $id_pend):?>
			<div class="form-group">
				...
				<select class="form-control form-control-sm select2 required" id="id_pend" name="id_pend">
		...
		<div class="form-group">
			...
			<input id="pin" name="pin" class="form-control form-control-sm digits" minlength="6" maxlength="6" type="text" placeholder="PIN Warga"></input>
