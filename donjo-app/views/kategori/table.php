...
<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("kategori/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash ">&nbsp;</span>Hapus Data</button>
</div>
</div>
</div>
      ...
      <tr>
        ...
        <td>
          <div class="uibutton-group">
            ...
            <?php endif; ?>
            <a href="<?php echo site_url("kategori/sub_kategori/$data[id]")?>" class="uibutton tipsy south" title="Rincian Sub kategori"><span class="fa fa-list "></span> Detail</a>
            ...
            <?php if($data['enabled'] == '2'):?>
              <a href="<?php echo site_url("kategori/kategori_lock/".$data['id'])?>" class="uibutton tipsy south"  title="Aktivasi kategori"><span class="fa fa-lock "></span></a>
            <?php elseif($data['enabled'] == '1'): ?>
              ...
              <a href="<?php echo site_url("kategori/ajax_add_sub_kategori/$data[id]")?>" class="uibutton tipsy south" target="ajax-modal" rel="window" header="Tambah Sub kategori <?php echo $data['kategori']?>" class="uibutton tipsy south" title="Tambah Sub kategori"><span class="fa fa-plus-square "></span></a>
            <?php endif?>
          </div>
        </td>
