	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control form-control-sm required" id="tipe" name="tipe" style="width:50%"; onchange="ubah_pesan(this.value);">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea id="link" name="link" class="form-control form-control-sm link" style="height: 200px; resize: none;"><?php $main and print($main['link']) ?></textarea>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
					<label id="sx3" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($main['enabled'] =='1'): ?>active<?php endif ?>">
					...
					<label id="sx4" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($main['enabled'] =='2'): ?>active<?php endif ?>">
