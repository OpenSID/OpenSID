				...
				<div class="card card-outline card-info">
					<div class="card-body">
						<div class="card-header with-border">
							<a href="<?= site_url('data_persil/clear')?>" class="btn btn-flat btn-primary btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" title="Kembali Ke Daftar Persil"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Persil</a>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<form name='mainform' action="<?= site_url('data_persil/simpan_persil')?>" method="POST"  id="validasi" class="form-horizontal">
									<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input name="no_persil" class="form-control form-control-sm angka required" type="text" placeholder="Nomor Surat Persil" name="nama" value="<?= $persil["nomor"] ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="no_persil" class="col-sm-3 control-label">No. Urut Bidang</label>
											<div class="col-sm-8">
												<input name="nomor_urut_bidang" class="form-control form-control-sm angka required" type="text" placeholder="Nomor urut untuk bidang tanah dengan nomor persil sama" value="<?= $persil["nomor_urut_bidang"] ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="kelas"  class="col-sm-3 control-label">Tipe Tanah</label>
											<div class="col-sm-4">
												<select class="form-control form-control-sm" id="tipe" name="tipe" type="text" placeholder="Tuliskan Kelas Tanah" >
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select class="form-control form-control-sm required" id="kelas" name="kelas" type="text" placeholder="Tuliskan Kelas Tanah" >
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input name="luas_persil" class="form-control form-control-sm angka required" type="text" placeholder="Luas persil secara keseluruhan (M2)" value="<?= $persil["luas_persil"] ?>">
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
												<label  class="btn btn-info btn-flat btn-xs col-sm-3 form-check-label <?= $persil["lokasi"] ? NULL : 'active' ?>">
												...
												<label  class="btn btn-info btn-flat btn-xs col-sm-3 form-check-label <?= $persil["lokasi"] ? 'active' : NULL ?>">
										...
										<div class="form-group">
											...
											<div id="pilih">
												<div class="col-sm-4" >
													<select class="form-control form-control-sm select2 required" id="id_wilayah" name="id_wilayah" style="width:100%">
											...
											<div id="manual">
												<div class="col-sm-8">
													<textarea id="lokasi" class="form-control form-control-sm required" type="text" placeholder="Lokasi" name="lokasi" ><?= $persil["lokasi"] ?></textarea>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select class="form-control form-control-sm required" id="kelas" name="cdesa_awal" type="text" <?php $persil and print('disabled')?> placeholder="C-Desa pemilik awal persil ini" >
