											...
											<div class="table-responsive">
												<table class="table table-bordered table-striped table-hover" >
													...
													<tr>
														<td>Nomor C-DESA</td>
														<td >:</td>
														<td><?= sprintf("%04s", $persil_detail["c_desa"])?></td>
													</tr><tr>
														<td>Nomor Persil</td>
														<td >:</td>
													...
													<tr>
														...
														<td >:</td>
														<td><?= $persil_jenis[$persil_detail["persil_jenis_id"]][0]?></br></td>
													</tr>
													<tr>
														<td>Kelas Tanah</td>
														<td >:</td>
														<td><?= $persil_detail["kode"]?></td>
													</tr>
													<tr>
														<td>Luas Tanah</td>
														<td >:</td>
													...
													<tr>
														<td>Lokasi</td><td >:</td><td><?= ($persil_detail["lokasi"])?: "RT: ".$persil_detail["rt"]." RW: ".$persil_detail["rw"]." Dusun ".strtoupper($persil_detail["dusun"]) ?></td>
													</tr>
												</table>
											</div>
										</div>
