			...
			<div class="col-md-12">
				<div class="card card-outline card-info">
					<div class="card-header">
						<a href="#" class="btn btn-flat btn-success btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" data-toggle="modal" data-target="#ModalAdd"><i class="fa fa-plus"></i> Tambah Data</a>
						<a href="#" id="btn_salin" class="btn btn-flat btn-success btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class="fa fa-plus"></i>Tambah Data dari Template</a>
					</div>
					<div class="card-header with-border">
						<form action="<?= site_url('keuangan_manual/set_tahun_terpilih') ?>" method="POST" class="form form-horizontal">
							<div class="row">
								...
								<div class="col-md-2">
									<select class="form-control form-control-sm" name="tahun_anggaran" onchange="this.form.submit()">
					...
					<div class="card-body">
						...
						<div role="tabpanel" class="tab-pane" id="tab-header">
									...
									<ul class="nav nav-tabs" role="tablist" id="myTab">
										<li role="presentation" class="nav-item active"><a class="nav-link" href="#pendapatan_tab" aria-controls="pendapatan_tab" role="tab" data-toggle="tab">Pendapatan</a></li>
										<li class="nav-item" role="presentation"><a class="nav-link" href="#belanja_tab" aria-controls="belanja_tab" role="tab" data-toggle="tab">Belanja</a></li>
										<li class="nav-item" role="presentation"><a class="nav-link" href="#pembiayaan_tab" aria-controls="pembiayaan_tab" role="tab" data-toggle="tab">Pembiayaan</a></li>
									</ul>
									<!-- Sub tab panes -->
			...
			<form class="form-horizontal">
				<div class="modal-body">
					...
					<div class='form-group'>
						...
						<div class="col-sm-8">
							<select class="form-control form-control-sm " id="Kd_Akun" name="Kd_Akun">
					...
					<div class='form-group' id="Pendapatan">
						...
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Rincian_pd" name="Kd_Rincian_pd">
					...
					<div class='form-group' id="Belanja">
						...
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Keg" name="Kd_Keg">
					...
					<div class='form-group' id="Pembiayaan">
						<label class="col-sm-3 control-label" >Kode Rincian</label>
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Rincian_by" name="Kd_Rincian_by">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm " id="Nilai_Anggaran" name="Nilai_Anggaran" placeholder="Nilai Anggaran"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" >Nilai Realisasi</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm " id="Nilai_Realisasi" name="Nilai_Realisasi" placeholder="Nilai Realisasi"/>
						</div>
					</div>
				</div>
				...
				<div class="modal-footer">
					...
					<button class="btn btn-flat btn-info btn-xs" id="btn_simpan"><i class='fa fa-check'></i>Simpan</button>
				</div>
			</form>
		</div>
	</div>
			...
			<form class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" >Tahun</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm " id="Tahun2" name="Tahun_edit" placeholder="Tahun"/>
						</div>
					</div>
					...
					<div class='form-group'>
						<label class="col-sm-3 control-label" >Jenis Anggaran</label>
						<div class="col-sm-8">
							<select class="form-control form-control-sm " id="Kd_Akun2" name="Kd_Akun_edit" disabled>
								<option value="">Pilih Jenis Anggaran</option>
								<?php foreach ($lakun as $data): ?>
									<option value="<?= $data['Akun']?><?= $data['Nama_Akun']?>" <?php selected($main['Kd_Akun'], $data['Akun']); ?>><?= $data['Akun'] ?><?= $data['Nama_Akun']?></option>
								<?php endforeach;?>
					...
					<div class='form-group' id="Pendapatan_edit">
						<label class="col-sm-3 control-label" >Kode Rincian</label>
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Rincian2_pd" name="Kd_Rincian_edit_pd">
								<option value="">Pilih Rekening Pendapatan</option>
								<?php foreach ($lpendapatan as $data): ?>
					...
					<div class='form-group' id="Belanja_edit">
						<label class="col-sm-3 control-label" >Kode Kegiatan</label>
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Keg2_bl" name="Kd_Keg_edit_bl">
								<option value="">Pilih Rekening Belanja</option>
								<?php foreach ($lbelanja as $data): ?>
					...
					<div class='form-group' id="Pembiayaan_edit">
						<label class="col-sm-3 control-label" >Kode Rincian</label>
						<div class="col-sm-8">
							<select class="form-control form-control-sm" id="Kd_Rincian2_by" name="Kd_Rincian_edit_by">
								<option value="">Pilih Rekening Pembiayaan</option>
								<?php foreach ($lbiaya as $data): ?>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" >Nilai Anggaran</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm " id="Nilai_Anggaran2" name="Nilai_Anggaran_edit" placeholder="Nilai Anggaran"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" >Nilai Realisasi</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm " id="Nilai_Realisasi2" name="Nilai_Realisasi_edit" placeholder="Nilai Realisasi"/>
						</div>
					</div>
				...
				<div class="modal-footer">
					<button class="btn btn-flat btn-danger btn-xs" data-dismiss="modal" aria-hidden="true"><i class='fa fa-sign-out'></i> Tutup</button>
					<button class="btn btn-flat btn-info btn-xs" id="btn_update"><i class='fa fa-check'></i>Simpan</button>
				</div>
			</form>
		</div>
	</div>
			...
			<form class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control form-control-sm " id="kodetahun" name="kodetahun" placeholder="Tahun Anggaran"/>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-flat btn-danger btn-xs" data-dismiss="modal" aria-hidden="true"><i class='fa fa-sign-out'></i> Tutup</button>
					<button class="btn btn-flat btn-info btn-xs" id="btn_salin1"><i class='fa fa-check'></i>Salin</button>
				</div>
			</form>
		</div>
	</div>
