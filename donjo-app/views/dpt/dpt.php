				...
				<div class="box box-info">
					<div class="box-header with-border">
						<div class="col-sm-8 col-lg-9">
							<div class="row">
								<a href="<?= site_url('dpt/pemilihan') ?>" class="btn btn-social btn-flat btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Daftar Pemilihan"><i class="fa fa-list"></i>Daftar Pemilihan</a>
								...
								<div class="row">
									<div class="input-group">
										...
										<div class="input-group input-group-sm date">
											...
											<input class="form-control input-sm datepicker pull-right" onchange="$('#tglform').submit()" name="tanggal_pemilihan" type="text" value="<?= $this->session->tanggal_pemilihan ?>">
										</div>
									</div>
								</div>
							</form>
					...
					<div class="box-header">
						<h4 class="text-center"><strong>DAFTAR CALON PEMILIH UNTUK TANGGAL PEMILIHAN <?= $this->session->tanggal_pemilihan ?></strong></h4>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-sm-12">
													...
													<table class="table table-bordered dataTable table-striped table-hover tabel-daftar">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<?php if ($o == 8) : ?>
																	<th nowrap><a href="<?= site_url("dpt/index/{$p}/7") ?>">Umur Pada <?= $this->session->tanggal_pemilihan ?> <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o == 7) : ?>
																	<th nowrap><a href="<?= site_url("dpt/index/{$p}/8") ?>">Umur Pada <?= $this->session->tanggal_pemilihan ?> <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else : ?>
																	<th nowrap><a href="<?= site_url("dpt/index/{$p}/7") ?>">Umur Pada <?= $this->session->tanggal_pemilihan ?> <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
