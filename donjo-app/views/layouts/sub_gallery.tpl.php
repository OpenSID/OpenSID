...
<div style="position: absolute; top: 0px; left: 0px; display: block; z-index: 6; opacity: 1;" id="frontcy">
<?php //$this->load->view('partials/scroller.php');?>
</div>
</div>-->
...
<!-- content isi -->
<?php $this->load->view('partials/sub_gallery.php');?>
