						...
						<table class="table table-bordered table-striped table-hover tabel-rincian">
							<tbody>
								...
								<tr>
									...
									<td><?= $main['kode_propinsi'] . '.' . $main['kode_kabupaten'] . '.' . $main['kode_kecamatan'] . '.'. $main['kode_desa']; ?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><?= $main['kode_propinsi'] . '.' . $main['kode_kabupaten'] . '.' . $main['kode_kecamatan']; ?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><?= $main['kode_propinsi'] . '.' . $main['kode_kabupaten']; ?></td>
								</tr>
								<tr>
