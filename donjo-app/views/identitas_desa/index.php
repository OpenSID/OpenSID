			...
			<div class="col-md-12">
				<div class="card card-outline card-info">
					<div class="card-header with-border">
						<a href="<?= site_url('identitas_desa/form'); ?>" class="btn btn-flat btn-warning btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left" title="Ubah Biodata" ><i class="fa fa-edit"></i> Ubah Data <?= $desa; ?></a>
						<a href="<?= site_url('identitas_desa/maps/kantor'); ?>" class="btn btn-flat bg-purple btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class='fa fa-map-marker'></i> Lokasi Kantor <?= $desa; ?></a>
						<a href="<?= site_url('identitas_desa/maps/wilayah'); ?>" class="btn btn-flat btn-info btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"><i class='fa fa-map'></i> Peta Wilayah <?= $desa; ?></a>
					</div>
					<form id="mainform" name="mainform" action="" method="post">
						<div class="card-body">
							<div class="card-body bg-identitas">
								<img class="img-identitas img-fluid mx-auto d-block card-img-top" src="<?= gambar_desa($main['logo']); ?>" alt="logo">
