...
<table class="list">
  <tr>
    ...
    <td width="70">
      <div class="uibutton-group">
        <a class="uibutton special" href="<?php echo site_url("database")?>/export_excel"><span class="fa fa-download"></span> Download</a>
      </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="70">
     <div class="uibutton-group">
      <a class="uibutton special" href="<?php echo site_url("database")?>/export_csv"><span class="fa fa-download"></span> Download</a>
     </div>
    </td>
  </tr>
</table>
