    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
          ...
          <td><div class="uibutton-group">
            <?php if($data['id_tipe']==1 OR $data['id_tipe']==2){?><a href="<?php echo site_url("surat_master/parameter/$data[id]")?>" class="uibutton"><span class="icon-list icon-large"> Parameter</span></a><?php }?><a href="<?php echo site_url("surat_master/form/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="icon-edit icon-large"> Ubah </span></a><a href="<?php echo site_url("surat_master/delete/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="icon-trash icon-large"></span></a><a href="<?php echo site_url("surat_master/atribut/$data[id]")?>" class="uibutton tipsy south" title="Atribut Surat"><span class="icon-list  icon-large"> Atribut</span></a>
			</div>
          </td>
