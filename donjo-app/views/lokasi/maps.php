...
window.onload = function()
{
  ...
  var baseLayers = getBaseLayers(peta_lokasi, '<?=$this->setting->google_key?>');
	...
	layerCustom = tampilkan_layer_area_garis_lokasi(peta_lokasi, '<?=addslashes(json_encode($all_area))?>', '<?=addslashes(json_encode($all_garis))?>', '<?=addslashes(json_encode($all_lokasi))?>', '<?= base_url().LOKASI_SIMBOL_LOKASI?>');
