...
<?php   elseif($o==1): ?>
<th align="left"><a href="<?php  echo site_url("plan/index/$p/2")?>">Kategori <span class="fa fa-sort-desc fa-sm">
<?php   else: ?>
<th align="left"><a href="<?php  echo site_url("plan/index/$p/1")?>">Kategori <span class="fa fa-sort fa-sm">
<?php   endif; ?>&nbsp;</span></a></th>

<?php   if($o==4): ?>
<th align="left"><a href="<?php  echo site_url("plan/index/$p/3")?>">Aktif <span class="fa fa-sort-asc fa-sm">
<?php   elseif($o==3): ?>
<th align="left"><a href="<?php  echo site_url("plan/index/$p/4")?>">Aktif <span class="fa fa-sort-desc fa-sm">
<?php   else: ?>
<th align="left"><a href="<?php  echo site_url("plan/index/$p/3")?>">Aktif <span class="fa fa-sort fa-sm">
<?php   endif; ?>&nbsp;</span></a></th>
<th>Kategori</th>
<th>Jenis</th>
<th></th>
