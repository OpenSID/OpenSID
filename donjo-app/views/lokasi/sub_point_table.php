...
<button type="button" title="Delete Data" onclick="deleteAllBox('mainform','<?php  echo site_url("plan/delete_all/")?>')" class="uibutton tipsy south"><span class="fa fa-trash">&nbsp;</span>Hapus Data</button>
</div>
</div>
</div>
...
<td>
<a href="<?php  echo site_url("plan/ajax_add_sub_lokasi/$lokasi/$data[id]")?>" class="ui-icons fa fa-edit tipsy south" target="ajax-modal" rel="window" header="Edit lokasi" title="Edit Data"></a><a href="<?php  echo site_url("plan/delete_sub_lokasi/$lokasi/$data[id]")?>" class="ui-icons fa fa-trash tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php  if($data['enabled'] == '2'):?><a href="<?php  echo site_url("lokasi_lock_sub_lokasi/$lokasi/$data[id]")?>" class="ui-icons fa fa-lock tipsy south" title="Enable lokasi"></a><?php  elseif($data['enabled'] == '1'): ?><a href="<?php  echo site_url("lokasi_unlock_sub_lokasi/$lokasi/$data[id]")?>" class="ui-icons fa fa-unlock tipsy south" title="Disable lokasi"></a><?php  endif;?>
</td>
