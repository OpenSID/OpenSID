	...
	<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header with-border">
							<a href="<?= site_url("plan")?>" class="btn btn-flat btn-info btn-xs btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block visible-xl-inline-block text-left"  title="Tambah Artikel">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input name="nama" class="form-control form-control-sm nomor_sk required" maxlength="100" type="text" value="<?=$lokasi['nama']?>"></input>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3">Kategori</label>
								<div class="col-sm-7">
									<select class="form-control form-control-sm required" id="ref_point" name="ref_point" style="width:100%;">
							...
							<?php if ($lokasi["foto"]): ?>
								<div class="form-group">
									...
									<div class="col-sm-7">
									  <img class="attachment-img img-fluid rounded-circle" src="<?= base_url().LOKASI_FOTO_LOKASI?>kecil_<?= $lokasi['foto']?>" alt="Foto">
									</div>
								</div>
							<?php endif; ?>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<textarea id="desk" name="desk" class="form-control form-control-sm required" style="height: 200px;"><?= $lokasi['desk']?></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
									<label id="sx3" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($lokasi['enabled'] =='1' OR $lokasi['enabled'] == NULL): ?>active<?php endif ?>">
									...
									<label id="sx4" class="btn btn-info btn-flat btn-xs col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($lokasi['enabled'] == '2' ): ?>active<?php endif ?>">
