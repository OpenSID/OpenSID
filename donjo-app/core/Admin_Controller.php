...
class Admin_Controller extends MY_Controller
{
    ...
    private function cek_identitas_desa(): void
    {
        ...
        if (! config_item('demo_mode') && app(PerbaruiLangganan::class)->perlu()) {
            // Perlu-tidaknya menyegarkan state langganan ditentukan oleh add-on
            // penyedia langganan (mis. modul Pelanggan) — core tak lagi membaca
            // cache `status_langganan` maupun token berlangganan langsung.
