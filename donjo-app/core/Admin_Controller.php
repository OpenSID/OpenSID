...
class Admin_Controller extends MY_Controller
{
    ...
    private function cek_identitas_desa(): void
    {
        ...
        $validasi = app(\App\Services\Penjaga\PenjagaPermintaan::class)->izinkanPermintaan();
        ...
        $this->header['notif_langganan']  = collect(app(\App\Services\Pengumuman\SumberPengumuman::class)->pengumuman())->firstWhere('jenis', 'langganan');
