...
class Curly
{
    ...
    public static function request($method, $url, array $params = [], array $options = [])
    {
        ...
        if (null === static::$certificate) {
            static::$certificate = __DIR__ . DIRECTORY_SEPARATOR . 'cacert.pem';
        }
    ...
    public static function download($url, $destination, array $options = [])
    {
        ...
        if (false === ($fopen = fopen($destination, 'w+b'))) {
    ...
    public static function platform()
    {
        ...
        return $platforms[PHP_OS] ?? 'Unknown';
    }
}
