<?php class Keluar_model extends CI_Model {
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		//Main Query
		$select_sql = "SELECT u.*, n.nama AS nama, w.nama AS nama_user, n.nik AS nik, k.nama AS format, k.kode_surat as kode_surat, k.url_surat as berkas, s.id_pend as pamong_id_pend, s.pamong_nama AS pamong, p.nama as nama_pamong_desa ";
