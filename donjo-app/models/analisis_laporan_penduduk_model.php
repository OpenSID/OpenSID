<?php class analisis_laporan_penduduk_model extends CI_Model{
	...
	function list_data($o=0,$offset=0,$limit=500){
		...
		//Main Query
		$sql   = "SELECT u.*,(SELECT SUM(i.bobot * nilai) FROM analisis_respon r LEFT JOIN analisis_indikator i ON r.id_indikator = i.id LEFT JOIN analisis_parameter z ON r.id_parameter = z.id WHERE r.id_subjek = u.id AND i.act_analisis=1 AND r.id_periode=?)/$pembagi as cek FROM tweb_penduduk u  WHERE 1 ";
