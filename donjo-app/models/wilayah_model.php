 ...
 *
 * SID adalah software tak berbayar (Opensource) boleh digunakan oleh siapa saja selama bukan untuk kepentingan profit atau komersial.
...
class Wilayah_Model extends CI_Model {
	...
	function update($id=''){
		...
		$this->db->where('rw','0');
		$this->db->where('rt','0');
		$outp = $this->db->update('tweb_wil_clusterdesa',penetration($data));
