...
class Sms_model extends CI_Model
{
    ...
    function paging_kontak($p = 1, $o = 0)
    {
        ...
        $sql = "SELECT COUNT(id_kontak) as id FROM daftar_kontak";
    ...
    function search_kontak_sql()
    {
        if (isset($_SESSION['cari_kontak'])) {
            ...
            $kw                = $this->db->escape_like_str($cari);
            $kw                = '%' . $kw . '%';
            $search_kontak_sql = " WHERE nama LIKE '$kw' OR no_hp LIKE '$kw' ";
    ...
    function delete_kontak($id = 0)
    {
        ...
        $this->db->query("DELETE FROM anggota_grup_kontak WHERE id_kontak = ".$id);
    ...
    function delete_all_kontak()
    {
        ...
        if (count($id_cb)) {
            ...
            $this->db->query("DELETE FROM anggota_grup_kontak WHERE id_kontak IN (" . $list_id . ")");
            $this->db->trans_complete(); 
            $outp = true;
        } else
            $outp = false;
    ...
    function paging_grup($p = 1, $o = 0)
    {
        ...
        $sql = "SELECT COUNT(TB.id_grup) as id FROM daftar_grup TB WHERE 1 ";
    ...
    function list_data_grup($o = 0, $offset = 0, $limit = 500)
    {
        ...
        //Main Query
        $sql = "SELECT TB.* FROM daftar_grup TB WHERE 1 ";
    ...
    function delete_grup($id = 0)
    {
        ...
        $this->db->query("DELETE FROM anggota_grup_kontak WHERE id_grup = ".$id);
        $this->db->trans_complete();
    }
    function delete_all_grup()
    {
        ...
        if (count($id_cb)) {
            ...
            $this->db->query("DELETE FROM anggota_grup_kontak WHERE id_grup IN (" . $list_id . ")");
            $this->db->trans_complete();
            $outp = true;
        } else
            $outp = false;
    ...
    {
        $sql = "SELECT COUNT(id_kontak) FROM daftar_anggota_grup WHERE id_grup=$id ";
    ...
    function list_data_anggota($id = 0, $o = 0, $offset = 0, $limit = 500)
    {
        ...
        $sql = "SELECT * FROM daftar_anggota_grup WHERE id_grup=$id ";
