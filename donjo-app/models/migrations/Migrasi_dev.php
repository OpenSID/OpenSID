...
class Migrasi_dev extends MY_model
{
    ...
    {
        return $hasil && $this->migrasi_2023121352($hasil);
    ...
    protected function migrasi_2023121352($hasil)
    {
        try {
            // analisis master
            ...
            // pembangunan
            $hasil = $hasil && $this->tambahForeignKey('pembangunan_lokasi_fk', 'pembangunan', 'id_lokasi', 'lokasi', 'id', true);
    ...
    protected function migrasi_2023122252($hasil)
    {
        ...
        if (!Schema::hasColumn('setting_modul', 'uuid')) {
            ...
            DB::table('setting_modul')->orderBy('id')->chunk(100, function ($items) {
