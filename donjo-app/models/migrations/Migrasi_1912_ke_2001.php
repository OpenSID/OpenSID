...
class Migrasi_1912_ke_2001 extends CI_model {
  ...
  public function up()
  {
  	 // Ubah kode surat
		$this->db
			->where('url_surat', 'surat_ket_nikah')
			->where('lampiran')
			->update('tweb_surat_format', array('lampiran' => 'f-2.12.php'));
// Perbesar nilai klasifikasi melebihi 999.99
	  $this->dbforge->modify_column('tweb_desa_pamong',	'pamong_nip varchar(21)  NULL DEFAULT NULL');
