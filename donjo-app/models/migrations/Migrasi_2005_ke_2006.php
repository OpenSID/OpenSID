...
class Migrasi_2005_ke_2006 extends CI_model {
	...
	private function data_apbdes_manual()
	{
		...
		$query = "
			...
			('209', 'Input Data', 'keuangan/manual_apbdes', '1', 'fa-keyboard-o', '3', '2', '201', '0', 'fa-keyboard-o'),
			('210', 'Laporan Manual', 'keuangan/laporan_manual', '1', 'fa-bar-chart', '4', '2', '201', '0', 'fa-bar-chart')
