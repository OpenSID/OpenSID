<?php class Surat_Model extends CI_Model{
	...
	function coba($url=''){
		...
		//  Pakai file sementara yang dihapus oleh php secara otomatis kalau sudah tidak terpakai
		$handle = tmpfile();
		...
		//  File didownload dengan nama <jenissurat>_<tgl>_<nomorsurat>.rtf
		$filename = nama_surat_download($url, $input[nomor]);
		header('Content-Type: application/rtf');
		header('Content-Disposition: attachment; filename=' . $filename . ';');
		readfile($meta_data["uri"]);
