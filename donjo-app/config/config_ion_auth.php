...
$config['identity']                   = '%IDENTITY%';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
$config['min_password_length']        = %MIN_PASS_LENGTH%;                   // Minimum Required Length of Password
$config['max_password_length']        = %MAX_PASS_LENGTH%;                  // Maximum Allowed Length of Password
$config['email_activation']           = %EMAIL_ACTIVATION%;               // Email Activation for registration
$config['manual_activation']          = FALSE;               // Manual Activation for registration
$config['remember_users']             = TRUE;                // Allow users to be remembered and enable auto-login
$config['user_expire']                = %USER_EXPIRE%;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['session_data'] = 'password,first_name';
