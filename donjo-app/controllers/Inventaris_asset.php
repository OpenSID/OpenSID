...
class Inventaris_asset extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->render_view('inventaris/asset/table', $data, $nav, TRUE);
	}
	...
	public function view($id)
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/view_inventaris', $data, $nav, TRUE);
	}
	...
	public function view_mutasi($id)
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/view_mutasi', $data, $nav, TRUE);
	}
	...
	public function edit($id)
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/edit_inventaris', $data, $nav, TRUE);
	}
	...
	public function edit_mutasi($id)
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/edit_mutasi', $data, $nav, TRUE);
	}
	...
	public function form()
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/form_tambah', $data, $nav, TRUE);
	}
	...
	public function form_mutasi($id)
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/form_mutasi', $data, $nav, TRUE);
	}
	...
	public function mutasi()
	{
		...
		// Isi nilai true jika menggunakan minisidebar
		$this->render_view('inventaris/asset/table_mutasi', $data, $nav, TRUE);
	}
