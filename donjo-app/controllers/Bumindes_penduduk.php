...
class Bumindes_penduduk extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(['header_model', 'penduduk_model', 'keluarga_model', 'wilayah_model', 'referensi_model', 'web_dokumen_model', 'program_bantuan_model', 'lapor_model']);
	...
	// ---- BREAK CONTROLLER, ALL CODE BELOW FROM Penduduk.Php
	// ---- Need confirmation about this, for now just leave it
	...
	public function form($p = 1, $o = 0, $id = '')
	{
		...
		$this->set_minsidebar(1);
		$this->render('bumindes/penduduk/penduduk_form', $data);
	}
	...
	public function detail($p = 1, $o = 0, $id = 0)
	{
		...
		$this->set_minsidebar(1);
		$this->render('bumindes/penduduk/penduduk_detail', $data);
	}
	...
	public function dokumen($id = '')
	{
		...
		$this->render('bumindes/penduduk/penduduk_dokumen', $data);
	}
	...
	public function dokumen_form($id = 0, $id_dokumen = 0)
	{
		...
		$this->load->view('bumindes/penduduk/dokumen_form', $data);
	}
	...
	public function dokumen_list($id = 0)
	{
		...
		$this->load->view('bumindes/penduduk/dokumen_ajax', $data);
	}
	...
	public function cetak_biodata($id = '')
	{
		...
		$data['penduduk'] = $this->penduduk_model->get_penduduk($id);
		$this->load->view('bumindes/penduduk/cetak_biodata', $data);
	}
	...
	public function ajax_adv_search()
	{
		...
		$this->load->view("bumindes/penduduk/ajax_adv_search_form", $data);
	}
	...
	public function ajax_penduduk_maps($p = 1, $o = 0, $id = '', $edit = '')
	{
		...
		$this->render("bumindes/penduduk/ajax_penduduk_maps", $data);
	}
	...
	public function edit_status_dasar($p = 1, $o = 0, $id = 0)
	{
		...
		$this->load->view('bumindes/penduduk/ajax_edit_status_dasar', $data);
	}
	...
	public function search_kumpulan_nik()
	{
		...
		$this->load->view("bumindes/penduduk/ajax_search_kumpulan_nik", $data);
	}
	...
	public function program_bantuan()
	{
		...
		$this->load->view("bumindes/penduduk/pencarian_program_bantuan", $data);
	}
