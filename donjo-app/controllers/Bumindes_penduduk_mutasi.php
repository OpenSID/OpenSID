...
class Bumindes_penduduk_mutasi extends Admin_Controller {
	...
	public function ajax_cetak($o = 0, $aksi = '')
	{
		...
		$data['form_action_privasi'] = site_url("bumindes_penduduk_mutasi/cetak/$o/$aksi/1");

		$this->load->view("bumindes/penduduk/mutasi/ajax_cetak_bersama", $data);
	}
	...
	public function cetak($o = 0, $aksi = '', $privasi_nik = 0)
	{
		...
		$this->load->view("bumindes/penduduk/mutasi/content_mutasi_".$aksi, $data);
	}
