...
return [
    ...
    'Upload_error_messages' =>[1 => 'Загруженный файл превышает параметр upload_max_filesize в php.ini', 2 => 'Загруженный файл превышает параметр MAX_FILE_SIZE, указанный в HTML-форме', 3 => 'Файл был загружен только частично', 4 => 'Файл не удалось загрузить', 6 => 'Отсутствует временная папка', 7 => 'Не удалось записать файл на диск', 8 => 'Расширение PHP остановило загрузку файла', 'post_max_size' => 'Загруженный файл превышает параметр post_max_size в php.ini', 'max_file_size' => 'Размер файла слишком большой', 'min_file_size' => 'Размер файла слишком маленький', 'accept_file_types' => 'Недопустимый тип файла', 'max_number_of_files' => 'Превышено максимальное количество файлов', 'max_width' => 'Изображение превышает максимальную ширину', 'min_width' => 'Изображение требует минимальной ширины', 'max_height' => 'Изображение превышает максимальную высоту', 'min_height' => 'Изображение требует минимальной высоты', 'abort' => 'Загрузка файла прервана', 'image_resize' => 'Не удалось изменить размер изображения'],
    ...
    'Copy_Cut_Size_Limit' => 'Выбранные файлы/папки слишком большие для %s. Ограничение: %d Мб за одну операцию',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Выбрано слишком много файлов/папок для %s. Ограничение: %d файлов за одну операцию',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Вы не можете %s файлы.',
    ...
    'Function_Disabled' => 'Функция %s была отключена на сервере.',
    // %s = cut or copy
    'File_Permission' => 'Разрешения на файл',
    'File_Permission_Not_Allowed' => 'Изменение разрешений %s не допускается.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Вы не можете %s этот файл.',
    // %s = open or edit
    'Edit' => 'Редактировать',
    ...
    'Valid_Extensions' => 'Разрешённые расширения файла: %s',
    // %s = txt,log etc.
    ...
    'max_size_reached' => "Папка достигла максимального размера в %d MB.",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
