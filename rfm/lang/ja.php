...
return [
    ...
    'Copy_Cut_Size_Limit' => '選択したファイルが/フォルダを％sするには大きすぎます。 リミット: %d MB/操作',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => '選択したファイルが/フォルダを％sするには大きすぎます。 リミット: %d ファイル/操作',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'ファイルを %s する許可がありません。',
    ...
    'Function_Disabled' => '%s はサーバによって無効にされています。',
    // %s = cut or copy
    'File_Permission' => 'ファイルの権限',
    'File_Permission_Not_Allowed' => '%s の権限変更は許可されていません。',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'このファイルを%sことができませんでした。',
    // %s = open or edit
    'Edit' => '編集する',
    'Edit_File' => "ファイルを編集",
