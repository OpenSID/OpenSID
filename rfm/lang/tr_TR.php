...
return [
    ...
    'Copy_Cut_Size_Limit' => 'Seçilen dosyalar/klasörler için çok büyük  %s. Limit: %d MB/İşlemi',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Siz çok fazla dosya/klasör seçtiniz %s. Limit:%d Dosyalar/İşlemler',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => '%s Dosyaları için izin verilmez.',
    ...
    'Function_Disabled' => '%s İşlevi sunucu tarafından devre dışı bırakıldı.',
    // %s = cut or copy
    'File_Permission' => 'Dosya İzinleri',
    'File_Permission_Not_Allowed' => '%s Dosya İzinlerinin değiştirilmesine izin verilmiyor.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Bu dosyayı %s izniniz bulunmuyor.',
    // %s = open or edit
    'Edit' => 'Düzenle',
    ...
    'Valid_Extensions' => 'Geçerli eklentiler: %s',
    // %s = txt,log etc.
