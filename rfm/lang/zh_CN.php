...
return [
    ...
    'Copy_Cut_Size_Limit' => '无法 %s 选择的文件，选择的文件太大，超过了允许的大小: %d MB',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => '无法 %s 选择的文件，您选择的文件和文件夹数目超过限制: %d 个文件',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => ' 您没有权限 %s 文件',
    ...
    'Function_Disabled' => '%s 功能已经被服务器禁用。',
    // %s = cut or copy
