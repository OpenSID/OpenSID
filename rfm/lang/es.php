...
return [
    ...
    'Upload_error_messages' =>[1 => 'El archivo subido excede la directiva upload_max_filesize en php.ini', 2 => 'El archivo subido excede la directiva MAX_FILE_SIZE especificada en el formulario HTML', 3 => 'El archivo subido solo fue subido parcialmente', 4 => 'No se ha subido ninún archivo', 6 => 'No se encuentra la carpeta temporal', 7 => 'Falló la escritura del archivo en el disco', 8 => 'Una extensión de PHP detuvo la subida del archivo', 'post_max_size' => 'El archivo subido excede la directiva upload_max_filesize en php.ini', 'max_file_size' => 'El archivo es demasiado grande', 'min_file_size' => 'El archivo es demasiado pequeño', 'accept_file_types' => 'Tipo de archivo (Filetype) no permitido', 'max_number_of_files' => 'Número máximo de archivos excedido', 'max_width' => 'La imagen excede el ancho máximo', 'min_width' => 'La imagen requiere un ancho mínimo', 'max_height' => 'La imagen excede el alto máximo', 'min_height' => 'La imagen requiere un alto mínimo', 'abort' => 'Subida de archivo cancelada', 'image_resize' => 'Error al redimensionar la imagen'],
    ...
    'Copy_Cut_Size_Limit' => 'Los archivos/carpetas seleccionados son demasiado grandes para %s. Límite: %d MB/operación',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Ha seleccionado demasiados archivos/carpetas para %s. Límite: %d archivos/operación',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'No está permitido de %s archivos.',
    ...
    'Function_Disabled' => 'La función %s ha sido deshabilitada en el servidor.',
    // %s = cut or copy
    'File_Permission' => 'Permisos de archivos',
    'File_Permission_Not_Allowed' => 'Cambiar %s permisos no está permitido.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'No estás autorizado a %s este archivo.',
    // %s = open or edit
    'Edit' => 'Editar',
    ...
    'max_size_reached' => "La carpeta de imágenes ha excedido el tamaño máximo de %d MB.",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
