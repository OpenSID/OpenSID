...
return [
    ...
    'Copy_Cut_Size_Limit' => 'Zvolené soubory/složky jsou příliš velké pro operaci %s. Limit: %d MB/operace',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Zvolili jste příliš mnoho souborů/složek pro operaci %s. Limit: %d souborů/operace',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Nemáte oprávnění %s.',
    ...
    'Function_Disabled' => 'Funkce %s byla zamítnuta serverem.',
    // %s = cut or copy
    'File_Permission' => 'Práva souboru',
    'File_Permission_Not_Allowed' => 'Změna oprávnění pro %s není povolena.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Nemáte oprávnění %s tento soubor.',
    // %s = open or edit
    'Edit' => 'Upravit',
    ...
    'Valid_Extensions' => 'Povolené přípony: %s',
    // %s = txt,log etc.
    ...
    'max_size_reached' => "Vaše složka s obrázky dosáhla maximální velikosti %d MB.",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
