...
return [
    ...
    'Copy_Cut_Size_Limit' => 'فایل/پوشه انتخابی از حداکثر حجم مجاز برای %s بزرگتر هستند. محدودیت: %d MB/عملیات',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'تعداد فایل/پوشه های انتخابی برای %s بسیار زیاد است . محدودیت: %d فایل/عملیات',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'شما اجازه %s این فایل را ندارید .',
    ...
    'Function_Disabled' => 'تابع %s از سمت سرور غیر فعال شده است .',
    // %s = cut or copy
    'File_Permission' => 'دسترسی فایل',
    'File_Permission_Not_Allowed' => 'تغییر دسترسی %s مجاز نمی باشد .',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'شما نمیتوانید این فایل را %s کنید.',
    // %s = open or edit
    'Edit' => 'ویرایش',
    ...
    'Valid_Extensions' => 'پسوند های مجاز : %s',
    // %s = txt,log etc.
    ...
    'max_size_reached' => "پوشه تصویر شما به حداکثر اندازه خود [%d MB] رسیده است .",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
