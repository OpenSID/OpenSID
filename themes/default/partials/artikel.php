	...
	<div class="artikel" id="<?= 'artikel-'.$single_artikel['judul']?>">
		...
		<div class="form-group" style="clear:both;">
			<ul id="pageshare" title="Bagikan ke teman anda" class="pagination">
				<li class="sbutton" id="fb"><a name="fb_share" href="http://www.facebook.com/sharer.php?u=<?= site_url('first/artikel/'.$single_artikel['thn'].'/'.$single_artikel['bln'].'/'.$single_artikel['hri'].'/'.$single_artikel['slug'])?>" target="_blank"><i class="fa fa-facebook-square"></i>&nbsp;Share</a></li>
				<li class="sbutton" id="rt"><a href="http://twitter.com/share?url=<?=site_url('first/artikel/'.$single_artikel['thn'].'/'.$single_artikel['bln'].'/'.$single_artikel['hri'].'/'.$single_artikel['slug'])?>" class="twitter-share-button" target="_blank"><i class="fa fa-twitter"></i>&nbsp;Tweet</a></li>
				<li class="sbutton" id="gpshare"><a href="https://plus.google.com/share?url=<?= site_url('first/artikel/'.$single_artikel['thn'].'/'.$single_artikel['bln'].'/'.$single_artikel['hri'].'/'.$single_artikel['slug']).'&hl=id'?>" target="_blank"><i class="fa fa-google-plus" style="color:red"></i>&nbsp;Bagikan</a></li>
				<li class="sbutton" id="wa_share"><a href="https://api.whatsapp.com/send?text=<?= site_url('first/artikel/'.$single_artikel['thn'].'/'.$single_artikel['bln'].'/'.$single_artikel['hri'].'/'.$single_artikel['slug'])?>" target="_blank"><i class="fa fa-whatsapp" style="color:green"></i>&nbsp;WhatsApp</a></li>
			</ul>
			<!--
