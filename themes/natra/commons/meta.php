...
<script language='javascript' src="<?= base_url('assets/front/js/jquery.min.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/sankey.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/organization.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/accessibility.js?v='.VERSION); ?>"></script>
...
<script src="<?= base_url('assets/js/leaflet.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/front/js/layout.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/front/js/jquery.colorbox.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/leaflet-providers.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/highcharts.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/highcharts-3d.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/exporting.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/highcharts-more.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/mapbox-gl.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/leaflet-mapbox-gl.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/peta.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/sankey.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/organization.js?v='.VERSION); ?>"></script>
<script src="<?= base_url('assets/js/highcharts/accessibility.js?v='.VERSION); ?>"></script>
