			...
			foreach($artikel as $data){
				...
				<li class=\"artikel\">
					...
					<div class=\"teks\">
						...
						<div class=\"img\">";
							if($data['gambar']!=''){
								if(is_file(LOKASI_FOTO_ARTIKEL."sedang_".$data['gambar'])) {
									echo "<img src=\"".AmbilFotoArtikel($data['gambar'],'sedang')."\" alt=\"". $data["judul"] ."\"/>";
								}else{
						...
						<div class=\"post\">".$abstrak." <a href=\"". site_url("first/artikel/".$data["id"]."") ."\"><div class=\"readmore\">Selengkapnya <i class=\"fa fa-arrow-right\"></i></a></div></div>
