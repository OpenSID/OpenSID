...
<div id="footer-left">&copy; 2006-<?php echo date("Y");?> <a target="_blank" href="https://github.com/OpenSID/OpenSID">OpenSID</a> <?php echo AmbilVersi()?>. Dikembangkan oleh <a target="_blank" href="https://www.facebook.com/groups/OpenSID/">Komunitas OpenSID</a>. <br>Tema Hadakewa 1.1 dibuat oleh <a href="https://www.facebook.com/agung.adi.5623" target="_blank">Happy Agung</a>.<br />Dikelola oleh Pemerintah <?php echo ucwords($this->setting->sebutan_desa)?> <?php echo unpenetration($desa['nama_desa'])?></div>
<div id="footer-right">
