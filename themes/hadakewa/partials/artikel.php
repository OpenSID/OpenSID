...
<?php if($single_artikel["id"]) : ?>
	<div class="artikel" id="<?= 'artikel-'.$single_artikel['judul']?>">
		...
		<?php if($single_artikel['id_kategori'] == 1000) : ?>
			<?php foreach($detail_agenda AS $data): ?>
				<p>TANGGAL KEGIATAN : <?= tgl_indo2($data['tgl_agenda'])?>
				<p>KOORDINATOR KEGIATAN : <?= $data['koordinator_kegiatan']?>
				<p>LOKASI KEGIATAN : <?= $data['lokasi_kegiatan']?>	
			<?php endforeach; ?>
		<?php endif; ?>		
