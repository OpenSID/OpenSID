...
CREATE TABLE `tweb_penduduk` (
  ...
  `alamat_tempat_lahir` varchar(100) NOT NULL,
...
INSERT INTO user (`id`, `username`, `password`, `id_grup`, `email`, `last_login`, `active`, `nama`, `company`, `phone`, `foto`, `session`) VALUES ('1', 'admin', '$2y$10$LDaj72md5YyAc3Nx.LlTMeaAIcP7DGkY.Bhusr10QbISYR2LfUWKS', '1', 'admin@combine.or.id', '2016-09-11 02:55:19', '1', 'Administrator', 'ADMIN', '321', 'favicon.png', 'a8d4080245664ed2049c1b2ded7cac30');
