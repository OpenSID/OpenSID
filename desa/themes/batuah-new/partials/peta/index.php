...
<div class="mainpage peta-style">
	<div class="margin-side-10">
	<div style="padding-top:10px!important;">
	<div class="center-head bggrad-color2 flexcenter" style="border-radius:5px 5px 0 0;">
						<div class="icon-titlepage bgcolor-1 flexcenter"><svg viewBox="0 0 24 24"><path d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" /></svg></div>
						<h1>Peta <?= ucwords($this->setting->sebutan_desa); ?></h1>
					</div>
	</div>				
	<form id="mainform_map" name="mainform_map" method="post">
	  <div class="row">
		<div class="col-md-12">
		  <div id="map" style="margin-top:10px!important;border-radius:5px;">
			<div class="leaflet-top leaflet-left">
			  <?php theme_view('partials/peta/components/content_desa.php', ['desa' => $desa, 'list_ref' => $list_ref, 'wilayah' => ucwords($this->setting->sebutan_desa . ' ' . $desa['nama_desa'])]) ?>
			  <?php theme_view('partials/peta/components/content_dusun.php', ['dusun_gis' => $dusun_gis, 'list_ref' => $list_ref, 'wilayah' => ucwords($this->setting->sebutan_dusun . ' ')]) ?>
			  <?php theme_view('partials/peta/components/content_rw.php', ['rw_gis' => $rw_gis, 'list_ref' => $list_ref, 'wilayah' => ucwords($this->setting->sebutan_dusun . ' ')]) ?>
			  <?php theme_view('partials/peta/components/content_rt.php', ['rt_gis' => $rt_gis, 'list_ref' => $list_ref, 'wilayah' => ucwords($this->setting->sebutan_dusun . ' ')]) ?>
			</div>
