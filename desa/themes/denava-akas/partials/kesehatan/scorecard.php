...
<div class="container-page mb-20">
    <div class="headingpage border-grey-soft bg-white flexleft" style="border-radius:5px 5px 0 0;">
        ...
        <h2>Tabel Data Convergensi Stunting</h2>
        <?php if (IS_PREMIUM && IS_241010) : ?>
        <a href="cetak/cetak<?= '?kuartal=' . $kuartal . '&tahun=' . $_tahun . '&id=' . $id ?>" class="tombol bg-color3 flexcenter" style="margin: 3px; float: right;" target="_blank"><i class="fa fa-print"></i>&nbsp;Cetak</a>
        <a href="cetak/unduh<?= '?kuartal=' . $kuartal . '&tahun=' . $_tahun . '&id=' . $id ?>" class="tombol bg-color5 flexcenter" style="margin: 3px; float: right;" target="_blank"><i class="fa fa-download"></i>&nbsp;Unduh</a>
        <?php endif ?>
    </div>
