  ...
  <div class="modal-dialog" style="margin:0 !important;">
    <div class="modal-container-small">
      <div class="modal-article">
        <div class="topmodal bg-grey-dark2 flexleft" data-dismiss="modal" aria-hidden="true" id="myModalLabel"><div class="close-button"></div></div>
        <div class="modal-article-inner">
          <div class="withscroll">
            <div class="relative-hid2 modal-article-content bgwhite" id="myModalLabel">
