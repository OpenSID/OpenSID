...
<div class="col-default" style="margin-top:5px !important;">
	...
	<div class="statistik-inner">
		...
		<div class="statcircle bgwhite flexcenter">
			...
			<?php if ($data['jumlah'] != "-" AND $data['nama']!= "JUMLAH"): ?>	
					...
					<?php if($i==0): ?><?php echo ($amount1 = $data['jumlah']); ?><?php endif; ?>
					<?php if($i==1): ?><?php echo ($amount2 = $data['jumlah']); ?><?php endif; ?>
					</font>
			<?php $i++; ?>
			<?php endif; ?>
			<?php endforeach; ?>
			...
			<p>Populasi</p>
			<h2 class="color-2"><?php echo ($total_amount = $amount1 + $amount2); ?></h2>
			</div>
		</div>
		</div>
