...
<?php if(IS_PREMIUM) : ?>	
<?php if (config_item('kode_kota') || theme_config('kode_kota', true)) : ?>
	...
	<div class="col-default">
		<div class="jadwal-shalat bgcolor-soft1 bordergrey1" id="jadwal-shalat">
			<div class="rowsame margin-minlr-5">
				<div class="jadwalshalat-judul">
						...
						<svg viewBox="0 0 791.000000 929.000000">
							<defs>
								...
								<linearGradient id="Gradient2" gradientTransform="rotate(90)">
									...
									<stop offset="40%" stop-color="var(--clr-1)" />
								</linearGradient>
							</defs>
					...
					<div class="jadwal-title">
						...
						<div class="shalat-bottom flexleft" style="align-self: end;"><img src="<?= base_url("$this->theme_folder/$this->theme/images/pngfile/shalat.png") ?>" /><span id="tanggalwaktu"></span></div>
					</div>
					<script>
						var tw = new Date();
				...
				<div class="jadwalshalat-isi">
					<div class="rowsame margin-minlr-5">
						<div class="jadwal-box2 bgcolor-soft1 bordercolor-1 flexcenter">
							...
							<div class="mosque"><img src="<?= base_url("$this->theme_folder/$this->theme/images/svgfile/mosque.svg") ?>" /></div>
