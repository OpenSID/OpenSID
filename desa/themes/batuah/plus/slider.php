...
<style>
.slider-container{width: 100%;display: block;position: relative;overflow:hidden;background-size:cover;background-repeat:no-repeat;background-position:center;min-height:60vh;border-radius:5px;}
@media (max-width: 992px) {
.slider-container{min-height:0px !important;}		
}
</style>
