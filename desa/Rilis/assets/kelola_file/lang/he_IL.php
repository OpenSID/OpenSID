...
return [
    ...
    'Copy_Cut_Size_Limit' => 'גודל הקובצים / התיקיה גדולים מדי %s. הגבלה: %d MB/לפעולה',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'בחר יותר מדי תיקיות/קבצים לפעולה %s. הגבלה: %d files/operation',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'אינך ראשי ל%s קבצים.',
    // %s(1) = cut or copy, %s(2) = files or folders
    'Image_Editor_No_Save',
    'לא ניתן לשמור את התמונה .',
    'Image_Editor_Exit' => "Exit",
    'Image_Editor_Save' => "Save",
    'Zip_No_Extract',
    'לא ניתן לחלץ , הקבץ פגום.',
    'Zip_Invalid',
    'סוג או פורמט הקובץ אינו נתמך. חוקי: zip, gz, tar.',
    'Dir_No_Write',
    'התיקיה שבחרת אינה ניתנת לכתיבה',
    'Function_Disabled',
    'ה %s פונקציה אינה פעילה.',
    // %s = cut or copy
    'File_Permission',
    'הראשות קובץ',
    'File_Permission_Not_Allowed',
    'שינוי %s הראשות לא ניתנת לעריכה.',
    // %s = files or folders
    'File_Permission_Recursive',
    'החל רקורסיביות?',
    'File_Permission_Wrong_Mode',
    "הרשאות שנתנו אינן חוקיות.",
    'User',
    'משתמשים',
    'Group',
    'קבוצות',
    ...
    'לא',
    'Lang_Not_Found',
    'לא ניתן למצוא את השפה המבוקשת .',
    'Lang_Change',
    'החלף שפה',
    'File_Not_Found',
    'לא ניתן לאתר את הקובץ המבוקש.',
    'File_Open_Edit_Not_Allowed',
    'אינך מורשה ל%s את הקובץ.',
    // %s = open or edit
    'Edit',
    'ערוך',
    'Edit_File',
    ...
    "הקובץ נשמר בהצלחה .",
    'File_Save_Error',
    "שגיאה בעת שמירת הקובץ.",
    'New_File' => 'קובץ חדש',
    'No_Extension' => 'חובה לציין את סיומת הקובץ.',
    'Valid_Extensions' => 'סיומות חוקיות: %s',
    // %s = txt,log etc.
