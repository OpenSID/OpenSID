...
return new class () extends Migration {
    ...
    public function up()
    {
        Schema::create('keuangan_ta_sppbukti', static function (Blueprint $table) {
            $table->integer('id', true);
            $table->integer('config_id')->nullable()->index('keuangan_ta_sppbukti_config_fk');
            $table->integer('id_keuangan_master')->index('id_keuangan_ta_sppbukti_master_fk');
    ...
    {
        Schema::dropIfExists('keuangan_ta_sppbukti');
    }
};
