...
class Html5QrcodeScanner {
    ...
    static ASSET_FILE_SCAN = "../assets/images/file-scan.gif";
    static ASSET_CAMERA_SCAN = "../assets/images/camera-scan.gif";
    ...
    __createHeader(dashboard) {
        ...
        headerMessageContainer.style.fontSize = "10px";
    ...
    __createSectionControlPanel() {
        ...
        requestPermissionButton.innerHTML = '<i class="fa fa-camera"></i>Scan dari Kamera';
        requestPermissionButton.className = "btn btn-social btn-success btn-sm";
    ...
    __createSectionSwap() {
        ...
        const TEXT_IF_CAMERA_SCAN_SELECTED
            = '<i class="fa fa-file-picture-o"></i>&nbsp;&nbsp; Scan dari File &nbsp;&nbsp;&nbsp;';
        const TEXT_IF_FILE_SCAN_SELECTED
            = '<i class="fa fa-camera"></i>Scan dari Kamera';
        const WARNA_IF_CAMERA_SCAN_SELECTED
            = "btn btn-social btn-danger btn-sm";
        const WARNA_IF_FILE_SCAN_SELECTED
            = "btn btn-social btn-success btn-sm";
        ...
        swithToFileBasedLink.addEventListener('click', function () {
            ...
            if ($this.currentScanType == Html5QrcodeScanner.SCAN_TYPE_CAMERA) {
                ...
                swithToFileBasedLink.className = WARNA_IF_FILE_SCAN_SELECTED;
                ...
                swithToFileBasedLink.className = WARNA_IF_CAMERA_SCAN_SELECTED;
                $this.currentScanType = Html5QrcodeScanner.SCAN_TYPE_CAMERA;
                $this.__insertCameraScanImageToScanRegion();
            }
