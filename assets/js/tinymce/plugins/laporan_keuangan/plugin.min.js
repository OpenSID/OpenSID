				...
				var menuItem = {
					...
					getSubmenuItems: function() {
						return [
							...
							{
								type: 'menuitem',
								text: 'Laporan Keuangan (Belanja per Kelompok)-Impor-Semester 1',
								icon: 'table',
								onAction: function() {
									var url = BASE_URL + "index.php/keuangan/cek_tahun";
									...
									$.ajax({
										...
										success: function (data) {
											...
											editor.windowManager.open( {
												...
												onSubmit: function (api) {
													var data = api.getData();
													editor.insertContent('[[lap-RP-APBD-sm1,'+ data.tahun +']]');
													api.close();
												},
							...
							{
								type: 'menuitem',
								text: 'Laporan Keuangan (Belanja per Kelompok)-Impor-Semester 2',
								icon: 'table',
								onAction: function() {
									var url = BASE_URL + "index.php/keuangan/cek_tahun";
									...
									$.ajax({
										...
										success: function (data) {
											...
											editor.windowManager.open( {
												...
												onSubmit: function (api) {
													var data = api.getData();
													editor.insertContent('[[lap-RP-APBD-sm2,'+ data.tahun +']]');
													api.close();
												},
							...
							{
								type: 'menuitem',
								text: 'Laporan Keuangan (Belanja per Bidang)-Impor-Semester 1',
								icon: 'table',
								onAction: function() {
									var url = BASE_URL + "index.php/keuangan/cek_tahun";
									...
									$.ajax({
										...
										success: function (data) {
											...
											editor.windowManager.open( {
												...
												onSubmit: function (api) {
													var data = api.getData();
													editor.insertContent('[[lap-RP-APBD-Bidang-sm1,' + data.tahun +']]');
													api.close();
												},
							...
							{
								type: 'menuitem',
								text: 'Laporan Keuangan (Belanja per Bidang)-Impor-Semester 2',
								icon: 'table',
								onAction: function() {
									var url = BASE_URL + "index.php/keuangan/cek_tahun";
									...
									$.ajax({
										...
										success: function (data) {
											...
											editor.windowManager.open( {
												...
												onSubmit: function (api) {
													var data = api.getData();
													editor.insertContent('[[lap-RP-APBD-Bidang-sm2,' + data.tahun +']]');
													api.close();
												},
