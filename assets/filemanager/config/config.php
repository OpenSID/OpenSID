...
if (file_exists('../../desa/config/config_rfm.php')) {
	include('../../desa/config/config_rfm.php');
}
...
$config = array(
    ...
    */
    ...
    //'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $folder_app . '/opensid',
    /*
    |--------------------------------------------------------------------------
