	...
	$('#dokumen').DataTable({
		...
		'aoColumnDefs': [{
			...
			'mRender': function (data, type, row) {
				let action = ``;
				if (row[1])
					action = `<button type="button" class="btn bg-orange btn-flat btn-sm edit text-center" data-toggle="modal" data-target="#modal" data-title="Ubah Data" title="Ubah Data"  title="Ubah Data" data-id="${row[4]}"><i class="fa fa-edit"></i></button>`;
