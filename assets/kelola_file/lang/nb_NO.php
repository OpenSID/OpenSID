...
return [
    ...
    'Copy_Cut_Size_Limit' => 'De valgte filene/mappene er for store for %s. Grense: %d MB/operasjon',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Du valgte for mange filer/mapper for %s. Grense: %d filer/operasjon',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Du har ikke lov til å %s filer.',
    ...
    'Function_Disabled' => 'Funksjonen %s er blitt deaktivert av serveren.',
    // %s = cut or copy
    'File_Permission' => 'Filrettigheter',
    'File_Permission_Not_Allowed' => 'Forandring av %s rettigheter er ikke tillatt.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Du har ikke tillatelse til å %s denne filen.',
    // %s = open or edit
    'Edit' => 'Rediger',
    ...
    'Valid_Extensions' => 'Gyldige fil-etternavn: %s',
    // %s = txt,log etc.
