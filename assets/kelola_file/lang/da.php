...
return [
    ...
    'Copy_Cut_Size_Limit' => 'De valgte filer/mapper er for store til at %s. Max.: %d MB/operation',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Du har valgt for mange filer/mapper til at %s. Max.: %d filer/operation',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Du har ikke tilladelse til at %s filer. Tal med din administrator.',
    ...
    'Function_Disabled' => 'Denne %s funktion er slået fra af serveren.',
    // %s = cut or copy
    'File_Permission' => 'Fil tilladelser',
    'File_Permission_Not_Allowed' => 'Det er ikke tilladt at ændre tilladelsen for %s.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Du har ikke tiladelse til at %s denne fil.',
    // %s = open or edit
    'Edit' => 'Redigér',
    ...
    'Valid_Extensions' => 'Gyldige filtyper er: %s',
    // %s = txt,log etc.
