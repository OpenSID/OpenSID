...
return [
    ...
    'Copy_Cut_Size_Limit' => 'Os arquivos/pastas selecionados são grandes demais para %s. Limite: %d MB/operação',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Você selecionou muitos arquivos/pastas para %s. Limite: %d arquivos/operação',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Você não tem permissão para %s arquivos.',
    ...
    'Function_Disabled' => 'A função %s foi desativado pelo servidor.',
    // %s = cut or copy
    'File_Permission' => 'Permissão arquivo',
    'File_Permission_Not_Allowed' => 'Mudanças de permissões de %s não são permitidos.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Você não tem permissão para %s este arquivo.',
    // %s = open or edit
    'Edit' => 'Editar',
    ...
    'max_size_reached' => "Sua pasta de imagens atingiu seu tamanho máximo de %d MB.",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
