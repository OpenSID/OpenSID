...
return [
    ...
    'Copy_Cut_Size_Limit' => 'I file o cartelle selezionati sono troppo grandi per %s. Il limite è: %d MB/operazione',
    // %s = cut or copy
    'Copy_Cut_Count_Limit' => 'Hai selezionato troppi file/cartelle da %s. Il limite è: %d file/operazione',
    // %s = cut or copy
    'Copy_Cut_Not_Allowed' => 'Non hai i permessi per %s %s.',
    ...
    'Function_Disabled' => 'La funzione %s è stata disabilitata.',
    // %s = cut or copy
    'File_Permission' => 'Permessi file',
    'File_Permission_Not_Allowed' => 'Il cambiamento dei permessi di %s non è permesso.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Non hai il permesso di %s questo file.',
    // %s = open or edit
    'Edit' => 'Modifica',
    ...
    'New_File' => 'Nuovo file',
    'No_Extension',
    "Non hai inserito l'estensione del file.",
    'Valid_Extensions' => 'Estensioni valide: %s',
    // %s = txt,log etc.
