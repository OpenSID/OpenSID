<page orientation="portrait" format="210x330" style="font-size: 10pt">
    ...
    <table id="kop" class="disdukcapil">
        ...
        <tr>
            ...
            <td>: </td>
            <td colspan="27">[Form_hari_dpN] / [Form_tanggal_dpN] / [Form_jam_dpN] WIB</td>
        </tr>
        <tr>
            <td colspan="1">&nbsp;</td>
            <td colspan="20">Tempat akad nikah</td>
            <td>: </td>
            <td colspan="27">[Form_tempat_dpN]</td>
        </tr>
        <tr>
            <td colspan="1">&nbsp;</td>
            <td colspan="20">Maskawin</td>
            <td>: </td>
            <td colspan="27">[Form_maskawin_dpN]</td>
        </tr>
    ...
    <table class="disdukcapil" style="margin-top: -5px; border: 0px;">
        ...
        <tr>
            ...
            <td colspan="14">
                ...
                <br>
                <br>
                <div><strong>[NAma_dcpw]</strong></div>
            </td>
        </tr>
    </table>
