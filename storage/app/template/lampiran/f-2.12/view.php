...
<page orientation="portrait" format="210x330" style="font-size: 8pt">
        ...
        <tr>
            ...
            <td colspan="46">
                <table align="right" style="padding: 5px 15px; border: solid 1px black;">
                    <tr>
                        <td><strong>Kode. F-2.12</strong></td>
                    </tr>
                </table>
            </td>
            <td>&nbsp;&nbsp;</td>
    ...
    <table class="disdukcapil" style="margin-top: 0px;">
        ...
        <tr>
            ...
            <td colspan="48">
                <table align="center" style="padding: 5px 15px; border: solid 1px black;">
                    <tr>
                        <td><strong style="font-size: 12pt;">FORMULIR PENCATATAN PERKAWINAN</strong></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="16" class="kotak">Hari, Tanggal, Bulan dan Tahun Melapor</td>
            <td>&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="12" class="kotak">Pukul</td>
            <td>&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="12" class="kotak">Agama/Penghayat Kepercayaan</td>
            <td>&nbsp;&nbsp;</td>
            <td class="kotak" colspan="31"><?= $input['agama_kawin'] ?></td>
            <!-- <td colspan="8" class="left">1. Islam</td>
            <td colspan="8" class="left">2. Kristen</td>
            <td colspan="8" class="left">3. Katholik</td>
            <td colspan="8" class="left">4. Hindu</td> -->
        ...
        <tr>
            ...
            <td colspan="14" class="kotak">Tanggal Putusan Penetapan Pengadilan</td>
            <td>&nbsp;&nbsp;</td>
            <td colspan="2" class="tengah">Tgl</td>
        ...
        <tr>
            ...
            <td colspan="14" class="kotak">Nama Pemuka Agama/Pghyt Kepercayaan</td>
            <td>&nbsp;&nbsp;</td>
            <td colspan="30" class="kotak"><?= $input['nama_pemuka'] ?></td>
        </tr>
        <tr>
            <td>&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td colspan="13" style="text-align: center;"><strong>(<?= padded_string_center('', 50) ?>)</strong></td>
            <td colspan="9">&nbsp;</td>
