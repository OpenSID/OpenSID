...
<page orientation="landscape" format="F4" style="font-size: 16pt">
	<table style="width:100%; border: solid 1px black; margin: auto; padding-top: 10px; padding-left: 10px; padding-right: 15px">
		<tr>
			<td style="width: 100%; padding-bottom: 139px;">
				...
				<table class="disdukcapil">
					...
					<tr>
						...
						<td rowspan="3" class="kotak satu"><?= trim($input['jenis_permohonan'], "'"); ?></td>
					...
					<tr>
						<td>5.</td>
						<td>Alamat Asal</td>
						<td colspan=12 class="kotak" style="text-transform: uppercase;"><?= $individu['alamat']; ?></td>
					...
					<tr>
						...
						<td colspan=8 class="kotak" style="text-transform: uppercase;"><?= $config['nama_desa']; ?></td>
						<td colspan=1>&nbsp;</td>
						<td colspan=4>c. Kab/Kota</td>
						<td colspan=10 class="kotak" style="text-transform: uppercase;"><?= $config['nama_kabupaten']; ?></td>
					</tr>

					<tr>
						<td>&nbsp;</td>
						<td>b. Kecamatan</td>
						<td colspan=8 class="kotak" style="text-transform: uppercase;"><?= $config['nama_kecamatan']; ?></td>
						<td colspan=1>&nbsp;</td>
						<td colspan=4>d. Provinsi</td>
						<td colspan=10 class="kotak" style="text-transform: uppercase;"><?= $config['nama_propinsi']; ?></td>
					</tr>
					...
					<tr>
						...
						<td colspan=12 class="kotak" style="text-transform: uppercase;"><?= $input['alamat_tujuan']; ?></td>
						<td colspan=2 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;RT</td>
						<?php for ($i = 0; $i < 3; $i++) : ?>
							<td class="kotak satu">
					...
					<tr>
						<td>&nbsp;</td>
						<td>a. Desa/Kelurahan</td>
						<td colspan=8 class="kotak" style="text-transform: uppercase;"><?= $input['desa_atau_kelurahan_tujuan']; ?></td>
						<td colspan=1>&nbsp;</td>
						<td colspan=4>c. Kab/Kota</td>
						<td colspan=10 class="kotak" style="text-transform: uppercase;"><?= $input['kabupaten_tujuan']; ?></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>b. Kecamatan</td>
						<td colspan=8 class="kotak" style="text-transform: uppercase;"><?= $input['kecamatan_tujuan']; ?></td>
						<td colspan=1>&nbsp;</td>
						<td colspan=4>d. Provinsi</td>
						<td colspan=10 class="kotak" style="text-transform: uppercase;"><?= $input['provinsi_tujuan']; ?></td>
					</tr>
...
<page orientation="landscape" format="F4" style="font-size: 14pt">
	<table style="width:94.3%; border: solid 1px black; margin: auto; padding-top: 5px; padding-left: 10px; padding-right: 34px">
		<tr>
			<td style="width: 100%; padding-bottom: 90px;">
				<table class="disdukcapil">
					<tr>
						<td>12.</td>
				...
				<table class="disdukcapil">
					...
					<tr>
						...
						<td rowspan="2" class="kotak satu"><?= trim($input['tipe_sponsor'], "'"); ?></td>
					...
					<tr>
						<td>17.</td>
						<td>Negara Tujuan</td>
						<td colspan=16 class="kotak" style="text-transform: uppercase;"><?= $input['negara_tujuan']; ?></td>
						<td colspan=1>&nbsp;</td>
						<?php for ($i = 0; $i < 3; $i++) : ?>
							<td class="kotak satu">
					...
					<tr>
						<td>17.</td>
						<td>Alamat Tujuan</td>
						<td colspan=20 class="kotak" style="text-transform: uppercase;"><?= $input['alamat_tujuan_luar_negeri']; ?></td>
					</tr>

					<tr>
						<td>18.</td>
						<td>Penanggung Jawab</td>
						<td colspan=20 class="kotak" style="text-transform: uppercase;"><?= $input['penanggung_jawab']; ?></td>
					</tr>
				...
				<table class="ttd">
					...
					<tr class="pendek">
						...
						<td>
							<?= $config['nama_kabupaten']; ?>, <?= tgl_indo(date('Y-m-d')) ?>
						</td>
					</tr>
					<tr class="pendek">
