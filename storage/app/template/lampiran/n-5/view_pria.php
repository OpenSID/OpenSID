<page orientation="portrait" format="F4" style="font-size: 11pt">
    ...
    <tr style="height: 18px;">
    <td style="width: 26.6281%; text-align: center; height: 18px;"><strong>[NAma_dapp]</strong></td>
    <td style="width: 2.75528%; height: 18px;"> </td>
    <td style="width: 70.6166%; text-align: center; height: 18px;"><strong>[NAma_dipp]</strong></td>
    </tr>
    <tr style="height: 18px;">
