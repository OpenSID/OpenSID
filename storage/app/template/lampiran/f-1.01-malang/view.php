...
<page orientation="landscape" format="F4" style="font-size: 7pt">
    <table style="width:100%; border: solid 1px black; margin: auto">
        <tr>
            <td style="width: 100%; padding-bottom: 15px; padding-right: 5px; padding-left: 5px">
                <!-- KOP Surat -->
                <table style="width: 100%; border-bottom: 2px solid black; margin-bottom: 20px;">
                    <tr>
                        <td style="width: 15%; text-align: center;">[logo]</td>
                        <td style="width: 70%; text-align: center;">
                            <h2 style="margin: 3;">PEMERINTAH KABUPATEN MALANG</h2>
                            <h2 style="margin: 3;">DINAS KEPENDUDUKAN DAN PENCATATAN SIPIL</h2>
                            <p style="margin: 3; font-size: 10pt;">
                                Jl. Trunojoyo Telp. 0341-399744 Fax. 0341-399744
                            </p>
                            <p style="margin: 3; font-size: 10pt;">
                                Email : dispenduk@malangkab.go.id - Website : http://dispendukcapil.malangkab.go.id
                            </p>
                            <h3 strong style="margin: 3; margin-bottom: 10px">KEPANJEN - 65163</h3>
                        </td>

                        <td style="width: 15%; text-align: right; vertical-align: top; padding-top: 40px">
                            <table style="padding: 5px 15px; border: solid 1px black; display: inline-block;">
                                <tr>
                                    <td><strong style="font-size: 16pt;">F-1.01</strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table class="disdukcapil" style="margin-top: 0px; border: 0px;">
                    ...
                    <tr>
                        ...
                        <td class="kanan"> : </td>
                        <td colspan="28" class="kotak" style="text-transform: uppercase;"><?= $individu['alamat'] ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <?php for ($i = 0; $i < 3; $i++): ?>
                            <td class="kotak padat tengah">
                                <?php if (isset($kepala_keluarga['wilayah']['rt'])): ?>
                                    <?= angka0($kepala_keluarga['wilayah']['rt'])[$i] ?? '&nbsp;'; ?>
                                <?php else: ?>
                                    &nbsp;
                                <?php endif; ?>
                            </td>
                        ...
                        <?php for ($i = 0; $i < 3; $i++): ?>
                            <td class="kotak satu" style="padding-left: 8px;">
                                <?php if (isset($kepala_keluarga['wilayah']['rw'])): ?>
                                    <?= angka0($kepala_keluarga['wilayah']['rw'])[$i] ?? '&nbsp;'; ?>
                                <?php else: ?>
                                    &nbsp;
                                <?php endif; ?>
                            </td>
                    ...
                    <tr>
                        ...
                        <?php endfor; ?>
                        <td colspan="3"></td>
                        <td colspan="23" class="kotak" style="text-transform: uppercase;"><?= $config['nama_propinsi'] ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td>10.</td>
                        ...
                        <?php endfor; ?>
                        <td colspan="3"></td>
                        <td colspan="23" class="kotak" style="text-transform: uppercase;"><?= $config['nama_kabupaten'] ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td>11.</td>
                        ...
                        <?php endfor; ?>
                        <td colspan="3"></td>
                        <td colspan="23" class="kotak" style="text-transform: uppercase;"><?= $config['nama_kecamatan'] ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td>12.</td>
                        ...
                        <?php endfor; ?>
                        <td></td>
                        <td colspan="23" class="kotak" style="text-transform: uppercase;"><?= $config['nama_desa'] ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td>13.</td>
                        ...
                        <td class="kanan"> : </td>
                        <td colspan="28" class="kotak" style="text-transform: uppercase;"><?= $individu['dusun'] ?></td>
                        <td colspan="2"></td>
                    </tr>
...
<page orientation="landscape" format="F4" style="font-size: 7pt">
    <table style="width:100%; border: solid 1px black; margin: auto">
        <tr>
            <td style="width: 100%; padding-bottom: 20px; padding-right: 10px; padding-left: 10px">
                <table class="disdukcapil" style="margin-top: 0px; border: 0px;">
                    <tr>
                        <td colspan="48" style="height: 10px"><strong>DATA ANGGOTA KELUARGA</strong></td>
                    </tr>
                    <tr>
                        <td colspan="48" style="height: 10px">Catatan :</td>
                    </tr>
                    <tr>
                        <td colspan="48" style="height: 10px">&nbsp;&nbsp;&nbsp;- Bagi Penduduk WNI mengisi Kolom 2 s.d 6, 10 s.d 31, 38 s.d 41</td>
                    </tr>
                    <tr>
                        <td colspan="48" style="height: 10px">&nbsp;&nbsp;&nbsp;- <i>For Foreigners only, please fill column 2 to 13, 15 to 41</i></td>
                    </tr>
                    <tr>
                        <td colspan="48" style="height: 10px">&nbsp;&nbsp;&nbsp;- Bagi WNI di luar wilayah NKRI mengisi nomor 2 s.d 31, 38 s.d 41</td>
                    </tr>
                </table>

                <!-- 1 sampai 7-->
                <?php $kolom = 7 ?>
                <table style="border-collapse: collapse; margin-top: 6px" class="disdukcapil">
                    <col style="width: 2%;">
                    <col style="width: 30%;">
                    <col style="width: 10%;">
                    <col style="width: 10%;">
                    ...
                    <tr>
                        <td class="judul tengah" rowspan="2" style="height: 15px">No.</td>
                    ...
                    <?php for ($i = 0; $i < MAX_ANGGOTA_F101; $i++): ?>
                        <tr>
                            ...
                            <td class="tengah <?= $class ?>" style="height: 11px"><?= $i + 1; ?></td>
                ...
                <table style="border-collapse: collapse;" class="disdukcapil">
                    ...
                    <tr>
                        <td class="judul tengah" style="height: 20px">No.</td>
                        ...
                        <tr>
                            ...
                            <?php if ($i < count($anggota)): ?>
                                ...
                                <td class="tengah <?= $class ?>">
                                    <?php switch (ucwords(strtolower($anggota[$i]['status_perkawinan']))) {
                                        case 'Belum Kawin':
                                            $status = 1;
                                            break;
...
<page orientation="landscape" format="F4" style="font-size: 7pt">
    <table style="width:100%; border: solid 1px black; margin: auto">
        <tr>
            <td style="width: 100%; padding-bottom: 16px; padding-right: 10px; padding-left: 10px">
                <!-- 24 sampai 33-->
                <br /><br />
                ...
                <table style="border-collapse: collapse;" class="disdukcapil">
                    ...
                    <tr>
                        <td class="judul tengah" style="height: 30px">No.</td>
                    ...
                    <?php for ($i = 0; $i < MAX_ANGGOTA_F101; $i++): ?>
                        <tr>
                            <?php $class = ($i == 10 - 1) ? 'bawah' : 'anggota'; ?>
                            <td class="tengah <?= $class ?>" style="height: 12px"><?= $i + 1; ?></td>
                            <?php if ($i < count($anggota)): ?>
                ...
                <table style="border-collapse: collapse;" class="disdukcapil">
                    ...
                    <tr>
                        ...
                        <td class="judul tengah">Tempat Datang Pertama</td>
                ...
                <table class="ttd" style="margin-top: 15px; font-size: 10pt">
                    <col style="width:3%">
                    <col style="width:20%">
                    <col style="width:48%">
                    <col style="width:20%">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td class="center">Kepala Dinas Kependudukan dan Pencatatan Sipil Kabupaten <?= $config['nama_kabupaten'] ?></td>
                        <td>&nbsp;</td>
