...
<section x-data="{catMenu: false}">
  ...
  <div x-show="catMenu" x-on:click="catMenu = false" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 z-30 backdrop-blur-sm"></div>
  ...
  <div class="lg:py-3 px-3 lg:block transform transition-transform duration-300 lg:visible z-40"
    ...
    <div class="flex lg:flex-row flex-col justify-between items-center relative z-10">
      <ul class="w-full text-sm">
        ...
        <li class="lg:inline-block">
          <a href="{{ site_url("{$alt_slug}/kategori/{$menu['slug']}") }}"
            class="block lg:inline-block py-2 px-3 hover:text-link">
            {{ $menu['kategori'] }}
          </a>
        </li>
      ...
      <div class="flex flex-col lg:flex-row gap-3 mt-5 lg:mt-0 flex-wrap lg:justify-end w-full px-3">
        ...
        @endif
        <a href="{{ site_url('siteman') }}" class="btn btn-accent text-sm w-full lg:w-auto text-center">Login Admin <i
