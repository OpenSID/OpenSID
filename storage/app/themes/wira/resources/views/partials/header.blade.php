    ...
    <div class="relative z-10 h-full flex flex-col lg:flex-row pt-16 lg:pt-16">
        ...
        <div class="lg:hidden flex-1 relative">
            ...
            <div class="relative z-10 flex flex-col items-left justify-center h-full px-4 text-center">
                ...
                {{-- Clock for Mobile --}}
                <div class="mt-4 bg-white/20 backdrop-blur-sm rounded-lg p-3 inline-block mx-auto">
                    <div class="text-center">
                        <div id="digital-date-mobile" class="text-xs text-white opacity-90 mb-1">
                            Loading...
                        </div>
                        <div id="working-hours-mobile" class="text-xs text-white opacity-80">
        ...
        <div class="hidden mt-12 mb-12 lg:flex w-100px h-100px items-center justify-center relative">
            <div class="torn-paper-image w-full h-full relative">
                <img src="{{ $bg_header }}" alt="Desa Image" class="w-full h-full object-cover">

                {{-- Clock Overlay on Desktop Image --}}
                <div class="absolute top-4 left-4 right-4 z-30">
                    <div class="bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                        <div class="text-left">
                            <div id="digital-clock" class="text-2xl lg:text-3xl font-mono font-bold mb-1 text-white">
                                00:00:00
                            </div>
                            <div id="digital-date" class="text-sm opacity-90 mb-2 text-white">
                                Loading...
                            </div>
                            <div id="working-hours" class="text-xs opacity-80 text-white">
                                {{-- Working hours for current day will be inserted here by JavaScript --}}
                            </div>
                        </div>
                    </div>
