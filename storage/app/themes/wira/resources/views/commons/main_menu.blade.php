        ...
        @if (menu_tema())
            @foreach (menu_tema() as $menu)
                ...
                <li class="inline-block relative" @if ($has_dropdown) x-data="{dropdown: false}" @endif>
                    ...
                    <a href="{{ $menu_link }}" class=" p-2 inline-block hover:bg-primary-200" @mouseover="dropdown = true" @mouseleave="dropdown = false" @click="dropdown = !dropdown" @if ($has_dropdown) aria-expanded="false"
