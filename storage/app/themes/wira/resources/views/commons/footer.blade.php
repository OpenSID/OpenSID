...
<footer class="container mx-auto lg:px-5 px-3 pt-5 footer">
    <div
            ...
            <p>
                ...
                @if (file_exists('mitra'))
                    ...
                    <a href="https://my.idcloudhost.com/aff.php?aff=3172" rel="noopener noreferrer" target="_blank">
                        <img src="{{ base_url('/assets/images/Logo-IDcloudhost.png') }}" class="h-4 inline-block"
                            alt="Logo-IDCloudHost" title="Logo-IDCloudHost">
                    </a>
                @endif
            </p>
        </span>
        @if (setting('tte'))
            <div class="space-x-1">
                <img src="{{ asset('assets/images/bsre.png?v', false) }}" alt="Bsre" class="img-responsive"
                    style="width: 185px;" />
            </div>
        @endif
            ...
            @foreach ($social_media as $sm)
                @if ($link = $sm['link'])
                    <li class="inline-block">
                        <a href="{{ $link }}"
                            class="inline-flex items-center justify-center {{ $sm['color'] }} h-8 w-8 rounded-full">
