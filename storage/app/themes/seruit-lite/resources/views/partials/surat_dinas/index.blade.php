...
<head>
    ...
    <title>Verifikasi Surat Dinas - {{ ucwords(setting('sebutan_desa') . ' ' . identitas('nama_desa')) }}</title>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const loadingHtml = `
            <div class="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                ...
                <p class="mt-3 font-semibold">Memverifikasi Data Surat Dinas...</p>
            </div>`;
        ...
        const notFoundHtml = `
            <div class="p-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-900/30 dark:text-red-300 flex items-center" role="alert">
                ...
                <div>
                    <span class="font-bold">Gagal!</span> Surat Dinas tidak ditemukan dalam sistem kami.
                </div>
            </div>`;
        ...
        const createSuccessHtml = (surat) => `
            <div class="space-y-4">
                ...
                <div class="p-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-900/30 dark:text-green-300 flex items-center mt-6" role="alert">
                    ...
                    <div>
                        <span class="font-bold">Terverifikasi!</span> Surat Dinas ini adalah benar dan tercatat dalam database sistem informasi kami.
                    </div>
                </div>
            </div>
        `;
