        ...
        <table class="w-full text-sm" id="tabel-detail">
            <thead class="bg-gray-100 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th rowspan="2" class="p-3 text-left text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Jenis Barang</th>
            ...
            <tfoot class="bg-gray-100 dark:bg-gray-700/50 font-bold">
                <tr>
                    <th colspan="10" class="p-3 text-right text-xs uppercase">TOTAL</th>
    ...
    $(document).ready(function() {
        $('#tabel-detail').DataTable({
            ...
            columns: [
                ...
                { data: 'attributes.kondisi', name: 'kondisi', className: 'text-center p-2 border border-gray-300 dark:border-gray-600' },
                { data: 'attributes.kontruksi', name: 'kontruksi', className: 'p-2 border border-gray-300 dark:border-gray-600' },
