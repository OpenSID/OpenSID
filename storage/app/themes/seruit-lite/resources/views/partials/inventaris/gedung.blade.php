        ...
        <table class="w-full text-sm" id="tabel-detail">
            <thead class="bg-gray-100 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th rowspan="2" class="p-3 text-left text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Lokasi</th>
...
<script>
    ...
    $(document).ready(function() {
        $('#tabel-detail').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `{{ ci_route('internal_api.inventaris-gedung') }}`,
                method: 'POST',
            ...
            columns: [
                ...
                { data: 'attributes.letak', name: 'letak', className: 'p-2 border border-gray-300 dark:border-gray-600' },
