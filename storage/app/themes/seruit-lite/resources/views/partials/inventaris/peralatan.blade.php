        ...
        <table class="w-full text-sm" id="tabel-detail">
            <thead class="bg-gray-100 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th rowspan="2" class="p-3 text-left text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Merk/Type</th>
                    <th rowspan="2" class="p-3 text-center text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Tahun</th>
                    <th colspan="2" class="p-3 text-center text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Nomor</th>
                    ...
                    <th rowspan="2" class="p-3 text-right text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Harga (Rp)</th>
                </tr>
                <tr>
                    <th class="p-2 text-center text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Polisi</th>
                    <th class="p-2 text-center text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">BPKB</th>
                </tr>
            </thead>
            <tbody></tbody>
    ...
    $(document).ready(function() {
        $('#tabel-detail').DataTable({
            ...
            columns: [
                ...
                { data: 'attributes.merk', name: 'merk', className: 'p-2 border border-gray-300 dark:border-gray-600' },
                ...
                { data: 'attributes.no_polisi', name: 'no_polisi', className: 'text-center p-2 border border-gray-300 dark:border-gray-600' },
                { data: 'attributes.no_bpkb', name: 'no_bpkb', className: 'text-center p-2 border border-gray-300 dark:border-gray-600' },
