        ...
        <table class="w-full text-sm" id="tabel-detail">
            <thead class="bg-gray-100 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th class="p-3 text-center text-xs font-bold uppercase tracking-wider border border-gray-300 dark:border-gray-600">Jumlah</th>
            ...
            <tfoot class="bg-gray-100 dark:bg-gray-700/50 font-bold">
                <tr>
                    <th colspan="6" class="p-3 text-right text-xs uppercase">TOTAL</th>
...
<script>
    ...
    $(document).ready(function() {
        $('#tabel-detail').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `{{ ci_route('internal_api.inventaris-asset') }}`,
                method: 'POST',
            ...
            columns: [
                ...
                { data: 'attributes.jumlah', name: 'jumlah', className: 'text-center p-2 border border-gray-300 dark:border-gray-600' },
