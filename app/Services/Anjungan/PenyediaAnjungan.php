...
/**
 * Kontrak penyedia kios (didaftarkan add-on ke {@see PenentuanAnjungan}).
 */
interface PenyediaAnjungan
{
    /**
     ...
     *
     * @param ModeAktivasiAnjungan $mode {@see ModeAktivasiAnjungan::DeviceCheck}
     *              (hanya kios "utama" mis. ANJUNGAN, tanpa menandai sesi) atau
     *              {@see ModeAktivasiAnjungan::Login} (semua tipe kios + tandai
