...
namespace App\Libraries\OTP\Interface;
...
interface OtpInterface
{
     ...
     * @return bool
     */
    public function verifikasiOtp($otp, $user = null);
     ...
     * @return void
     */
    public function verifikasiBerhasil($user, $nama);
     ...
     * @return bool
     */
    public function cekVerifikasiOtp($user);
     ...
     * @return bool
     */
    public function cekAkunTerdaftar($chat_id);
     ...
     * @return bool
     */
    public function kirimPesan(array $data = []);
}
