...
-- Dumping structure for table sid.setting_aplikasi
...
-- Dumping data for table sid.setting_aplikasi: ~56 rows (approximately)
...
INSERT INTO `setting_aplikasi` (`id`, `key`, `value`, `keterangan`, `jenis`, `kategori`) VALUES
	...
	(408, 'jenis_peta', '4', 'Jeni peta yang digunakan', 'option-kode', NULL);
/*!40000 ALTER TABLE `setting_aplikasi` ENABLE KEYS */;

-- Dumping structure for table sid.setting_aplikasi_options
CREATE TABLE IF NOT EXISTS `setting_aplikasi_options` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table sid.setting_aplikasi_options: ~18 rows (approximately)
DELETE FROM `setting_aplikasi_options`;
/*!40000 ALTER TABLE `setting_aplikasi_options` DISABLE KEYS */;
INSERT INTO `setting_aplikasi_options` (`id`, `id_setting`, `value`, `kode`) VALUES
	...
	(19, 408, 'OpenStreetMap', 1),
	(20, 408, 'OpenStreetMap H.O.T.', 2),
	(21, 408, 'Mapbox Streets', 3),
	(22, 408, 'Mapbox Satellite', 4),
	(23, 408, 'Mapbox Satellite-Street', 5);
/*!40000 ALTER TABLE `setting_aplikasi_options` ENABLE KEYS */;
