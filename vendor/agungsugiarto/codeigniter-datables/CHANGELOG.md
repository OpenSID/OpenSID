...
```php
use Fluent\DataTables\Facades\DataTables;
...
use Fluent\DataTables\EloquentDataTable;
...
use Fluent\DataTables\CollectionDataTable;
...
- Namespace changed from `Fluent\DataTables` to `Fluent\DataTables`.
