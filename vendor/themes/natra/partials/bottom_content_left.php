                                    ...
                                    <a href="<?= site_url('artikel/'.buat_slug($headline))?>">
                                     <?php if ($headline["gambar"] != "") : ?>
                                        <?php if (is_file(LOKASI_FOTO_ARTIKEL . "sedang_" . $headline['gambar'])) : ?>
                                            <img data-src="<?= AmbilFotoArtikel($headline['gambar'], 'sedang') ?>" src="<?= assets('images/img-loader.gif') ?>" width="300" class="yall_lazy img-fluid img-thumbnail hidden-sm hidden-xs" style="float:left; margin:0 8px 4px 0;" />
                                            <img data-src="<?= AmbilFotoArtikel($headline['gambar'], 'sedang') ?>" src="<?= assets('images/img-loader.gif') ?>" width="100%" class="yall_lazy img-fluid img-thumbnail hidden-lg hidden-md" style="float:left; margin:0 8px 4px 0;" />
                                        <?php else : ?>
                        ...
                        <li>
                            <div class="catgimg2_container2">
                                ...
                                <?php if (is_file(LOKASI_FOTO_ARTIKEL."kecil_".$data['gambar'])): ?>
                                    <img data-src="<?= AmbilFotoArtikel($data['gambar'], 'sedang') ?>" src="<?= assets('images/img-loader.gif') ?>" width="300" class="yall_lazy img-fluid img-thumbnail hidden-sm hidden-xs" style="float:left; margin:0 8px 4px 0;" alt="<?= $data["judul"] ?>" />
                                            <img data-src="<?= AmbilFotoArtikel($data['gambar'], 'sedang') ?>" src="<?= assets('images/img-loader.gif') ?>" width="100%" class="yall_lazy img-fluid img-thumbnail hidden-lg hidden-md" style="float:left; margin:0 8px 4px 0;" alt="<?= $data["judul"] ?>" />
                                <?php else: ?>
