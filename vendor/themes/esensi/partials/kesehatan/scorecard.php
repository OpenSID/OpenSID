<div class="row" style="display: flex; justify-content: flex-end;">
    <a href="cetak/cetak<?= '?kuartal=' . $kuartal . '&tahun=' . $_tahun . '&id=' . $id ?>" class="btn btn-info visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" style="margin: 10px;" target="_blank"><i class="fa fa-print"></i>
        Cetak</a>
    <a href="cetak/unduh<?= '?kuartal=' . $kuartal . '&tahun=' . $_tahun . '&id=' . $id ?>" class="btn btn-primary visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" style="margin: 10px;" target="_blank"><i class="fa fa-download"></i>
        Unduh</a>
</div>
<div class="row">
