                    ...
                    <div class="grider mlr-min1vh">
                        <div class="col-input">
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control required nama required" maxlength="50"
                        ...
                        <div class="col-input">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bilangan telepon required" name="telepon"
                                    placeholder="Masukkan No. Telp./HP" maxlength="20" pattern="[0-9]+" autocomplete="off"
                                    required>
                            </div>
                        </div>
                        <div class="col-input">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" placeholder="Asal Instansi"
                                    name="instansi" maxlength="100" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-input">
                            <div class="form-group">
                ...
                <div class="capture">
                                        ...
                                        <g transform="translate(1 1)">
                                            <g>
                                                <g>
                                                    ...
                                                    <path
                                                        d="M383,186.733c-9.387,0-17.067,7.68-17.067,17.067c0,9.387,7.68,17.067,17.067,17.067s17.067-7.68,17.067-17.067 C400.067,194.413,392.387,186.733,383,186.733z">
                                                    </path>
                                                </g>
                                            </g>
                                        </g>
                    ...
                    <div class="capture-bottom" style="align-self: end;">
                        <div class="d-grid" style="margin:0;padding:0;">
                            <button class="btn knob bg-c1" type="submit" id="simpan"
                                {{ $kamera ? 'disabled' : '' }}><svg viewBox="0 0 24 24">
