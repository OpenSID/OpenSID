...
<div class="box box-info">
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input id="nama"
                    ...
                    maxlength="50" type="text" placeholder="Nama {{ $wilayahLabel }}" name="{{ $level }}"
                    value="{{ $wilayah->$level }}">
            </div>
        </div>
        @if ($wilayah->kepala)
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <select class="form-control select2 select2-infinite" data-url="wilayah/apipendudukwilayah"
                    style="width: 100%;" id="id_kepala" name="id_kepala">
