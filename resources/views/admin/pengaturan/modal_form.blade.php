            ...
            <div class="form-group" id="form_{{ $pengaturan->key }}">
                ...
                @elseif ($pengaturan->jenis == 'textarea')
                    <textarea {!! $pengaturan->attribute
                        ? str_replace('class="', 'class="form-control input-sm required ', $pengaturan->attribute)
                        : 'class="form-control input-sm required"' !!} name="{{ $pengaturan->key }}" placeholder="{{ $pengaturan->keterangan }}"
                ...
                @elseif (in_array($pengaturan->jenis, ['input-text', 'input-number', 'select-simbol', 'select-boolean', 'select-array', 'select-multiple-array']))
                    ...
                    @php
                        ...
                        $value['attributes'] = implode(' ', array_map(function ($key, $val) {
                            return $key . '="' . $val . '"';
