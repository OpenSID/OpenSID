    ...
    <div class="col-md-9">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                @endif
                @if (can('h'))
                <a href="{{ ci_route('simbol.salin_simbol_default') }}"
                            ...
                            <ul id="icons" class="bs-glyphicons">
                                ...
                                <li>
                                    <label>
                                        ...
                                        <a href="#" data-href="{{ ci_route(" simbol.delete_simbol.{$data['id']}") }}"
                                            style="margin-top:10px;" class="btn btn-danger btn-sm btn-block"
                                            title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i
    ...
    <div class="modal fade" id="ModalSimbol" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="mainform" name="mainform" action="{{ ci_route('simbol.tambah_simbol') }}" method="post"
                    ...
                    <div class="modal-footer">
                        {!! batal() !!}
                        <button type="submit" class="btn btn-social btn-info btn-sm" id="simpan"><i
