              ...
              {!! form_open_multipart(route('user_setting.update', $auth->id), 'id="validate_user"') !!}
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input class="form-control input-sm" type="text" value="{{ $auth->username }}" disabled></input>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="btn-group col-xs-12 col-sm-8 input-group" data-toggle="buttons">
                      <label class="btn btn-info btn-flat btn-sm col-xs-6 col-sm-5 col-lg-3 form-check-label @active($auth->notif_telegram == 1)">
                        <input type="radio" name="notif_telegram" class="form-check-input" value="1" autocomplete="off" @selected($auth->notif_telegram == 1)> Aktif
                      </label>
                      <label class="btn btn-info btn-flat btn-sm col-xs-6 col-sm-5 col-lg-3 form-check-label @active($auth->notif_telegram == 0)">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control input-sm pwdLengthNist" type="text" id="id_telegram" name="id_telegram" value="{{ $auth->id_telegram }}" />
                  </div>
