...
<div class="box box-info">
    <div class="box-header with-border">
        @if (can('u'))
        <a href="{{ ci_route('penduduk.dokumen_form', $penduduk->id) }}" title="Tambah" data-remote="false"
            data-toggle="modal" data-target="#modalBox" data-title="Tambah"
        ...
        <a href="#confirm-delete" title="Hapus Data"
            onclick="deleteAllBox('mainform','{{ ci_route('penduduk.delete_dokumen', $penduduk->id) }}')"
        ...
        @endif
        <a href="{{ preg_match('/bumindes_arsip/i', $_SERVER['HTTP_REFERER']) ? ci_route('bumindes_arsip.clear') : ci_route('penduduk.detail', "
            1/0/{$penduduk->id}") }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block
            visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali ke Halaman
