                    ...
                    <table class="table table-bordered table-striped table-hover" >
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" >
                                <tbody>
                                    <tr>
                                        <td>Status Dasar</td><td >:</td><td><span class="{{ ($penduduk->status_dasar != App\Enums\StatusDasarEnum::HIDUP) ? 'label label-danger' : '' }}"><strong>{{ strtoupper(App\Enums\StatusDasarEnum::valueOf($penduduk->status_dasar)) }}</strong></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Hubungan Dalam Keluarga</td><td >:</td><td>{{ App\Enums\SHDKEnum::valueOf($penduduk->kk_level) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelamin</td><td >:</td><td>{{ strtoupper(App\Enums\JenisKelaminEnum::valueOf($penduduk->sex)) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Agama</td><td >:</td><td>{{ strtoupper($penduduk->agama->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Status Penduduk</td><td >:</td><td>{{ strtoupper(App\Enums\StatusPendudukEnum::valueOf($penduduk->status)) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Tempat / Tanggal Lahir</td><td >:</td><td>{{ strtoupper($penduduk->tempatlahir) }} / {{ strtoupper($penduduk->tanggallahir->format('d-m-Y')) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Tempat Dilahirkan</td><td >:</td><td>{{ strtoupper($penduduk->dilahirkan)  }}</td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelahiran</td><td >:</td><td>{{ strtoupper($penduduk->jenisLahir)  }}</td>
                                    </tr>
                                    <tr>
                                        <td>Kelahiran Anak Ke</td><td >:</td><td>{{ $penduduk->kelahiran_anak_ke  }}</td>
                                    </tr>
                                    <tr>
                                        <td>Penolong Kelahiran</td><td >:</td><td>{{ strtoupper($penduduk->penolongLahir)  }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Pendidikan dalam KK</td><td >:</td><td>{{ strtoupper($penduduk->pendidikanKK->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Pendidikan sedang ditempuh</td><td >:</td><td>{{ strtoupper($penduduk->pendidikan->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Pekerjaan</td><td >:</td><td>{{ strtoupper($penduduk->pekerjaan->nama) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Warga Negara</td><td >:</td><td>{{ strtoupper($penduduk->warganegara->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Nomor Paspor</td><td >:</td><td>{{ strtoupper($penduduk->dokumen_pasport) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Berakhir Paspor</td><td >:</td><td>{{ strtoupper(tgl_indo_out($penduduk->tanggal_akhir_paspor)) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Alamat</td><td >:</td><td>{{ strtoupper($penduduk->keluarga->alamat) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Dusun</td><td >:</td><td>{{ strtoupper($penduduk->wilayah->dusun) }}</td>
                                    </tr>
                                    <tr>
                                        <td>RT/ RW</td><td >:</td><td>{{ strtoupper($penduduk->wilayah->rt) }} / {{ $penduduk->wilayah->rw }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Status Kawin</td><td >:</td><td>{{ strtoupper($penduduk->statusPerkawinan) }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Golongan Darah</td><td >:</td><td>{{ $penduduk->golonganDarah->nama ?? 'TIDAK TAHU' }}</td>
                                    </tr>
                                    <tr>
                                        <td>Cacat</td><td >:</td><td>{{ strtoupper($penduduk->cacat->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Sakit Menahun</td><td >:</td><td>{{ strtoupper($penduduk->sakitMenahun->nama) }}</td>
                                    </tr>
                                    ...
                                    @if ($penduduk->id_sex == App\Enums\JenisKelaminEnum::PEREMPUAN)
                                        <tr>
                                            <td>Status Kehamilan</td><td >:</td><td>{{ strtoupper(App\Enums\HamilEnum::valueOf($penduduk->hamil)) }}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <td>Nama/Nomor Asuransi Kesehatan</td><td >:</td><td>{{ $penduduk->asuransi->nama . ' / ' . strtoupper($penduduk->no_asuransi)  }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Bahasa</td><td >:</td><td>{{ $penduduk->bahasa->nama }}</td>
                                    </tr>
                                    <tr>
