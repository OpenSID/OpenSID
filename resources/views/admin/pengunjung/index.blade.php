            ...
            <div class="col-md-12">
                <div class="box box-info">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="{{ ci_route('pengunjung.cetak') }}"
                                                class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                                                title="Cetak Laporan" target="_blank"><i
                                                    class="fa fa-print "></i>Cetak</a>
                                            <a href="{{ ci_route('pengunjung.cetak.unduh') }}"
                                                class="btn btn-social bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                                                title="Unduh Laporan" target="_blank"><i
                                                    class="fa fa-print "></i>Unduh</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-red">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail', 1) }}" class="small-box-footer">Detail <i
                            ...
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-purple">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail', 2) }}" class="small-box-footer">Detail <i
                                            class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-green">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail', 3) }}" class="small-box-footer">Detail <i
                                            class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-yellow">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail', 4) }}" class="small-box-footer">Detail <i
                                            class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-gray">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail', 5) }}" class="small-box-footer">Detail <i
                                            class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-xs-6">
                                <div class="small-box bg-blue">
                                    ...
                                    <a href="{{ ci_route('pengunjung.detail') }}" class="small-box-footer">Detail <i
                                            class="fa fa-arrow-circle-right"></i></a>
                                </div>
                                <a href="{{ ci_route('pengunjung.detail', 1) }}" class="small-box-footer">Detail <i
                                        class="fa fa-arrow-circle-right"></i></a>
                    ...
                    <div class="box-header">
                        <hr>
                        <h4 class="text-center"><strong>Statistik Pengunjung Website {{ $main['judul'] }}<strong>
                        </h4>
                        <hr>
                    </div>
                    <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ $main['lblx'] == 'Bulan' ? getBulan($data['Tanggal'])
                                                            . ' ' . date('Y') : tgl_indo2($data['Tanggal']) }}
                                                        </td>
