        ...
        <div class="box-body">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control input-sm" type="text" placeholder="Masukkan sebutan anjungan" name="sebutan_anjungan_mandiri"
                            value="{{ $pengaturan['sebutan_anjungan_mandiri'] }}">
                    </div>
                </div>
                <div class="form-group">
