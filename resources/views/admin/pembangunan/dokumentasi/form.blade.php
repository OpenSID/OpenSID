    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <a href="{{ ci_route('pembangunan_dokumentasi.dokumentasi', $pembangunan->id) }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group col-sm-8 kiri" data-toggle="buttons">
                                <label id="label_pilih"
                                    class="btn btn-info btn-sm col-sm-3 form-check-label active focus">
                                    <input type="radio" name="jenis_persentase" class="form-check-input" value="1"
                                        autocomplete="off" onchange="pilih_persentase(this.value);"> Pilih Persentase
                                </label>
                                <label id="label_manual" class="btn btn-info btn-sm col-sm-3 form-check-label">
                                    <input type="radio" name="jenis_persentase" class="form-check-input" value="2"
                                        autocomplete="off" onchange="pilih_persentase(this.value);"> Tulis Manual
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div id="pilih">
                                <div class="col-sm-7">
                                    <select class="form-control input-sm select2 required" id="id_persentase"
                                        name="id_persentase" onchange="show_hide_anggaran(this.value)">
                                        <option value=''>-- Pilih Persentase Pembangunan --</option>
                                        @foreach ($persentase as $value)
                                        <option value="{{ $value }}" @selected($main->persentase == $value)>{{ $value }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div id="manual">
                                <div class="col-sm-7">
                                    <input maxlength="50" class="form-control input-sm required" name="persentase"
                                        id="persentase" type="text" onkeyup="show_hide_anggaran(this.value)"
                                        placeholder="Contoh: 50%" value="{{ $main->persentase }}" />
                                </div>
                            </div>
                        </div>
                        @if ($main->gambar)
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img class="attachment-img img-responsive img-circle"
                                    src="{{ base_url(LOKASI_GALERI . $main->gambar) }}" alt="Gambar Dokumentasi"
                        ...
                        <div class="form-group" id="anggaran">
                            ...
                            <div class="col-sm-7">
                                <input class="form-control input-sm" name="perubahan_anggaran" id="ubahanggaran"
                                    type="number" min="0" value="{{ $perubahan }}">
                            </div>
                        </div>
                        <div class="form-group">
