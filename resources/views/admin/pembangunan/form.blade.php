    ...
    <div class="col-md-9">
        <div class="box box-info">
            <div class="box-header with-border">
                <a href="{{ ci_route('admin_pembangunan') }}"
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="judul" name="judul" class="form-control input-sm strip_tags judul required"
                            value="{{ e($main->judul) }}" type="text" maxlength="50" minlength="5" maxlength="100"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input maxlength="50" class="form-control input-sm strip_tags required" name="volume"
                            id="volume" value="{{ $main->volume }}" type="text" placeholder="Volume Pembangunan" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="waktu">Waktu</label>
                    <div class="col-sm-6">
                        <input maxlength="50" class="form-control number input-sm required" name="waktu" id="waktu"
                            value="{{ $main->waktu }}" type="text" placeholder="Lamanya pembangunan" />
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control input-sm select2" id="sumber_dana" name="sumber_dana"
                            style="width:100%;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control input-sm select2" id="tahun_anggaran" name="tahun_anggaran"
                                    style="width:100%;">
                                    @foreach (tahun(1999) as $value)
                                    <option value="{{ $value }}" @selected($value==$main->tahun_anggaran)>{{ $value }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control input-sm required bilangan" name="anggaran" id="anggaran"
                                    value="{{ $main->anggaran }}" type="text" placeholder="Anggaran" readonly />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input id="sumber_biaya_pemerintah" name="sumber_biaya_pemerintah" onkeyup="cek()"
                                    class="form-control input-sm required bilangan" maxlength="12" type="text"
                                    placeholder="Sumber Biaya Pemerintah" value="{{ $main->sumber_biaya_pemerintah }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input id="sumber_biaya_provinsi" name="sumber_biaya_provinsi" onkeyup="cek()"
                                    class="form-control input-sm required bilangan" maxlength="12" type="text"
                                    placeholder="Sumber Biaya Provinsi" value="{{ $main->sumber_biaya_provinsi }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input id="sumber_biaya_kab_kota" name="sumber_biaya_kab_kota"
                                    class="form-control input-sm required bilangan" maxlength="12" onkeyup="cek()"
                                    type="text" placeholder="Sumber Biaya Kab / Kota"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input id="sumber_biaya_swadaya" name="sumber_biaya_swadaya"
                                    class="form-control input-sm required bilangan" maxlength="12" type="text"
                                    onkeyup="cek()" placeholder="Sumber Biaya Swadaya"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input maxlength="50" class="form-control input-sm strip_tags required"
                            name="pelaksana_kegiatan" id="pelaksana_kegiatan" value="{{ $main->pelaksana_kegiatan }}"
                            type="text" placeholder="Pelaksana Kegiatan Pembangunan" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="btn-group col-sm-6" data-toggle="buttons">
                                <label
                                    class="btn btn-info btn-sm form-check-label col-sm-6 {{ $main->lokasi ? null : 'active' }}">
                                    <input type="radio" name="jenis_lokasi" class="form-check-input" value="1"
                                        autocomplete="off" onchange="pilih_lokasi(this.value);"> Pilih Lokasi
                                </label>
                                <label
                                    class="btn btn-info btn-sm form-check-label col-sm-6 {{ $main->lokasi ? 'active' : null }}">
                                    <input type="radio" name="jenis_lokasi" class="form-check-input" value="2"
                                        autocomplete="off" onchange="pilih_lokasi(this.value);"> Tulis Manual
                                </label>
                            </div>
                        </div>
                        <br>
                        <div id="pilih">
                            <select class="form-control input-sm select2 required" id="id_lokasi" name="id_lokasi">
                                ...
                                <option value="{{ $item['id'] }}" @selected($item['id']==$main->id_lokasi)>{{
                                    strtoupper($item['dusun']) }} {{ empty($item['rw']) ? '' : " - RW {$item['rw']}" }}
                                    {{ empty($item['rt']) ? '' : " / RT {$item['rt']}" }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div id="manual">
                            <textarea id="lokasi" class="form-control input-sm strip_tags required" type="text"
                                placeholder="Lokasi" name="lokasi" rows="3">{{ e($main->lokasi) }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea id="manfaat" name="manfaat" class="form-control input-sm strip_tags required"
                            name="manfaat" placeholder="Manfaat" rows="3">{{ e($main->manfaat) }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="manfaat">Keterangan</label>
                    <div class="col-sm-9">
                        <textarea id="keterangan" class="form-control input-sm strip_tags required" name="keterangan"
                            placeholder="Keterangan" rows="3">{{ e($main->keterangan) }}</textarea>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3">
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <img class="img-responsive" id="previewImage" src="{{ to_base64(LOKASI_GALERI . $main->foto) }}"
                    alt="Gambar Utama Pembangunan">
                @else
                <img class="img-responsive" id="previewImage" src="{{ asset('images/404-image-not-found.jpg') }}"
                    alt="Gambar Utama Pembangunan" />
                @endif
