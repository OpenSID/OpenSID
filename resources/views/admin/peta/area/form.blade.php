					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
								<label id="sx3" class="btn btn-info  btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label @if ($area->enabled == '1' || $area->enabled == null) {{ 'active' }} @endif">
									<input id="sx1" type="radio" name="enabled" class="form-check-input" type="radio" value="1" @if ($area->enabled == '1' || $area->enabled == null) {{ 'checked' }} @endif autocomplete="off"> Aktif
								</label>
								<label id="sx4" class="btn btn-info  btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label @if ($area->enabled == '2') {{ 'active' }} @endif">
									<input id="sx2" type="radio" name="enabled" class="form-check-input" type="radio" value="2" @if ($area->enabled == '2') {{ 'checked' }} @endif autocomplete="off"> Tidak Aktif
								</label>
							</div>
						</div>
					</div>
