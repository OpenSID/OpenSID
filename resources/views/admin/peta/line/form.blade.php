        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input name="nama" class="form-control input-sm nomor_sk required" maxlength="100" type="text"
                            placeholder="Nama Jenis Garis" value="{{ $line['nama'] }}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group my-colorpicker2">
                            <input type="text" id="color" name="color" class="form-control input-sm warna required"
                                placeholder="#FFFFFF" value="{{ $line['color'] }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="tebal" class="form-control input-sm nomor_sk required" id="tebal" type="number"
                            value="{{ $line['tebal'] ?? 3 }}" min="1" max="10" />
                    </div>
                </div>
                <div class="form-group">
