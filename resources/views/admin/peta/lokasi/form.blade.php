                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control input-sm select2 required" id="ref_point" name="ref_point">
                            ...
                            <option value="{{ $data->id }}" @selected($data->id == $plan->ref_point)>{{ $data->nama }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <textarea id="desk" name="desk" class="form-control input-sm required"
                            style="height: 200px;white-space: pre-wrap;">{{ $plan->desk }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
                        <label id="sx3"
                            class="btn btn-info  btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label @if ($plan->enabled == '1' || $plan->enabled == null) {{ 'active' }} @endif">
                        ...
                        <label id="sx4"
                            class="btn btn-info  btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label @if ($plan->enabled == '2') {{ 'active' }} @endif">
                ...
                <div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
                    <label id="sx3"
                        ...
                        <input id="sx1" type="radio" name="enabled" class="form-check-input" type="radio" value="1" @if
                            ($plan->enabled == '1' || $plan->enabled == null) {{ 'checked' }} @endif
                        autocomplete="off"
                        > Aktif
                    </label>
                    <label id="sx4"
