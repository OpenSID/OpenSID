...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('buku_keperluan') }}">Data Keperluan</a></li>
...
@section('content')
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="{{ route('buku_keperluan') }}" class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
