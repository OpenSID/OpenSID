        ...
        <div id="body">
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <div class="header">
                            <h4 class="kop">PEMERINTAH {{ strtoupper(setting('sebutan_kabupaten')) }} {{ strtoupper($desa['nama_kabupaten']) }}</h4>
                            <h4 class="kop">KECAMATAN {{ strtoupper($desa['nama_kecamatan']) }}</h4>
                            <h4 class="kop">{{ strtoupper(setting('sebutan_desa')) }} {{ strtoupper($desa['nama_desa']) }}</h4>
                        </div>
                    </td>
                </tr>
            </table>
                    ...
                    <tr>
                        <td colspan="6">
                            <table>
                                ...
                                @for ($i = 0; $i < count($ref_disposisi); $i += 2)
                                    <tr>
