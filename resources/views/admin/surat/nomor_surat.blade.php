<div class="form-group">
    ...
    <div class="col-sm-4">
        <input id="nomor" class="form-control input-sm digits required" type="text" placeholder="Nomor Surat"
            name="nomor" value="{{ $surat_terakhir['no_surat_berikutnya'] }}">
    ...
    @if (!empty($setting->format_nomor_surat))
        <div class="col-sm-4">
            <p class="help-block"><em>Format nomor surat: </em><span
                    id="format_nomor">{{ $format_nomor_surat }}</span></p>
        </div>
    @endif
</div>
