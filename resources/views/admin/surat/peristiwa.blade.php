@if ($peristiwa->kode_peristiwa == $logpenduduk::BARU_LAHIR)
    ...
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-8">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->getDiLahirkanAttribute()) }}"
                disabled>
        </div>
    </div>
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-8">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->tempatlahir) }}"
                disabled>
        </div>
    </div>
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-4">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->getJenisLahirAttribute()) }}"
                disabled>
        </div>
    </div>
    <div class="form-group konfirmasi">
    ...
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-4">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->getPenolongLahirAttribute()) }}"
                disabled>
        </div>
    </div>
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-4">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->berat_lahir) }} gram"
                disabled>
        </div>
    </div>
    <div class="form-group konfirmasi">
        ...
        <div class="col-sm-4">
            <input class="form-control input-sm" type="text" value="{{ strtoupper($peristiwa->penduduk->panjang_lahir) }} cm"
                disabled>
        </div>
    </div>
@endif
