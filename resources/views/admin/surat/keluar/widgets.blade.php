@if (setting('sinkronisasi_opendk'))
    <div class="alert alert-warning alert-dismissible">
        ...
        Fitur Sinkronisasi Surat TTE ke {{ setting('sebutan_kecamtan') }} saat ini masih berupa demo menunggu proses penyempurnaan dan terdapat {{ setting('sebutan_kecamtan') }} yang sudah mengimplentasikan TTE.
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12 widget-surat">
            <a href="{{ ci_route('keluar.kecamatan') }}">
                <div class="info-box bg-orange {{ $tab_ini == 13 ? 'active' : '' }}">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ ucwords(setting('sebutan_kecamtan')) }}</span>
