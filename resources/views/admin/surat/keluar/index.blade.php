    ...
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <a href="{{ ci_route('keluar.perorangan') }}"
                    class="btn btn-social bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                        class="fa fa-archive"></i> Rekam Surat Perorangan</a>
                <a href="{{ ci_route('keluar.graph') }}"
                    class="btn btn-social bg-orange btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                        class="fa fa-pie-chart"></i> Pie Surat Keluar</a>
                <a href="{{ ci_route('keluar.dialog_cetak/cetak') }}"
                    class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Cetak Arsip Layanan Surat"><i class="fa fa-print"></i> Cetak</a>
                <a href="{{ ci_route('keluar.dialog_cetak/unduh') }}"
                    ...
                    data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Unduh Arsip Layanan Surat"><i class="fa fa-download"></i> Unduh</a>
            </div>
            @endif
                            ...
                            <form id="mainform" name="mainform" method="post">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control input-sm select2 filter-table" name="jenis"
                                                style="width: 100%;">
                                        ...
                                        @if (can('u'))
                                        <div class="form-group">
                                            <button id="perbaiki" type="button"
                                                title="Semua surat yang berstatus proses atau tidak ada statusnya akan di ubah menjadi siap cetak"
                                                class="btn btn-social bg-orange btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                                                    class="fa fa-cogs "></i>Perbaiki</button>
                                        </div>
                                        @endif
                                    </div>
                                </div>
