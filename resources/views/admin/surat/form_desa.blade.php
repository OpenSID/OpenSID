        ...
        <form id="main" name="main" method="POST" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6 col-lg-4">
                    <select id="nik" name="nik" class="form-control input-sm required" data-placeholder="-- Cari NIK / Tag ID Card / Nama Penduduk --" onchange="formAction('main')" data-surat="{{ $surat->id }}">
                        @if ($individu)
