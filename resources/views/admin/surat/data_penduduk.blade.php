@if ($individu)
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <a id="showData" class="btn btn-social btn-danger btn-sm"
                onclick="$(this).closest('.form-group').next('#kel').removeClass('hide');$(this).next('a').removeClass('hide');$(this).toggleClass('hide ')"><i
                    class="fa fa-search-plus"></i>
                Tampilkan</a>
            <a id="hideData" class="btn btn-social btn-danger btn-sm hide"
                onclick="$(this).closest('.form-group').next('#kel').addClass('hide');$(this).prev('a').removeClass('hide');$(this).toggleClass('hide ')"><i
