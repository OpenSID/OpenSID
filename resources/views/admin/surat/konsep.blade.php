...
@section('content')
    ...
    <div class="box box-info">
        ...
        <div class="box-footer text-center">
            ...
            <button type="button" id="preview-pdf" class="btn btn-social btn-vk btn-success btn-sm"><i
                    class="fa fa-eye"></i>Tinjau PDF</button>
            <button type="button" id="cetak-pdf" class="btn btn-social btn-success btn-sm"><i
                    class="fa fa-file-pdf-o"></i>Cetak PDF</button>
            @if ($tolak != '-1')
                <a onclick="formAction('validasi', '{{ $aksi_konsep }}')" id="konsep"
