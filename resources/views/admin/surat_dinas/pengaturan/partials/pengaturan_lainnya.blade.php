<div class="tab-pane" id="lainnya">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="format_tanggal_surat" class="format_tanggal form-control input-sm required" placeholder="d F Y" value="{{ setting('format_tanggal_surat_dinas') }}">
