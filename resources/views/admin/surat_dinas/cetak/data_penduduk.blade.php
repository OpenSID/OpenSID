@if ($individu)
    ...
    @includeWhen(isset($pengikut), 'admin.surat_dinas.cetak.pengikut')
    @includeWhen(isset($pengikut_kis), 'admin.surat_dinas.cetak.pengikut_kis')
    @includeWhen(isset($pengikut_pindah), 'admin.surat_dinas.cetak.pengikut_pindah')
@endif

@includeWhen(isset($peristiwa), 'admin.surat_dinas.cetak.peristiwa')
