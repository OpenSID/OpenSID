...
@section('breadcrumb')
<li class="active">Buku Rekapitulasi Jumlah Penduduk</li>
@endsection
...
<div class="row">
    <div class="col-md-3">
        @include('admin.bumindes.penduduk.side', ['selectedNav' => 'rekapitulasi'])
    </div>
    <div class="col-md-9">
...
<script>
    $(document).ready(function() {
        var urlDatatables = "{{ ci_route('bumindes_penduduk_rekapitulasi.datatables') }}";
