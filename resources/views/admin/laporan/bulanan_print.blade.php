    ...
    <table>
        ...
        <tr>
            <td colspan="2" class="text"><span
                    style="border-bottom: 2px solid;">{{ strtoupper($desa['nama_kabupaten']) }}</span></td>
            <td colspan="11">&nbsp;</td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
            <td colspan="10" class="judul" style="padding-bottom: 10px;"><span style="border-bottom: 2px solid;">LAPORAN
                    BULANAN DESA/KELURAHAN</span></td>
        <tr>
        <tr>
...
@section('content')
    ...
    <table class="tftable">
        ...
        <tr>
            ...
            <td class="bilangan">{{ show_zero_as($rincian_pindah['TOTAL_KK_L'] + $rincian_pindah['TOTAL_KK_P'], '-') }}
            </td>
        </tr>
    </table>
@endsection
