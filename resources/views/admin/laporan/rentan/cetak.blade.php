...
@section('title', 'Cetak Laporan Kelompok Rentan')
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td width="3%">:</td>
                <td width="38.5%">{{ $desa['nama_desa'] }}</td>
                <td></td>
            </tr>
            <tr>
                ...
                @foreach($dusunObj as $namaRw => $rwObj)
                    @foreach($rwObj as $rt)
                        ...
                        <tr>
                            ...
                            <td align="right">{{ $totalPendudukPria }}</td>
                            <td align="right">{{ $totalPendudukWanita }}</td>
                            <td align="right">{{ $main['bayi'][$rt->id]['total'] ?? 0 }}</td>
                            <td align="right">{{ $main['balita'][$rt->id]['total'] ?? 0 }}</td>
                            <td align="right">{{ $main['sd'][$rt->id]['total'] ?? 0 }}</td>
                            <td align="right">{{ $main['smp'][$rt->id]['total'] ?? 0 }}</td>
                            <td align="right">{{ $main['sma'][$rt->id]['total'] ?? 0 }}</td>
                            <td align="right">{{ $main['lansia'][$rt->id]['total'] ?? 0 }}</td>
                            ...
                            <td align="right">{{ $main['hamil'][$rt->id]['total'] ?? 0 }}</td>
                            @php
