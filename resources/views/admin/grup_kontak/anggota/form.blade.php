...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('daftar_kontak') }}">Grup Kontak</a></li>
    ...
    {!! form_open($formAction, 'class="form-horizontal" id="validasi"') !!}
      ...
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#data-penduduk" data-toggle="tab">Daftar Penduduk {{ $setting->sebutan_desa }}</a></li>
          <li ><a href="#data-kontak" data-toggle="tab">Daftar Kontak</a></li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="data-penduduk">
            <div class="box-header with-border">
              <a href="{{ route('grup_kontak.anggota', $grupKontak->id_grup) }}" class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
...
<script>
  $(document).ready(function () {
    ...
    var TableDataPenduduk = $('#tabeldatapenduduk').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "{{ route('grup_kontak.penduduk', $grupKontak->id_grup) }}",
      columns: [
    ...
    var TableDataKontak = $('#tabeldatakontak').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "{{ route('grup_kontak.kontak', $grupKontak->id_grup) }}",
      columns: [
        { data: 'ceklist', class: 'padat', searchable: false, orderable: false },
        { data: 'DT_RowIndex', class: 'padat', searchable: false, orderable: false },
        { data: 'nama', name: 'nama', searchable: true, orderable: true},
