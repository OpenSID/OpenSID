...
@section('title')
    <h1>
        {{ $action }} Data Mutasi Inventaris Jalan
    </h1>
@endsection

@section('breadcrumb')
    <li><a href="{{ site_url('inventaris_jalan_mutasi') }}">Daftar Mutasi Inventaris Jalan</a></li>
        ...
        <div class="col-md-9">
            <div class="box box-info">
                <div class="box-header with-border">
                    @include('admin.layouts.components.tombol_kembali', ['url' => site_url('inventaris_jalan_mutasi'), 'label' => 'Daftar Mutasi Inventaris Jalan'])
                </div>
                <form class="form-horizontal" id="validasi" name="form_jalan" method="post" action="{{ $form_action }}">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input
                                    ...
                                    id="tahun"
                                    type="text"
                                    value="{{ strtotime($main->inventaris->tanggal_dokument != '0000-00-00') ? '-' : date('d M Y', strtotime($main->inventaris->tanggal_dokument)) }}"
                                    disabled
                                />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" class="form-control input-sm required" name="keterangan" @disabled($view_mark) id="keterangan">{{ $main->inventaris->keterangan }}</textarea>
                            </div>
                        </div>
