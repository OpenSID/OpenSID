        ...
        <div class="col-md-9">
            <div class="box box-info">
                <div class="box-header with-border">
                    @include('admin.layouts.components.tombol_kembali', ['url' => site_url('inventaris_asset_mutasi'), 'label' => 'Daftar Mutasi Asset Lainnya'])
                </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-3 control-label required" style="text-align:left;" for="nama_barang">Nama
                                Barang</label>
                            <div class="col-sm-8">
                                <input type="hidden" name="id_inventaris_jalan" id="id_inventaris_jalan" value="{{ $main->inventaris->id }}">
                                <input
                                    maxlength="50"
                            ...
                            <div class="col-sm-4">
                                <select name="mutasi" id="mutasi" class="form-control input-sm" @disabled($view_mark)>
                                    <optgroup label="Penghapusan">
                                        ...
                                        <option value="Diperbaiki" @selected($main->jenis_mutasi == 'Diperbaiki')>Status Diperbaiki</option>
                                    </optgroup>
                                    ...
                                    <optgroup label="Jual">
                                        <option value="Masih Baik Dijual" @selected($main->jenis_mutasi == 'Masih Baik Dijual')>Masih Baik
                                        </option>
                                        <option value="Barang Rusak Dijual" @selected($main->jenis_mutasi == 'Barang Rusak Dijual')>Rusak
                                        </option>
                                    </optgroup>
                                </select>
                            </div>
                        ...
                        <div class="form-group disumbangkan">
                            ...
                            <div class="col-sm-8">
                                <input
                                    ...
                                    id="sumbangkan"
                                    type="text"
                                    value="{{ $main->inventaris->sumbangkan }}"
                                />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input
                                    ...
                                    id="tahun"
                                    type="text"
                                    value="{{ strtotime($main->inventaris->tahun_pengadaan != '0000-00-00') ? '-' : date('d M Y', strtotime($main->inventaris->tahun_pengadaan)) }}"
                                    disabled
                                />
                            </div>
                        </div>
                        <div class="form-group harga_jual">
                            ...
                            <div class="col-sm-4">
                                <input
                                    ...
                                    id="harga_jual"
                                    type="text"
                                    value="{{ $main->inventaris->harga_jual }}"
                                    @disabled($view_mark)
                                />
                            </div>
                        </div>
