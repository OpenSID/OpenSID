...
@section('title')
    <h1>
        {{ $action }} Data Mutasi Inventaris Peralatan Dan Mesin
    </h1>
@endsection

@section('breadcrumb')
    <li><a href="{{ site_url('inventaris_peralatan_mutasi') }}">Daftar Mutasi Inventaris Peralatan Dan Mesin</a></li>
        ...
        <div class="col-md-9">
            <div class="box box-info">
                <div class="box-header with-border">
                    <x-kembali-button judul="Kembali Ke Daftar Mutasi Peralatan Dan Mesin" url="inventaris_peralatan_mutasi" />
                </div>
