...
<div class="box box-info">
    <div class="box-header with-border">
        ...
        <div class="btn-group btn-group-vertical">
            <a class="btn btn-social btn-flat btn-success btn-sm" data-toggle="dropdown"><i class='fa fa-plus'></i>
                Tambah</a>
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a href="{{ site_url("suplemen/form_terdata/{$suplemen->id}/1") }}" class="btn btn-social btn-block
                        btn-sm" title="Tambah Satu Data Warga"><i class="fa fa-plus"></i> Tambah Satu Data Warga</a>
                </li>
                <li>
                    <a href="{{ site_url("suplemen/form_terdata/{$suplemen->id}/2") }}" class="btn btn-social btn-block
                        btn-sm" title="Tambah Beberapa Data Warga"><i class="fa fa-plus"></i> Tambah Beberapa Data
                        Warga</a>
                </li>
            </ul>
        </div>
