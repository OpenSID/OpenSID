...
<div class="box box-info">
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <select class="form-control input-sm required" {{ $suplemen->sasaran && $suplemen->terdata->count() > 0
                    ? 'disabled' : '' }} required name="sasaran">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="form-control input-sm required" placeholder="Nama Data Suplemen" type="text" name="nama"
                    value="{{ $suplemen->nama }}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea name="keterangan" class="form-control input-sm" maxlength="300" placeholder="Keterangan"
                    rows="3" style="resize:none;">{{ $suplemen->keterangan }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea name="keterangan" class="form-control input-sm" maxlength="300" placeholder="Keterangan" rows="3"
                style="resize:none;">{{ $suplemen->keterangan }}</textarea>
        </div>
    </div>
</div>
<div class="box-footer">
