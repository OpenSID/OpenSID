...
<div class="box box-info">
    <div class="box-header with-border">
        <a href="{{ ci_route('suplemen') }}"
            class="btn btn-social btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Suplemen</a>
        <a href="{{ ci_route('suplemen.rincian', $suplemen->id) }}"
            class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Terdata Suplemen</a>
    </div>
    ...
    <form id="main" name="main" method="POST" class="form-horizontal">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control required input-sm select2 required" required
                        onchange="formAction('main')" id="terdata" name="id_terdata" style="width:100%;"
                        data-suplemen="{{ $suplemen->id }}" data-sasaran="{{ $suplemen->sasaran }}">
                        @if ($individu)
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label" for="nama">{{ $suplemen->sasaran == 1 ? 'Nama Terdata' : 'Kepala Keluarga'
            }}</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea name="keterangan" class="form-control input-sm" maxlength="300" placeholder="Keterangan" rows="3"
                style="resize:none;">{{ $terdata->keterangan }}</textarea>
        </div>
    </div>
</div>
