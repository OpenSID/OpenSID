        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input id="ukuran" name="ukuran" class="form-control input-sm number" min="100" max="400" type="text" placeholder="Kosongkan jika ingin dimensi bawaan" />
                    </div>
                </div>
    ...
    <div class="col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                <a href="{{ route('identitas_desa') }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Data {{ ucwords($setting->sebutan_desa) }}"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Data Identitas
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="kode_pos">Kode Pos
                        {{ ucwords($setting->sebutan_desa) }}</label>
                    <div class="col-sm-2">
                        <input id="kode_pos" name="kode_pos" class="form-control input-sm number" minlength="5" maxlength="5" type="text" placeholder="Kode Pos {{ ucwords($setting->sebutan_desa) }}" value="{{ $main['kode_pos'] }}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="email_desa">E-Mail
                        {{ ucwords($setting->sebutan_desa) }}</label>
                    <div class="col-sm-8">
                        <input id="email_desa" name="email_desa" class="form-control input-sm email" maxlength="50" type="text" placeholder="E-Mail {{ ucwords($setting->sebutan_desa) }}" value="{{ $main['email_desa'] }}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="telepon">Nomor Ponsel
                        {{ ucwords($setting->sebutan_desa) }}</label>
                    <div class="col-sm-8">
                        <input id="telepon-operator" name="nomor_operator" class="form-control input-sm bilangan" type="text" maxlength="15" placeholder="Nomor Ponsel" value="{{ $main['nomor_operator'] }}" />
                    </div>
                </div>
                @endif
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="website">Website
                        {{ ucwords($setting->sebutan_desa) }}</label>
                    <div class="col-sm-8">
                        <input id="website" name="website" class="form-control input-sm url" maxlength="50" type="text" placeholder="Website {{ ucwords($setting->sebutan_desa) }}" value="{{ $main['website'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input readonly id="nama_kecamatan" name="nama_kecamatan" class="form-control input-sm required" type="text" placeholder="Nama {{ ucwords($setting->sebutan_kecamatan) }}" value="{{ $main['nama_kecamatan'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="kode_kecamatan">Kode
                        {{ ucwords($setting->sebutan_kecamatan) }}</label>
                    <div class="col-sm-2">
                        <input readonly id="kode_kecamatan" name="kode_kecamatan" class="form-control input-sm required" type="text" placeholder="Kode {{ ucwords($setting->sebutan_kecamatan) }}" value="{{ $main['kode_kecamatan'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="nama_kecamatan">Nama
                    ...
                    <div class="col-sm-8">
                        <input id="nama_kepala_camat" name="nama_kepala_camat" class="form-control input-sm nama required" maxlength="50" type="text" placeholder="Nama {{ ucwords($setting->sebutan_camat) }}" value="{{ $main['nama_kepala_camat'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="nip_kepala_camat">NIP
                        {{ ucwords($setting->sebutan_camat) }}</label>
                    <div class="col-sm-4">
                        <input id="nip_kepala_camat" name="nip_kepala_camat" class="form-control input-sm nomor_sk" maxlength="50" type="text" placeholder="NIP {{ ucwords($setting->sebutan_camat) }}" value="{{ $main['nip_kepala_camat'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input readonly id="nama_kabupaten" name="nama_kabupaten" class="form-control input-sm required" type="text" placeholder="Nama {{ ucwords($setting->sebutan_kabupaten) }}" value="{{ $main['nama_kabupaten'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="kode_kabupaten">Kode
                        {{ ucwords($setting->sebutan_kabupaten) }}</label>
                    <div class="col-sm-2">
                        <input readonly id="kode_kabupaten" name="kode_kabupaten" class="form-control input-sm required" type="text" placeholder="Kode {{ ucwords($setting->sebutan_kabupaten) }}" value="{{ $main['kode_kabupaten'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="nama_propinsi">Nama Provinsi</label>
                    <div class="col-sm-8">
                        <input readonly id="nama_propinsi" name="nama_propinsi" class="form-control input-sm required" type="text" placeholder="Nama Propinsi" value="{{ $main['nama_propinsi'] }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="kode_propinsi">Kode Provinsi</label>
                    <div class="col-sm-2">
                        <input readonly id="kode_propinsi" name="kode_propinsi" class="form-control input-sm required" type="text" placeholder="Kode Provinsi" value="{{ $main['kode_propinsi'] }}" />
                    </div>
                </div>
            </div>
