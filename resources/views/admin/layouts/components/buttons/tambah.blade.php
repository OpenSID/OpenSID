@if (can('u'))
    @if ($modal)
        <a href="{{ site_url($url) }}"
            ...
            title="{{ $judul ?? 'Tambah' }} Data" data-target="#{{ $modalTarget ?? 'modalBox' }}" data-remote="false"
            data-toggle="modal" data-backdrop="false" data-keyboard="false" data-title="{{ $judul ?? 'Tambah' }} Data"><i
    ...
    @else
        <a href="{{ site_url($url) }}"
            ...
            title="{{ $judul ?? 'Tambah' }} Data" target="_blank"><i
