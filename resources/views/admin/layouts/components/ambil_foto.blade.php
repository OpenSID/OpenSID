    ...
    <div class="box-body box-profile">
        ...
        @if (isset($show_dimensi) && $show_dimensi)
            <div class="row" style="margin-bottom: 8px">
                ...
                <div class="col-sm-6">
                    <input name="lebar" class="form-control input-sm bilangan" type="number" value="200"
                        placeholder="200">
                </div>
            </div>
            <div class="row" style="margin-bottom: 8px">
                ...
                <div class="col-sm-6">
                    <input name="tinggi" class="form-control input-sm bilangan" type="number" value="200"
                        placeholder="200">
                </div>
            </div>
        @endif
        ...
        <div class="input-group input-group-sm text-center">
            ...
            <span class="input-group-btn">
                ...
                @if (!empty($penduduk['id']))
                    <a href="#" data-href="{{ ci_route('penduduk.foto_bawaan', $penduduk['id']) }}"
                        class="btn btn-warning btn-block" title="Kembalikan" data-toggle="modal"
