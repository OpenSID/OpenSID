<div class="box box-widget">
    <div class="box-footer no-padding">
        <ul class="nav nav-stacked">
            <li class="@active($selected_nav == 'peraturan')"><a href="{{ site_url('dokumen_sekretariat/peraturan') }}">{{ SebutanDesa('Buku Peraturan di [Desa]') }}</a>
            </li>
            <li class="@active($selected_nav == 'keputusan')"><a href="{{ site_url('dokumen_sekretariat/keputusan') }}">Buku Keputusan {{ ucwords(setting('sebutan_kepala_desa')) }}</a></li>
