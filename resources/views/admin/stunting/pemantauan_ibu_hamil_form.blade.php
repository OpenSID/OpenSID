...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('stunting/pemantauan_ibu_hamil') }}">Bulanan Ibu Hamil</a></li>
        ...
        <div class="col-md-9 col-lg-9">
            <div class="box box-info">
                <div class="box-header with-border">
                    <a href="{{ route('stunting.pemantauan_ibu_hamil') }}"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->pemeriksaan_kehamilan)">
                                        <input type="radio" name="pemeriksaan_kehamilan" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->pemeriksaan_kehamilan) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->pemeriksaan_kehamilan)">
                                        <input type="radio" name="pemeriksaan_kehamilan" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->pemeriksaan_kehamilan) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div id="konsumsi_pil_fe" name="konsumsi_pil_fe" class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->konsumsi_pil_fe)">
                                        <input type="radio" name="konsumsi_pil_fe" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->konsumsi_pil_fe) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->konsumsi_pil_fe)">
                                        <input type="radio" name="konsumsi_pil_fe" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->konsumsi_pil_fe) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->pemeriksaan_nifas)">
                                        <input type="radio" name="pemeriksaan_nifas" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->pemeriksaan_nifas) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->pemeriksaan_nifas)">
                                        <input type="radio" name="pemeriksaan_nifas" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->pemeriksaan_nifas) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->konseling_gizi)">
                                        <input type="radio" name="konseling_gizi" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->konseling_gizi) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->konseling_gizi)">
                                        <input type="radio" name="konseling_gizi" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->konseling_gizi) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->kunjungan_rumah)">
                                        <input type="radio" name="kunjungan_rumah" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->kunjungan_rumah) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->kunjungan_rumah)">
                                        <input type="radio" name="kunjungan_rumah" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->kunjungan_rumah) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->akses_air_bersih)">
                                        <input type="radio" name="akses_air_bersih" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->akses_air_bersih) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->akses_air_bersih)">
                                        <input type="radio" name="akses_air_bersih" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->akses_air_bersih) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->kepemilikan_jamban)">
                                        <input type="radio" name="kepemilikan_jamban" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->kepemilikan_jamban) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->kepemilikan_jamban)">
                                        <input type="radio" name="kepemilikan_jamban" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->kepemilikan_jamban) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-xs-12 col-sm-12" data-toggle="buttons">
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active($ibuHamil->jaminan_kesehatan)">
                                        <input type="radio" name="jaminan_kesehatan" class="form-check-input" type="radio" value="1"
                                            @checked($ibuHamil->jaminan_kesehatan) autocomplete="off">Ya
                                    </label>
                                    <label
                                        class="btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-6 form-check-label @active(!$ibuHamil->jaminan_kesehatan)">
                                        <input type="radio" name="jaminan_kesehatan" class="form-check-input" type="radio" value="0"
                                            @checked(!$ibuHamil->jaminan_kesehatan) autocomplete="off">Tidak
                                    </label>
                                </div>
                            </div>
                        </div>
