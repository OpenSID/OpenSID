        ...
        <tr>
            <td>
                <table border="1" class="border thick">
                    <thead>
                        <tr>
                            <th colspan="9" style="text-align: left; padding: 15px 10px;">TABEL 1. JUMLAH SASARAN 1.000 HPK (IBU
                                HAMIL DAN ANAK 0-23 BULAN)</th>
                        </tr>
                        <tr>
                            <th width="15%" rowspan="2" colspan="3" class="text-center" style="vertical-align: middle;">Sasaran</th>
                            <th width="45%" rowspan="2" colspan="2" class="text-center" style="vertical-align: middle;">JML TOTAL
                                RUMAH TANGGA 1.000 HPK </th>
                        ...
                        <tr>
                            <th colspan="9" style="padding: 10px;"></th>
                        </tr>
                        <tr>
                            <th colspan="9" style="text-align: left; padding: 15px 10px;">TABEL 2. HASIL PENGUKURAN TIKAR PERTUMBUHAN (DETEKSI DINI STUNTING) </th>
                        </tr>
                        <tr>
        ...
        <tr>
            <td>
                <table border="1" class="border thick">
                    <thead>
                        <tr>
                            <th colspan="9" style="text-align: left; padding: 15px 10px;">TABEL 3. KELENGKAPAN KONVERGENSI PAKET
                        ...
                        <tr>
                            ...
                            <td colspan="3" rowspan="2" style="vertical-align: middle;">Orang tua/pengasuh yang memiliki
                                ...
                                sekali. </td>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">Laki-laki</th>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">
                                <?= $dataAnak0sd2Tahun['jumlah'] ?>
                            </td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">
                                <?= $dataAnak0sd2Tahun['persen'] ?>
                            </td>
                        </tr>
                        <tr>
                            <th colspan="9" style="padding: 10px;"></th>
                        ...
                        <tr>
                            <th colspan="9" style="text-align: left; padding: 15px 10px;">TABEL 4. TINGKAT KONVERGENSI DESA
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th colspan="9" style="text-align: left; padding: 15px 10px;">TABEL 5. PENGGUNAAN DANA DESA DALAM
