...
{!! form_open_multipart($form_action, 'id="validasi"') !!}
	<div class='modal-body'>
		<div class="form-group">
			...
			<a href="{{ route('unduh' , encrypt('assets/import/format_impor_klasifikasi_surat.xlsx')) }}" class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block text-center"><i class="fa fa-file-excel-o"></i> Contoh Format Impor Klasifikasi</a>
		</div>
	</div>
