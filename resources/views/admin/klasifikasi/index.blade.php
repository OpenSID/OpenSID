    ...
    <div class="{{ $modul_ini != 'sekretariat' ? 'col-md-9' : 'col-md-12' }}">
        <div class="box box-info">
            <div class="box-header with-border">
                @if (can('u'))
                <a href="{{ ci_route('klasifikasi.form') }}"
                ...
                <a href="#confirm-delete" title="Hapus Data"
                    onclick="deleteAllBox('mainform', '{{ ci_route('klasifikasi.delete_all') }}')"
                ...
                @endif
                @if (can('u'))
                <a href="{{ ci_route('klasifikasi.impor') }}"
                    ...
                    title="Impor" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Impor"><i
                        class="fa fa-upload "></i> Impor</a>
                @endif
                <a href="{{ ci_route('klasifikasi.ekspor') }}"
                    class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    title="Ekspor"><i class="fa fa-download"></i> Unduh</a>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
