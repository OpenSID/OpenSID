<form id="validasi" action="{{ $form_action }}" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control input-sm required" id="judul" name="judul" value="{{ $main->judul }}" placeholder="Judul" @disabled($main->kirim)/>
        </div>

        <div class="form-group">
            <label for="tahun">Tahun</label>
            <input type="number" class="form-control input-sm required" id="tahun" name="tahun" value="{{ $main->tahun }}" placeholder="Tahun"  @disabled($main->kirim) min="1945" max="2030"/>
        </div>
