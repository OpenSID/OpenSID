    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                @include('admin.layouts.components.tombol_kembali', ['url' => ci_route('web_widget'), 'label' =>
                'Widget'])
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input id="judul" name="judul" class="form-control input-sm strip_tags judul required"
                            type="text" placeholder="Judul Widget" value="{{ $widget['judul'] }}"></input>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select id="isi-statis" name="isi-statis" class="form-control input-sm select2 required">
                            ...
                            <optgroup label="{{ $theme }}">
                                ...
                                <option @selected($widget['isi']===str_replace('.blade.php', '' ,
                                    basename($temaWidget)))
                                    value="{{ str_replace('.blade.php', '', basename($temaWidget)) }}">
                                    {{ $temaWidget }}
                                </option>
                                @endforeach
                            </optgroup>
                        ...
                        @else
                        <span
                            class="help-block"><code>Widget tidak tersedia atau sudah ditambahkan semua (desa/widgets atau desa/themes/nama_tema/resources/views/widgets)</code></span>
                        @endif
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="status" id="status" class="form-control input-sm required">
                            ...
                            <option value="{{ $value }}" @selected(isset($widget['enabled']) &&
