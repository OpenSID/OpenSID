...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('teks_berjalan') }}">Teks Berjalan</a></li>
		...
		<div class="box-body">
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea id="teks" class="form-control input-sm required" placeholder="Isi teks berjalan"
						name="teks" rows="5" style="resize:none;">{{ $teks['teks'] }}</textarea>
				</div>
			</div>
			<div class="col-sm-12">
				<div class="form-group">
			...
			<div class="col-md-12" id="box_judul_tautan" style="display: {{ $teks['tautan'] ? '' : 'none'; }}">
				<div class="form-group">
					...
					<input {{ $teks['tautan'] ? '' : 'disabled' ; }} class="form-control input-sm required" placeholder="Judul tautan ke artikel atau url" name="judul_tautan" id="input_judul_tautan" value="{{ $teks['judul_tautan'] }}" maxlength="150"/>
				</div>
			</div>
			<div class="col-sm-12">
				<div class="form-group">
