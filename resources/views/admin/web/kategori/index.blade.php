...
<div class="box box-info">
    <div class="box-header with-border">
        @if (can('u'))
        <a href="{{ ci_route('kategori.ajax_form', $parent) }}" title="Tambah {{ $parent > 0 ? 'Sub' : '' }} Kategori"
        ...
        <a href="#confirm-delete" title="Hapus Data"
            onclick="deleteAllBox('mainform', '{{ ci_route('kategori.delete', $parent) }}')"
