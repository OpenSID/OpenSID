...
<div class="box box-info">
  <div class="box-header with-border">
    ...
    @endif
    @if (can('h'))
      <a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '{{ route('surat_mohon.deleteAll') }}')" class="btn btn-social btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus</a>
    @endif
  </div>
  <div class="box-body">
...
<script>
  $(document).ready(function () {
    var TableData = $('#tabeldata').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "{{ route('surat_mohon.datatables') }}",
      columns: [
        ...
        { data: 'ref_syarat_nama', name: 'ref_syarat_nama', searchable: true, orderable: true },
      ],
      order: [[ 3, 'asc' ]]
    });
