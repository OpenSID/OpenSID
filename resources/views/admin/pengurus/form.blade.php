            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input id="pamong_nama" name="pamong_nama" class="form-control input-sm pengurus-luar-desa <?= !empty($individu) ?: 'required' ?>" type="text" placeholder="Nama" value="<?= $pamong['pamong_nama'] ?>" style="display: none;" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input id="pamong_nik" name="pamong_nik" class="form-control input-sm pengurus-luar-desa nik" type="text" maxlength="16" placeholder="Nomor Induk Kependudukan" value="<?= $pamong['pamong_nik'] ?>" style="display: none;" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="pamong_niap"><?= setting('sebutan_nip_desa') ?></label>
                    <div class="col-sm-7">
                        <input id="pamong_niap" name="pamong_niap" class="form-control input-sm digits" type="text" maxlength="25" placeholder="<?= setting('sebutan_nip_desa') ?>" value="<?= $pamong['pamong_niap'] ?>" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input id="pamong_tag_id_card" name="pamong_tag_id_card" class="form-control input-sm pengurus-luar-desa tag_id_card" type="text" maxlength="17" placeholder="Tag ID Card" value="<?= $pamong['pamong_tag_id_card'] ?>" style="display: none;" />
                    </div>
                </div>
                <div class="form-group">
