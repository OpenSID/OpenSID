                                                                ...
                                                                >
                                                                    <tr>
                                                                        <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <a href="{{ site_url("pengguna/verifikasi/{$hash}?signature={$signature}&expires={$expire}") }}" class="button button-primary" target="_blank" rel="noopener"
                                                ...
                                                <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                    <p
                                                        ...
                                                        ><a href="{{ site_url("verify-email/{$hash}?signature={$signature}&expires={$expire}") }}"
                                                            ...
                                                            >{{ site_url("pengguna/verifikasi/{$hash}?signature={$signature}&expires={$expire}") }}</a></span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
