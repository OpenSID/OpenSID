                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p
                                            ...
                                            Anda menerima email ini karena kami menerima permintaan setel ulang sandi untuk akun Anda.</p>
                                        <table
                                            class="action"
                                            align="center"
                                            width="100%"
                                                                ...
                                                                >
                                                                    <tr>
                                                                        <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <a href="{{ ci_route("siteman.reset_kata_sandi.{$token}?email={$email}") }}" class="button button-primary" target="_blank" rel="noopener"
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Tautan pengaturan ulang kata sandi ini akan kedaluwarsa dalam 60 menit.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Jika Anda tidak meminta pengaturan ulang kata sandi, tidak ada tindakan lebih lanjut yang diperlukan.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Salam,<br>OpenSID</p>
                                            ...
                                            <tr>
                                                <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                    <p
                                                        ...
                                                        Jika Anda kesulitan mengklik tombol "Setel Ulang Kata Sandi", salin dan tempel URL di bawah ini
                                                        ...
                                                        ><a href="{{ ci_route("siteman.reset_kata_sandi.{$token}?email={$email}") }}"
                                                            ...
                                                            >{{ ci_route("siteman.reset_kata_sandi.{$token}?email={$email}") }}</a></span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
