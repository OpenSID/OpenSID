...
<div class="box box-info">
    <div class="box-header with-border">
        @if (can('u'))
        <a href="{{ ci_route('lampiran.form') }}" title="Tambah Lampiran Surat"
        ...
        <a href="#confirm-delete" title="Hapus Data"
            onclick="deleteAllBox('mainform','{{ ci_route('lampiran/delete_all') }}')"
        ...
        <div class="btn-group-vertical radius-3">
            ...
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a href="{{ ci_route('lampiran.impor') }}" class="btn btn-social btn-block btn-sm"
                ...
                <li>
                    <a target="_blank" class="btn btn-social btn-block btn-sm aksi-terpilih"
                        title="Ekspor Lampiran Surat"
                        onclick="formAction('mainform', '{{ ci_route('lampiran.ekspor') }}'); return false;"><i
                            class="fa fa-download"></i> Ekspor Lampiran Surat</a>
                </li>
            </ul>
        </div>
        <a href="{{ ci_route('pengaturan_lampiran') }}" title="Pengaturan"
            class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
            <i class="fa fa-gear"></i> Pengaturan
        </a>
        @endif
        <a href="{{ ci_route('surat_master') }}"
