...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-sm nama_desa required" id="nama" name="nama"
                                placeholder="Nama lampiran" value="{{ $lampiranSurat->nama }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                        <label id="lm1"
                            ...
                            <input id="im1" type="radio" name="status" class="form-check-input" type="radio" value="1"
                        ...
                        <label id="lm2"
                            class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$lampiranSurat->status)">
                            <input id="im2" type="radio" name="status" class="form-check-input" type="radio" value="0"
                                @checked(!$lampiranSurat->status)
                            autocomplete="off"
                            >Tidak Aktif
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control input-sm select2-tags required" name="orientasi">
                            ...
                            <option value="{{ $value }}" @selected(($lampiranSurat->orientasi ?? $default_orientations)
                                === $value)>
                                {{ $value }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control input-sm select2-tags required" name="ukuran">
                            ...
                            <option value="{{ $value }}" @selected(($lampiranSurat->ukuran ?? $default_sizes) ===
                                $value)>
                                {{ $value }}</option>
                            @endforeach
                        </select>
        ...
        <div class="tab-pane" id="template-lampiran">
            ...
            <div class="box-body">
                <div class="form-group">
                    <textarea name="template_desa" data-filemanager='<?= json_encode(['
                        external_filemanager_path'=> base_url() . 'assets/filemanager/', 'filemanager_title' => 'Responsive Filemanager', 'filemanager_access_key' => $session->fm_key], JSON_THROW_ON_ERROR) ?>' data-salintemplate="isi" class="form-control input-sm editor required">{{ $lampiranSurat->template_desa ?? $lampiranSurat->template }}</textarea>
                </div>
            </div>
        </div>
