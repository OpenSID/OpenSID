<div class="tab-pane active" id="pengaturan-umum">
    ...
    <div class="box-body form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control input-sm nama_terbatas required" id="nama" name="nama"
                        placeholder="Nama Layanan" value="{{ $suratMaster->nama }}" />
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control input-sm" id="satuan_masa_berlaku" name="satuan_masa_berlaku">
                            ...
                            <option value="{{ $kode_masa }}" @selected($suratMaster->satuan_masa_berlaku ===
                                $kode_masa)>{{ $judul_masa }}
                            </option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <select class="form-control input-sm select2-tags required" name="orientasi">
                    ...
                    <option value="{{ $value }}" @selected(($suratMaster->orientasi ?? $default_orientations) ===
                        $value)>
                        {{ $value }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons" style="margin: 0 0 5px 0">
                <label id="lmg1"
                    ...
                    <input id="img1" type="radio" name="margin_global" @checked($margin_global) class="form-check-input"
                        type="radio" value="1" autocomplete="off">Ya
                </label>
                <label id="lmg2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$margin_global)">
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons" style="margin: 0 0 5px 0">
                <label id="lmg11"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active($format_nomor_global)">
                    <input id="img11" type="radio" name="format_nomor_global" @checked($format_nomor_global)
                        class="form-check-input" type="radio" value="1" autocomplete="off">Ya
                </label>
                <label id="lmg21"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$format_nomor_global)">
                    <input id="img21" type="radio" name="format_nomor_global" class="form-check-input"
                        @checked(!$format_nomor_global) type="radio" value="0" autocomplete="off">Tidak
                </label>
            </div>
            <div id="manual_nomor_surat" style="display: none;">
                <div class="col-sm-7 col-sm-offset-3">
                    <input type="text" class="form-control input-sm" name="format_nomor"
                        placeholder="[nomor_surat, 3]/PK-TBT/[bulan_romawi]/[tahun]" value="{{ $format_nomor }}">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <select class="form-control input-sm select2" name="lampiran[]" multiple="multiple"
                    data-placeholder="Pilih Lampiran">
                    @foreach ($daftar_lampiran as $value)
                    <option value="{{ $value }}" @selected(in_array($value, explode(',', $suratMaster->lampiran)))>{{
                        $value }} </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lq1"
                    ...
                    <input id="iq1" type="radio" name="qr_code" class="form-check-input" type="radio" value="1"
                ...
                <label id="lq2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->qr_code)">
                    <input id="iq2" type="radio" name="qr_code" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->qr_code)
                    autocomplete="off"
                    >Tidak
                </label>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lh1" for="ih1"
                    ...
                    <input id="ih1" type="radio" name="header" class="form-check-input" type="radio" value="1"
                        @checked($header==1) autocomplete="off">Semua Halaman
                </label>
                <label id="lh2" for="lh2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active($header == 2)">
                    <input id="ih2" type="radio" name="header" class="form-check-input" type="radio" value="2"
                        @checked($header==2) autocomplete="off">Hanya Halaman Awal
                </label>
                <label id="lh3" for="lh3"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active($header == 0)">
                    <input id="ih3" type="radio" name="header" class="form-check-input" type="radio" value="0"
                        @checked($header==0) autocomplete="off">Tidak
                </label>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lf1"
                    ...
                    <input id="if1" type="radio" name="footer" class="form-check-input" type="radio" value="1"
                        @checked($footer) autocomplete="off">Ya
                </label>
                <label id="lf2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$footer)">
                    <input id="if2" type="radio" name="footer" class="form-check-input" type="radio" value="0"
                        @checked(!$footer) autocomplete="off">Tidak
                </label>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lbg1"
                    ...
                    <input id="ibg1" type="radio" name="logo_garuda" class="form-check-input" type="radio" value="1"
                ...
                <label id="lbg2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->logo_garuda)">
                    <input id="ibg2" type="radio" name="logo_garuda" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->logo_garuda)
                    autocomplete="off"
                    >Tidak
                </label>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lk1"
                    ...
                    <input id="ik1" type="radio" name="kecamatan" class="form-check-input" type="radio" value="1"
                ...
                <label id="lk2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->kecamatan)">
                    <input id="ik2" type="radio" name="kecamatan" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->kecamatan)
                    autocomplete="off"
                    >Tidak
                </label>
        ...
        <div class="form-group">
            ...
            <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
                <label id="lm1"
                    ...
                    <input id="im1" type="radio" name="mandiri" class="form-check-input" type="radio" value="1"
                ...
                <label id="lm2"
                    class="tipe btn btn-info btn-sm col-xs-12 col-sm-6 col-lg-3 form-check-label @active(!$suratMaster->mandiri)">
                    <input id="im2" type="radio" name="mandiri" class="form-check-input" type="radio" value="0"
                        @checked(!$suratMaster->mandiri)
                    autocomplete="off"
                    >Tidak
                </label>
...
<div class="modal fade" id="confirm-restore" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-exclamation-triangle text-red"></i> Konfirmasi
                </h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-social btn-danger btn-sm pull-left" data-dismiss="modal"><i
                        class="fa fa-sign-out"></i> Tutup</button>
                <a class="btn-ok">
                    <a href="{{ ci_route('surat_master.restore_surat_bawaan', $suratMaster->url_surat) }}"
                        class="btn btn-social btn-success btn-sm" id="ok-restore"><i class="fa fa-refresh"></i>
                        Kembalikan</a>
                </a>
            </div>
        </div>
