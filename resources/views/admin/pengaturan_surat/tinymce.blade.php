...
<div class="tab-pane" id="form-isian">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs customized-tab" id="tabs">
            ...
            <li id="list-{{ $item }}" data-name="{{ $item }}"><a href="#tab-{{ $item }}" data-toggle="tab">{{ str_replace('_', ' ', $item) }}</a></li>
            @empty
            @endforelse
        </ul>
        <div class="tab-content custom">
            <div class="tab-pane active" id="form-utama">
                <div class="box-body">
                    <button type="button" class="utama-delete btn btn-danger btn-sm pull-right hide" onclick="deleteTab(event)"><i class="fa fa-times-circle"></i> Hapus Tab</button>
                        ...
                        <table class="table table-hover table-striped sumber-data">
                            <tbody>
                                ...
                                <tr class="warga_desa">
                                    ...
                                    <td>
                                        <select id="individu_kk_level" class="form-control input-sm" name="individu_kk_level">
                                            <option value="">SEMUA</option>
            ...
            <div class="tab-pane" id="tab-{{ $item }}">
                ...
                <div class="box-body">
                    <button type="button" class="btn btn-danger btn-sm pull-right" data-kategori="{{ $item }}" onclick="deleteTab(event)"><i class="fa  fa-times-circle"></i> Hapus Tab</button>
                        ...
                        <table class="table table-hover table-striped sumber-data">
                            <tbody>
                                ...
                                <tr class="warga_desa">
                                    <td>Status Hubungan Dalam Keluarga (SHDK)</td>
                                    <td>
                                        <select id="individu_kk_level" class="form-control input-sm select2 kategori" name="kategori_individu_kk_level[{{ $item }}]">
                                            <option value="">SEMUA</option>
                                            @foreach ($form_isian['daftar_shdk'] as $key => $data)
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_kategori" placeholder="Nama Kategori" value="">
                        <label for="nama_kategori" generated="true" class="error" id="error_category"></label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="reset" class="btn btn-social btn-danger btn-sm"><i class="fa fa-times"></i> Batal</button>
                    <button type="submit" class="btn btn-social btn-info btn-sm" id="btn-new-tab" data-backdrop="false" data-dismiss="modal"><i class="fa fa-check"></i> Simpan</button>
                </div>
            </div>
        </div>
    </div>
            ...
            $("#form-utama").clone(true)
                .map(function() {
                    editElm = $(this)
                        ...
                        .find('select')
                        .end();
                    // console.log(editElm[0].querySelector('.sumber-data'));s
