        ...
        <div class="tab-pane" id="alur">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <span class="help-block text-red @display(!$sekdes)">User {{ $ref_jabatan->where('id', '=', 2)->first()->nama }} belum tersedia</span>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="input-group col-xs-12 col-sm-8">
                     ...
                     <span class="help-block text-red @display(!$kades)">User {{ $ref_jabatan->where('id', '=', 1)->first()->nama }} belum tersedia</span>
                </div>
            </div>
        </div>
            ...
            <div class="box-body">
                @if (!$kades)
                    <div class="callout callout-danger">
                         <p>Pengaturan modul TTE hanya bisa aktif jika user <strong>Kepala {{ setting('sebutan_desa') }}</strong> sudah dibuat dan aktif.</p>
                    </div>
                @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tte_api" class="form-control input-sm" value="{{ $tte['tte_api'] }}" @disabled(!$kades)>
                </div>
                <div class="form-group">
