<div class="box-header with-border">
    ...
    @if (in_array($suratMaster->jenis, [3, 4]))
        @if (super_admin() && $suratMaster->jenis == 3)
            <a
                id="restore_surat_bawaan"
                href="#"
                data-href="{{ ci_route('surat_master.restore_surat_bawaan', $suratMaster->url_surat) }}"
                title="Mengembalikan Surat Bawaan/Sistem"
                data-toggle="modal"
                data-target="#confirm-restore"
