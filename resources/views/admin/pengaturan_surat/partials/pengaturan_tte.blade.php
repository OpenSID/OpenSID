            ...
            <div class="input-group col-xs-12 col-sm-8">
                <div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons" style="padding: 0px;">
                    <label
                        ...
                        <input type="radio" name="tte" class="form-check-input" value="1" autocomplete="off"
                            @checked(setting('tte')=='1' ) @disabled(!$kades)>Ya</label>
                    <label
                        class="btn btn-info btn-flat btn-sm col-xs-6 col-sm-5 col-lg-3 form-check-label @active(setting('tte') == '0') @disabled(!$kades)">
                        <input type="radio" name="tte" class="form-check-input" value="0" autocomplete="off"
                            @checked(setting('tte')=='0' ) @disabled(!$kades)>Tidak
                    </label>
                </div>
            </div>
        </div>
