    ...
    <table class="table table-hover table-striped">
        <tbody>
            ...
            <tr class="duplikasi" id="gandakan-{{ $key }}" data-id="{{ $key }}">
                ...
                <td><input type="text" name="nama_kode[]" class="form-control input-sm isian" value="{{ $value->nama }}"
                ...
                <td>
                    <textarea
                        ...
                        name="pilihan_kode[]" rows="5" placeholder="Masukkan Pilihan" {{ $value->tipe != 'select-otomatis' || $value->tipe != 'select-manual' ? 'disabled' : '' }}>{{ json_encode($value->pilihan) }}
                    </textarea>
                    <select
