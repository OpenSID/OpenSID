                    ...
                    <table class="table table-bordered table-striped table-hover tabel-rincian">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ "Desa {$response->data->desa->nama_desa}, {{ ucwords(setting('sebutan_kecamtan')) }} {$response->data->desa->nama_kec}, Kabupaten {$response->data->desa->nama_kab}, Provinsi {$response->data->desa->nama_prov}" }}</td>
                                {{-- prettier-ignore-end --}}
                            </tr>
                            <tr>
                                <td>Domain Desa</td>
