        ...
        <div class='col-md-12'>
            <div class="callout callout-success update">
                ...
                <p align="justify">
                    ...
                    melakukan pembaruan dapat dilihat di <a
                        href="https://github.com/{{ config_item('nama_aplikasi') }}/{{ config_item('nama_aplikasi') }}/wiki/Panduan-Update-{{ config_item('nama_aplikasi') }}"
                ...
                <a href="{{ $rilis['url_download'] }}" class="btn btn-social bg-navy btn-sm"
