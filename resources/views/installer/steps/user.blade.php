    ...
    <form method="post" action="{{ site_url('install/user') }}">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                id="username" type="text" name="username" value="{{ set_value('username') }}" required>
        ...
        <div class="mb-3">
            ...
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="password" type="password" name="password" value="{{ set_value('password') }}" required>
        ...
        <div class="mb-3">
            ...
            <input
                class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="confirm_password" type="password" name="confirm_password" value="{{ set_value('confirm_password') }}" required>
