                                ...
                                <div id="smartwizard">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="langkah-4" class="tab-pane" role="tabpanel">
                                            ...
                                            <input type="text" class="form-control input-md bilangan pin required <?= jecho($cek_anjungan['keyboard'] == 1, true, 'kbvnumber') ?>" name="user_id" value="Akun Telegram Anda <?= $tgl_verifikasi_telegram != null ? 'Sudah' : 'Belum' ?> di verifikasi"
                            ...
                            <div class="<?= $tab_aktif['status'] == 1 ? 'active' : '' ?> tab-pane" id="email">
                                ...
                                <div id="smartwizard-email">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="langkah-4" class="tab-pane" role="tabpanel">
                                            <h2 class="StepTitle">Langkah 4 Status Verifikasi</h2>
                                            <input type="text" class="form-control input-md bilangan pin required <?= jecho($cek_anjungan['keyboard'] == 1, true, 'kbvnumber') ?>" name="user_email" value="Alamat Email Anda <?= $tgl_verifikasi_email != null ? 'Sudah' : 'Belum' ?> di verifikasi"
