                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <p>Klik tombol Perbaiki untuk memperbaiki semua collation table yang tidak
                                        sesuai menjadi collation <code>{{ $ci->db->dbcollat }}</code>.<br><a href="#"
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr data-log-tidak-sinkron="{{ $penduduk['nik'] }}">
                                        ...
                                        <td><button type="button" class="btn btn-sm btn-danger"
                                                data-title="Data Catatan Peristiwa Penduduk {{ $penduduk['nama'] }} / {{ $penduduk['nik'] }}"
                                                data-url='periksaLogPenduduk' data-ref='{!! json_encode([' penduduk'=>
                                                $penduduk]) !!}'
                                                data-toggle="modal"
                                                data-target="#modal-kosong"
                                                data-close-btn-center=1
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr data-log-keluarga-ganda="{{ $keluarga['id'] }}">
                                        ...
                                        <td><button type="button" class="btn btn-sm btn-danger"
                                                data-title="Data Catatan Peristiwa Keluarga {{ $keluarga['no_kk'] }} / {{ $keluarga['alamat'] }}"
                                                data-url='periksaLogKeluarga' data-ref='{!! json_encode([' keluarga'=>
                                                $keluarga]) !!}'
                                                data-toggle="modal"
                                                data-target="#modal-kosong"
                                                data-close-btn-center=0
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><button
                                                onclick="$.get('periksaKlasifikasiSurat/hapus', {id: {{ $klasifikasi['id'] }}},function(){$(event.target).replaceWith(`<button class='btn btn-sm btn-success'><i class='fa fa-check'></i> Sudah dihapus</button>`)},'json')"
                                                type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>
                                                Hapus </button></td>
                                    </tr>
                                    @endforeach
                                </table>
