...
<body class="hold-transition register-page">
	<div class="register-box">
		<div class="register-box-body">
			<h4 class="login-box-msg"><i class="fa fa-warning text-danger"></i> Koneksi database gagal</h4>
			<hr>
			<p>Atasi dengan melakukan langkah sebagai berikut:</p>
			<ol style="text-align: justify">
				<li>Pastikan telah membuat database untuk OpenSID.</li>
				<li>Buka file desa/config/database menggunakan editor.</li>
				...
				<li>Simpan file desa/config/database.</li>
