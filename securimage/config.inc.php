...
// Ambil konfigurasi database dari folder desa
$database_config = dirname(__FILE__) . '/../desa/config/database.php';
...
return array(
    ...
    'database_host'    => $db['default']['hostname'],     // database server host to connect to
    'database_user'    => $db['default']['username'],     // database user to connect as
    'database_pass'    => $db['default']['password'],     // database user password
    'database_name'    => $db['default']['database'],     // name of database to select (you must create this first or use an existing database)
