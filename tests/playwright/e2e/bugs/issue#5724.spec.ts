...
test.describe('Security: TinyMCE Image Plugin - Blind SSRF Prevention (Issue #5724)', () => {
  ...
  test('EXPLOIT: Should reject URL without protocol - imgur.com/image.jpg (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - URL Parsing Bypass without protocol',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject double protocol - http://https://malicious.com (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - Double Protocol Bypass',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject @ technique bypass - imgur.com@attacker.com (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - @ Symbol Bypass Technique',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject protocol-relative URL - //malicious.com (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - Protocol-Relative URL Bypass',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject mixed case protocol to bypass lowercase check (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - Case Bypass Technique',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject URL with encoded characters - http://127%2e0%2e0%2e1 (Issue #5724 Bypass)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - URL Encoding Bypass',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject IPv6 localhost - http://[::1]/image.jpg (Issue #5724)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - IPv6 Localhost Bypass',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject octal IP notation - http://0177.0.0.1 (Issue #5724)', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - Octal IP Bypass',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject OOB domain (Interactsh) without protocol - pixgynseoykkounnlrstf1hr0hzrcvau4.oast.fun/test.jpg', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - SSRF via OOB Domain without protocol',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject OOB domain (Interactsh) with https protocol - https://pixgynseoykkounnlrstf1hr0hzrcvau4.oast.fun/test.jpg', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - SSRF via OOB Domain (not whitelisted)',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
  ...
  test('EXPLOIT: Should reject OOB domain (Interactsh) with protocol-relative URL - //pixgynseoykkounnlrstf1hr0hzrcvau4.oast.fun/test.jpg', {
    annotation: {
      type: 'issue',
      description: 'https://github.com/OpenSID/premium/issues/5724 - SSRF via Protocol-relative URL',
    },
  }, async ({ page }) => {
    // Open image dialog
    const imageButton = page.locator('button[data-mce-name="image"]');
