				...
				<div>
					...
					<div id="isi">
						<table width="100%">
							...
							<tr><td >Alamat</td><td >:</td><td >RT. <?= unpenetration($ibu['rt'])?>, RW. <?= unpenetration($ibu['rw'])?>, Dusun <?= unpenetration(ununderscore($ibu['dusun']))?>, <?= ucwords($this->setting->sebutan_desa)?> <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten_singkat)?> <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
							...
							<tr><td >Alamat</td><td >:</td><td >RT. <?= unpenetration($ayah['rt'])?>, RW. <?= unpenetration($ayah['rw'])?>, Dusun <?= unpenetration(ununderscore($ayah['dusun']))?>, <?= ucwords($this->setting->sebutan_desa)?> <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten_singkat)?> <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
						</table>
						<div id="isi2">
							<table width="100%">
