...
<tr><td>Keterangan </td><td>:</td><td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo unpenetration(ununderscore($data['dusun']))?>, Rt. <?php echo $data['rt']?>, <?php echo unpenetration($desa['nama_desa'])?>, <?php echo unpenetration($desa['nama_kecamatan'])?>, <?php echo unpenetration($desa['nama_kabupaten'])?> akan menikah di KUA Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> <?php echo ucwords($this->setting->sebutan_kabupaten)?> <?php echo unpenetration($desa['nama_kabupaten'])?>. Berhubung orang tersebut tidak mempunyai Wali Nasab, kami mohon dengan hormat Bapak Kepala KUA Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> supaya berkenan menjadi Wali.</td></tr>
</table>
<table width="100%">
<tr></tr>
