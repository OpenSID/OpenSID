						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-horizontal">
							<div class="col-sm-12">
								...
								<div class="form-group bg-info" style="padding-top:10px;padding-bottom:5px">
									<label class="col-sm-3 text-right text-red"><strong>BARANG JUAL BELI :</strong></label>
								</div>
								<div class="form-group">
								...
								<div class="form-group bg-info" style="padding-top:10px;padding-bottom:5px">
									<label class="col-sm-3 text-right text-red"><strong>IDENTITAS BELI :</strong></label>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3 col-lg-2">
										<div class="input-group input-group-sm date">
											...
											<input title="Pilih Tanggal" class="form-control input-sm required" name="tanggallahir" id="tgl_1" type="text"/>
										</div>
									</div>
								</div>
								<div class="form-group">
