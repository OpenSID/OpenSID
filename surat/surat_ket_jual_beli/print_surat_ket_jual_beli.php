				...
				<div>
					...
					<div id="isi3">
						<table width="100%">
							...
							<tr><td>Tempat dan Tgl. Lahir (Umur)</td><td>:</td><td><?= ($data['tempatlahir'])?>, <?= tgl_indo($data['tanggallahir'])?> (<?= $data['umur']?> Tahun)</td></tr>
							...
							<?= $input['jenis']?> tersebut tidak dalam sengketa dengan pihak lain sehingga dapat dijual kepada pihak kedua yaitu:</td><td width="3%"></td><td width="64%"></td></tr>
					...
					<table width="100%">
						...
						<tr></tr>
						<tr></tr>
						<tr><td width="23%" align="center">Mengetahui,</td><td width="30%"></td><td  align="center"><?= $desa['nama_desa']?>, <?= $tanggal_sekarang?></td></tr>
						<tr><td width="23%" align="center">Ketua Adat <?= $desa['nama_desa']?></td><td width="30%"></td><td align="center"><?= $input['jabatan']?> <?= $desa['nama_desa']?></td></tr>
						<tr></tr>
						<tr></tr>
						<tr></tr>
						<tr></tr>
						...
						<tr></tr>
						<tr></tr>
						<tr><td  align="center">( <?= $input['ketua_adat']?> )<td></td><td align="center">( <?= $input['pamong']?> )</td></tr>
					</table>
				</div>
			</div>
			<div id="aside"></div>
