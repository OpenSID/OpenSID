						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-horizontal">
							<div class="col-md-12">
								...
								<div class="form-group bg-info" style="padding-top:10px;padding-bottom:5px">
									<label class="col-sm-3 text-right text-red"><strong>DATA KELAHIRAN :</strong></label>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="input-group input-group-sm date">
											...
											<input title="Pilih Tanggal" class="form-control input-sm required" name="tanggllahir" id="tgl_1" type="text"/>
										</div>
									</div>
								</div>
								<div class="form-group">
