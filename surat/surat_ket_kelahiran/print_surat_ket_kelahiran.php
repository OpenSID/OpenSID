		...
		<div id="content" class="container_12 clearfix">
			<div id="content-main" class="grid_7">
				...
				<div>
					...
					<table width="100%">
						<tr>
							<td class="indentasi">Yang bertanda tangan dibawah ini <?= unpenetration($input['jabatan'])?> <?= unpenetration($desa['nama_desa'])?>, Kecamatan <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten)?> <?= unpenetration($desa['nama_kabupaten'])?>, Provinsi <?= unpenetration($desa['nama_propinsi'])?> menerangkan bahwa pada: </td>
						</tr>
					</table>
					<div id="isi">
						<table width="100%">
							...
							<tr></tr>
							<tr></tr>
							<tr><td colspan="3">Telah lahir seorang anak <?= $input['sex']?> bernama : <?= unpenetration($input['nama_bayi'])?></td></tr>
							<tr></tr>
							<tr></tr>
							<tr></tr>
							<tr><td colspan="3"><strong>Dari seorang ibu :</strong></td></tr>
							<tr><td>Nama Lengkap</td><td>:</td><td><?= unpenetration($data['nama'])?></td></tr>
							...
							<tr><td>Alamat</td><td>:</td><td>RT. <?= $data['rt']?>, RW. <?= $data['rw']?>, Dusun <?= unpenetration(ununderscore($data['dusun']))?>, <?= ucwords($this->setting->sebutan_desa)?> <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten_singkat)?> <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
							<tr></tr>
							<tr></tr>
							<tr></tr>
							<tr><td colspan="3"><strong>Istri dari :</strong></td></tr>
							<tr><td>Nama Lengkap</td><td>:</td><td><?= unpenetration($data['nama_suami'])?></td></tr>
