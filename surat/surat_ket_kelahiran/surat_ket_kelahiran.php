		...
		<div class="row">
            ...
            <a href="#" class="btn btn-social btn-flat btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Lihat Info Isian Surat"  data-toggle="modal" data-target="#infoBox" data-title="Lihat Info Isian Surat">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group bg-info" style="margin-bottom:0px;padding-top:10px;padding-bottom:10px">
                ...
                <div class="form-group ibu_desa" <?php if (empty($ibu)) echo 'style="display: none;"'; ?>>
                  <label for="ibu_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA IBU DARI DATABASE :</strong></label>
                </div>
                <div class="form-group ibu_desa" <?php if (empty($ibu)) echo 'style="display: none;"'; ?>>
                  ...
                  <div class="col-sm-5">
                    <select class="form-control  input-sm select2" id="id_ibu" name="id_ibu" style ="width:100%;"  onchange="submit_form_ambil_data(this.id);">
                      <option value="">--  Cari NIK Ibu--</option>
                      <?php foreach ($perempuan as $data):?>
                        <option value="<?= $data['id']?>" <?php if ($ibu['nik']==$data['nik']){?>selected<?php }?>>NIK :<?= $data['nik']." - ".$data['nama']?></option>
                      <?php endforeach;?>
                    </select>
                  </div>
                </div>
                <?php if ($ibu): ?>
                  ...
                  <?php if (!empty($ayah)): ?>
                    <div class="form-group" >
                      <label for="ayah_desa"  class="col-sm-3 control-label text-red" ><strong>DATA AYAH DARI DATABASE :</strong></label>
                    </div>
                    <div class="form-group ibu_desa" <?php if (empty($ibu)) echo 'style="display: none;"'; ?>>
                      <label for="ibu_desa" class="col-sm-3 control-label" ><strong>NIK / Nama Ayah :</strong></label>
                      <div class="col-sm-8">
                ...
                <?php if (empty($ibu)): ?>
                  <div class="form-group ibu_luar_desa" >
                    <label for="ayah_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA IBU TIDAK TERDATA :</strong></label>
                  </div>
                  <div class="form-group ibu_luar_desa">
                  ...
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm required" name="tanggal_lahir_ibu" id="tgl_1" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_ibu']?>" onchange="$('input[name=umur_ibu]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="pekerjaanibu" id="pekerjaanibu" onchange="$('input[name=pekerjaanid_ibu]').val($(this).find(':selected').data('pekerjaanid'));">
                        ...
                        <?php foreach ($pekerjaan as $data):?>
                          <option value="<?= $data['nama']?>" data-pekerjaanid="<?= $data['id']?>" <?php if ($data['nama']==$_SESSION['post']['pekerjaanibu']) echo 'selected'?>><?= $data['nama']?></option>
                        <?php endforeach;?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-3">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggalperkawinan_ibu" id="tgl_2" type="text" value="<?= $_SESSION['post']['tanggalperkawinan_ibu']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ibu_luar_desa">
                ...
                <?php if (empty($ibu) or ($ibu and empty($ayah))): ?>
                  <div class="form-group ibu_luar_desa" >
                    <label for="ayah_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA AYAH TIDAK TERDATA :</strong></label>
                  </div>
                  <div class="form-group ibu_luar_desa">
                  ...
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_ayah" id="tgl_3" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tempat_lahir_ayah']?>" onchange="$('input[name=umur_ayah]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm select2" name="pekerjaanayah" id="pekerjaanayah" style ="width:100%;"  onchange="$('input[name=pekerjaanid_ayah').val($(this).find(':selected').data('pekerjaanid'));">
                        <option value="">-- Pekerjaan --</option>
                        <?php foreach ($pekerjaan as $data):?>
                          <option value="<?= $data['nama']?>" data-pekerjaanid="<?= $data['id']?>" <?php if ($data['nama']==$_SESSION['post']['pekerjaanayah']) echo 'selected'?>><?= $data['nama']?></option>
                        <?php endforeach;?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="form-group bg-info" style="margin-bottom:0px;padding-top:10px;padding-bottom:10px">
                  ...
                  <div class="btn-group col-sm-8" data-toggle="buttons">
                    ...
                    <label id="label_bayi_2" class="btn btn-info btn-flat btn-sm col-sm-4 col-md-4 col-lg-3 form-check-label <?php if (empty($bayi)):?>active<?php endif?>">
                      <input id="bayi_2" type="radio" name="bayi" class="form-check-input" type="radio" value="2" <?php if (empty($bayi)):?>checked<?php endif;?> autocomplete="off" onchange="ubah_bayi(this.value);"> Tidak Terdata
                    </label>
                  </div>
								</div>
                <div class="form-group bayi_desa" <?php if (empty($bayi)) echo 'style="display: none;"'; ?>>
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA KELAHIRAN DARI DATABASE</strong></label>
                </div>
                <div class="form-group bayi_desa" <?php if (empty($bayi)) echo 'style="display: none;"'; ?>>
                ...
                <?php if (empty($bayi)): ?>
                  <div class="form-group bayi_luar_desa">
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA KELAHIRAN BELUM TERDATA</strong></label>
                  </div>
                  <div class="form-group bayi_luar_desa">
                    <label for="nama_bayi"  class="col-sm-3 control-label">Nama Bayi</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama_bayi" class="form-control input-sm required" placeholder="Nama Bayi" value="<?= $_SESSION['post']['nama_bayi']?>"></input>
                    </div>
                  </div>
                  <div class="form-group bayi_luar_desa">
                    <label for="nik_bayi"  class="col-sm-3 control-label">NIK Bayi</label>
                    <div class="col-sm-8">
                      <input type="text" name="nik_bayi" class="form-control input-sm required" placeholder="NIK Bayi" value="<?= $_SESSION['post']['nik_bayi']?>"></input>
                  ...
                  <div class="form-group bayi_luar_desa">
                    ...
                    <select name="sex" class="form-control input-sm required data_lahir" id="sex" onchange="$('input[name=nama_sex]').val($(this).find(':selected').text());">
                      ...
                      <?php foreach ($sex as $data):?>
                        <option value="<?= $data['id']?>" <?php if ($data['id']==$_SESSION['post']['sex']) echo 'selected'?>><?= $data['nama']?></option>
                      <?php endforeach;?>
                    </select>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input id="hari"  class="form-control input-sm data_lahir" type="text" placeholder="Hari Lahir" name="hari" value="<?= $_SESSION['post']['hari']?>">
                  </div>
                  <div class="col-sm-3">
                    <div class="input-group input-group-sm date">
                      <div class="input-group-addon">
                      ...
                      <input title="Pilih Tanggal" class="form-control input-sm data_lahir required" placeholder="Tgl. Lahir" name="tanggallahir" id="tgl_4" type="text" value="<?= $_SESSION['post']['tanggallahir']?>"/>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="input-group input-group-sm date">
                      ...
                      <input class="form-control input-sm data_lahir required" placeholder="Jam Lahir" name="waktu_lahir" id="jam_1" type="text"  value="<?= $_SESSION['post']['waktu_lahir']?>"/>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="tempat_dilahirkan" class="form-control input-sm required data_lahir" id="tempat_dilahirkan">
                      <?php foreach ($tempat_dilahirkan as $id => $nama):?>
                        <option value="<?= $id?>" <?php if ($_SESSION['post']['tempat_dilahirkan']==$id) echo 'selected'?>><?= $nama?></option>
                      <?php endforeach;?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="col-sm-4">
                    <select name="jenis_kelahiran" class="form-control input-sm required data_lahir" id="jenis_kelahiran">
                      <?php foreach ($jenis_kelahiran as $id => $nama):?>
                        <option value="<?= $id?>" <?php if ($_SESSION['post']['jenis_kelahiran']==$id) echo 'selected'?>><?= $nama?></option>
                      <?php endforeach;?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="col-sm-4">
                    <select name="penolong_kelahiran" class="form-control input-sm required data_lahir" id="jenis_kelahiran">
                      <?php foreach ($penolong_kelahiran as $id => $nama):?>
                        <option value="<?= $id?>" <?php if ($_SESSION['post']['penolong_kelahiran']==$id) echo 'selected'?>><?= $nama?></option>
                      <?php endforeach;?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group pelapor_desa" <?php if (empty($pelapor)) echo 'style="display: none;"'; ?>>
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA PELAPOR DARI DATABASE</strong></label>
                </div>
                <div class="form-group pelapor_desa" <?php if (empty($pelapor)) echo 'style="display: none;"'; ?>>
                  <label for="ibu_desa" class="col-sm-3 control-label" ><strong>NIK / Nama :</strong></label>
                  <div class="col-sm-5">
                ...
                <?php if (empty($pelapor)): ?>
                  <div class="form-group pelapor_luar_desa" >
                    <label for="ayah_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA PELAPOR LUAR DESA :</strong></label>
                  </div>
                  <div class="form-group pelapor_luar_desa">
                  ...
                  <div class="form-group pelapor_luar_desa">
                    ...
                    <div class="col-sm-8">
                      <input  class="form-control input-sm required" type="text" placeholder="NIK Pelapor" name="nama_pelapor" value="<?= $_SESSION['post']['nik_pelapor']?>">
                    </div>
                  </div>
                  <div class="form-group pelapor_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_pelapor" id="tgl_5" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_pelapor']?>" onchange="$('input[name=umur_pelapor]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group pelapor_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="pekerjaanpelapor" id="pekerjaanpelapor" onchange="$('input[name=pekerjaanid_pelapor]').val($(this).find(':selected').data('pekerjaanid'));">
                        <option value="">-- Pekerjaan --</option>
                        <?php foreach ($pekerjaan as $data):?>
                          <option value="<?= $data['nama']?>" data-pekerjaanid="<?= $data['id']?>" <?php if ($data['nama']==$_SESSION['post']['pekerjaanpelapor']) echo 'selected'?>><?= $data['nama']?></option>
                        <?php endforeach;?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group pelapor_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control input-sm" type="text" name="alamat_pelapor" id="alamat_pelapor" placeholder="Alamat Ibu" value="<?= $_SESSION['post']['alamat_pelapor']?>">
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group saksi1_desa" <?php if (empty($saksi1)) echo 'style="display: none;"'; ?>>
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA SAKSI 1 DARI DATABASE</strong></label>
                </div>
                <div class="form-group saksi1_desa" <?php if (empty($saksi1)) echo 'style="display: none;"'; ?>>
                ...
                <?php if (empty($saksi1)): ?>
                  <div class="form-group saksi1_luar_desa" >
                    <label for="ayah_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA SAKSI 1 LUAR DESA :</strong></label>
                  </div>
                  <div class="form-group saksi1_luar_desa">
                  ...
                  <div class="form-group saksi1_luar_desa">
                    ...
                    <div class="col-sm-8">
                      <input  class="form-control input-sm required" type="text" placeholder="NIK Saksi" name="nama_saksi1" value="<?= $_SESSION['post']['nik_saksi1']?>">
                    </div>
                  </div>
                  <div class="form-group saksi1_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_saksi1" id="tgl_6" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_saksi1']?>" onchange="$('input[name=umur_saksi1]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group saksi1_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="pekerjaansaksi1" id="pekerjaansaksi1" onchange="$('input[name=pekerjaanid_saksi1]').val($(this).find(':selected').data('pekerjaanid'));">
                        <option value="">-- Pekerjaan --</option>
                        <?php foreach ($pekerjaan as $data):?>
                          <option value="<?= $data['nama']?>" data-pekerjaanid="<?= $data['id']?>" <?php if ($data['nama']==$_SESSION['post']['pekerjaansaksi1']) echo 'selected'?>><?= $data['nama']?></option>
                        <?php endforeach;?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group saksi1_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control input-sm" type="text" name="alamat_saksi1" id="alamat_saksi1" placeholder="Alamat Ibu" value="<?= $_SESSION['post']['alamat_saksi1']?>">
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group saksi2_desa" <?php if (empty($saksi2)) echo 'style="display: none;"'; ?>>
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA SAKSI 2 DARI DATABASE</strong></label>
                </div>
                <div class="form-group saksi2_desa" <?php if (empty($saksi2)) echo 'style="display: none;"'; ?>>
                ...
                <?php if (empty($saksi2)): ?>
                  <div class="form-group saksi2_luar_desa" >
                    <label for="ayah_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA SAKSI 2 LUAR DESA :</strong></label>
                  </div>
                  <div class="form-group saksi2_luar_desa">
                  ...
                  <div class="form-group saksi2_luar_desa">
                    ...
                    <div class="col-sm-8">
                      <input  class="form-control input-sm required" type="text" placeholder="NIK Saksi" name="nama_saksi2" value="<?= $_SESSION['post']['nik_saksi2']?>">
                    </div>
                  </div>
                  <div class="form-group saksi2_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_saksi2" id="tgl_6" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_saksi2']?>" onchange="$('input[name=umur_saksi2]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group saksi2_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="pekerjaansaksi2" id="pekerjaansaksi2" onchange="$('input[name=pekerjaanid_saksi2]').val($(this).find(':selected').data('pekerjaanid'));">
                        <option value="">-- Pekerjaan --</option>
                        <?php foreach ($pekerjaan as $data):?>
                          <option value="<?= $data['nama']?>" data-pekerjaanid="<?= $data['id']?>" <?php if ($data['nama']==$_SESSION['post']['pekerjaansaksi2']) echo 'selected'?>><?= $data['nama']?></option>
                        <?php endforeach;?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group saksi2_luar_desa">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control input-sm" type="text" name="alamat_saksi2" id="alamat_saksi2" placeholder="Alamat Ibu" value="<?= $_SESSION['post']['alamat_saksi2']?>">
                    </div>
                    <div class="col-sm-2">
                ...
                <?php endif; ?>
                <div class="form-group">
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>PENANDA TANGAN</strong></label>
                </div>
                <div class="form-group">
