...
<page orientation="landscape" format="A3" style="font-size: 8pt">
  ...
  <table class="disdukcapil" style="margin-top: 0px; border: 0px;">
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan="20" class="kotak"><div><?php echo $individu['kepala_kk']?></div></td>
     ...
     <tr>
      ...
      <td>:</td>
      <td colspan="20" class="kotak"><div><?php echo $individu['alamat_wilayah']; ?></div></td>
    ...
    <tr>
      ...
      <?php for($i=0; $i<2; $i++) : ?>
        <td class="kotak padat tengah"><?php echo $jml[$i]?></td>
      <?php endfor; ?>
      <td>orang</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan=5 class="kotak"><?php echo $individu['dusun'];?></td>
    </tr>
 ...
 -->    <tr>
    ...
    <?php for($i=0; $i<MAX_ANGGOTA_F101; $i++): ?>
      <tr>
        ...
        <td class="tengah <?php echo $class?>"><?php echo $i+1; ?></td>
        <?php if ($i < count($anggota)) : ?>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['nama']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['nik']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['alamat_sebelumnya']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['dokumen_pasport']?></td>
          <td class="tengah <?php echo $class?>"><?php echo tgl_indo_out($anggota[$i]['tanggal_akhir_paspor'])?></td>
        <?php else: ?>
          <?php for($k=0; $k<5; $k++): ?>
            <td class="tengah <?php echo $class?>">&nbsp;</td>
          <?php endfor; ?>
        <?php endif;?>
      </tr>
    <?php endfor; ?>
    ...
    <?php for($i=0; $i<MAX_ANGGOTA_F101; $i++): ?>
      <tr>
        ...
        <?php if ($i < count($anggota)) : ?>
          ...
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['golongan_darah_id']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['agama_id']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['status_kawin_id']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo ($anggota[$i]['akta_perkawinan'] ? '2' : '1')?></div></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['akta_perkawinan']?></td>
          <td class="tengah <?php echo $class?>"><?php echo tgl_indo_out($anggota[$i]['tanggalperkawinan'])?></td>
          <td class="kode <?php echo $class?>"><div><?php echo ($anggota[$i]['akta_perceraian'] ? '2' : '1')?></div></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['akta_perceraian']?></td>
          <td class="tengah <?php echo $class?>"><?php echo tgl_indo_out($anggota[$i]['tanggalperceraian'])?></td>
        <?php else: ?>
          <?php for($k=0; $k<15; $k++): ?>
            <td class="tengah <?php echo $class?>">&nbsp;</td>
          <?php endfor; ?>
  ...
  <table style="margin-top: 5px; border-collapse: collapse;" class="disdukcapil">
    ...
    <?php for($i=0; $i<MAX_ANGGOTA_F101; $i++): ?>
      <tr>
        ...
        <td class="tengah <?php echo $class?>"><?php echo $i+1; ?></td>
        <?php if ($i < count($anggota)) : ?>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['kk_level']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo ($anggota[$i]['cacat_id'] ? '2' : '1')?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['cacat_id']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['pendidikan_kk_id']?></div></td>
          <td class="kode <?php echo $class?>"><div><?php echo $anggota[$i]['pekerjaan_id']?></div></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['ibu_nik']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['nama_ibu']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['ayah_nik']?></td>
          <td class="tengah <?php echo $class?>"><?php echo $anggota[$i]['nama_ayah']?></td>
        <?php else: ?>
          <?php for($k=0; $k<9; $k++): ?>
            <td class="tengah <?php echo $class?>">&nbsp;</td>
          <?php endfor; ?>
