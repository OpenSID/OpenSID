		...
		<div class="row">
          ...
          <div class="box-header with-border">
              ...
              <h5><strong>Form ini menghasilkan:</strong></h5>
							...
							<p>2. Lampiran F-2.29 SURAT KETERANGAN KEMATIAN bagi warga yang meninggal</p>
            ...
            <form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-horizontal">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  <label for="ttl"  class="col-sm-3 control-label">Hari / Tanggal / Jam Lahir</label>
                  <div class="col-sm-3">
                    <input  id="hari"  class="form-control input-sm" type="text" placeholder="Hari Lahir" name="hari" value="<?= $_SESSION['post']['hari']?>">
                  </div>
                  <div class="col-sm-3">
                    <div class="input-group input-group-sm date">
                      ...
                      <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_mati" id="tgl_1" type="text" value="<?= $_SESSION['post']['tanggal_mati']?>"/>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="input-group input-group-sm date">
                      ...
                      <input class="form-control input-sm required" name="jam" id="jam_1" type="text" value="<?= $_SESSION['post']['jam']?>"/>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_ayah" id="tgl_2" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tempat_lahir_ayah']?>" onchange="$('input[name=umur_ayah]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group ibu_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_ibu" id="tgl_3" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_ibu']?>" onchange="$('input[name=umur_ibu]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group pelapor_desa" <?php if (empty($pelapor)):?>style="display: none;"<?php endif;?>>
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>DATA PELAPOR WARGA DESA</strong></label>
                </div>
                <div class="form-group pelapor_desa" <?php if (empty($pelapor)):?>style="display: none;"<?php endif;?>>
                  ...
                  <div class="form-group pelapor_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_pelapor" id="tgl_4" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_pelapor']?>" onchange="$('input[name=umur_pelapor]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                ...
                <?php if (empty($saksi1)): ?>
                  ...
                  <div class="form-group saksi1_luar_desa">
                    <label for="nik_saksi1"  class="col-sm-3 control-label">NIK Pelapor</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group saksi1_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal" class="form-control input-sm required" name="tanggal_lahir_saksi1" id="tgl_5" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggal_lahir_saksi1']?>" onchange="$('input[name=umur_saksi1]').val(_calculateAge($(this).val()));"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                ...
                <?php if (empty($saksi2)): ?>
                  ...
                  <div class="form-group saksi2_luar_desa">
                    <label for="nik_saksi2"  class="col-sm-3 control-label">NIK Pelapor</label>
                    <div class="col-sm-8">
