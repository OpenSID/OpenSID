			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?php echo $form_action?>" method="POST" target="_blank" class="form-horizontal">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-3 col-lg-4">
										<input  id="hari" readonly="readonly" class="form-control input-sm" type="text" placeholder="Hari Lahir" name="hari" value="<?= $_SESSION['post']['hari']?>">
									</div>
