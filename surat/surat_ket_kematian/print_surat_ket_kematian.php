			...
			<div id="content-main" class="grid_7">
				...
				<div>
					...
					<table width="100%">
						...
						<tr></tr>
						<tr></tr>
						<tr><td class="indentasi">Yang bertanda tangan dibawah ini <?= unpenetration($input['jabatan'])?>  <?= unpenetration($desa['nama_desa'])?>, Kecamatan <?= unpenetration($desa['nama_kecamatan'])?>, <?= ucwords($this->setting->sebutan_kabupaten)?> <?= unpenetration($desa['nama_kabupaten'])?>, Provinsi <?= unpenetration($desa['nama_propinsi'])?> menerangkan bahwa: </td></tr>
					</table>
					<div id="isi3">
						<table width="100%">
							<tr><td width="35%">Nama</td><td width="3%">:</td><td ><?= unpenetration($data['nama'])?></td></tr>
							...
							<tr><td>Nama</td><td>:</td><td><?= unpenetration($input['nama'])?></td></tr>
