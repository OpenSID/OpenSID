		...
		<div>
			...
			<div id="isi3">
				<table width="100%">
					...
					<tr><td class="indentasi" colspan="3">Bahwa yang tersebut namanya diatas, memang benar penduduk kami yang memiliki usaha <?= $input['usaha']?>, berlokasi di Dusun <?= $data['dusun']?>, <?= ucwords($this->setting->sebutan_desa)?> <?= $desa['nama_desa']?>, Kecamatan <?= $desa['nama_kecamatan']?>, <?= ucwords($this->setting->sebutan_kabupaten)?> <?= $desa['nama_kabupaten']?>.</td></tr>
