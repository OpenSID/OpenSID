...
<h5 class="kop2"><?php echo $desa['alamat_kantor']?> Email : <?php echo (unpenetration($desa['email_desa']))?> Kode Pos : <?php echo (unpenetration($desa['kode_pos']))?></h5>
...
<div class="clear"></div>
<table width="100%">
<td  class="indentasi" colspan="3">Yang bertanda tangan dibawah ini Kepala Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan dengan sebenarnya bahwa :  </td></tr>
</table>
</table><div id="isi3">
<table width="100%">
...
<tr><td>Alamat/ Tempat Tinggal</td><td>:</td><td> <?php echo ucwords(strtolower($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo ununderscore(unpenetration($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?></td></tr>
</table>
<table width="100%"> 
<td  class="indentasi" colspan="3">Orang tersebut diatas adalah benar-benar warga kami yang bertempat tinggal di <?php echo ucwords(strtolower($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo ununderscore(unpenetration($data['dusun']))?> Desa <?php echo unpenetration($desa['nama_desa'])?> Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?> Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?> dan tercatat dengan
