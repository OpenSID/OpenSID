							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select class="form-control  input-sm select2" id="cari_nik" name="nik" style ="width:100%;" onchange="formAction('main')">
										<option selected="selected">--  Cari NIK Penduduk--</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group input-group-sm date">
										...
										<input title="Pilih Tanggal" name="berlaku_dari" id="tgl_1" class="form-control input-sm required" type="text"/>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="input-group input-group-sm date">
										...
										<input title="Pilih Tanggal" class="form-control input-sm required" name="berlaku_sampai" id="tgl_2" type="text"/>
									</div>
								</div>
							</div>
