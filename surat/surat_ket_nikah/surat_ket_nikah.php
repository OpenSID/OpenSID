            ...
            <form action="" id="main" name="main" method="POST" class="form-horizontal">
              <div class="col-md-12">
                ...
                <div class="form-group pria_desa" <?php if (empty($pria)):?>style="display: none;"<?php endif;?>>
                  <label for="pria_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>A.1 DATA CALON PASANGAN PRIA WARGA DESA :</strong></label>
                </div>
                <div class="form-group pria_desa" <?php if (empty($pria)):?>style="display: none;"<?php endif;?>>
              ...
              <div class="col-md-12">
                ...
                <?php if (empty($pria)): ?>
                  <div class="form-group pria_luar_desa" >
                    <label for="pria_luar_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>A.1 DATA CALON PASANGAN PRIA LUAR DESA</strong></label>
                  </div>
                  <div class="form-group pria_luar_desa">
                  ...
                  <div class="form-group pria_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_pria" id="tgl_1" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_pria']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group pria_luar_desa">
                ...
                <?php else: ?>
                  <div class="form-group ayah_pria" >
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>A.2 DATA AYAH PASANGAN PRIA (Isi jika ayah bukan warga <?= strtolower($this->setting->sebutan_desa)?> ini ini)</strong></label>
                  </div>
                  <div class="form-group ayah_pria">
                  ...
                  <div class="form-group ayah_pria">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_ayah_pria" id="tgl_2" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_ayah_pria']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ayah_pria">
                ...
                <?php else: ?>
                  <div class="form-group ibu_pria" >
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>A.3 DATA IBU PASANGAN PRIA (Isi jika ibu bukan warga <?= strtolower($this->setting->sebutan_desa)?> ini)</strong></label>
                  </div>
                  <div class="form-group ibu_pria">
                    <label class="col-sm-3 control-label" ><strong>Nama Lengkap</strong></label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group ibu_pria">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_ibu_pria" id="tgl_3" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_ibu_pria']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ibu_pria">
                ...
                <?php if (empty($pria) OR $pria['status_kawin']=="CERAI MATI"): ?>
                  <div class="form-group" >
                      <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>A.4 DATA ISTRI TERDAHULU </strong></label>
                    </div>
                  ...
                  <div class="form-group istri_dulu">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_istri_dulu" id="tgl_4" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_istri_dulu']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group istri_dulu">
                ...
                <div class="form-group wanita_desa" <?php if (empty($wanita)):?>style="display: none;"<?php endif;?>>
                  <label for="wanita_desa" class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.1 DATA CALON PASANGAN WANITA WARGA DESA :</strong></label>
                </div>
                <div class="form-group wanita_desa" <?php if (empty($wanita)):?>style="display: none;"<?php endif;?>>
                ...
                <?php if (empty($wanita)): ?>
                  <div class="form-group wanita_luar_desa" >
                    <label for="wanita_luar_desa"  class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.1 DATA CALON PASANGAN WANITA LUAR DESA</strong></label>
                  </div>
                  <div class="form-group wanita_luar_desa">
                  ...
                  <div class="form-group wanita_luar_desa">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_wanita" id="tgl_5" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_wanita']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group wanita_luar_desa">
                ...
                <?php if ($ayah_wanita): ?>
                  <div class="form-group" >
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.2 DATA AYAH PASANGAN WANITA</strong></label>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label" ><strong>Nama Lengkap</strong></label>
                    <div class="col-sm-8">
                ...
                <?php else: ?>
                  <div class="form-group ayah_wanita" >
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.2 DATA AYAH PASANGAN WANITA (Isi jika ayah bukan warga <?= strtolower($this->setting->sebutan_desa)?> ini)</strong></label>
                  </div>
                  <div class="form-group ayah_wanita">
                    <label class="col-sm-3 control-label" ><strong>Nama Lengkap</strong></label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group ayah_wanita">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_ayah_wanita" id="tgl_6" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_ayah_wanita']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ayah_wanita">
                ...
                <?php else: ?>
                  <div class="form-group ibu_wanita" >
                    <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.3 DATA IBU PASANGAN WANITA (Isi jika ibu bukan warga <?= strtolower($this->setting->sebutan_desa)?> ini)</strong></label>
                  </div>
                  <div class="form-group ibu_wanita">
                    <label class="col-sm-3 control-label" ><strong>Nama Lengkap</strong></label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group  ibu_wanita">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_ibu_wanita" id="tgl_7" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_ibu_wanita']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ibu_wanita">
                ...
                <?php if (empty($wanita) OR $wanita['status_kawin']=="CERAI MATI"): ?>
                  <div class="form-group" >
                      <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.4 DATA SUAMI TERDAHULU </strong></label>
                    </div>
                  ...
                  <div class="form-group suami_dulu">
                    ...
                    <div class="col-sm-2">
                      <div class="input-group input-group-sm date">
                        ...
                        <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_suami_dulu" id="tgl_8" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_suami_dulu']?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group suami_dulu">
                ...
                <?php endif; ?>
                <div class="form-group" >
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>B.5 DATA WALI NIKAH </strong></label>
                </div>
                ...
                <div class="form-group wali">
                  ...
                  <div class="col-sm-2">
                    <div class="input-group input-group-sm date">
                      ...
                      <input title="Pilih Tanggal"  class="form-control input-sm" name="tanggallahir_wali" id="tgl_9" type="text" placeholder="Tgl. Lahir" value="<?= $_SESSION['post']['tanggallahir_wali']?>"/>
                    </div>
                  </div>
                </div>
                <div class="form-group wali">
                ...
                <div class="form-group" >
                  <label class="col-xs-12 col-sm-3 col-lg-3 control-label bg-maroon" style="padding-top:10px;padding-bottom:10px"><strong>C. DATA PERNIKAHAN </strong></label>
                </div>
                <div class="form-group wali">
                  ...
                  <div class="col-sm-2">
                    <div class="input-group input-group-sm date">
                      ...
                      <input title="Pilih Tanggal"  class="form-control input-sm required" name="tanggal_nikah" id="tgl_10" type="text" placeholder="Tgl. Nikah" value="<?= $_SESSION['post']['tanggal_nikah']?>"/>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="input-group input-group-sm date">
