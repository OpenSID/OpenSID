			...
			<div>
				<table width="100%">
					...
					<div class="header">
						...
						<h5 class="kop2"><?= (unpenetration($desa['alamat_kantor']))?> <?= (unpenetration($desa['email_desa']))?> Kode Pos : <?= (unpenetration($desa['kode_pos']))?></h5>
				...
				<div id="isi3">
					<table width="100%">
						<tr><td width="23%">1. Nama Lengkap</td><td width="3%">:</td><td width="64%"><b><?= unpenetration($data['nama'])?></td></tr>
						...
						<tr><td>8. Alamat/ Tempat Tinggal</td><td>:</td><td><?= ucwords(strtolower($data['alamat']))?> RT. <?= $data['rt']?> RW. <?= $data['rw']?> Dusun <?= unpenetration(ununderscore($data['dusun']))?> Desa <?= unpenetration($desa['nama_desa'])?> Kecamatan <?= unpenetration($desa['nama_kecamatan'])?> Kabupaten <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
					</table>
					<table width="100%">
