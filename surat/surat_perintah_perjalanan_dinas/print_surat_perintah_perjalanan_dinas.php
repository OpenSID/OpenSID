			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<div align="center"><u><h4 class="kop">SURAT PERINTAH PERJALANAN DINAS</h4></u></div>
						<div align="center"><h4 class="kop">Nomor : <?= $input['nomor']?></h4></div>
					</table>
					<table width="100%">
						<td class="indentasi">Yang bertanda tangan dibawah ini Kepala <?= unpenetration($input['jabatan'])?> <?= unpenetration($desa['nama_desa'])?>, Kecamatan <?= unpenetration($desa['nama_kecamatan'])?>,
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td>Pangkat / Golongan </td><td>:</td><td><?= $input['pangkat_gol']?></td></tr>
								<tr><td>Jabatan </td><td>:</td><td><?= $input['jabatan1']?></td></tr>
								<tr><td>Tingkat Biaya Perjalanan </td><td>:</td><td><?= $input['biaya']?></td></tr>
							...
							<table width="100%">
								...
								<tr></tr>
								<tr></tr>
								<tr><td  class="indentasi">Demikian Surat Perintah Perjalanan Dinas ini  kami buat untuk dapat dipergunakan sebagaimana mestinya. </td></tr>
								<tr></tr>
								<tr></tr>
								<tr></tr>
								<tr></tr>
