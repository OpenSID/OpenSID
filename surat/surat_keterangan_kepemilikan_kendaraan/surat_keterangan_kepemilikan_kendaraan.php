...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Kepemilikan Kendaraan</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Keterangan Kepemilikan Kendaraan</li>
		</ol>
	</section>
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<div class="bg-primary col-sm-12">
									<br>IDENTITAS / DETAIL KENDARAAN<br><br>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<input name="nama_pemilik" class="form-control input-sm required" placeholder="Nama Pemilik Kendaraan">
								</div>
								<div class="col-sm-3">
									<label for="alamat_pemilik">Alamat Pemilik</label>
									<input name="alamat_pemilik" class="form-control input-sm required" placeholder="Alamat Pemilik Kendaraan">
								</div>
							</div>
