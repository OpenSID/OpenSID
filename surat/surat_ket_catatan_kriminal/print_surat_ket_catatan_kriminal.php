				...
				<div>
					...
					<div id="isi3">
						<table width="100%">
							...
							No. KK: <?= $data['no_kk']?> dengan NIK: <?= $data['nik']?>, kepala keluarga : <?= $data['kepala_kk']?> menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik </td></tr>
							<tr><td>Keperluan </td><td>:</td><td> Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk <?= $input['keterangan']?></td></tr>
						</table>
						<table width="100%">
							<tr><td class="indentasi">Demikian Surat ini dibuat, untuk dipergunakan sebagaimana mestinya.</td></tr>
							<tr></tr>
							<tr></tr>
							<tr></tr>
							<tr></tr>
					...
					<table width="100%">
						...
						<tr></tr>
						<tr></tr>
						<tr><td width="10%"></td><td width="50%"></td><td  align="center"><?= $desa['nama_desa']?>, <?= $tanggal_sekarang?></td></tr>
