				...
				<div>
					...
					<div id="isi3">
						<table width="100%">
							...
							No. KK: <?= $data['no_kk']?> dengan NIK: <?= $data['nik']?>, kepala keluarga : <?= unpenetration($data['kepala_kk'])?> menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik </td></tr>
