<?php
    ...
    $input['tanggal_lahir_kematian'] = $individu['tanggallahir'];
    $input['umur_kematian'] = str_pad($individu['umur'], 3, "0", STR_PAD_LEFT);
    $input['jk_kematian'] = $individu['sex_id'];
    $input['pekerjaanid_kematian'] = $individu['pekerjaan'];
    $input['pekerjaan_kematian'] = $individu['pekerjaan'];
