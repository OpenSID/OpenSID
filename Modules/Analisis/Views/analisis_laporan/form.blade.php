    ...
    <div class="col-md-8 col-lg-9">
        <div class="box box-info">
            <div class="box-header with-border">
                <a href="{{ ci_route('analisis_laporan.'.$analisis_master['id'].'.dialog_kuisioner.'.$id.'.cetak') }}"
                    class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Cetak Laporan Hasil Analisis {{ $asubjek }} {{ $subjek['nama'] }} "><i
                        class="fa fa-print "></i> Cetak</a>

                <a href="{{ ci_route('analisis_laporan.'.$analisis_master['id'].'.dialog_kuisioner.'.$id.'.unduh') }}"
                    class="btn btn-social bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Unduh Laporan Hasil Analisis {{ $asubjek }} {{ $subjek['nama'] }} "><i
                        class="fa fa-download "></i> Unduh</a>

                <a href="{{ ci_route('analisis_laporan', $analisis_master['id']) }}"
                    class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    title="Kembali Ke Laporan Hasil Klasifikasi">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td><a
                                    href="{{ ci_route('analisis_master.'.$analisis_master['id'].'.menu')  }}">{{ $analisis_master['nama'] }}</a>
                            </td>
                        </tr>
                        <tr>
