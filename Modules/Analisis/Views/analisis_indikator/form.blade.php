				...
				<div class="col-md-8 col-lg-9">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="{{ ci_route('analisis_indikator', $analisis_master['id']) }}"
								class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
									class="fa fa-arrow-circle-left "></i> Kembali Ke Indikator Analisis</a>
						</div>
						<div class="box-body">
							<div class="row">
										...
										<div class="col-sm-5">
											<select class="form-control select2" id="referensi" name="referensi" {{ $disabled }}>
												...
												<option value="{{ $referensi }}"
													@selected($analisis_indikator['referensi'] == $referensi) data-tipe="{{ $data['tipe'] ?? 4 }}">
										...
										<div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
											...
											<label id="sx2" {{ $disabled }}
												...
												<input id="group2" type="radio" name="id_tipe" class="form-check-input"
													type="radio" value="2" onclick="{{ $analisis_indikator['id_tipe'] }}"
													autocomplete="off">Pilihan (Ganda)
											</label>
											<label id="sx1" {{ $disabled }}
												...
												<input id="group1" type="radio" name="id_tipe" class="form-check-input"
													type="radio" value="3" onclick="{{ $analisis_indikator['id_tipe'] }}"
													autocomplete="off">Isian Jumlah (Kuantitatif)
											</label>
											<label id="sx4" {{ $disabled }}
												...
												<input id="group4" type="radio" name="id_tipe" class="form-check-input"
													type="radio" value="4" onclick="{{ $analisis_indikator['id_tipe'] }}"
													autocomplete="off">Isian Teks (Kualitatif)
											</label>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea id="pertanyaan" class="form-control input-sm required"
												placeholder="Pertanyaan" name="pertanyaan" rows="5"
												@readonly($analisis_master['jenis'] == 1)>{{ $analisis_indikator['pertanyaan']}}</textarea>
										</div>
									</div>
								</div>
								<div class="col-sm-12">
								...
								<div class="col-sm-12 delik">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input id="bobot" class="form-control input-sm number required" type="number"
												placeholder="Bobot Pertanyaan" min="0" max="100" name="bobot"
									...
									<div class="form-group">
										...
										<div class="btn-group col-sm-7" data-toggle="buttons">
											<label id="aksi1"
												...
												<input id="aksi1" type="radio" name="act_analisis" class="form-check-input"
													type="radio" value="1"
											...
											<label id="aksi2"
												...
												<input id="aksi2" type="radio" name="act_analisis" class="form-check-input"
													type="radio" value="2"
									...
									<div class="form-group">
										...
										<div class="btn-group col-sm-7" data-toggle="buttons">
											<label id="ss1"
												...
												<input type="radio" name="is_publik" class="form-check-input" type="radio"
													value="1" @checked($analisis_indikator['is_publik'] == '1')
													autocomplete="off"> Ya
											</label>
											<label id="ss2"
