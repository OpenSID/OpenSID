    ...
    <div class="col-md-8 col-lg-9">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <a href="{{ ci_route('analisis_respon.'.$analisis_master['id'].'.data_ajax') }}"
                    ...
                    title="Unduh data respon" data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Unduh Data Respon">
                    <i class="fa fa-download"></i>Unduh
                </a>
                @if (can('u'))
                <a href="{{ ci_route('analisis_respon.'.$analisis_master['id'].'.import') }}"
                    ...
                    title="Impor Data Respon" data-remote="false" data-toggle="modal" data-target="#modalBox"
                    data-title="Impor Data">
                    <i class="fa fa-upload"></i>Impor
                </a>
                    @if ($analisis_master['format_impor'] == 1) 
                    <a href="{{ ci_route('analisis_respon.'.$analisis_master['id'].'.form_impor_bdt') }}"
                        ...
                        title="Impor Data BDT 2015" data-remote="false" data-toggle="modal" data-target="#modalBox"
