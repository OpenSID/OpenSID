<div class='modal-body'>
    <form id="validasi" action="{{ ci_route('analisis_respon.'.$analisis_master['id'].'.data_unduh') }}"
        ...
        <p>
            ...
            <div class="timeline-footer row">
                <button name="tipe" value="1" type="submit" onclick="refreshFormCsrf()"
                    ...
                    wrap target="_blank"><i class="fa fa-download"></i> Form Excel + Isi Data</button>
            </div>
        </p>
        <p>
            Unduh form kosong menampilkan daftar kode untuk setiap kolom.
            <div class="timeline-footer row">
                <button name="tipe" value="2" type="submit" onclick="refreshFormCsrf()"
                    class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin"
                    wrap target="_blank"><i class="fa fa-download"></i> Form Excel + Kode Data</button>
            </div>
        </p>
