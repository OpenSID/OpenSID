...
<form id="validasi" action="{{ $form_action }}" method="post">
	<div class="modal-body">
		<div class="form-group">
			...
			<input id="kategori" class="form-control input-sm required nomor_sk" maxlength="50" type="text"
				placeholder="Kategori Indikator" name="kategori" value="{{ $analisis_kategori->kategori }}">
		</div>
	</div>
