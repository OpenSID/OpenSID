    ...
    <div class="col-md-8 col-lg-9">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                @if (can('u'))
                <a href="{{ ci_route('analisis_klasifikasi.'.$analisis_master['id'].'.form' ) }}"
                    data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Data"
                    class="btn btn-social btn-success btn-sm"><i class='fa fa-plus'></i>
                    Tambah</a>

                @endif
                @if (can('h'))
                <a href="#confirm-delete" title="Hapus Data"
                    onclick="deleteAllBox('mainform', '{{ ci_route('analisis_klasifikasi.'.$analisis_master['id'].'.delete') }}')"
