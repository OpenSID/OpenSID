...
<div class="box box-info">
    <div class="box-header with-border">
        <a href="{{ ci_route('analisis_master') }}"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="nama" class="form-control input-sm required judul" maxlength="40" type="text"
                                placeholder="Nama Analisa" name="nama" value="{{ $analisis_master['nama'] }}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
                ...
                <div class=" col-sm-12">
                    <div class="form-group hide" id="idelik">
                        ...
                        <div class="col-sm-7 col-lg-4">
                            <select class="form-control input-sm" id="id_kelompok" name="id_kelompok"
                                style="width:100%">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-4">
                            <select class="form-control input-sm" id="format_impor" name="format_impor"
                                @selected($analisis_master['jenis'] == 1)>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="pembagi" class="form-control input-sm bilangan_titik" maxlength="10" type="text"
                                placeholder="Bilangan Pembagi" name="pembagi"
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea id="deskripsi" class="form-control input-sm required"
                                placeholder="Deskripsi Analisis"
                                name="deskripsi">{{ $analisis_master['deskripsi'] }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input readonly class="form-control input-sm"
                                value="{{ tgl_indo($analisis_master['gform_last_sync']) }}">
                        </div>
                    </div>
                </div>
                @endif
