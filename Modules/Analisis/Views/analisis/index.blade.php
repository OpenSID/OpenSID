    ...
    <div class="box-header with-border">
        ...
        <div class="btn-group btn-group-vertical">
            ...
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a href="{{ ci_route('analisis_master.form') }}" class="btn btn-social btn-block btn-sm"
                        title="Analisis Baru"><i class="fa fa-plus"></i> Analisis Baru</a>
                </li>
                <li>
                    <a href="{{ ci_route('analisis_master.import_gform') }}" class="btn btn-social btn-block btn-sm"
                        title="Impor dari Google Form" data-remote="false" data-toggle="modal" data-target="#modalBox"
                        data-title="Impor Google Form"><i class="fa fa-plus"></i> Impor dari Google Form</a>
                </li>
            </ul>
        </div>
        @endif
        ...
        <a href="#confirm-delete" title="Hapus Data"
            onclick="deleteAllBox('mainform', '{{ ci_route('analisis_master.delete') }}')"
        ...
        @endif
        @if(can('u'))
        <a href="{{ ci_route('analisis_master.import_analisis') }}"
            class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
            title="Impor Analisis" data-remote="false" data-toggle="modal" data-target="#modalBox"
            data-title="Impor Analisis"><i class="fa fa-upload"></i> Impor Analisis</a>
        @endif
    </div>
    <div class="box-body">
        <div class="row mepet">
