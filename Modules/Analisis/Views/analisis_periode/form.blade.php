...
<form id="validasi" action="{{ $form_action }}" method="post">
    <div class="box-body">
        <div class="form-group">
            ...
            <input id="nama" class="form-control input-sm required nomor_sk" type="text"
                placeholder="Nama Priode" name="nama" value="{{ $analisis_periode['nama'] }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="tahun_pelaksanaan" class="form-control input-sm required bilangan" maxlength="4"
                type="text" placeholder="Tahun" name="tahun_pelaksanaan" value="{{ $analisis_periode['tahun_pelaksanaan'] }}">
        </div>
        @if(! $analisis_periode)
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="keterangan" class="form-control input-sm" placeholder="Keterangan"
                name="keterangan" rows="5">{{ $analisis_periode['keterangan'] }}</textarea>
        </div>
        <div class="form-group">
