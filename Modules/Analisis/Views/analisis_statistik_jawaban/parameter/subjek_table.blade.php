	...
	<div class="col-md-8 col-lg-9">
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<a href="{{ ci_route('analisis_statistik_jawaban', $analisis_master['id']) }}"
					class="btn btn-social btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
					title="Kembali Ke Laporan Per Indikator"><i class="fa fa-arrow-circle-left "></i>Kembali Ke
							...
							<table class="table table-bordered dataTable table-hover nowrap">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="{{ ci_route('penduduk.detail', $data->id_pend) }}"
												target="_blank">{{ $data->nik }}</a></td>
										<td nowrap width="30%"><a
												href="{{ ci_route('penduduk.detail', $data->id_pend) }}"
												target="_blank">{{ $data->nama }}</a></td>
