    ...
    <div class="col-md-8 col-lg-9">
        <div class="box box-info">
            <div class="box-header with-border">
                <form id="validasi" action="{{ ci_route('analisis_statistik_jawaban.'.$analisis_master['id'].'.cetak') }}"
                    method="POST" target="_blank">
                    <button name="tipe" value="cetak" type="submit"
                                class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                                target="_blank"><i class="fa fa-print"></i> Cetak</button>
                    <button name="tipe" value="unduh" type="submit"
                                ...
                                target="_blank"><i class="fa fa-download"></i> Unduh</button>
