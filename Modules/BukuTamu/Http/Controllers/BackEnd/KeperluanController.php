...
use Modules\BukuTamu\Http\Requests\KeperluanRequest;
...
class KeperluanController extends AnjunganBaseController
{
    ...
    public function insert(KeperluanRequest $request)
    {
        isCan('u');
    ...
    public function update(KeperluanRequest $request, $id = null)
    {
        isCan('u');
