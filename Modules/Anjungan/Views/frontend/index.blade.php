...
<head>
    ...
    <link href="{{ module_asset('css/default.css') }}" rel="stylesheet">
    <link href="{{ module_asset('css/color/nature.css') }}" rel="stylesheet">
    <link href="{{ module_asset('css/color/nature.css') }}" rel="stylesheet alternate" title="nature" />
    <link href="{{ module_asset('css/color/travel.css') }}" rel="stylesheet alternate" title="travel" />
    <link href="{{ module_asset('css/color/casual.css') }}" rel="stylesheet alternate" title="casual" />
    <link href="{{ module_asset('css/darkmode.css') }}" rel="stylesheet">
    <link href="{{ module_asset('css/style.css') }}" rel="stylesheet">
    <link href="{{ module_asset('css/screen.css') }}" rel="stylesheet">
    @stack('css')

    <!-- jQuery 3 -->
    <script src="{{ module_asset('js/jquery.min.js') }}"></script>
    <script src="{{ module_asset('js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ module_asset('js/flickity.js') }}"></script>
</head>
    ...
    <div class="full-container" id="element">
        ...
        <div class="anjungan-head plr-master difle-l">
            ...
            <div class="topright difle-l">
                <a class="topright-icon radius-4 popup" title="Kehadiran Perangkat Desa" data-value="./kehadiran"><img src="{{ module_asset('images/icon/absen.png') }}">
                    <p>Absen</p>
                </a>
                <a class="topright-icon radius-4" href="./buku-tamu"><img src="{{ module_asset('images/icon/bukutamu.png') }}">
                    <p>Buku<br />Tamu</p>
                </a>
                <?php $pemerintah = explode(' ', ucwords(setting('sebutan_pemerintah_desa'))); ?>
                <a class="topright-icon radius-4" data-bs-toggle="modal" data-bs-target="#aparatur"><img src="{{ module_asset('images/icon/aparatur.png') }}">
                    <p><?= $pemerintah[0] ?><br /><?= $pemerintah[1] ?></p>
                </a>
                <a class="topright-icon radius-4 popup" data-value="./layanan-mandiri/masuk"><img src="{{ module_asset('images/icon/mandiri.png') }}">
                    <p>Layanan<br />Mandiri</p>
                </a>
                <div style="position:relative;">
                    <div class="topright-icon radius-4" data-bs-toggle="dropdown">
                        <div><img src="{{ module_asset('images/icon/warna.png') }}">
                            <p>Pilih<br />Warna</p>
                        </div>
                    </div>
                    <div class="dropdown-menu colorstyle" role="menu">
                        ...
                        <div class="darklight difle-l" onclick="setDarkMode(true)" id="darkBtn">
                            <div class="darklight-icon radius-4 difle-c"><img src="{{ module_asset('images/icon/dark.png') }}"></div>
                            <p>Gelapkan Layar</p>
                        </div>
                    </div>
                </div>
                <div class="topright-icon iconhid radius-4" id="openfull" onclick="openFullscreen();">
                    <div><img src="{{ module_asset('images/icon/maximize.png') }}">
                        <p>Full<br />Screen</p>
                    </div>
                </div>
                <div class="topright-icon iconhid radius-4" id="exitfull" onclick="closeFullscreen();">
                    <div><img src="{{ module_asset('images/icon/minimize.png') }}">
...
<script>
    var light = '{{ module_asset('images/icon/light.png') }}';
    var dark = '{{ module_asset('images/icon/dark.png') }}';
</script>

<script src="{{ module_asset('js/support.js') }}"></script>
