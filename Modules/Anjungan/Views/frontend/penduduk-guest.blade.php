                ...
                <div class="content">
                    <section>
                        <div class="article-box d-flex"
                            style="height:46.5vh; display:flex; align-items:center; justify-content:center; padding:0;">
                            <form id="form-ktp" action="{{ ci_route('anjungan-mandiri/penduduk-guest') }}" method="POST" autocomplete="off"
                                style="width:100%; max-width:340px; margin:auto; text-align:center;">
                                ...
                                @if (ENVIRONMENT == 'development')
                                    ...
                                    <div class="form-group" style="margin-bottom:12px;width:100%;">
                                        <input type="text" class="form-control" id="tag_id_card" name="tag_id_card" placeholder="Pindai KTP-el di sini"
                                            required autofocus
                                ...
                                @else
                                    ...
                                    <input type="text" id="tag_id_card" name="tag_id_card" placeholder="Pindai KTP-el di sini" required autofocus
                                        style="width:0; height:0; overflow:hidden; border:none; padding:0; margin:0;">
                                @endif
                            
                                <button type="submit" class="btn btn-primary btn-block"
                                    style="width:100%; padding:8px 0; font-size:1em; border-radius:5px; background:var(--bg2); color:#fff; border:none; {{ $display }}">
                                    Lanjutkan
                                </button>
                            </form>
                        </div>
                    ...
                    <section>
                        <div class="article-box difle-c"
                            style="height:46.5vh;align-items:center;justify-content:center;padding:0;">
                            <form action="{{ ci_route('anjungan-mandiri/penduduk-guest') }}" method="POST"
                                autocomplete="off" style="width:100%;max-width:340px;margin:auto;">
                                <input type="hidden" name="{{ $ci->security->get_csrf_token_name() }}"
                                    value="{{ $ci->security->get_csrf_hash() }}" />
                                <div class="form-group" style="margin-bottom:12px;width:100%;">
                                ...
                                <button type="submit" class="btn btn-primary btn-block"
                                    style="width:100%;padding:8px 0;font-size:1em;border-radius:5px;background:var(--bg2);color:#fff;border:none;">Lanjutkan</button>
                            </form>
                        </div>
                    </section>
                </div>
