    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header btn-warning">
                ...
                <h4 class="modal-title">III. ANGGOTA KELUARGA</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="table-responsive" id="tabel_ket_demografi">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-demografi"') !!}
                    ...
                    <div class="table-responsive" id="tabel_pendidikan">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-pendidikan"') !!}
                        ...
                        <table class="table table-bordered table-hover" style="margin-bottom: 0px;">
                            ...
                            <tbody>
                                ...
                                <tr id="tr_4_415">
                                    <td>415. Ijazah/STTB tertinggi yang dimiliki</td>
                                    <td>
                                        @include('admin.layouts.components.select_pilihan_dtsen', [
                                            'class' => 'select2',
                    ...
                    <div class="table-responsive" id="tabel_ketenagakerjaan">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-ketenagakerjaan"') !!}
                        ...
                        <table class="table table-bordered table-hover" style="margin-bottom: 0px;">
                            ...
                            <tbody>
                                ...
                                <tr id="tr_4_418">
                                    <td>418. Status dalam pekerjaan utama</td>
                                    <td>
                                        @include('admin.layouts.components.select_pilihan_dtsen', [
                                            'class' => 'select2',
                                ...
                                <tr id="tr_4_419a">
                                    <td>Keterampilan khusus/sertifikat keahlian yang dimiliki</td>
                                    <td>
                                        @include('admin.layouts.components.select_pilihan_dtsen', [
                                            'class' => 'select2',
                                            'attribut' => 'id="pilihan_4_419a" name="pilihan[4][419a]"',
                                            'pilihan' => $pilihan4['419a'],
                                        ])
                                    </td>
                                </tr>
                                <tr id="tr_4_419b">
                                    <td>Pendapatan sebulan terakhir</td>
                                    <td>
                                        @include('admin.layouts.components.select_pilihan_dtsen', [
                                            'class' => 'select2',
                                            'attribut' => 'id="pilihan_4_419b" name="pilihan[4][419b]"',
                                            'pilihan' => $pilihan4['419b'],
                                        ])
                                    </td>
                                </tr>
                    ...
                    <div class="table-responsive" id="tabel_kepemilikan_usaha">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-kepemilikan-usaha"') !!}
                        ...
                        <table class="table table-bordered table-hover" style="margin-bottom: 0px;">
                            ...
                            <tbody>
                                ...
                                <tr id="tr_4_421">
                                    <td>421. Apakah lapangan usaha dari usaha utama tersebut?</td>
                                    <td>
                                        @include('admin.layouts.components.select_pilihan_dtsen', [
                                            'class' => 'select2',
                    ...
                    <div class="table-responsive" id="tabel_kesehatan">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-kesehatan"') !!}
                    ...
                    <div class="table-responsive" id="tabel_program_perlindungan_sosial">
                        {!! form_open( ci_route('dtsen/pendataan/save') . '/' . $dtsen->id, 'class="form-4 form-validasi" id="form-4-program-perlindungan-sosial"') !!}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modal-tab4').on('show.bs.modal', function (e) {
                ...
                let table = button.data('table') || 'tabel_ket_demografi'; // Ambil data-table
                
                console.log('Modal dibuka, table:', table); // Untuk debugging
                
                // Hide semua tabel dulu
                $('#tabel_ket_demografi, #tabel_pendidikan, #tabel_ketenagakerjaan, #tabel_kepemilikan_usaha, #tabel_kesehatan, #tabel_program_perlindungan_sosial').hide();
                
                // Show tabel yang dipilih
                $('#' + table).show();
            });
